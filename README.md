...
- 다음 보강 우선순위는 로그 정책 런타임 적용/전파, ADM 거래/오류/감사 통합 관제 고도화, 브라우저 클릭 검증, broker 실연동 검증, center-cut 기본 구현체 순서입니다.
