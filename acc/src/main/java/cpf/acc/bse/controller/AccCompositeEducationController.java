...
public class AccCompositeEducationController {
    ...
    @Operation(summary = "ACC 오케스트레이션 복합 거래", description = "ACC가 MBR 조회 후 EXS 외부연계를 호출하고 transactionGlobalId와 segment 흐름을 반환합니다.")
    ...
    @Operation(summary = "MBR 중첩 외부연계 복합 거래", description = "ACC가 MBR을 호출하고 MBR이 EXS를 호출하는 중첩 흐름을 반환합니다.")
