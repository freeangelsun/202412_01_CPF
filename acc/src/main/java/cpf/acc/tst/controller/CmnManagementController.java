...
/**
 * ACC??퐣 CMN ?⑤벏???온??疫꿸퀡????꾪뀱??롫뮉 ??묐탣 ?뚢뫂?껅에?살쑎??낅빍??
 *
 * <p>CMN?? ?꾨뗀諭? 롫뗄?놅쭪?, ??쇱젟?쏆늿? 쏆뮆而??⑤벏???怨쀬뵠?怨? ?온?귐뗫???덈뼄.
 * ???뚢뫂?껅에?살쑎??ACC ??끦??λ퓠??CMN ??뺥돩??? 욊낯??雅뚯눘??쳸?녿툡 鈺곌퀬???源낆쨯/??륁젟/?????귐뗫늄??됰뻻???꾪뀱??롫뮉
 * ??? ??????됰뻻??낅빍??</p>
 *
 * <p>CRUD쎛 ?源껊궗??롢늺 ?CMN ??뺥돩??? ??? ?Ŋ?녺몴?앸맩???귐뗫늄??됰뻻????
 * 쏆늿? WAS ??됰퓠??뺣뮉 ??쇱벉 鈺곌퀬?띌겫???ㅼ뮇??DB 쏅???쏆꼷???몃빍??</p>
 */
@RestController
@Validated
...
public class CmnManagementController {
    ...
    public CmnManagementController(
        ...
        // ?⑤벏???꾨뗀諭?鈺곌퀬??CRUD/?Ŋ???귐뗫늄??됰뻻 ??뺥돩??쇱뿯??덈뼄.
        this.codeCacheService = codeCacheService;
        // ?⑤벏??롫뗄?놅쭪? 鈺곌퀬??CRUD/?Ŋ???귐뗫늄??됰뻻 ??뺥돩??쇱뿯??덈뼄.
        this.messageCacheService = messageCacheService;
        // ?⑤벏????쇱젟?鈺곌퀬??CRUD/?Ŋ???귐뗫늄??됰뻻 ??뺥돩??쇱뿯??덈뼄.
     ...
     * ?⑤벏???꾨뗀諭띄몴?鈺곌퀬???몃빍??
     *
     * @param codeId ?꾨뗀諭?ID??낅빍?? ??됱몵???ｊ탷 鈺곌퀬?띄몴???묐뻬??몃빍??
     * @param codeKey ?꾨뗀諭???쇱뿯??덈뼄. codeId쎛 ??얩?codeKey쎛 ??됱몵?쏆늿? ?꾨뗀諭???뤴뫖以??鈺곌퀬???몃빍??
    ...
    public ResponseEntity<Map<String, Object>> updateCode(
        ...
        // ??륁젟 ??CodeCacheService쎛 ?꾨뗀諭??Ŋ?녺몴?앸맩???귐뗫늄??됰뻻??몃빍??
     ...
     * ?⑤벏??롫뗄?놅쭪???鈺곌퀬???몃빍??
     *
     * @param messageId 롫뗄?놅쭪? ID??낅빍?? ??됱몵???ｊ탷 鈺곌퀬?띄몴???묐뻬??몃빍??
     * @param messageKey 롫뗄?놅쭪? ??쇱뿯??덈뼄.
     * @param locale ?꾨선 ?꾨뗀諭??낅빍?? messageKey?? ??ｍ뜞 ??됱몵????꾨선 ??ｊ탷 鈺곌퀬?띄몴???묐뻬??몃빍??
     * @param messageType 롫뗄?놅쭪? ?醫륁굨??낅빍?? EXTERNAL ??뮉 INTERNAL??낅빍??
    ...
    public ResponseEntity<Map<String, Object>> getMessages(
        ...
        if (messageId != null) {
            ...
            // ??살첒 롫뗄?놅쭪???EXTERNAL/INTERNAL ?醫륁굨????롫떊 鈺곌퀬???????됰뮸??덈뼄.
     ...
     * ?⑤벏??롫뗄?놅쭪????源낆쨯??몃빍??
     *
     * @param request ?源낆쨯??롫뗄?놅쭪? ?類ｋ궖??낅빍??
     ...
     * ?⑤벏??롫뗄?놅쭪?????륁젟??몃빍??
     *
     * @param messageId ??륁젟??롫뗄?놅쭪? ID??낅빍??
     * @param request ??륁젟??롫뗄?놅쭪? ?類ｋ궖??낅빍??
     ...
     * ?⑤벏????쇱젟쏅???鈺곌퀬???몃빍??
     *
     * @param configId ??쇱젟 ID??낅빍?? ??됱몵???ｊ탷 鈺곌퀬?띄몴???묐뻬??몃빍??
     * @param configKey ??쇱젟 ??쇱뿯??덈뼄. configId쎛 ??얩?configKey쎛 ??됱몵???疫꿸퀣? ??ｊ탷 鈺곌퀬?띄몴???묐뻬??몃빍??
