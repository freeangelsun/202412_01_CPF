...
/**
 * ADM 배치 관제가 PFW DB의 Spring Batch 메타 테이블을 사용하도록 고정합니다.
 *
 * <p>ADM은 PFW, CMN, ADM, MBR datasource를 함께 로딩하므로 Spring Batch 자동설정이
 * 단일 datasource를 추론할 수 없습니다. 배치 실행 메타는 CPF 운영 표준에 따라 pfwDB의
