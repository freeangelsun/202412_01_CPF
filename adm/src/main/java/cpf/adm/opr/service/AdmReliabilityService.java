...
/**
 * PFW reliability 테이블을 ADM 운영 화면/API에 제공하는 조회·수동 처리 서비스입니다.
 */
@Service
public class AdmReliabilityService {
    ...
    public AdmReliabilityService(@Qualifier("pfwJdbcTemplate") JdbcTemplate pfwJdbcTemplate) {
    ...
    public ChangeResult requestDlqReplay(String messageId, String operatorId, String reason) {
        ...
        int updated = pfwJdbcTemplate.update("""
        ...
        return new ChangeResult(before, findOne("pfw_broker_dlq", "message_id", messageId), reason);
    }
    ...
    public ChangeResult resolveUnknown(
        ...
        return new ChangeResult(before, findOne("pfw_unknown_result", "unknown_id", unknownId), reason);
    }
