...
/**
 * 업무에서 자주 쓰는 임시 식별자 생성 유틸리티입니다.
 *
 * <p>글로벌 거래ID는 PFW의 {@code TransactionIdGenerator}를 사용해야 합니다.
 * 이 클래스는 업무 임시번호, 화면 요청번호, 샘플 데이터 키처럼 거래ID가 아닌 보조 식별자에만 사용합니다.</p>
 */
public final class IdUtils {
    ...
    /**
     * 지정한 접두어와 날짜/난수를 조합한 업무용 임시 ID를 생성합니다.
     *
     * @param prefix 업무 접두어
