      ...
      <aside class="cpf-card detail-card" aria-live="polite">
        ...
        <template v-if="selected">
          ...
          <template v-else>
            ...
            <pre v-else class="detail-json">{{ safeJson(detailPayload) }}</pre>
          </template>
