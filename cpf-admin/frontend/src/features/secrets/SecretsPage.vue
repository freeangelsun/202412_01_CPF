...
async function rotate(){message.value="";metadata.value=await admApi<any>("/adm/api/secrets/rotate",{method:"POST",body:{provider:provider.value,key:key.value,reason:reason.value}});message.value="Rotation 요청 완료"}
