...
export type AdmApprovalPoliciesResponse = Array<Record<string, unknown>>;
...
export type AdmAuthLogoutResponse = { loggedOut: boolean };
...
export type AdmBatchFindExecutionsResponse = Array<Record<string, unknown>>;
...
export type AdmBatchFindExecutionTargetsResponse = Array<Record<string, unknown>>;
...
export type AdmBatchFindGhostCandidatesResponse = Array<Record<string, unknown>>;
...
export type AdmBatchFindInstancesResponse = Array<Record<string, unknown>>;
...
export type AdmBatchFindJobsResponse = Array<Record<string, unknown>>;
...
export type AdmBatchFindLocksResponse = Array<Record<string, unknown>>;
...
export type AdmBatchFindOperationLogsResponse = Array<Record<string, unknown>>;
...
export type AdmBatchFindRelationsResponse = Array<Record<string, unknown>>;
...
export type AdmBatchFindSchedulesResponse = Array<Record<string, unknown>>;
...
export type AdmBatchFindStepExecutionsResponse = Array<Record<string, unknown>>;
...
export type AdmBatchFindWorkersResponse = Array<Record<string, unknown>>;
...
export type AdmBatchRunSchedulerOnceResponse = Array<Record<string, unknown>>;
...
export type AdmBatchSimulateScheduleResponse = Array<Record<string, unknown>>;
...
export type AdmBreakGlassFindSessionsResponse = Array<Record<string, unknown>>;
...
export type AdmCacheSummaryResponse = { available: boolean; domains?: Array<{ domain?: string; sample?: string; status?: string }>; durableBacklog: number; message?: string; metrics?: Record<string, unknown>; providerHealth?: Record<string, unknown> };
...
export type AdmCapabilityManagementIssuesResponse = Array<Record<string, unknown>>;
...
export type AdmCenterCutFindJobsResponse = Array<Record<string, unknown>>;
...
export type AdmCenterCutFindParametersResponse = Array<Record<string, unknown>>;
...
export type AdmCenterCutFindResultsResponse = Array<Record<string, unknown>>;
...
export type AdmCenterCutFindTargetsResponse = Array<Record<string, unknown>>;
...
export type AdmCodeDeleteCodeResponse = Array<Record<string, unknown>>;
...
export type AdmCodeFindCodesResponse = Array<Record<string, unknown>>;
...
export type AdmConfigDeleteConfigResponse = Array<Record<string, unknown>>;
...
export type AdmConfigFindConfigsResponse = Array<Record<string, unknown>>;
...
export type AdmDownloadDownloadCsvResponse = Array<number>;
...
export type AdmDownloadFindDownloadAuditLogsResponse = Array<{ adminId?: string; completedAt?: string; downloadId?: number; downloadType?: string; includeSensitiveYn?: string; maskedYn?: string; reason?: string; requestedAt?: string; rowCount?: number; status?: string }>;
...
export type AdmDownloadFindPoliciesResponse = Array<{ description?: string; downloadType?: string; includeSensitiveAllowed: boolean; menuId?: string }>;
...
export type AdmFeatureFlagRequestOverrideResponse = Record<string, string>;
...
export type AdmFeatureFlagSearchResponse = Array<Record<string, unknown>>;
...
export type AdmFileJobDetailResponse = { appliedBy?: string; approvalId?: string; controlBy?: string; controlReason?: string; controlUpdatedAt?: string; createdAt?: string; dryRun: boolean; errorCode?: string; errorMessage?: string; failedRows: number; format?: string; jobId?: string; jobType?: Record<string, unknown>; operationId?: string; reason?: string; requestHash?: string; requestedBy?: string; resolvedBy?: string; resultSha256?: string; retentionUntil?: string; rollbackSupported: boolean; sourceSha256?: string; state?: Record<string, unknown>; successRows: number; templateCode?: string; templateVersion: number; totalRows: number; updatedAt?: string };
...
export type AdmFileJobListResponse = Array<{ appliedBy?: string; approvalId?: string; controlBy?: string; controlReason?: string; controlUpdatedAt?: string; createdAt?: string; dryRun: boolean; errorCode?: string; errorMessage?: string; failedRows: number; format?: string; jobId?: string; jobType?: Record<string, unknown>; operationId?: string; reason?: string; requestHash?: string; requestedBy?: string; resolvedBy?: string; resultSha256?: string; retentionUntil?: string; rollbackSupported: boolean; sourceSha256?: string; state?: Record<string, unknown>; successRows: number; templateCode?: string; templateVersion: number; totalRows: number; updatedAt?: string }>;
...
export type AdmFileJobRowsResponse = Array<{ businessKey?: string; errorCode?: string; message?: string; rowNumber: number; state?: string }>;
...
export type AdmFileJobUploadResponse = { appliedBy?: string; approvalId?: string; controlBy?: string; controlReason?: string; controlUpdatedAt?: string; createdAt?: string; dryRun: boolean; errorCode?: string; errorMessage?: string; failedRows: number; format?: string; jobId?: string; jobType?: Record<string, unknown>; operationId?: string; reason?: string; requestHash?: string; requestedBy?: string; resolvedBy?: string; resultSha256?: string; retentionUntil?: string; rollbackSupported: boolean; sourceSha256?: string; state?: Record<string, unknown>; successRows: number; templateCode?: string; templateVersion: number; totalRows: number; updatedAt?: string };
...
export type AdmGatewayFindApplyStatusResponse = Array<Record<string, unknown>>;
...
export type AdmGatewayFindBindingsResponse = Array<Record<string, unknown>>;
...
export type AdmGatewayFindConnectionTestsResponse = Array<Record<string, unknown>>;
...
export type AdmGatewayFindGroupMembersResponse = Array<Record<string, unknown>>;
...
export type AdmGatewayFindServerGroupsResponse = Array<Record<string, unknown>>;
...
export type AdmGatewayOperationsEventsResponse = Array<Record<string, unknown>>;
...
export type AdmHealthInstanceDetailResponse = { health?: Record<string, unknown>; reportedAt?: string; stale: boolean };
...
export type AdmIncidentAcknowledgeResponse = { acknowledgedAt?: string; correlationId?: string; createdAt?: string; createdBy?: string; escalationLevel: number; firstOccurredAt?: string; incidentId: number; lastOccurredAt?: string; occurrenceCount: number; ownerId?: string; policyCode?: string; policyId: number; resolvedAt?: string; severity?: string; sourceId?: string; sourceType?: string; status?: string; summary?: string; title?: string; transactionId?: string; updatedAt?: string; updatedBy?: string; version: number };
...
export type AdmIncidentCreateMaintenanceResponse = { createdAt?: string; createdBy?: string; endsAt?: string; maintenanceCode?: string; maintenanceId: number; startsAt?: string; targetId?: string; targetType?: string; updatedAt?: string; updatedBy?: string; useYn?: string; version: number };
...
export type AdmIncidentCreatePolicyResponse = { createdAt?: string; createdBy?: string; escalationMinutes: number; eventSubType?: string; eventType?: string; policyCode?: string; policyId: number; receiverGroup?: string; severity?: string; thresholdCount: number; updatedAt?: string; updatedBy?: string; useYn?: string; version: number; windowSeconds: number };
...
export type AdmIncidentEscalateResponse = { acknowledgedAt?: string; correlationId?: string; createdAt?: string; createdBy?: string; escalationLevel: number; firstOccurredAt?: string; incidentId: number; lastOccurredAt?: string; occurrenceCount: number; ownerId?: string; policyCode?: string; policyId: number; resolvedAt?: string; severity?: string; sourceId?: string; sourceType?: string; status?: string; summary?: string; title?: string; transactionId?: string; updatedAt?: string; updatedBy?: string; version: number };
...
export type AdmIncidentFindIncidentResponse = { acknowledgedAt?: string; correlationId?: string; createdAt?: string; createdBy?: string; escalationLevel: number; firstOccurredAt?: string; incidentId: number; lastOccurredAt?: string; occurrenceCount: number; ownerId?: string; policyCode?: string; policyId: number; resolvedAt?: string; severity?: string; sourceId?: string; sourceType?: string; status?: string; summary?: string; title?: string; transactionId?: string; updatedAt?: string; updatedBy?: string; version: number };
...
export type AdmIncidentFindTimelineResponse = Array<{ actionType?: string; actorId?: string; afterStatus?: string; approvalRequestId?: string; beforeStatus?: string; createdAt?: string; incidentId: number; reason?: string; timelineId: number }>;
...
export type AdmIncidentIngestSignalResponse = { incidentId?: number; observedCount: number; result?: string; signalId: number; suppressedByMaintenance: boolean; thresholdCount: number };
...
export type AdmIncidentRecordPostmortemResponse = { acknowledgedAt?: string; correlationId?: string; createdAt?: string; createdBy?: string; escalationLevel: number; firstOccurredAt?: string; incidentId: number; lastOccurredAt?: string; occurrenceCount: number; ownerId?: string; policyCode?: string; policyId: number; resolvedAt?: string; severity?: string; sourceId?: string; sourceType?: string; status?: string; summary?: string; title?: string; transactionId?: string; updatedAt?: string; updatedBy?: string; version: number };
...
export type AdmIncidentReopenResponse = { acknowledgedAt?: string; correlationId?: string; createdAt?: string; createdBy?: string; escalationLevel: number; firstOccurredAt?: string; incidentId: number; lastOccurredAt?: string; occurrenceCount: number; ownerId?: string; policyCode?: string; policyId: number; resolvedAt?: string; severity?: string; sourceId?: string; sourceType?: string; status?: string; summary?: string; title?: string; transactionId?: string; updatedAt?: string; updatedBy?: string; version: number };
...
export type AdmIncidentResolveResponse = { acknowledgedAt?: string; correlationId?: string; createdAt?: string; createdBy?: string; escalationLevel: number; firstOccurredAt?: string; incidentId: number; lastOccurredAt?: string; occurrenceCount: number; ownerId?: string; policyCode?: string; policyId: number; resolvedAt?: string; severity?: string; sourceId?: string; sourceType?: string; status?: string; summary?: string; title?: string; transactionId?: string; updatedAt?: string; updatedBy?: string; version: number };
...
export type AdmIncidentUpdateMaintenanceResponse = { createdAt?: string; createdBy?: string; endsAt?: string; maintenanceCode?: string; maintenanceId: number; startsAt?: string; targetId?: string; targetType?: string; updatedAt?: string; updatedBy?: string; useYn?: string; version: number };
...
export type AdmIncidentUpdatePolicyResponse = { createdAt?: string; createdBy?: string; escalationMinutes: number; eventSubType?: string; eventType?: string; policyCode?: string; policyId: number; receiverGroup?: string; severity?: string; thresholdCount: number; updatedAt?: string; updatedBy?: string; useYn?: string; version: number; windowSeconds: number };
...
export type AdmLogExportCreateResponse = { downloadUrl?: string; expiresAt?: string; exportId?: string; fileName?: string; maskedContent?: string; status?: string; watermark?: string };
...
export type AdmLogExportDownloadResponse = Array<number>;
...
export type AdmMaintenanceFindActionsResponse = Array<Record<string, unknown>>;
...
export type AdmManagedServerFindAllQuery = { environment?: string; status?: string; keyword?: string; page?: number; size?: number };
export type AdmManagedServerFindAllHeaders = Record<string, never>;
export type AdmManagedServerFindAllResponse = { hasNext: boolean; items?: Array<{ activeRuntimeCount: number; description?: string; displayName?: string; enabled: boolean; environment?: string; hostname?: string; location?: string; managedServerId?: string; managementIdentity?: string; registeredAt?: string; rowVersion: number; runtimeCount: number; serverGroup?: string; serverName?: string; status?: string; tagsJson?: string; updatedAt?: string; zone?: string }>; page: number; size: number; totalElements: number; totalPages: number };
...
export type AdmManagedServerFindOneResponse = { activeRuntimeCount: number; description?: string; displayName?: string; enabled: boolean; environment?: string; hostname?: string; location?: string; managedServerId?: string; managementIdentity?: string; registeredAt?: string; rowVersion: number; runtimeCount: number; serverGroup?: string; serverName?: string; status?: string; tagsJson?: string; updatedAt?: string; zone?: string };
...
export type AdmManagedServerSaveResponse = { activeRuntimeCount: number; description?: string; displayName?: string; enabled: boolean; environment?: string; hostname?: string; location?: string; managedServerId?: string; managementIdentity?: string; registeredAt?: string; rowVersion: number; runtimeCount: number; serverGroup?: string; serverName?: string; status?: string; tagsJson?: string; updatedAt?: string; zone?: string };
...
export type AdmMessageDeleteMessageResponse = Array<Record<string, unknown>>;
...
export type AdmMessageFindMessagesResponse = Array<Record<string, unknown>>;
...
export type AdmNotificationCancelDeliveryResponse = { attemptCount: number; deliveryId: number; deliveryStatus?: string; lastErrorCode?: string; leaseOwner?: string; leaseUntil?: string; maxAttempts: number; nextAttemptAt?: string; operationId?: string; requestHash?: string; updatedAt?: string; updatedBy?: string; version: number };
...
export type AdmNotificationDisableRuleResponse = { channelCode?: string; createdAt?: string; createdBy?: string; eventSubType?: string; eventType?: string; receiverGroup?: string; ruleId: number; severity?: string; templateCode?: string; updatedAt?: string; updatedBy?: string; useYn?: string };
...
export type AdmNotificationFindDeliveryAttemptsResponse = Array<{ attemptNo: number; attemptStatus?: string; completedAt?: string; createdAt?: string; createdBy?: string; deliveryId: number; leaseVersion: number; operationId?: string; providerMessage?: string; providerStatus?: string; startedAt?: string; workerId?: string }>;
...
export type AdmNotificationFindDeliveryLogsResponse = Array<{ attemptCount: number; createdAt?: string; createdBy?: string; deliveredAt?: string; deliveryId: number; deliveryMessage?: string; deliveryStatus?: string; eventType?: string; lastErrorCode?: string; leaseOwner?: string; leaseUntil?: string; maxAttempts: number; nextAttemptAt?: string; operationId?: string; receiver?: string; requestHash?: string; requestedAt?: string; ruleId?: number; targetId?: string; targetType?: string; updatedAt?: string; updatedBy?: string; version: number }>;
...
export type AdmNotificationFindDlqResponse = Array<{ attemptCount: number; createdAt?: string; createdBy?: string; deliveredAt?: string; deliveryId: number; deliveryMessage?: string; deliveryStatus?: string; eventType?: string; lastErrorCode?: string; leaseOwner?: string; leaseUntil?: string; maxAttempts: number; nextAttemptAt?: string; operationId?: string; receiver?: string; requestHash?: string; requestedAt?: string; ruleId?: number; targetId?: string; targetType?: string; updatedAt?: string; updatedBy?: string; version: number }>;
...
export type AdmNotificationFindRuleResponse = { channelCode?: string; createdAt?: string; createdBy?: string; eventSubType?: string; eventType?: string; receiverGroup?: string; ruleId: number; severity?: string; templateCode?: string; updatedAt?: string; updatedBy?: string; useYn?: string };
...
export type AdmNotificationFindRulesResponse = Array<{ channelCode?: string; createdAt?: string; createdBy?: string; eventSubType?: string; eventType?: string; receiverGroup?: string; ruleId: number; severity?: string; templateCode?: string; updatedAt?: string; updatedBy?: string; useYn?: string }>;
...
export type AdmNotificationRetryDeliveryResponse = { attemptCount: number; deliveryId: number; deliveryStatus?: string; lastErrorCode?: string; leaseOwner?: string; leaseUntil?: string; maxAttempts: number; nextAttemptAt?: string; operationId?: string; requestHash?: string; updatedAt?: string; updatedBy?: string; version: number };
...
export type AdmNotificationSaveRuleResponse = { channelCode?: string; createdAt?: string; createdBy?: string; eventSubType?: string; eventType?: string; receiverGroup?: string; ruleId: number; severity?: string; templateCode?: string; updatedAt?: string; updatedBy?: string; useYn?: string };
...
export type AdmNotificationSendTestResponse = { deliveryId: number; deliveryStatus?: string; providerVerification?: string; rule?: { channelCode?: string; createdAt?: string; createdBy?: string; eventSubType?: string; eventType?: string; receiverGroup?: string; ruleId: number; severity?: string; templateCode?: string; updatedAt?: string; updatedBy?: string; useYn?: string } };
...
export type AdmNotificationUpdateRuleResponse = { channelCode?: string; createdAt?: string; createdBy?: string; eventSubType?: string; eventType?: string; receiverGroup?: string; ruleId: number; severity?: string; templateCode?: string; updatedAt?: string; updatedBy?: string; useYn?: string };
...
export type AdmOperatorChangePasswordResponse = { accountStatus?: string; createdAt?: string; locked: boolean; mobileNo?: string; officePhoneNo?: string; operatorId?: string; operatorName?: string; passwordChangeRequired: boolean; passwordExpired: boolean; rawViewAllowed: boolean; roleIds?: Array<string>; updatedAt?: string; versionNo: number };
...
export type AdmOperatorCleanupExpiredSessionsResponse = { revoked: number };
...
export type AdmOperatorCreateOperatorResponse = { accountStatus?: string; createdAt?: string; locked: boolean; mobileNo?: string; officePhoneNo?: string; operatorId?: string; operatorName?: string; passwordChangeRequired: boolean; passwordExpired: boolean; rawViewAllowed: boolean; roleIds?: Array<string>; updatedAt?: string; versionNo: number };
...
export type AdmOperatorFindCreateResultResponse = { accountStatus?: string; createdAt?: string; locked: boolean; mobileNo?: string; officePhoneNo?: string; operatorId?: string; operatorName?: string; passwordChangeRequired: boolean; passwordExpired: boolean; rawViewAllowed: boolean; roleIds?: Array<string>; updatedAt?: string; versionNo: number };
...
export type AdmOperatorFindMenusResponse = Array<{ deleteAllowed: boolean; menuId?: string; menuName?: string; parentMenuId?: string; path?: string; readAllowed: boolean; sortOrder: number; writeAllowed: boolean }>;
...
export type AdmOperatorFindOperatorsResponse = Array<{ accountStatus?: string; createdAt?: string; locked: boolean; mobileNo?: string; officePhoneNo?: string; operatorId?: string; operatorName?: string; passwordChangeRequired: boolean; passwordExpired: boolean; rawViewAllowed: boolean; roleIds?: Array<string>; updatedAt?: string; versionNo: number }>;
...
export type AdmOperatorFindRolesResponse = Array<{ description?: string; roleId?: string; roleName?: string }>;
...
export type AdmOperatorFindSessionsResponse = Array<{ clientIp?: string; createdAt?: string; expiresAt?: string; issuedAt?: string; operatorId?: string; revoked: boolean; roleIds?: Array<string>; sessionId?: string; updatedAt?: string; userAgent?: string }>;
...
export type AdmOperatorPasswordPolicyResponse = { expireDays: number; historyCount: number; maxFailCount: number; minLength: number; requiredCategoryCount: number };
...
export type AdmOperatorRawContactResponse = { mobileNo?: string; officePhoneNo?: string; operatorId?: string; rawViewAllowed: boolean; transactionId?: string };
...
export type AdmOperatorResetPasswordResponse = { accountStatus?: string; createdAt?: string; locked: boolean; mobileNo?: string; officePhoneNo?: string; operatorId?: string; operatorName?: string; passwordChangeRequired: boolean; passwordExpired: boolean; rawViewAllowed: boolean; roleIds?: Array<string>; updatedAt?: string; versionNo: number };
...
export type AdmOperatorRevokeSessionResponse = { revoked: number };
...
export type AdmOperatorUnlockOperatorResponse = { accountStatus?: string; createdAt?: string; locked: boolean; mobileNo?: string; officePhoneNo?: string; operatorId?: string; operatorName?: string; passwordChangeRequired: boolean; passwordExpired: boolean; rawViewAllowed: boolean; roleIds?: Array<string>; updatedAt?: string; versionNo: number };
...
export type AdmOperatorUpdateContactResponse = { accountStatus?: string; createdAt?: string; locked: boolean; mobileNo?: string; officePhoneNo?: string; operatorId?: string; operatorName?: string; passwordChangeRequired: boolean; passwordExpired: boolean; rawViewAllowed: boolean; roleIds?: Array<string>; updatedAt?: string; versionNo: number };
...
export type AdmOperatorUpdateRolesResponse = { accountStatus?: string; createdAt?: string; locked: boolean; mobileNo?: string; officePhoneNo?: string; operatorId?: string; operatorName?: string; passwordChangeRequired: boolean; passwordExpired: boolean; rawViewAllowed: boolean; roleIds?: Array<string>; updatedAt?: string; versionNo: number };
...
export type AdmOperatorUpdateStatusResponse = { accountStatus?: string; createdAt?: string; locked: boolean; mobileNo?: string; officePhoneNo?: string; operatorId?: string; operatorName?: string; passwordChangeRequired: boolean; passwordExpired: boolean; rawViewAllowed: boolean; roleIds?: Array<string>; updatedAt?: string; versionNo: number };
...
export type AdmOperatorValidatePasswordResponse = { operatorId?: string; violations?: Array<string> };
...
export type AdmPermissionCreateApiPermissionResponse = { apiGroupCode?: string; apiName?: string; apiPath?: string; apiPermissionId?: string; buttonId?: string; createdAt?: string; httpMethod?: string; menuId?: string; permissionCode?: string; updatedAt?: string; useYn?: string };
...
export type AdmPermissionCreateButtonResponse = { actionCode?: string; apiPattern?: string; buttonId?: string; buttonName?: string; createdAt?: string; httpMethod?: string; menuId?: string; sortOrder: number; updatedAt?: string; useYn?: string };
...
export type AdmPermissionCreateMenuResponse = { createdAt?: string; menuId?: string; menuName?: string; menuPath?: string; parentMenuId?: string; sortOrder: number; updatedAt?: string; useYn?: string };
...
export type AdmPermissionCreateRoleResponse = { createdAt?: string; description?: string; roleId?: string; roleName?: string; roleType?: string; updatedAt?: string; useYn?: string };
...
export type AdmPermissionFindApiPermissionResponse = { apiGroupCode?: string; apiName?: string; apiPath?: string; apiPermissionId?: string; buttonId?: string; createdAt?: string; httpMethod?: string; menuId?: string; permissionCode?: string; updatedAt?: string; useYn?: string };
...
export type AdmPermissionFindApiPermissionMatrixResponse = Array<Record<string, unknown>>;
...
export type AdmPermissionFindApiPermissionsResponse = Array<{ apiGroupCode?: string; apiName?: string; apiPath?: string; apiPermissionId?: string; buttonId?: string; createdAt?: string; httpMethod?: string; menuId?: string; permissionCode?: string; updatedAt?: string; useYn?: string }>;
...
export type AdmPermissionFindButtonResponse = { actionCode?: string; apiPattern?: string; buttonId?: string; buttonName?: string; createdAt?: string; httpMethod?: string; menuId?: string; sortOrder: number; updatedAt?: string; useYn?: string };
...
export type AdmPermissionFindButtonMatrixResponse = Array<Record<string, unknown>>;
...
export type AdmPermissionFindButtonsResponse = Array<{ actionCode?: string; apiPattern?: string; buttonId?: string; buttonName?: string; createdAt?: string; httpMethod?: string; menuId?: string; sortOrder: number; updatedAt?: string; useYn?: string }>;
...
export type AdmPermissionFindManagedMenuResponse = { createdAt?: string; menuId?: string; menuName?: string; menuPath?: string; parentMenuId?: string; sortOrder: number; updatedAt?: string; useYn?: string };
...
export type AdmPermissionFindManagedMenusResponse = Array<{ createdAt?: string; menuId?: string; menuName?: string; menuPath?: string; parentMenuId?: string; sortOrder: number; updatedAt?: string; useYn?: string }>;
...
export type AdmPermissionFindMenuMatrixResponse = Array<Record<string, unknown>>;
...
export type AdmPermissionFindRoleResponse = { createdAt?: string; description?: string; roleId?: string; roleName?: string; roleType?: string; updatedAt?: string; useYn?: string };
...
export type AdmPermissionFindRolesResponse = Array<{ createdAt?: string; description?: string; roleId?: string; roleName?: string; roleType?: string; updatedAt?: string; useYn?: string }>;
...
export type AdmPermissionUpdateApiPermissionResponse = { apiGroupCode?: string; apiName?: string; apiPath?: string; apiPermissionId?: string; buttonId?: string; createdAt?: string; httpMethod?: string; menuId?: string; permissionCode?: string; updatedAt?: string; useYn?: string };
...
export type AdmPermissionUpdateApiPermissionStatusResponse = { apiGroupCode?: string; apiName?: string; apiPath?: string; apiPermissionId?: string; buttonId?: string; createdAt?: string; httpMethod?: string; menuId?: string; permissionCode?: string; updatedAt?: string; useYn?: string };
...
export type AdmPermissionUpdateButtonResponse = { actionCode?: string; apiPattern?: string; buttonId?: string; buttonName?: string; createdAt?: string; httpMethod?: string; menuId?: string; sortOrder: number; updatedAt?: string; useYn?: string };
...
export type AdmPermissionUpdateButtonStatusResponse = { actionCode?: string; apiPattern?: string; buttonId?: string; buttonName?: string; createdAt?: string; httpMethod?: string; menuId?: string; sortOrder: number; updatedAt?: string; useYn?: string };
...
export type AdmPermissionUpdateMenuResponse = { createdAt?: string; menuId?: string; menuName?: string; menuPath?: string; parentMenuId?: string; sortOrder: number; updatedAt?: string; useYn?: string };
...
export type AdmPermissionUpdateMenuStatusResponse = { createdAt?: string; menuId?: string; menuName?: string; menuPath?: string; parentMenuId?: string; sortOrder: number; updatedAt?: string; useYn?: string };
...
export type AdmPermissionUpdateRoleResponse = { createdAt?: string; description?: string; roleId?: string; roleName?: string; roleType?: string; updatedAt?: string; useYn?: string };
...
export type AdmPermissionUpdateRoleStatusResponse = { createdAt?: string; description?: string; roleId?: string; roleName?: string; roleType?: string; updatedAt?: string; useYn?: string };
...
export type AdmRemoteLogSearchResponse = Array<Record<string, unknown>>;
...
export type AdmResiliencePolicyRequestResponse = Record<string, string>;
...
export type AdmResiliencePolicySearchResponse = Array<Record<string, unknown>>;
...
export type AdmRetentionPolicyPauseOptions = CpfGeneratedBaseOptions & { data: AdmRetentionPolicyPauseBody; path: AdmRetentionPolicyPausePath; query?: never; headers?: CpfGeneratedHeaders; };
export async function admRetentionPolicyPause<T = AdmRetentionPolicyPauseResponse>(options: AdmRetentionPolicyPauseOptions): Promise<T> {
  const response = await orvalAdmRetentionPolicyPause(options.path["policyId"] as Parameters<typeof orvalAdmRetentionPolicyPause>[0], options.data as unknown as Parameters<typeof orvalAdmRetentionPolicyPause>[1], { signal: options.signal, headers: options.headers } as Parameters<typeof orvalAdmRetentionPolicyPause>[2]);
  return response.data as T;
}
...
export type AdmRetentionPolicyResumeOptions = CpfGeneratedBaseOptions & { data: AdmRetentionPolicyResumeBody; path: AdmRetentionPolicyResumePath; query?: never; headers?: CpfGeneratedHeaders; };
export async function admRetentionPolicyResume<T = AdmRetentionPolicyResumeResponse>(options: AdmRetentionPolicyResumeOptions): Promise<T> {
  const response = await orvalAdmRetentionPolicyResume(options.path["policyId"] as Parameters<typeof orvalAdmRetentionPolicyResume>[0], options.data as unknown as Parameters<typeof orvalAdmRetentionPolicyResume>[1], { signal: options.signal, headers: options.headers } as Parameters<typeof orvalAdmRetentionPolicyResume>[2]);
  return response.data as T;
}
...
export type AdmRetentionRunPauseOptions = CpfGeneratedBaseOptions & { data: AdmRetentionRunPauseBody; path: AdmRetentionRunPausePath; query?: never; headers?: CpfGeneratedHeaders; };
export async function admRetentionRunPause<T = AdmRetentionRunPauseResponse>(options: AdmRetentionRunPauseOptions): Promise<T> {
  const response = await orvalAdmRetentionRunPause(options.path["runId"] as Parameters<typeof orvalAdmRetentionRunPause>[0], options.data as unknown as Parameters<typeof orvalAdmRetentionRunPause>[1], { signal: options.signal, headers: options.headers } as Parameters<typeof orvalAdmRetentionRunPause>[2]);
  return response.data as T;
}
...
export type AdmRuntimeControlFindCapabilitiesResponse = Array<Record<string, unknown>>;
...
export type AdmRuntimeInventoryFindAllQuery = { environment?: string; capability?: string; status?: string; keyword?: string; page?: number; size?: number };
export type AdmRuntimeInventoryFindAllHeaders = Record<string, never>;
export type AdmRuntimeInventoryFindAllResponse = { hasNext: boolean; items?: Array<{ applicationName?: string; applicationRole?: string; artifactVersion?: string; capabilities?: Record<string, string>; cpfVersion?: string; environment?: string; instanceId?: string; javaVersion?: string; lastSeenAt?: string; managedServerId?: string; runtimeHostname?: string; serverName?: string; serviceId?: string; startedAt?: string; status?: string; systemCode?: string; zone?: string }>; page: number; size: number; totalElements: number; totalPages: number };
...
export type AdmSecretFindProvidersResponse = Array<Record<string, unknown>>;
...
export type AdmSecurityFindIpAllowlistResponse = Array<Record<string, unknown>>;
...
export type AdmSecurityFindMfaStatesResponse = Array<Record<string, unknown>>;
...
export type AdmServiceRegistryFindCallHistoryResponse = Array<Record<string, unknown>>;
...
export type AdmServiceRegistryFindCircuitStatesResponse = Array<Record<string, unknown>>;
...
export type AdmServiceRegistryFindEndpointsResponse = Array<Record<string, unknown>>;
...
export type AdmServiceRegistryFindHealthResponse = Array<Record<string, unknown>>;
...
export type AdmServiceRegistryFindInstancesResponse = Array<Record<string, unknown>>;
...
export type AdmServiceRegistryFindRoutingPoliciesResponse = Array<Record<string, unknown>>;
...
export type AdmServiceRegistryFindServicesResponse = Array<Record<string, unknown>>;
...
export type AdmTransactionMetaFindPageResponse = { available: boolean; items?: Array<Record<string, unknown>>; page: number; size: number; totalElements: number; totalPages: number };
...
export type FindAdmBatchJobInstanceLogsResponse = Array<Record<string, unknown>>;
...
export type FindAdmBrokerDlqResponse = Array<Record<string, unknown>>;
...
export type FindAdmBrokerInboxResponse = Array<Record<string, unknown>>;
...
export type FindAdmBrokerOutboxResponse = Array<Record<string, unknown>>;
...
export type FindAdmFileTransferHistoryResponse = Array<Record<string, unknown>>;
...
export type FindAdmIdempotencyRecordsResponse = Array<Record<string, unknown>>;
...
export type FindAdmUnknownResultsResponse = Array<Record<string, unknown>>;
...
export type GetAdmSystemVersionResponse = Record<string, string>;
...
export type ResolveAdmUnknownResultResponse = { after?: Record<string, unknown>; before?: Record<string, unknown>; reason?: string };
