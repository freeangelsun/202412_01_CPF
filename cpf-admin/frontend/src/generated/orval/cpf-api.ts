...
export const admCacheEvictKey = async (data: AdmCacheEvictKeyRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admCacheEvictKeyResponse> => {
  return cpfOrvalRequest<admCacheEvictKeyResponse>(getAdmCacheEvictKeyUrl(), { ...options, method: 'POST', headers: { 'Content-Type': 'application/json', ...options?.headers }, data });
};
...
export const getAdmCacheEvictKeyMutationOptions = <TError = unknown, TContext = unknown>(
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ...
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admCacheEvictKey>>, {data: AdmCacheEvictKeyRequest}> = (props) => { const { data } = props; return admCacheEvictKey(data, requestOptions); };
  return { mutationFn, ...mutationOptions };
};
...
export const useAdmCacheEvictKey = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admCacheEvictKey>>, TError, {data: AdmCacheEvictKeyRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admCacheEvictKey>>, TError, {data: AdmCacheEvictKeyRequest}, TContext> => useMutation(getAdmCacheEvictKeyMutationOptions(options), queryClient);
...
export const admCacheEvictNamespace = async (data: AdmCacheEvictNamespaceRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admCacheEvictNamespaceResponse> => {
  return cpfOrvalRequest<admCacheEvictNamespaceResponse>(getAdmCacheEvictNamespaceUrl(), { ...options, method: 'POST', headers: { 'Content-Type': 'application/json', ...options?.headers }, data });
};
...
export const getAdmCacheEvictNamespaceMutationOptions = <TError = unknown, TContext = unknown>(
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admCacheEvictNamespace>>, {data: AdmCacheEvictNamespaceRequest}> = (props) => { const { data } = props; return admCacheEvictNamespace(data, requestOptions); };
  return { mutationFn, ...mutationOptions };
};
...
export const useAdmCacheEvictNamespace = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admCacheEvictNamespace>>, TError, {data: AdmCacheEvictNamespaceRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admCacheEvictNamespace>>, TError, {data: AdmCacheEvictNamespaceRequest}, TContext> => useMutation(getAdmCacheEvictNamespaceMutationOptions(options), queryClient);
...
export const admCacheReconcile = async (data: AdmCacheControlRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admCacheReconcileResponse> => {
  return cpfOrvalRequest<admCacheReconcileResponse>(getAdmCacheReconcileUrl(), { ...options, method: 'POST', headers: { 'Content-Type': 'application/json', ...options?.headers }, data });
};
...
export const getAdmCacheReconcileMutationOptions = <TError = unknown, TContext = unknown>(
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admCacheReconcile>>, {data: AdmCacheControlRequest}> = (props) => { const { data } = props; return admCacheReconcile(data, requestOptions); };
  return { mutationFn, ...mutationOptions };
};
...
export const useAdmCacheReconcile = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admCacheReconcile>>, TError, {data: AdmCacheControlRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admCacheReconcile>>, TError, {data: AdmCacheControlRequest}, TContext> => useMutation(getAdmCacheReconcileMutationOptions(options), queryClient);
...
export const admCacheRefresh = async (params: AdmCacheRefreshParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admCacheRefreshResponse> => {
  return cpfOrvalRequest<admCacheRefreshResponse>((() => { const base = getAdmCacheRefreshUrl(); const search = new URLSearchParams(); if (params.target) search.set('target', params.target); search.set('reason', params.reason); return base + '?' + search.toString(); })(), { ...options, method: 'POST' });
};
...
export const getAdmCacheRefreshMutationOptions = <TError = unknown, TContext = unknown>(
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admCacheRefresh>>, {params: AdmCacheRefreshParams}> = (props) => { const { params } = props; return admCacheRefresh(params, requestOptions); };
  return { mutationFn, ...mutationOptions };
};
...
export const useAdmCacheRefresh = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admCacheRefresh>>, TError, {params: AdmCacheRefreshParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admCacheRefresh>>, TError, {params: AdmCacheRefreshParams}, TContext> => useMutation(getAdmCacheRefreshMutationOptions(options), queryClient);
...
export const admCacheSummary = async (options?: CpfOrvalGeneratedRequestOptions): Promise<admCacheSummaryResponse> => {
  return cpfOrvalRequest<admCacheSummaryResponse>(getAdmCacheSummaryUrl(), { ...options, method: 'GET' });
};
