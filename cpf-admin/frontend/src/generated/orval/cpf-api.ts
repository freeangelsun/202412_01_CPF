...
import type {
  ...
  AdmApprovalDirectoryEntry,
  AdmApprovalExecuteParams,
  AdmApprovalExecutionStatus,
  AdmApprovalPoliciesParams,
  AdmApprovalReconcileParams,
  AdmApprovedOperationCommand,
  AdmApprovedOperationResult,
  ...
  AdmBatchRuntimeInstancesParams,
  ...
  AdmCacheControlResponse,
  AdmCacheSummaryResponse,
  ...
  AdmCapabilityManagementIssuesParams,
  AdmCapabilityManagementOverviewParams,
  ...
  AdmFileJobResponse,
  AdmFileJobRowResponse,
  AdmFileJobState,
  AdmFileJobType,
  AdmFileJobUploadParams,
  AdmFileJobUploadRequest,
  ...
  AdmNotificationDeliveryAttemptResponse,
  AdmNotificationDeliveryLogResponse,
  AdmNotificationDeliveryStatusResponse,
...
export const admApprovalPolicySave = async (data: PolicyRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admApprovalPolicySaveResponse> => {
...
export const getAdmApprovalPolicySaveMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admApprovalPolicySave>>, TError, {data: PolicyRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admApprovalPolicySave>>, TError, {data: PolicyRequest}, TContext> => {
  ...
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admApprovalPolicySave>>, {data: PolicyRequest}> = (props) => {
    const { data } = props;
...
export type AdmApprovalPolicySaveMutationBody = PolicyRequest;
...
export const useAdmApprovalPolicySave = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admApprovalPolicySave>>, TError, {data: PolicyRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admApprovalPolicySave>>, TError, {data: PolicyRequest}, TContext> => {
...
export const admApprovalRequest = async (data: CreateRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admApprovalRequestResponse> => {
...
export const getAdmApprovalRequestMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admApprovalRequest>>, TError, {data: CreateRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admApprovalRequest>>, TError, {data: CreateRequest}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admApprovalRequest>>, {data: CreateRequest}> = (props) => {
    const { data } = props;
...
export type AdmApprovalRequestMutationBody = CreateRequest;
export type AdmApprovalRequestMutationError = unknown;

export const useAdmApprovalRequest = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admApprovalRequest>>, TError, {data: CreateRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admApprovalRequest>>, TError, {data: CreateRequest}, TContext> => {
...
export const admApprovalDecision = async (id: number, data: DecisionRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admApprovalDecisionResponse> => {
...
export const getAdmApprovalDecisionMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admApprovalDecision>>, TError, {id: number; data: DecisionRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admApprovalDecision>>, TError, {id: number; data: DecisionRequest}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admApprovalDecision>>, {id: number; data: DecisionRequest}> = (props) => {
    const { id, data } = props;
...
export type AdmApprovalDecisionMutationBody = DecisionRequest;
export type AdmApprovalDecisionMutationError = unknown;

export const useAdmApprovalDecision = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admApprovalDecision>>, TError, {id: number; data: DecisionRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admApprovalDecision>>, TError, {id: number; data: DecisionRequest}, TContext> => {
...
export const admApprovalExecute = async (id: number, params: AdmApprovalExecuteParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admApprovalExecuteResponse> => {
...
export const getAdmApprovalExecuteMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admApprovalExecute>>, TError, {id: number; params: AdmApprovalExecuteParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admApprovalExecute>>, TError, {id: number; params: AdmApprovalExecuteParams}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admApprovalExecute>>, {id: number; params: AdmApprovalExecuteParams}> = (props) => {
...
export const useAdmApprovalExecute = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admApprovalExecute>>, TError, {id: number; params: AdmApprovalExecuteParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admApprovalExecute>>, TError, {id: number; params: AdmApprovalExecuteParams}, TContext> => {
...
export type admApprovalReconcileResponseSuccess = (admApprovalReconcileResponse200) & {
  headers: Headers;
};

export type admApprovalReconcileResponse = (admApprovalReconcileResponseSuccess)

export const getAdmApprovalReconcileUrl = (id: number) => `/adm/api/approvals/requests/${encodeURIComponent(String(id))}/reconcile`;

export const admApprovalReconcile = async (id: number, params: AdmApprovalReconcileParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admApprovalReconcileResponse> => {
  return cpfOrvalRequest<admApprovalReconcileResponse>(getAdmApprovalReconcileUrl(id), {
    ...options,
    method: 'POST',
    params: { reason: params.reason },
  });
...
export const getAdmApprovalReconcileMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admApprovalReconcile>>, TError, {id: number; params: AdmApprovalReconcileParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admApprovalReconcile>>, TError, {id: number; params: AdmApprovalReconcileParams}, TContext> => {
  const mutationKey = ['admApprovalReconcile'];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admApprovalReconcile>>, {id: number; params: AdmApprovalReconcileParams}> = (props) => {
    const { id, params } = props;
    return admApprovalReconcile(id, params, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};

export type AdmApprovalReconcileMutationResult = NonNullable<Awaited<ReturnType<typeof admApprovalReconcile>>>;
export type AdmApprovalReconcileMutationBody = never;
export type AdmApprovalReconcileMutationError = unknown;

export const useAdmApprovalReconcile = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admApprovalReconcile>>, TError, {id: number; params: AdmApprovalReconcileParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admApprovalReconcile>>, TError, {id: number; params: AdmApprovalReconcileParams}, TContext> => {
  return useMutation(getAdmApprovalReconcileMutationOptions(options), queryClient);
};
// CPF PRE-RUNTIME FALLBACK END admApprovalReconcile
...
export const admAuditLogFindAuditLogs = async (params?: AdmAuditLogFindAuditLogsParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admAuditLogFindAuditLogsResponse> => {
  return cpfOrvalRequest<admAuditLogFindAuditLogsResponse>(getAdmAuditLogFindAuditLogsUrl(), {
    ...options,
    method: 'GET',
    params: { operatorId: params?.operatorId, actionType: params?.actionType, targetType: params?.targetType, targetId: params?.targetId, limit: params?.limit },
  });
};
...
export const admAuthLogout = async (options?: CpfOrvalGeneratedRequestOptions): Promise<admAuthLogoutResponse> => {
...
export const getAdmAuthLogoutMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admAuthLogout>>, TError, void, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
...
export const useAdmAuthLogout = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admAuthLogout>>, TError, void, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admAuthLogout>>, TError, void, TContext> => {
...
export const admAuthMe = async (options?: CpfOrvalGeneratedRequestOptions): Promise<admAuthMeResponse> => {
...
export const getAdmAuthMeQueryKey = () => ["adm", "api", "auth", "me"] as const;
...
export const admBatchRuntimeCommand = async (data: BatchRuntimeCommandRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admBatchRuntimeCommandResponse> => {
...
export const getAdmBatchRuntimeCommandMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admBatchRuntimeCommand>>, TError, {data: BatchRuntimeCommandRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admBatchRuntimeCommand>>, TError, {data: BatchRuntimeCommandRequest}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admBatchRuntimeCommand>>, {data: BatchRuntimeCommandRequest}> = (props) => {
    const { data } = props;
    return admBatchRuntimeCommand(data, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};

export type AdmBatchRuntimeCommandMutationResult = NonNullable<Awaited<ReturnType<typeof admBatchRuntimeCommand>>>;
export type AdmBatchRuntimeCommandMutationBody = BatchRuntimeCommandRequest;
...
export const useAdmBatchRuntimeCommand = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admBatchRuntimeCommand>>, TError, {data: BatchRuntimeCommandRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admBatchRuntimeCommand>>, TError, {data: BatchRuntimeCommandRequest}, TContext> => {
...
export const admBatchRuntimeCreateDeploymentPlan = async (data: BatchRuntimeDeploymentPlanRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admBatchRuntimeCreateDeploymentPlanResponse> => {
...
export const getAdmBatchRuntimeCreateDeploymentPlanMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admBatchRuntimeCreateDeploymentPlan>>, TError, {data: BatchRuntimeDeploymentPlanRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admBatchRuntimeCreateDeploymentPlan>>, TError, {data: BatchRuntimeDeploymentPlanRequest}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admBatchRuntimeCreateDeploymentPlan>>, {data: BatchRuntimeDeploymentPlanRequest}> = (props) => {
    const { data } = props;
    return admBatchRuntimeCreateDeploymentPlan(data, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};
...
export type AdmBatchRuntimeCreateDeploymentPlanMutationBody = BatchRuntimeDeploymentPlanRequest;
...
export const useAdmBatchRuntimeCreateDeploymentPlan = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admBatchRuntimeCreateDeploymentPlan>>, TError, {data: BatchRuntimeDeploymentPlanRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admBatchRuntimeCreateDeploymentPlan>>, TError, {data: BatchRuntimeDeploymentPlanRequest}, TContext> => {
...
export const admBatchRuntimeInstances = async (params?: AdmBatchRuntimeInstancesParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admBatchRuntimeInstancesResponse> => {
  return cpfOrvalRequest<admBatchRuntimeInstancesResponse>(getAdmBatchRuntimeInstancesUrl(), {
    ...options,
    method: 'GET',
    params: { staleAfterSeconds: params?.staleAfterSeconds },
  });
};

export const getAdmBatchRuntimeInstancesQueryKey = (params?: MaybeRefOrGetter<AdmBatchRuntimeInstancesParams>) => ["adm", "api", "batch-runtime", "instances", toValue(params)] as const;
...
export const getAdmBatchRuntimeInstancesQueryOptions = <TData = Awaited<ReturnType<typeof admBatchRuntimeInstances>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmBatchRuntimeInstancesParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admBatchRuntimeInstances>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmBatchRuntimeInstancesQueryKey(toValue(params));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admBatchRuntimeInstances>>> = ({ signal }) => admBatchRuntimeInstances(toValue(params), { signal, ...requestOptions });
...
export function useAdmBatchRuntimeInstances<TData = Awaited<ReturnType<typeof admBatchRuntimeInstances>>, TError = unknown>(
  ...
  const queryOptions = getAdmBatchRuntimeInstancesQueryOptions(params, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
...
export const admBatchJobDefinitions = async (params?: AdmBatchJobDefinitionsParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admBatchJobDefinitionsResponse> => {
  return cpfOrvalRequest<admBatchJobDefinitionsResponse>(getAdmBatchJobDefinitionsUrl(), {
    ...options,
    method: 'GET',
    params: { jobId: params?.jobId, state: params?.state, limit: params?.limit },
  });
};

export const getAdmBatchJobDefinitionsQueryKey = (params?: MaybeRefOrGetter<AdmBatchJobDefinitionsParams>) => ["adm", "api", "batch-runtime", "job-definitions", toValue(params)] as const;

export const getAdmBatchJobDefinitionsQueryOptions = <TData = Awaited<ReturnType<typeof admBatchJobDefinitions>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmBatchJobDefinitionsParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admBatchJobDefinitions>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmBatchJobDefinitionsQueryKey(toValue(params));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admBatchJobDefinitions>>> = ({ signal }) => admBatchJobDefinitions(toValue(params), { signal, ...requestOptions });
...
export function useAdmBatchJobDefinitions<TData = Awaited<ReturnType<typeof admBatchJobDefinitions>>, TError = unknown>(
  ...
  const queryOptions = getAdmBatchJobDefinitionsQueryOptions(params, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
...
export const getAdmBatchJobDefinitionDetailUrl = (jobId: string, version: number) => `/adm/api/batch-runtime/job-definitions/${encodeURIComponent(String(jobId))}/versions/${encodeURIComponent(String(version))}`;

export const admBatchJobDefinitionDetail = async (jobId: string, version: number, options?: CpfOrvalGeneratedRequestOptions): Promise<admBatchJobDefinitionDetailResponse> => {
...
export const getAdmBatchJobDefinitionDetailQueryKey = (jobId: MaybeRefOrGetter<string>, version: MaybeRefOrGetter<number>) => ["adm", "api", "batch-runtime", "job-definitions", jobId, "versions", version] as const;
...
export const getAdmBatchJobDefinitionDetailQueryOptions = <TData = Awaited<ReturnType<typeof admBatchJobDefinitionDetail>>, TError = unknown>(
  jobId: MaybeRefOrGetter<string>, version: MaybeRefOrGetter<number>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admBatchJobDefinitionDetail>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
...
export type admRetentionPoliciesResponseSuccess = (admRetentionPoliciesResponse200) & {
  headers: Headers;
};

export type admRetentionPoliciesResponse = (admRetentionPoliciesResponseSuccess)

export const getAdmRetentionPoliciesUrl = () => `/adm/api/batch-runtime/retention/policies`;

export const admRetentionPolicies = async (options?: CpfOrvalGeneratedRequestOptions): Promise<admRetentionPoliciesResponse> => {
  return cpfOrvalRequest<admRetentionPoliciesResponse>(getAdmRetentionPoliciesUrl(), {
    ...options,
    method: 'GET',
...
export const getAdmRetentionPoliciesQueryKey = () => ["adm", "api", "batch-runtime", "retention", "policies"] as const;

export const getAdmRetentionPoliciesQueryOptions = <TData = Awaited<ReturnType<typeof admRetentionPolicies>>, TError = unknown>(
  options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admRetentionPolicies>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmRetentionPoliciesQueryKey();
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admRetentionPolicies>>> = ({ signal }) => admRetentionPolicies({ signal, ...requestOptions });
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admRetentionPolicies>>, TError, TData>;
};

export type AdmRetentionPoliciesQueryResult = NonNullable<Awaited<ReturnType<typeof admRetentionPolicies>>>;
export type AdmRetentionPoliciesQueryError = unknown;

export function useAdmRetentionPolicies<TData = Awaited<ReturnType<typeof admRetentionPolicies>>, TError = unknown>(
  options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admRetentionPolicies>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getAdmRetentionPoliciesQueryOptions(options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END admRetentionPolicies
...
export type admRetentionPolicySaveResponseSuccess = (admRetentionPolicySaveResponse200) & {
  headers: Headers;
};

export type admRetentionPolicySaveResponse = (admRetentionPolicySaveResponseSuccess)
...
export type admRetentionPolicyPauseResponseSuccess = (admRetentionPolicyPauseResponse200) & {
  headers: Headers;
};

export type admRetentionPolicyPauseResponse = (admRetentionPolicyPauseResponseSuccess)
...
export type admRetentionPolicyResumeResponseSuccess = (admRetentionPolicyResumeResponse200) & {
  headers: Headers;
};

export type admRetentionPolicyResumeResponse = (admRetentionPolicyResumeResponseSuccess)
...
export type admRetentionRunNowResponseSuccess = (admRetentionRunNowResponse200) & {
  headers: Headers;
};

export type admRetentionRunNowResponse = (admRetentionRunNowResponseSuccess)
...
export type admRetentionPreviewResponseSuccess = (admRetentionPreviewResponse200) & {
  headers: Headers;
};

export type admRetentionPreviewResponse = (admRetentionPreviewResponseSuccess)
...
export type admRetentionRunsResponseSuccess = (admRetentionRunsResponse200) & {
  headers: Headers;
};

export type admRetentionRunsResponse = (admRetentionRunsResponseSuccess)

export const getAdmRetentionRunsUrl = () => `/adm/api/batch-runtime/retention/runs`;

export const admRetentionRuns = async (params?: AdmRetentionRunsParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admRetentionRunsResponse> => {
  return cpfOrvalRequest<admRetentionRunsResponse>(getAdmRetentionRunsUrl(), {
    ...options,
    method: 'GET',
    params: { policyId: params?.policyId, limit: params?.limit },
  });
};

export const getAdmRetentionRunsQueryKey = (params?: MaybeRefOrGetter<AdmRetentionRunsParams>) => ["adm", "api", "batch-runtime", "retention", "runs", toValue(params)] as const;

export const getAdmRetentionRunsQueryOptions = <TData = Awaited<ReturnType<typeof admRetentionRuns>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmRetentionRunsParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admRetentionRuns>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmRetentionRunsQueryKey(toValue(params));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admRetentionRuns>>> = ({ signal }) => admRetentionRuns(toValue(params), { signal, ...requestOptions });
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admRetentionRuns>>, TError, TData>;
};

export type AdmRetentionRunsQueryResult = NonNullable<Awaited<ReturnType<typeof admRetentionRuns>>>;
export type AdmRetentionRunsQueryError = unknown;

export function useAdmRetentionRuns<TData = Awaited<ReturnType<typeof admRetentionRuns>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmRetentionRunsParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admRetentionRuns>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getAdmRetentionRunsQueryOptions(params, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END admRetentionRuns
...
export type admRetentionRunPauseResponseSuccess = (admRetentionRunPauseResponse200) & {
  headers: Headers;
};

export type admRetentionRunPauseResponse = (admRetentionRunPauseResponseSuccess)
...
export type admRetentionRunResumeResponseSuccess = (admRetentionRunResumeResponse200) & {
  headers: Headers;
};

export type admRetentionRunResumeResponse = (admRetentionRunResumeResponseSuccess)
...
export type admCapabilityManagementIssuesResponseSuccess = (admCapabilityManagementIssuesResponse200) & {
  headers: Headers;
};

export type admCapabilityManagementIssuesResponse = (admCapabilityManagementIssuesResponseSuccess)

export const getAdmCapabilityManagementIssuesUrl = () => `/adm/api/capability-management/issues`;

export const admCapabilityManagementIssues = async (params?: AdmCapabilityManagementIssuesParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admCapabilityManagementIssuesResponse> => {
  return cpfOrvalRequest<admCapabilityManagementIssuesResponse>(getAdmCapabilityManagementIssuesUrl(), {
    ...options,
    method: 'GET',
    params: { systemCode: params?.systemCode, systemId: params?.systemId, starterId: params?.starterId, capabilityId: params?.capabilityId, provider: params?.provider, includeStale: params?.includeStale },
  });
};

export const getAdmCapabilityManagementIssuesQueryKey = (params?: MaybeRefOrGetter<AdmCapabilityManagementIssuesParams>) => ["adm", "api", "capability-management", "issues", toValue(params)] as const;

export const getAdmCapabilityManagementIssuesQueryOptions = <TData = Awaited<ReturnType<typeof admCapabilityManagementIssues>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmCapabilityManagementIssuesParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admCapabilityManagementIssues>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmCapabilityManagementIssuesQueryKey(toValue(params));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admCapabilityManagementIssues>>> = ({ signal }) => admCapabilityManagementIssues(toValue(params), { signal, ...requestOptions });
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admCapabilityManagementIssues>>, TError, TData>;
};

export type AdmCapabilityManagementIssuesQueryResult = NonNullable<Awaited<ReturnType<typeof admCapabilityManagementIssues>>>;
export type AdmCapabilityManagementIssuesQueryError = unknown;

export function useAdmCapabilityManagementIssues<TData = Awaited<ReturnType<typeof admCapabilityManagementIssues>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmCapabilityManagementIssuesParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admCapabilityManagementIssues>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getAdmCapabilityManagementIssuesQueryOptions(params, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END admCapabilityManagementIssues
...
export type admCapabilityManagementOverviewResponseSuccess = (admCapabilityManagementOverviewResponse200) & {
  headers: Headers;
};

export type admCapabilityManagementOverviewResponse = (admCapabilityManagementOverviewResponseSuccess)

export const getAdmCapabilityManagementOverviewUrl = () => `/adm/api/capability-management/overview`;

export const admCapabilityManagementOverview = async (params?: AdmCapabilityManagementOverviewParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admCapabilityManagementOverviewResponse> => {
  return cpfOrvalRequest<admCapabilityManagementOverviewResponse>(getAdmCapabilityManagementOverviewUrl(), {
    ...options,
    method: 'GET',
    params: { environment: params?.environment, systemCode: params?.systemCode, systemId: params?.systemId, domainCode: params?.domainCode, domainId: params?.domainId, application: params?.application, module: params?.module, host: params?.host, instanceId: params?.instanceId, starterId: params?.starterId, capabilityId: params?.capabilityId, provider: params?.provider, version: params?.version, status: params?.status, includeStale: params?.includeStale, page: params?.page, size: params?.size },
  });
};

export const getAdmCapabilityManagementOverviewQueryKey = (params?: MaybeRefOrGetter<AdmCapabilityManagementOverviewParams>) => ["adm", "api", "capability-management", "overview", toValue(params)] as const;

export const getAdmCapabilityManagementOverviewQueryOptions = <TData = Awaited<ReturnType<typeof admCapabilityManagementOverview>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmCapabilityManagementOverviewParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admCapabilityManagementOverview>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmCapabilityManagementOverviewQueryKey(toValue(params));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admCapabilityManagementOverview>>> = ({ signal }) => admCapabilityManagementOverview(toValue(params), { signal, ...requestOptions });
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admCapabilityManagementOverview>>, TError, TData>;
};

export type AdmCapabilityManagementOverviewQueryResult = NonNullable<Awaited<ReturnType<typeof admCapabilityManagementOverview>>>;
export type AdmCapabilityManagementOverviewQueryError = unknown;

export function useAdmCapabilityManagementOverview<TData = Awaited<ReturnType<typeof admCapabilityManagementOverview>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmCapabilityManagementOverviewParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admCapabilityManagementOverview>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getAdmCapabilityManagementOverviewQueryOptions(params, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END admCapabilityManagementOverview
...
export const admFileJobUpload = async (data: FormData, params: AdmFileJobUploadParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admFileJobUploadResponse> => {
...
export const getAdmFileJobUploadMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admFileJobUpload>>, TError, {data: FormData; params: AdmFileJobUploadParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admFileJobUpload>>, TError, {data: FormData; params: AdmFileJobUploadParams}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admFileJobUpload>>, {data: FormData; params: AdmFileJobUploadParams}> = (props) => {
    const { data, params } = props;
    return admFileJobUpload(data, params, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};

export type AdmFileJobUploadMutationResult = NonNullable<Awaited<ReturnType<typeof admFileJobUpload>>>;
export type AdmFileJobUploadMutationBody = FormData;
export type AdmFileJobUploadMutationError = unknown;

export const useAdmFileJobUpload = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admFileJobUpload>>, TError, {data: FormData; params: AdmFileJobUploadParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admFileJobUpload>>, TError, {data: FormData; params: AdmFileJobUploadParams}, TContext> => {
...
export type admHealthInstanceListResponseSuccess = (admHealthInstanceListResponse200) & {
  headers: Headers;
};

export type admHealthInstanceListResponse = (admHealthInstanceListResponseSuccess)

export const getAdmHealthInstanceListUrl = () => `/adm/api/health/instances`;

export const admHealthInstanceList = async (params?: AdmHealthInstanceListParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admHealthInstanceListResponse> => {
  return cpfOrvalRequest<admHealthInstanceListResponse>(getAdmHealthInstanceListUrl(), {
    ...options,
    method: 'GET',
    params: { systemId: params?.systemId, readiness: params?.readiness, includeStale: params?.includeStale, page: params?.page, size: params?.size },
  });
};

export const getAdmHealthInstanceListQueryKey = (params?: MaybeRefOrGetter<AdmHealthInstanceListParams>) => ["adm", "api", "health", "instances", toValue(params)] as const;

export const getAdmHealthInstanceListQueryOptions = <TData = Awaited<ReturnType<typeof admHealthInstanceList>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmHealthInstanceListParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admHealthInstanceList>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmHealthInstanceListQueryKey(toValue(params));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admHealthInstanceList>>> = ({ signal }) => admHealthInstanceList(toValue(params), { signal, ...requestOptions });
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admHealthInstanceList>>, TError, TData>;
};

export type AdmHealthInstanceListQueryResult = NonNullable<Awaited<ReturnType<typeof admHealthInstanceList>>>;
export type AdmHealthInstanceListQueryError = unknown;

export function useAdmHealthInstanceList<TData = Awaited<ReturnType<typeof admHealthInstanceList>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmHealthInstanceListParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admHealthInstanceList>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getAdmHealthInstanceListQueryOptions(params, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END admHealthInstanceList
...
export type admHealthInstanceDetailResponseSuccess = (admHealthInstanceDetailResponse200) & {
  headers: Headers;
};

export type admHealthInstanceDetailResponse = (admHealthInstanceDetailResponseSuccess)

export const getAdmHealthInstanceDetailUrl = (systemId: string, instanceId: string) => `/adm/api/health/instances/${encodeURIComponent(String(systemId))}/${encodeURIComponent(String(instanceId))}`;

export const admHealthInstanceDetail = async (systemId: string, instanceId: string, options?: CpfOrvalGeneratedRequestOptions): Promise<admHealthInstanceDetailResponse> => {
  return cpfOrvalRequest<admHealthInstanceDetailResponse>(getAdmHealthInstanceDetailUrl(systemId, instanceId), {
    ...options,
    method: 'GET',
...
export const getAdmHealthInstanceDetailQueryKey = (systemId: MaybeRefOrGetter<string>, instanceId: MaybeRefOrGetter<string>) => ["adm", "api", "health", "instances", systemId, instanceId] as const;

export const getAdmHealthInstanceDetailQueryOptions = <TData = Awaited<ReturnType<typeof admHealthInstanceDetail>>, TError = unknown>(
  systemId: MaybeRefOrGetter<string>, instanceId: MaybeRefOrGetter<string>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admHealthInstanceDetail>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmHealthInstanceDetailQueryKey(toValue(systemId), toValue(instanceId));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admHealthInstanceDetail>>> = ({ signal }) => admHealthInstanceDetail(toValue(systemId), toValue(instanceId), { signal, ...requestOptions });
  return { queryKey, queryFn, enabled: computed(() => toValue(systemId) !== null && toValue(systemId) !== undefined && toValue(instanceId) !== null && toValue(instanceId) !== undefined), ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admHealthInstanceDetail>>, TError, TData>;
};

export type AdmHealthInstanceDetailQueryResult = NonNullable<Awaited<ReturnType<typeof admHealthInstanceDetail>>>;
export type AdmHealthInstanceDetailQueryError = unknown;

export function useAdmHealthInstanceDetail<TData = Awaited<ReturnType<typeof admHealthInstanceDetail>>, TError = unknown>(
  systemId: MaybeRefOrGetter<string>, instanceId: MaybeRefOrGetter<string>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admHealthInstanceDetail>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getAdmHealthInstanceDetailQueryOptions(systemId, instanceId, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END admHealthInstanceDetail
...
export type admIncidentRecordPostmortemResponseSuccess = (admIncidentRecordPostmortemResponse200) & {
  headers: Headers;
};

export type admIncidentRecordPostmortemResponse = (admIncidentRecordPostmortemResponseSuccess)

export const getAdmIncidentRecordPostmortemUrl = (incidentId: number) => `/adm/api/incidents/${encodeURIComponent(String(incidentId))}/postmortem`;

export const admIncidentRecordPostmortem = async (incidentId: number, data: IncidentActionRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admIncidentRecordPostmortemResponse> => {
  return cpfOrvalRequest<admIncidentRecordPostmortemResponse>(getAdmIncidentRecordPostmortemUrl(incidentId), {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    data,
...
export const getAdmIncidentRecordPostmortemMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admIncidentRecordPostmortem>>, TError, {incidentId: number; data: IncidentActionRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admIncidentRecordPostmortem>>, TError, {incidentId: number; data: IncidentActionRequest}, TContext> => {
  const mutationKey = ['admIncidentRecordPostmortem'];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admIncidentRecordPostmortem>>, {incidentId: number; data: IncidentActionRequest}> = (props) => {
    const { incidentId, data } = props;
    return admIncidentRecordPostmortem(incidentId, data, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};

export type AdmIncidentRecordPostmortemMutationResult = NonNullable<Awaited<ReturnType<typeof admIncidentRecordPostmortem>>>;
export type AdmIncidentRecordPostmortemMutationBody = IncidentActionRequest;
export type AdmIncidentRecordPostmortemMutationError = unknown;

export const useAdmIncidentRecordPostmortem = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admIncidentRecordPostmortem>>, TError, {incidentId: number; data: IncidentActionRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admIncidentRecordPostmortem>>, TError, {incidentId: number; data: IncidentActionRequest}, TContext> => {
  return useMutation(getAdmIncidentRecordPostmortemMutationOptions(options), queryClient);
};
// CPF PRE-RUNTIME FALLBACK END admIncidentRecordPostmortem
...
export type admIntegrationCryptoStatusResponseSuccess = (admIntegrationCryptoStatusResponse200) & {
  headers: Headers;
};

export type admIntegrationCryptoStatusResponse = (admIntegrationCryptoStatusResponseSuccess)

export const getAdmIntegrationCryptoStatusUrl = () => `/adm/api/integration-closure/crypto/status`;

export const admIntegrationCryptoStatus = async (options?: CpfOrvalGeneratedRequestOptions): Promise<admIntegrationCryptoStatusResponse> => {
  return cpfOrvalRequest<admIntegrationCryptoStatusResponse>(getAdmIntegrationCryptoStatusUrl(), {
    ...options,
    method: 'GET',
...
export const getAdmIntegrationCryptoStatusQueryKey = () => ["adm", "api", "integration-closure", "crypto", "status"] as const;

export const getAdmIntegrationCryptoStatusQueryOptions = <TData = Awaited<ReturnType<typeof admIntegrationCryptoStatus>>, TError = unknown>(
  options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admIntegrationCryptoStatus>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmIntegrationCryptoStatusQueryKey();
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admIntegrationCryptoStatus>>> = ({ signal }) => admIntegrationCryptoStatus({ signal, ...requestOptions });
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admIntegrationCryptoStatus>>, TError, TData>;
};

export type AdmIntegrationCryptoStatusQueryResult = NonNullable<Awaited<ReturnType<typeof admIntegrationCryptoStatus>>>;
export type AdmIntegrationCryptoStatusQueryError = unknown;

export function useAdmIntegrationCryptoStatus<TData = Awaited<ReturnType<typeof admIntegrationCryptoStatus>>, TError = unknown>(
  options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admIntegrationCryptoStatus>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getAdmIntegrationCryptoStatusQueryOptions(options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END admIntegrationCryptoStatus
...
export type admIntegrationDataQualityCorrectionExecuteResponseSuccess = (admIntegrationDataQualityCorrectionExecuteResponse200) & {
  headers: Headers;
};

export type admIntegrationDataQualityCorrectionExecuteResponse = (admIntegrationDataQualityCorrectionExecuteResponseSuccess)

export const getAdmIntegrationDataQualityCorrectionExecuteUrl = (approvalRequestId: number) => `/adm/api/integration-closure/data-quality/correction-approvals/${encodeURIComponent(String(approvalRequestId))}/execute`;

export const admIntegrationDataQualityCorrectionExecute = async (approvalRequestId: number, data: AdmIntegrationDataQualityCorrectionExecuteRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admIntegrationDataQualityCorrectionExecuteResponse> => {
  return cpfOrvalRequest<admIntegrationDataQualityCorrectionExecuteResponse>(getAdmIntegrationDataQualityCorrectionExecuteUrl(approvalRequestId), {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    data,
...
export const getAdmIntegrationDataQualityCorrectionExecuteMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admIntegrationDataQualityCorrectionExecute>>, TError, {approvalRequestId: number; data: AdmIntegrationDataQualityCorrectionExecuteRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admIntegrationDataQualityCorrectionExecute>>, TError, {approvalRequestId: number; data: AdmIntegrationDataQualityCorrectionExecuteRequest}, TContext> => {
  const mutationKey = ['admIntegrationDataQualityCorrectionExecute'];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admIntegrationDataQualityCorrectionExecute>>, {approvalRequestId: number; data: AdmIntegrationDataQualityCorrectionExecuteRequest}> = (props) => {
    const { approvalRequestId, data } = props;
    return admIntegrationDataQualityCorrectionExecute(approvalRequestId, data, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};

export type AdmIntegrationDataQualityCorrectionExecuteMutationResult = NonNullable<Awaited<ReturnType<typeof admIntegrationDataQualityCorrectionExecute>>>;
export type AdmIntegrationDataQualityCorrectionExecuteMutationBody = AdmIntegrationDataQualityCorrectionExecuteRequest;
export type AdmIntegrationDataQualityCorrectionExecuteMutationError = unknown;

export const useAdmIntegrationDataQualityCorrectionExecute = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admIntegrationDataQualityCorrectionExecute>>, TError, {approvalRequestId: number; data: AdmIntegrationDataQualityCorrectionExecuteRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admIntegrationDataQualityCorrectionExecute>>, TError, {approvalRequestId: number; data: AdmIntegrationDataQualityCorrectionExecuteRequest}, TContext> => {
  return useMutation(getAdmIntegrationDataQualityCorrectionExecuteMutationOptions(options), queryClient);
};
// CPF PRE-RUNTIME FALLBACK END admIntegrationDataQualityCorrectionExecute
...
export type admIntegrationDataQualityCorrectionApprovalRequestResponseSuccess = (admIntegrationDataQualityCorrectionApprovalRequestResponse200) & {
  headers: Headers;
};

export type admIntegrationDataQualityCorrectionApprovalRequestResponse = (admIntegrationDataQualityCorrectionApprovalRequestResponseSuccess)

export const getAdmIntegrationDataQualityCorrectionApprovalRequestUrl = (id: string) => `/adm/api/integration-closure/data-quality/quarantine/${encodeURIComponent(String(id))}/correction-approvals`;

export const admIntegrationDataQualityCorrectionApprovalRequest = async (id: string, data: AdmIntegrationDataQualityCorrectionApprovalRequestRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admIntegrationDataQualityCorrectionApprovalRequestResponse> => {
  return cpfOrvalRequest<admIntegrationDataQualityCorrectionApprovalRequestResponse>(getAdmIntegrationDataQualityCorrectionApprovalRequestUrl(id), {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    data,
...
export const getAdmIntegrationDataQualityCorrectionApprovalRequestMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admIntegrationDataQualityCorrectionApprovalRequest>>, TError, {id: string; data: AdmIntegrationDataQualityCorrectionApprovalRequestRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admIntegrationDataQualityCorrectionApprovalRequest>>, TError, {id: string; data: AdmIntegrationDataQualityCorrectionApprovalRequestRequest}, TContext> => {
  const mutationKey = ['admIntegrationDataQualityCorrectionApprovalRequest'];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admIntegrationDataQualityCorrectionApprovalRequest>>, {id: string; data: AdmIntegrationDataQualityCorrectionApprovalRequestRequest}> = (props) => {
    const { id, data } = props;
    return admIntegrationDataQualityCorrectionApprovalRequest(id, data, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};

export type AdmIntegrationDataQualityCorrectionApprovalRequestMutationResult = NonNullable<Awaited<ReturnType<typeof admIntegrationDataQualityCorrectionApprovalRequest>>>;
export type AdmIntegrationDataQualityCorrectionApprovalRequestMutationBody = AdmIntegrationDataQualityCorrectionApprovalRequestRequest;
export type AdmIntegrationDataQualityCorrectionApprovalRequestMutationError = unknown;

export const useAdmIntegrationDataQualityCorrectionApprovalRequest = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admIntegrationDataQualityCorrectionApprovalRequest>>, TError, {id: string; data: AdmIntegrationDataQualityCorrectionApprovalRequestRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admIntegrationDataQualityCorrectionApprovalRequest>>, TError, {id: string; data: AdmIntegrationDataQualityCorrectionApprovalRequestRequest}, TContext> => {
  return useMutation(getAdmIntegrationDataQualityCorrectionApprovalRequestMutationOptions(options), queryClient);
};
// CPF PRE-RUNTIME FALLBACK END admIntegrationDataQualityCorrectionApprovalRequest
...
export type admIntegrationDataQualityReplayResponseSuccess = (admIntegrationDataQualityReplayResponse200) & {
  headers: Headers;
};

export type admIntegrationDataQualityReplayResponse = (admIntegrationDataQualityReplayResponseSuccess)

export const getAdmIntegrationDataQualityReplayUrl = (id: string) => `/adm/api/integration-closure/data-quality/quarantine/${encodeURIComponent(String(id))}/replay`;

export const admIntegrationDataQualityReplay = async (id: string, data: AdmIntegrationDataQualityReplayRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admIntegrationDataQualityReplayResponse> => {
  return cpfOrvalRequest<admIntegrationDataQualityReplayResponse>(getAdmIntegrationDataQualityReplayUrl(id), {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    data,
...
export const getAdmIntegrationDataQualityReplayMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admIntegrationDataQualityReplay>>, TError, {id: string; data: AdmIntegrationDataQualityReplayRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admIntegrationDataQualityReplay>>, TError, {id: string; data: AdmIntegrationDataQualityReplayRequest}, TContext> => {
  const mutationKey = ['admIntegrationDataQualityReplay'];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admIntegrationDataQualityReplay>>, {id: string; data: AdmIntegrationDataQualityReplayRequest}> = (props) => {
    const { id, data } = props;
    return admIntegrationDataQualityReplay(id, data, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};

export type AdmIntegrationDataQualityReplayMutationResult = NonNullable<Awaited<ReturnType<typeof admIntegrationDataQualityReplay>>>;
export type AdmIntegrationDataQualityReplayMutationBody = AdmIntegrationDataQualityReplayRequest;
export type AdmIntegrationDataQualityReplayMutationError = unknown;

export const useAdmIntegrationDataQualityReplay = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admIntegrationDataQualityReplay>>, TError, {id: string; data: AdmIntegrationDataQualityReplayRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admIntegrationDataQualityReplay>>, TError, {id: string; data: AdmIntegrationDataQualityReplayRequest}, TContext> => {
  return useMutation(getAdmIntegrationDataQualityReplayMutationOptions(options), queryClient);
};
// CPF PRE-RUNTIME FALLBACK END admIntegrationDataQualityReplay
...
export type admIntegrationDataQualityValidateResponseSuccess = (admIntegrationDataQualityValidateResponse200) & {
  headers: Headers;
};

export type admIntegrationDataQualityValidateResponse = (admIntegrationDataQualityValidateResponseSuccess)
...
export type admIntegrationTimeHealthResponseSuccess = (admIntegrationTimeHealthResponse200) & {
  headers: Headers;
};

export type admIntegrationTimeHealthResponse = (admIntegrationTimeHealthResponseSuccess)

export const getAdmIntegrationTimeHealthUrl = () => `/adm/api/integration-closure/time/health`;

export const admIntegrationTimeHealth = async (params?: AdmIntegrationTimeHealthParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admIntegrationTimeHealthResponse> => {
  return cpfOrvalRequest<admIntegrationTimeHealthResponse>(getAdmIntegrationTimeHealthUrl(), {
    ...options,
    method: 'GET',
    params: { zone: params?.zone, maxSkewMillis: params?.maxSkewMillis },
  });
};

export const getAdmIntegrationTimeHealthQueryKey = (params?: MaybeRefOrGetter<AdmIntegrationTimeHealthParams>) => ["adm", "api", "integration-closure", "time", "health", toValue(params)] as const;

export const getAdmIntegrationTimeHealthQueryOptions = <TData = Awaited<ReturnType<typeof admIntegrationTimeHealth>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmIntegrationTimeHealthParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admIntegrationTimeHealth>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmIntegrationTimeHealthQueryKey(toValue(params));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admIntegrationTimeHealth>>> = ({ signal }) => admIntegrationTimeHealth(toValue(params), { signal, ...requestOptions });
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admIntegrationTimeHealth>>, TError, TData>;
};

export type AdmIntegrationTimeHealthQueryResult = NonNullable<Awaited<ReturnType<typeof admIntegrationTimeHealth>>>;
export type AdmIntegrationTimeHealthQueryError = unknown;

export function useAdmIntegrationTimeHealth<TData = Awaited<ReturnType<typeof admIntegrationTimeHealth>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmIntegrationTimeHealthParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admIntegrationTimeHealth>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getAdmIntegrationTimeHealthQueryOptions(params, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END admIntegrationTimeHealth
...
export type admIntegrationWebhookDlqResponseSuccess = (admIntegrationWebhookDlqResponse200) & {
  headers: Headers;
};

export type admIntegrationWebhookDlqResponse = (admIntegrationWebhookDlqResponseSuccess)

export const getAdmIntegrationWebhookDlqUrl = () => `/adm/api/integration-closure/webhooks/dlq`;

export const admIntegrationWebhookDlq = async (params?: AdmIntegrationWebhookDlqParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admIntegrationWebhookDlqResponse> => {
  return cpfOrvalRequest<admIntegrationWebhookDlqResponse>(getAdmIntegrationWebhookDlqUrl(), {
    ...options,
    method: 'GET',
    params: { limit: params?.limit },
  });
...
export const getAdmIntegrationWebhookDlqQueryKey = (params?: MaybeRefOrGetter<AdmIntegrationWebhookDlqParams>) => ["adm", "api", "integration-closure", "webhooks", "dlq", toValue(params)] as const;

export const getAdmIntegrationWebhookDlqQueryOptions = <TData = Awaited<ReturnType<typeof admIntegrationWebhookDlq>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmIntegrationWebhookDlqParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admIntegrationWebhookDlq>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmIntegrationWebhookDlqQueryKey(toValue(params));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admIntegrationWebhookDlq>>> = ({ signal }) => admIntegrationWebhookDlq(toValue(params), { signal, ...requestOptions });
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admIntegrationWebhookDlq>>, TError, TData>;
};

export type AdmIntegrationWebhookDlqQueryResult = NonNullable<Awaited<ReturnType<typeof admIntegrationWebhookDlq>>>;
export type AdmIntegrationWebhookDlqQueryError = unknown;

export function useAdmIntegrationWebhookDlq<TData = Awaited<ReturnType<typeof admIntegrationWebhookDlq>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmIntegrationWebhookDlqParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admIntegrationWebhookDlq>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getAdmIntegrationWebhookDlqQueryOptions(params, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END admIntegrationWebhookDlq
...
export type admIntegrationWebhookReplayResponseSuccess = (admIntegrationWebhookReplayResponse200) & {
  headers: Headers;
};

export type admIntegrationWebhookReplayResponse = (admIntegrationWebhookReplayResponseSuccess)

export const getAdmIntegrationWebhookReplayUrl = (id: string) => `/adm/api/integration-closure/webhooks/${encodeURIComponent(String(id))}/replay`;

export const admIntegrationWebhookReplay = async (id: string, params: AdmIntegrationWebhookReplayParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admIntegrationWebhookReplayResponse> => {
  return cpfOrvalRequest<admIntegrationWebhookReplayResponse>(getAdmIntegrationWebhookReplayUrl(id), {
    ...options,
    method: 'POST',
...
export const getAdmIntegrationWebhookReplayMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admIntegrationWebhookReplay>>, TError, {id: string; params: AdmIntegrationWebhookReplayParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admIntegrationWebhookReplay>>, TError, {id: string; params: AdmIntegrationWebhookReplayParams}, TContext> => {
  const mutationKey = ['admIntegrationWebhookReplay'];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admIntegrationWebhookReplay>>, {id: string; params: AdmIntegrationWebhookReplayParams}> = (props) => {
    const { id, params } = props;
    return admIntegrationWebhookReplay(id, params, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};

export type AdmIntegrationWebhookReplayMutationResult = NonNullable<Awaited<ReturnType<typeof admIntegrationWebhookReplay>>>;
export type AdmIntegrationWebhookReplayMutationBody = never;
export type AdmIntegrationWebhookReplayMutationError = unknown;

export const useAdmIntegrationWebhookReplay = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admIntegrationWebhookReplay>>, TError, {id: string; params: AdmIntegrationWebhookReplayParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admIntegrationWebhookReplay>>, TError, {id: string; params: AdmIntegrationWebhookReplayParams}, TContext> => {
  return useMutation(getAdmIntegrationWebhookReplayMutationOptions(options), queryClient);
};
// CPF PRE-RUNTIME FALLBACK END admIntegrationWebhookReplay
...
export const admLogPolicyAuditFindPolicyAudits = async (params?: AdmLogPolicyAuditFindPolicyAuditsParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admLogPolicyAuditFindPolicyAuditsResponse> => {
  return cpfOrvalRequest<admLogPolicyAuditFindPolicyAuditsResponse>(getAdmLogPolicyAuditFindPolicyAuditsUrl(), {
    ...options,
    method: 'GET',
    params: { operatorId: params?.operatorId, actionType: params?.actionType, targetType: params?.targetType, targetId: params?.targetId, policyId: params?.policyId, overrideId: params?.overrideId, limit: params?.limit },
  });
};
...
export type getAdmFileLogRecoveryStatusResponseSuccess = (getAdmFileLogRecoveryStatusResponse200) & {
  headers: Headers;
};

export type getAdmFileLogRecoveryStatusResponse = (getAdmFileLogRecoveryStatusResponseSuccess)

export const getGetAdmFileLogRecoveryStatusUrl = () => `/adm/api/observability/file-log-recovery`;

export const getAdmFileLogRecoveryStatus = async (options?: CpfOrvalGeneratedRequestOptions): Promise<getAdmFileLogRecoveryStatusResponse> => {
  return cpfOrvalRequest<getAdmFileLogRecoveryStatusResponse>(getGetAdmFileLogRecoveryStatusUrl(), {
    ...options,
    method: 'GET',
...
export const getGetAdmFileLogRecoveryStatusQueryKey = () => ["adm", "api", "observability", "file-log-recovery"] as const;

export const getGetAdmFileLogRecoveryStatusQueryOptions = <TData = Awaited<ReturnType<typeof getAdmFileLogRecoveryStatus>>, TError = unknown>(
  options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getAdmFileLogRecoveryStatus>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getGetAdmFileLogRecoveryStatusQueryKey();
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getAdmFileLogRecoveryStatus>>> = ({ signal }) => getAdmFileLogRecoveryStatus({ signal, ...requestOptions });
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof getAdmFileLogRecoveryStatus>>, TError, TData>;
};

export type GetAdmFileLogRecoveryStatusQueryResult = NonNullable<Awaited<ReturnType<typeof getAdmFileLogRecoveryStatus>>>;
export type GetAdmFileLogRecoveryStatusQueryError = unknown;

export function useGetAdmFileLogRecoveryStatus<TData = Awaited<ReturnType<typeof getAdmFileLogRecoveryStatus>>, TError = unknown>(
  options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getAdmFileLogRecoveryStatus>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getGetAdmFileLogRecoveryStatusQueryOptions(options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END getAdmFileLogRecoveryStatus
...
export type admOperationsGovernanceSnapshotResponseSuccess = (admOperationsGovernanceSnapshotResponse200) & {
  headers: Headers;
};

export type admOperationsGovernanceSnapshotResponse = (admOperationsGovernanceSnapshotResponseSuccess)

export const getAdmOperationsGovernanceSnapshotUrl = () => `/adm/api/operations-governance/snapshot`;

export const admOperationsGovernanceSnapshot = async (options?: CpfOrvalGeneratedRequestOptions): Promise<admOperationsGovernanceSnapshotResponse> => {
  return cpfOrvalRequest<admOperationsGovernanceSnapshotResponse>(getAdmOperationsGovernanceSnapshotUrl(), {
    ...options,
    method: 'GET',
...
export const getAdmOperationsGovernanceSnapshotQueryKey = () => ["adm", "api", "operations-governance", "snapshot"] as const;

export const getAdmOperationsGovernanceSnapshotQueryOptions = <TData = Awaited<ReturnType<typeof admOperationsGovernanceSnapshot>>, TError = unknown>(
  options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admOperationsGovernanceSnapshot>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmOperationsGovernanceSnapshotQueryKey();
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admOperationsGovernanceSnapshot>>> = ({ signal }) => admOperationsGovernanceSnapshot({ signal, ...requestOptions });
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admOperationsGovernanceSnapshot>>, TError, TData>;
};

export type AdmOperationsGovernanceSnapshotQueryResult = NonNullable<Awaited<ReturnType<typeof admOperationsGovernanceSnapshot>>>;
export type AdmOperationsGovernanceSnapshotQueryError = unknown;

export function useAdmOperationsGovernanceSnapshot<TData = Awaited<ReturnType<typeof admOperationsGovernanceSnapshot>>, TError = unknown>(
  options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admOperationsGovernanceSnapshot>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getAdmOperationsGovernanceSnapshotQueryOptions(options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END admOperationsGovernanceSnapshot
...
export const admOperatorValidatePassword = async (params: AdmOperatorValidatePasswordParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admOperatorValidatePasswordResponse> => {
  return cpfOrvalRequest<admOperatorValidatePasswordResponse>(getAdmOperatorValidatePasswordUrl(), {
    ...options,
    method: 'GET',
    params: { operatorId: params.operatorId, password: params.password },
  });
};
...
export const admOperatorFindSessions = async (params?: AdmOperatorFindSessionsParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admOperatorFindSessionsResponse> => {
...
export const getAdmOperatorFindSessionsQueryKey = (params?: MaybeRefOrGetter<AdmOperatorFindSessionsParams>) => ["adm", "api", "operators", "sessions", toValue(params)] as const;
...
export const getAdmOperatorFindSessionsQueryOptions = <TData = Awaited<ReturnType<typeof admOperatorFindSessions>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmOperatorFindSessionsParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admOperatorFindSessions>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmOperatorFindSessionsQueryKey(toValue(params));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admOperatorFindSessions>>> = ({ signal }) => admOperatorFindSessions(toValue(params), { signal, ...requestOptions });
...
export function useAdmOperatorFindSessions<TData = Awaited<ReturnType<typeof admOperatorFindSessions>>, TError = unknown>(
  ...
  const queryOptions = getAdmOperatorFindSessionsQueryOptions(params, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
...
export const admFeatureFlagRequestOverride = async (data: AdmFeatureFlagRequestOverrideRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admFeatureFlagRequestOverrideResponse> => {
...
export const getAdmFeatureFlagRequestOverrideMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admFeatureFlagRequestOverride>>, TError, {data: AdmFeatureFlagRequestOverrideRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admFeatureFlagRequestOverride>>, TError, {data: AdmFeatureFlagRequestOverrideRequest}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admFeatureFlagRequestOverride>>, {data: AdmFeatureFlagRequestOverrideRequest}> = (props) => {
    const { data } = props;
...
export type AdmFeatureFlagRequestOverrideMutationBody = AdmFeatureFlagRequestOverrideRequest;
...
export const useAdmFeatureFlagRequestOverride = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admFeatureFlagRequestOverride>>, TError, {data: AdmFeatureFlagRequestOverrideRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admFeatureFlagRequestOverride>>, TError, {data: AdmFeatureFlagRequestOverrideRequest}, TContext> => {
...
export const admFeatureFlagApproveOverride = async (requestId: string, data: AdmFeatureFlagApproveOverrideRequest, params: AdmFeatureFlagApproveOverrideParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admFeatureFlagApproveOverrideResponse> => {
...
export const getAdmFeatureFlagApproveOverrideMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admFeatureFlagApproveOverride>>, TError, {requestId: string; data: AdmFeatureFlagApproveOverrideRequest; params: AdmFeatureFlagApproveOverrideParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admFeatureFlagApproveOverride>>, TError, {requestId: string; data: AdmFeatureFlagApproveOverrideRequest; params: AdmFeatureFlagApproveOverrideParams}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admFeatureFlagApproveOverride>>, {requestId: string; data: AdmFeatureFlagApproveOverrideRequest; params: AdmFeatureFlagApproveOverrideParams}> = (props) => {
...
export type AdmFeatureFlagApproveOverrideMutationBody = AdmFeatureFlagApproveOverrideRequest;
...
export const useAdmFeatureFlagApproveOverride = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admFeatureFlagApproveOverride>>, TError, {requestId: string; data: AdmFeatureFlagApproveOverrideRequest; params: AdmFeatureFlagApproveOverrideParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admFeatureFlagApproveOverride>>, TError, {requestId: string; data: AdmFeatureFlagApproveOverrideRequest; params: AdmFeatureFlagApproveOverrideParams}, TContext> => {
...
export const admFeatureFlagRevokeOverride = async (requestId: string, data: AdmFeatureFlagRevokeOverrideRequest, params: AdmFeatureFlagRevokeOverrideParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admFeatureFlagRevokeOverrideResponse> => {
...
export const getAdmFeatureFlagRevokeOverrideMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admFeatureFlagRevokeOverride>>, TError, {requestId: string; data: AdmFeatureFlagRevokeOverrideRequest; params: AdmFeatureFlagRevokeOverrideParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admFeatureFlagRevokeOverride>>, TError, {requestId: string; data: AdmFeatureFlagRevokeOverrideRequest; params: AdmFeatureFlagRevokeOverrideParams}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admFeatureFlagRevokeOverride>>, {requestId: string; data: AdmFeatureFlagRevokeOverrideRequest; params: AdmFeatureFlagRevokeOverrideParams}> = (props) => {
    const { requestId, data, params } = props;
...
export type AdmFeatureFlagRevokeOverrideMutationBody = AdmFeatureFlagRevokeOverrideRequest;
...
export const useAdmFeatureFlagRevokeOverride = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admFeatureFlagRevokeOverride>>, TError, {requestId: string; data: AdmFeatureFlagRevokeOverrideRequest; params: AdmFeatureFlagRevokeOverrideParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admFeatureFlagRevokeOverride>>, TError, {requestId: string; data: AdmFeatureFlagRevokeOverrideRequest; params: AdmFeatureFlagRevokeOverrideParams}, TContext> => {
...
export const admResiliencePolicyRequest = async (data: AdmResiliencePolicyRequestRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admResiliencePolicyRequestResponse> => {
...
export const getAdmResiliencePolicyRequestMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admResiliencePolicyRequest>>, TError, {data: AdmResiliencePolicyRequestRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admResiliencePolicyRequest>>, TError, {data: AdmResiliencePolicyRequestRequest}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admResiliencePolicyRequest>>, {data: AdmResiliencePolicyRequestRequest}> = (props) => {
    const { data } = props;
...
export type AdmResiliencePolicyRequestMutationBody = AdmResiliencePolicyRequestRequest;
...
export const useAdmResiliencePolicyRequest = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admResiliencePolicyRequest>>, TError, {data: AdmResiliencePolicyRequestRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admResiliencePolicyRequest>>, TError, {data: AdmResiliencePolicyRequestRequest}, TContext> => {
...
export const admResiliencePolicyApprove = async (requestId: string, data: AdmResiliencePolicyApproveRequest, params: AdmResiliencePolicyApproveParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admResiliencePolicyApproveResponse> => {
...
export const getAdmResiliencePolicyApproveMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admResiliencePolicyApprove>>, TError, {requestId: string; data: AdmResiliencePolicyApproveRequest; params: AdmResiliencePolicyApproveParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admResiliencePolicyApprove>>, TError, {requestId: string; data: AdmResiliencePolicyApproveRequest; params: AdmResiliencePolicyApproveParams}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admResiliencePolicyApprove>>, {requestId: string; data: AdmResiliencePolicyApproveRequest; params: AdmResiliencePolicyApproveParams}> = (props) => {
    const { requestId, data, params } = props;
...
export type AdmResiliencePolicyApproveMutationBody = AdmResiliencePolicyApproveRequest;
...
export const useAdmResiliencePolicyApprove = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admResiliencePolicyApprove>>, TError, {requestId: string; data: AdmResiliencePolicyApproveRequest; params: AdmResiliencePolicyApproveParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admResiliencePolicyApprove>>, TError, {requestId: string; data: AdmResiliencePolicyApproveRequest; params: AdmResiliencePolicyApproveParams}, TContext> => {
...
export const admResiliencePolicyReject = async (requestId: string, data: AdmResiliencePolicyRejectRequest, params: AdmResiliencePolicyRejectParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admResiliencePolicyRejectResponse> => {
...
export const getAdmResiliencePolicyRejectMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admResiliencePolicyReject>>, TError, {requestId: string; data: AdmResiliencePolicyRejectRequest; params: AdmResiliencePolicyRejectParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admResiliencePolicyReject>>, TError, {requestId: string; data: AdmResiliencePolicyRejectRequest; params: AdmResiliencePolicyRejectParams}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admResiliencePolicyReject>>, {requestId: string; data: AdmResiliencePolicyRejectRequest; params: AdmResiliencePolicyRejectParams}> = (props) => {
    const { requestId, data, params } = props;
...
export type AdmResiliencePolicyRejectMutationBody = AdmResiliencePolicyRejectRequest;
...
export const useAdmResiliencePolicyReject = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admResiliencePolicyReject>>, TError, {requestId: string; data: AdmResiliencePolicyRejectRequest; params: AdmResiliencePolicyRejectParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admResiliencePolicyReject>>, TError, {requestId: string; data: AdmResiliencePolicyRejectRequest; params: AdmResiliencePolicyRejectParams}, TContext> => {
...
export type admPlatformVersionResponseSuccess = (admPlatformVersionResponse200) & {
  headers: Headers;
};

export type admPlatformVersionResponse = (admPlatformVersionResponseSuccess)

export const getAdmPlatformVersionUrl = () => `/adm/api/platform/version`;

export const admPlatformVersion = async (options?: CpfOrvalGeneratedRequestOptions): Promise<admPlatformVersionResponse> => {
  return cpfOrvalRequest<admPlatformVersionResponse>(getAdmPlatformVersionUrl(), {
    ...options,
    method: 'GET',
...
export const getAdmPlatformVersionQueryKey = () => ["adm", "api", "platform", "version"] as const;

export const getAdmPlatformVersionQueryOptions = <TData = Awaited<ReturnType<typeof admPlatformVersion>>, TError = unknown>(
  options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admPlatformVersion>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmPlatformVersionQueryKey();
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admPlatformVersion>>> = ({ signal }) => admPlatformVersion({ signal, ...requestOptions });
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admPlatformVersion>>, TError, TData>;
};

export type AdmPlatformVersionQueryResult = NonNullable<Awaited<ReturnType<typeof admPlatformVersion>>>;
export type AdmPlatformVersionQueryError = unknown;

export function useAdmPlatformVersion<TData = Awaited<ReturnType<typeof admPlatformVersion>>, TError = unknown>(
  options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admPlatformVersion>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getAdmPlatformVersionQueryOptions(options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END admPlatformVersion
...
export const getAdmRuntimeControlFindByOperationUrl = (commandId: string) => `/adm/api/runtime-control/commands/${encodeURIComponent(String(commandId))}`;

export const admRuntimeControlFindByOperation = async (commandId: string, options?: CpfOrvalGeneratedRequestOptions): Promise<admRuntimeControlFindByOperationResponse> => {
  return cpfOrvalRequest<admRuntimeControlFindByOperationResponse>(getAdmRuntimeControlFindByOperationUrl(commandId), {
    ...options,
    method: 'GET',
...
export const getAdmRuntimeControlFindByOperationQueryKey = (commandId: MaybeRefOrGetter<string>) => ["adm", "api", "runtime-control", "commands", commandId] as const;
...
export const getAdmRuntimeControlFindByOperationQueryOptions = <TData = Awaited<ReturnType<typeof admRuntimeControlFindByOperation>>, TError = unknown>(
  commandId: MaybeRefOrGetter<string>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admRuntimeControlFindByOperation>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmRuntimeControlFindByOperationQueryKey(toValue(commandId));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admRuntimeControlFindByOperation>>> = ({ signal }) => admRuntimeControlFindByOperation(toValue(commandId), { signal, ...requestOptions });
  return { queryKey, queryFn, enabled: computed(() => toValue(commandId) !== null && toValue(commandId) !== undefined), ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admRuntimeControlFindByOperation>>, TError, TData>;
};
...
export function useAdmRuntimeControlFindByOperation<TData = Awaited<ReturnType<typeof admRuntimeControlFindByOperation>>, TError = unknown>(
  ...
  const queryOptions = getAdmRuntimeControlFindByOperationQueryOptions(commandId, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
...
export const admRuntimeControlDeleteGroup = async (groupId: string, params: AdmRuntimeControlDeleteGroupParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admRuntimeControlDeleteGroupResponse> => {
  return cpfOrvalRequest<admRuntimeControlDeleteGroupResponse>(getAdmRuntimeControlDeleteGroupUrl(groupId), {
    ...options,
    method: 'DELETE',
    params: { commandId: params.commandId, expectedVersion: params.expectedVersion, reason: params.reason },
  });
};
...
export type admRuntimeInventoryFindAllResponseSuccess = (admRuntimeInventoryFindAllResponse200) & {
  headers: Headers;
};

export type admRuntimeInventoryFindAllResponse = (admRuntimeInventoryFindAllResponseSuccess)

export const getAdmRuntimeInventoryFindAllUrl = () => `/adm/api/runtime-inventory`;

export const admRuntimeInventoryFindAll = async (params?: AdmRuntimeInventoryFindAllParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admRuntimeInventoryFindAllResponse> => {
...
export const getAdmRuntimeInventoryFindAllQueryKey = (params?: MaybeRefOrGetter<AdmRuntimeInventoryFindAllParams>) => ["adm", "api", "runtime-inventory", toValue(params)] as const;

export const getAdmRuntimeInventoryFindAllQueryOptions = <TData = Awaited<ReturnType<typeof admRuntimeInventoryFindAll>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmRuntimeInventoryFindAllParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admRuntimeInventoryFindAll>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmRuntimeInventoryFindAllQueryKey(toValue(params));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admRuntimeInventoryFindAll>>> = ({ signal }) => admRuntimeInventoryFindAll(toValue(params), { signal, ...requestOptions });
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admRuntimeInventoryFindAll>>, TError, TData>;
};

export type AdmRuntimeInventoryFindAllQueryResult = NonNullable<Awaited<ReturnType<typeof admRuntimeInventoryFindAll>>>;
export type AdmRuntimeInventoryFindAllQueryError = unknown;

export function useAdmRuntimeInventoryFindAll<TData = Awaited<ReturnType<typeof admRuntimeInventoryFindAll>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmRuntimeInventoryFindAllParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admRuntimeInventoryFindAll>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getAdmRuntimeInventoryFindAllQueryOptions(params, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END admRuntimeInventoryFindAll
...
export type admManagedServerFindAllResponseSuccess = (admManagedServerFindAllResponse200) & {
  headers: Headers;
};

export type admManagedServerFindAllResponse = (admManagedServerFindAllResponseSuccess)

export const getAdmManagedServerFindAllUrl = () => `/adm/api/servers`;

export const admManagedServerFindAll = async (params?: AdmManagedServerFindAllParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admManagedServerFindAllResponse> => {
...
export const getAdmManagedServerFindAllQueryKey = (params?: MaybeRefOrGetter<AdmManagedServerFindAllParams>) => ["adm", "api", "servers", toValue(params)] as const;

export const getAdmManagedServerFindAllQueryOptions = <TData = Awaited<ReturnType<typeof admManagedServerFindAll>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmManagedServerFindAllParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admManagedServerFindAll>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmManagedServerFindAllQueryKey(toValue(params));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admManagedServerFindAll>>> = ({ signal }) => admManagedServerFindAll(toValue(params), { signal, ...requestOptions });
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admManagedServerFindAll>>, TError, TData>;
};

export type AdmManagedServerFindAllQueryResult = NonNullable<Awaited<ReturnType<typeof admManagedServerFindAll>>>;
export type AdmManagedServerFindAllQueryError = unknown;

export function useAdmManagedServerFindAll<TData = Awaited<ReturnType<typeof admManagedServerFindAll>>, TError = unknown>(
  params?: MaybeRefOrGetter<AdmManagedServerFindAllParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admManagedServerFindAll>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getAdmManagedServerFindAllQueryOptions(params, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END admManagedServerFindAll
...
export type admManagedServerSaveResponseSuccess = (admManagedServerSaveResponse200) & {
  headers: Headers;
};

export type admManagedServerSaveResponse = (admManagedServerSaveResponseSuccess)

export const getAdmManagedServerSaveUrl = () => `/adm/api/servers`;

export const admManagedServerSave = async (data: AdmManagedServerSaveRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admManagedServerSaveResponse> => {
  return cpfOrvalRequest<admManagedServerSaveResponse>(getAdmManagedServerSaveUrl(), {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    data,
...
export const getAdmManagedServerSaveMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admManagedServerSave>>, TError, {data: AdmManagedServerSaveRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admManagedServerSave>>, TError, {data: AdmManagedServerSaveRequest}, TContext> => {
  const mutationKey = ['admManagedServerSave'];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admManagedServerSave>>, {data: AdmManagedServerSaveRequest}> = (props) => {
    const { data } = props;
    return admManagedServerSave(data, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};

export type AdmManagedServerSaveMutationResult = NonNullable<Awaited<ReturnType<typeof admManagedServerSave>>>;
export type AdmManagedServerSaveMutationBody = AdmManagedServerSaveRequest;
export type AdmManagedServerSaveMutationError = unknown;

export const useAdmManagedServerSave = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admManagedServerSave>>, TError, {data: AdmManagedServerSaveRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admManagedServerSave>>, TError, {data: AdmManagedServerSaveRequest}, TContext> => {
  return useMutation(getAdmManagedServerSaveMutationOptions(options), queryClient);
};
// CPF PRE-RUNTIME FALLBACK END admManagedServerSave
...
export type admManagedServerFindOneResponseSuccess = (admManagedServerFindOneResponse200) & {
  headers: Headers;
};

export type admManagedServerFindOneResponse = (admManagedServerFindOneResponseSuccess)

export const getAdmManagedServerFindOneUrl = (managedServerId: string) => `/adm/api/servers/${encodeURIComponent(String(managedServerId))}`;

export const admManagedServerFindOne = async (managedServerId: string, options?: CpfOrvalGeneratedRequestOptions): Promise<admManagedServerFindOneResponse> => {
  return cpfOrvalRequest<admManagedServerFindOneResponse>(getAdmManagedServerFindOneUrl(managedServerId), {
    ...options,
    method: 'GET',
...
export const getAdmManagedServerFindOneQueryKey = (managedServerId: MaybeRefOrGetter<string>) => ["adm", "api", "servers", managedServerId] as const;

export const getAdmManagedServerFindOneQueryOptions = <TData = Awaited<ReturnType<typeof admManagedServerFindOne>>, TError = unknown>(
  managedServerId: MaybeRefOrGetter<string>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admManagedServerFindOne>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmManagedServerFindOneQueryKey(toValue(managedServerId));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admManagedServerFindOne>>> = ({ signal }) => admManagedServerFindOne(toValue(managedServerId), { signal, ...requestOptions });
  return { queryKey, queryFn, enabled: computed(() => toValue(managedServerId) !== null && toValue(managedServerId) !== undefined), ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admManagedServerFindOne>>, TError, TData>;
};

export type AdmManagedServerFindOneQueryResult = NonNullable<Awaited<ReturnType<typeof admManagedServerFindOne>>>;
export type AdmManagedServerFindOneQueryError = unknown;

export function useAdmManagedServerFindOne<TData = Awaited<ReturnType<typeof admManagedServerFindOne>>, TError = unknown>(
  managedServerId: MaybeRefOrGetter<string>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admManagedServerFindOne>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
  const queryOptions = getAdmManagedServerFindOneQueryOptions(managedServerId, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END admManagedServerFindOne
...
export type admManagedServerDisableResponseSuccess = (admManagedServerDisableResponse200) & {
  headers: Headers;
};

export type admManagedServerDisableResponse = (admManagedServerDisableResponseSuccess)

export const getAdmManagedServerDisableUrl = (managedServerId: string) => `/adm/api/servers/${encodeURIComponent(String(managedServerId))}/disable`;

export const admManagedServerDisable = async (managedServerId: string, data: AdmManagedServerDisableRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admManagedServerDisableResponse> => {
  return cpfOrvalRequest<admManagedServerDisableResponse>(getAdmManagedServerDisableUrl(managedServerId), {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    data,
...
export const getAdmManagedServerDisableMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admManagedServerDisable>>, TError, {managedServerId: string; data: AdmManagedServerDisableRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admManagedServerDisable>>, TError, {managedServerId: string; data: AdmManagedServerDisableRequest}, TContext> => {
  const mutationKey = ['admManagedServerDisable'];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admManagedServerDisable>>, {managedServerId: string; data: AdmManagedServerDisableRequest}> = (props) => {
    const { managedServerId, data } = props;
    return admManagedServerDisable(managedServerId, data, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};

export type AdmManagedServerDisableMutationResult = NonNullable<Awaited<ReturnType<typeof admManagedServerDisable>>>;
export type AdmManagedServerDisableMutationBody = AdmManagedServerDisableRequest;
export type AdmManagedServerDisableMutationError = unknown;

export const useAdmManagedServerDisable = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admManagedServerDisable>>, TError, {managedServerId: string; data: AdmManagedServerDisableRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admManagedServerDisable>>, TError, {managedServerId: string; data: AdmManagedServerDisableRequest}, TContext> => {
  return useMutation(getAdmManagedServerDisableMutationOptions(options), queryClient);
};
// CPF PRE-RUNTIME FALLBACK END admManagedServerDisable
...
export type admTransactionGroupFindBySubjectResponseSuccess = (admTransactionGroupFindBySubjectResponse200) & {
  headers: Headers;
};

export type admTransactionGroupFindBySubjectResponse = (admTransactionGroupFindBySubjectResponseSuccess)

export const getAdmTransactionGroupFindBySubjectUrl = () => `/adm/api/transaction-groups/subject-search`;

export const admTransactionGroupFindBySubject = async (data: AdmTransactionGroupFindBySubjectRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<admTransactionGroupFindBySubjectResponse> => {
  return cpfOrvalRequest<admTransactionGroupFindBySubjectResponse>(getAdmTransactionGroupFindBySubjectUrl(), {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    data,
...
export const getAdmTransactionGroupFindBySubjectMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admTransactionGroupFindBySubject>>, TError, {data: AdmTransactionGroupFindBySubjectRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admTransactionGroupFindBySubject>>, TError, {data: AdmTransactionGroupFindBySubjectRequest}, TContext> => {
  const mutationKey = ['admTransactionGroupFindBySubject'];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admTransactionGroupFindBySubject>>, {data: AdmTransactionGroupFindBySubjectRequest}> = (props) => {
    const { data } = props;
    return admTransactionGroupFindBySubject(data, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};

export type AdmTransactionGroupFindBySubjectMutationResult = NonNullable<Awaited<ReturnType<typeof admTransactionGroupFindBySubject>>>;
export type AdmTransactionGroupFindBySubjectMutationBody = AdmTransactionGroupFindBySubjectRequest;
export type AdmTransactionGroupFindBySubjectMutationError = unknown;

export const useAdmTransactionGroupFindBySubject = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admTransactionGroupFindBySubject>>, TError, {data: AdmTransactionGroupFindBySubjectRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admTransactionGroupFindBySubject>>, TError, {data: AdmTransactionGroupFindBySubjectRequest}, TContext> => {
  return useMutation(getAdmTransactionGroupFindBySubjectMutationOptions(options), queryClient);
};
// CPF PRE-RUNTIME FALLBACK END admTransactionGroupFindBySubject
...
export const admTransactionMetaFindTransactions = async (params?: AdmTransactionMetaFindTransactionsParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admTransactionMetaFindTransactionsResponse> => {
  return cpfOrvalRequest<admTransactionMetaFindTransactionsResponse>(getAdmTransactionMetaFindTransactionsUrl(), {
    ...options,
    method: 'GET',
    params: { moduleCode: params?.moduleCode, activeYn: params?.activeYn, operationId: params?.operationId, limit: params?.limit },
  });
};
...
export const admTransactionMetaFindPage = async (params?: AdmTransactionMetaFindPageParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admTransactionMetaFindPageResponse> => {
  return cpfOrvalRequest<admTransactionMetaFindPageResponse>(getAdmTransactionMetaFindPageUrl(), {
    ...options,
    method: 'GET',
    params: { moduleCode: params?.moduleCode, activeYn: params?.activeYn, operationId: params?.operationId, page: params?.page, size: params?.size },
  });
};
...
export const getAdmTransactionMetaFindTransactionUrl = (operationId: string) => `/adm/api/transactions/${encodeURIComponent(String(operationId))}`;

export const admTransactionMetaFindTransaction = async (operationId: string, options?: CpfOrvalGeneratedRequestOptions): Promise<admTransactionMetaFindTransactionResponse> => {
  return cpfOrvalRequest<admTransactionMetaFindTransactionResponse>(getAdmTransactionMetaFindTransactionUrl(operationId), {
    ...options,
    method: 'GET',
...
export const getAdmTransactionMetaFindTransactionQueryKey = (operationId: MaybeRefOrGetter<string>) => ["adm", "api", "transactions", operationId] as const;
...
export const getAdmTransactionMetaFindTransactionQueryOptions = <TData = Awaited<ReturnType<typeof admTransactionMetaFindTransaction>>, TError = unknown>(
  operationId: MaybeRefOrGetter<string>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof admTransactionMetaFindTransaction>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getAdmTransactionMetaFindTransactionQueryKey(toValue(operationId));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof admTransactionMetaFindTransaction>>> = ({ signal }) => admTransactionMetaFindTransaction(toValue(operationId), { signal, ...requestOptions });
  return { queryKey, queryFn, enabled: computed(() => toValue(operationId) !== null && toValue(operationId) !== undefined), ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof admTransactionMetaFindTransaction>>, TError, TData>;
};
...
export function useAdmTransactionMetaFindTransaction<TData = Awaited<ReturnType<typeof admTransactionMetaFindTransaction>>, TError = unknown>(
  ...
  const queryOptions = getAdmTransactionMetaFindTransactionQueryOptions(operationId, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
...
export const getAdmTransactionMetaInactivateUrl = (operationId: string) => `/adm/api/transactions/${encodeURIComponent(String(operationId))}/inactive`;

export const admTransactionMetaInactivate = async (operationId: string, params: AdmTransactionMetaInactivateParams, options?: CpfOrvalGeneratedRequestOptions): Promise<admTransactionMetaInactivateResponse> => {
  return cpfOrvalRequest<admTransactionMetaInactivateResponse>(getAdmTransactionMetaInactivateUrl(operationId), {
    ...options,
    method: 'POST',
    params: { policyVersion: params.policyVersion, reason: params.reason },
  });
};

export const getAdmTransactionMetaInactivateMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admTransactionMetaInactivate>>, TError, {operationId: string; params: AdmTransactionMetaInactivateParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof admTransactionMetaInactivate>>, TError, {operationId: string; params: AdmTransactionMetaInactivateParams}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof admTransactionMetaInactivate>>, {operationId: string; params: AdmTransactionMetaInactivateParams}> = (props) => {
    const { operationId, params } = props;
    return admTransactionMetaInactivate(operationId, params, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};
...
export const useAdmTransactionMetaInactivate = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof admTransactionMetaInactivate>>, TError, {operationId: string; params: AdmTransactionMetaInactivateParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof admTransactionMetaInactivate>>, TError, {operationId: string; params: AdmTransactionMetaInactivateParams}, TContext> => {
