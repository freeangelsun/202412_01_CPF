...
public class AdmMandatoryAuditInterceptor implements HandlerInterceptor {
    ...
    @Override public boolean preHandle(HttpServletRequest request,HttpServletResponse response,Object handler){
        ...
        long id=deliveryService.reserve(new AdmAuditDeliveryService.AuditCommand(CpfTransactionContext.transactionId(),CpfTransactionContext.traceId(),operatorId.trim(),"HTTP_MUTATION","ADM_API",target,"ADM mutation mandatory reservation",null,request.getRemoteAddr()));
