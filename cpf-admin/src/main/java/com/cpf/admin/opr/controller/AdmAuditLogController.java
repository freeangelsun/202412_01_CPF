...
public class AdmAuditLogController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    @GetMapping @CpfOnlineTransaction(id="OADMOP0050",name="ADMAuditLogList", ownerDomain="ADM")
    ...
    @GetMapping("/deliveries") @CpfOnlineTransaction(id="OADMOP0052",name="ADMAuditDeliveryList", ownerDomain="ADM")
    ...
    @PostMapping("/deliveries/{deliveryId}/retry") @CpfOnlineTransaction(id="OADMOP0053",name="ADMAuditDeliveryRetry", ownerDomain="ADM")
