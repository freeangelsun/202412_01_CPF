...
public class AdmAuditLogController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    @GetMapping    @Operation(operationId="admAuditLogFindAuditLogs",summary="감사 로그 조회")
    ...
    @GetMapping("/deliveries")    @Operation(operationId="admAuditDeliveryList",summary="감사 전달 상태 조회")
    ...
    @PostMapping("/deliveries/{deliveryId}/retry")    @Operation(operationId="admAuditDeliveryRetry",summary="감사 전달 수동 재처리")
