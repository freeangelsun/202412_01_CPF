...
public class AdmBatchController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    @GetMapping("/jobs")
    @CpfOnlineTransaction(id = "OADMBA0010", name = "ADMBatchJobList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0027", name = "ADMBatchJobDetail", ownerDomain="ADM")
    ...
    @PostMapping("/jobs")
    @CpfOnlineTransaction(id = "OADMBA0011", name = "ADMBatchJobRegister", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0012", name = "ADMBatchScheduleList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0023", name = "ADMBatchScheduleSimulation", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0013", name = "ADMBatchExecutionList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0035", name = "ADMBatchExecutionPage", ownerDomain="ADM")
    @Operation(
    ...
    public ResponseEntity<Map<String, Object>> findExecutionPage(
        ...
        return ResponseEntity.ok(batchOperationService.findExecutionPage(
                jobId, transactionId, springBatchJobInstanceId, workerId, serverInstanceId,
                status, fromDate, toDate, page, size));
    }

    @GetMapping("/executions/{executionId}")
    @CpfOnlineTransaction(id = "OADMBA0014", name = "ADMBatchExecutionDetail", ownerDomain="ADM")
    ...
    @GetMapping("/steps")
    @CpfOnlineTransaction(id = "OADMBA0028", name = "ADMBatchStepExecutionList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0015", name = "ADMBatchInstanceList", ownerDomain="ADM")
    ...
    @GetMapping("/workers")
    @CpfOnlineTransaction(id = "OADMBA0029", name = "ADMBatchWorkerList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0024", name = "ADMBatchRelationList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0025", name = "ADMBatchExecutionTargetList", ownerDomain="ADM")
    ...
    @GetMapping("/locks")
    @CpfOnlineTransaction(id = "OADMBA0030", name = "ADMBatchLockList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0031", name = "ADMBatchLockRelease", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0032", name = "ADMBatchGhostCandidateList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0033", name = "ADMBatchGhostAction", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0034", name = "ADMBatchOperationLogList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0026", name = "ADMBatchSchedulerRunOnce", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0018", name = "ADMBatchRun", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0019", name = "ADMBatchRetry", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0020", name = "ADMBatchStop", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0021", name = "ADMBatchScheduleEnable", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMBA0022", name = "ADMBatchScheduleDisable", ownerDomain="ADM")
    ...
    private static long requireExpectedVersion(Long expectedVersion, String operation) {
        return com.cpf.batch.api.CpfBatchOptimisticVersion.require(expectedVersion, operation);
    }
