...
public class AdmBreakGlassController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    @GetMapping @CpfOnlineTransaction(id="OADMBG0001",name="ADMBreakGlassList", ownerDomain="ADM") @Operation(operationId="admBreakGlassFindSessions", summary="Break-glass 세션 목록")
    ...
    @PostMapping @CpfOnlineTransaction(id="OADMBG0002",name="ADMBreakGlassOpen", ownerDomain="ADM") @Operation(operationId="admBreakGlassOpenSession", summary="Break-glass 세션 발급",
    ...
    @PostMapping("/{sessionId}/close") @CpfOnlineTransaction(id="OADMBG0003",name="ADMBreakGlassClose", ownerDomain="ADM") @Operation(operationId="admBreakGlassCloseSession", summary="Break-glass 세션 종료")
    ...
    @PostMapping("/{sessionId}/review") @CpfOnlineTransaction(id="OADMBG0004",name="ADMBreakGlassReview", ownerDomain="ADM") @Operation(operationId="admBreakGlassReviewSession", summary="Break-glass 사후검토")
