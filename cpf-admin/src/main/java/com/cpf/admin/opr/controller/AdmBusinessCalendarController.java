...
public class AdmBusinessCalendarController extends AdmBaseController {
    ...
    @GetMapping("/{calendarId}/days") @CpfOnlineTransaction(id="OADMCL0001",name="ADMBusinessCalendarDays", ownerDomain="ADM")
    ...
    @GetMapping("/{calendarId}/resolve") @CpfOnlineTransaction(id="OADMCL0002",name="ADMBusinessCalendarResolve", ownerDomain="ADM")
    ...
    @PutMapping("/{calendarId}/days/{businessDate}") @CpfOnlineTransaction(id="OADMCL0003",name="ADMBusinessCalendarSave", ownerDomain="ADM")
    ...
    @DeleteMapping("/{calendarId}/days/{businessDate}") @CpfOnlineTransaction(id="OADMCL0004",name="ADMBusinessCalendarDelete", ownerDomain="ADM")
