...
@CpfController @Validated @RequestMapping("/adm/api/cache") @Tag(name="ADM-OPR Cache",description="Provider health/metrics, durable invalidation and controlled eviction")
public class AdmCacheController extends com.cpf.admin.common.base.AdmBaseController {
 ...
 @GetMapping("/summary") @CpfOnlineTransaction(id="OADMOP0010",name="ADMCacheSummary", ownerDomain="ADM") @Operation(operationId="admCacheSummary",summary="Cache 운영 요약")
 public AdmCacheSummaryResponse summary(HttpServletRequest request){requireOperator(request);return service.summary();}
 @Hidden @PostMapping("/refresh") @CpfOnlineTransaction(id="OADMOP0011",name="ADMCacheRefresh", ownerDomain="ADM") @Operation(operationId="admCacheRefresh", summary="Cache Provider 상태와 durable invalidation을 새로고침")
 ...
 @Hidden @PostMapping("/evict-key") @CpfOnlineTransaction(id="OADMOP0012",name="ADMCacheEvictKey", ownerDomain="ADM") @Operation(operationId="admCacheEvictKey", summary="Version CAS 기반 Cache Key 제거")
 ...
 @Hidden @PostMapping("/evict-namespace") @CpfOnlineTransaction(id="OADMOP0013",name="ADMCacheEvictNamespace", ownerDomain="ADM") @Operation(operationId="admCacheEvictNamespace", summary="Version CAS 기반 Cache Namespace 제거")
 ...
 @Hidden @PostMapping("/reconcile") @CpfOnlineTransaction(id="OADMOP0014",name="ADMCacheReconcile", ownerDomain="ADM") @Operation(operationId="admCacheReconcile", summary="Durable invalidation과 Provider 상태 대사")
