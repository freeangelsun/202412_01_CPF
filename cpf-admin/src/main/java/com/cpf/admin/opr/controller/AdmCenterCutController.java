...
public class AdmCenterCutController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    @GetMapping("/jobs")
    @CpfOnlineTransaction(id = "OADMCT0010", name = "ADMCenterCutJobList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMCT0020", name = "ADMCenterCutJobDetail", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMCT0030", name = "ADMCenterCutJobParameters", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMCT0040", name = "ADMCenterCutSummary", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMCT0050", name = "ADMCenterCutTargets", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMCT0060", name = "ADMCenterCutResults", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMCT0070", name = "ADMCenterCutResultDetail", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMCT0080", name = "ADMCenterCutReprocessFailed", ownerDomain="ADM")
    @Operation(
    ...
    @CpfOnlineTransaction(id = "OADMCT0090", name = "ADMCenterCutReconcileUnknown", ownerDomain="ADM")
    @Operation(
