...
public class AdmDownloadController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    @GetMapping("/policies")
    @CpfOnlineTransaction(id = "OADMDW0001", name = "ADMDownloadPolicyList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMDW0002", name = "ADMDownloadAuditLogList", ownerDomain="ADM")
    ...
    @PostMapping("/csv")
    @CpfOnlineTransaction(id = "OADMDW0003", name = "ADMDownloadCsv", ownerDomain="ADM")
