...
public class AdmLogExportController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('LOG_EXPORT') or hasAuthority('ADM_LOG_EXPORT')")    @Operation(operationId = "admLogExportCreate", summary = "로그 상세 Export 생성",
    ...
    @PreAuthorize("hasAuthority('LOG_EXPORT') or hasAuthority('ADM_LOG_EXPORT')")    @Operation(operationId = "admLogExportDownload", summary = "만료 로그 Artifact 다운로드")
