...
public class AdmOperationsGovernanceController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    @GetMapping("/snapshot")
    @CpfOnlineTransaction(id = "OADMOG0010", name = "ADMOperationsGovernanceSnapshot", ownerDomain = "ADM")
    @Operation(operationId = "admOperationsGovernanceSnapshot", summary = "운영 정책·SLO 통합 Snapshot",
