...
public class AdmPermissionController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    @GetMapping("/roles")    @Operation(operationId = "admPermissionFindRoles", summary = "역할 관리 목록 조회", description = "ADM 역할의 유형, 사용 여부, 등록/수정 시각을 조회합니다.")
    public ResponseEntity<List<AdmRoleManagement>> findRoles() {
        return ResponseEntity.ok(permissionService.findRoles());
    }

    @GetMapping("/roles/{roleId}")    @Operation(operationId = "admPermissionFindRole", summary = "역할 상세 조회", description = "ADM 역할 상세 정보를 조회합니다.")
    ...
    @PostMapping("/roles")    @Operation(operationId = "admPermissionCreateRole", summary = "역할 등록", description = "ADM 역할을 등록하고 감사 로그를 남깁니다.")
    ...
    @PutMapping("/roles/{roleId}")    @Operation(operationId = "admPermissionUpdateRole", summary = "역할 수정", description = "ADM 역할을 수정하고 감사 로그를 남깁니다.")
    ...
    @PutMapping("/roles/{roleId}/status")    @Operation(operationId = "admPermissionUpdateRoleStatus", summary = "역할 사용 여부 변경", description = "ADM 역할 사용/중지 상태를 변경하고 감사 로그를 남깁니다.")
    ...
    @GetMapping("/menus")    @Operation(operationId = "admPermissionFindManagedMenus", summary = "메뉴 관리 목록 조회", description = "ADM 메뉴 계층과 사용 여부를 조회합니다.")
    public ResponseEntity<List<AdmMenuManagement>> findManagedMenus() {
        return ResponseEntity.ok(permissionService.findManagedMenus());
    }

    @GetMapping("/menus/{menuId}")    @Operation(operationId = "admPermissionFindManagedMenu", summary = "메뉴 상세 조회", description = "ADM 메뉴 상세 정보를 조회합니다.")
    ...
    @PostMapping("/menus")    @Operation(operationId = "admPermissionCreateMenu", summary = "메뉴 등록", description = "ADM 메뉴를 등록하고 감사 로그를 남깁니다.")
    ...
    @PutMapping("/menus/{menuId}")    @Operation(operationId = "admPermissionUpdateMenu", summary = "메뉴 수정", description = "ADM 메뉴를 수정하고 감사 로그를 남깁니다.")
    ...
    @PutMapping("/menus/{menuId}/status")    @Operation(operationId = "admPermissionUpdateMenuStatus", summary = "메뉴 사용 여부 변경", description = "ADM 메뉴 사용/중지 상태를 변경하고 감사 로그를 남깁니다.")
    ...
    @GetMapping("/buttons")    @Operation(operationId = "admPermissionFindButtons", summary = "버튼 관리 목록 조회", description = "ADM 메뉴별 버튼/행위와 연결 API 패턴을 조회합니다.")
    ...
    @GetMapping("/buttons/{buttonId}")    @Operation(operationId = "admPermissionFindButton", summary = "버튼 상세 조회", description = "ADM 버튼/행위 상세 정보를 조회합니다.")
    ...
    @PostMapping("/buttons")    @Operation(operationId = "admPermissionCreateButton", summary = "버튼 등록", description = "ADM 버튼/행위를 등록하고 감사 로그를 남깁니다.")
    ...
    @PutMapping("/buttons/{buttonId}")    @Operation(operationId = "admPermissionUpdateButton", summary = "버튼 수정", description = "ADM 버튼/행위를 수정하고 감사 로그를 남깁니다.")
    ...
    @PutMapping("/buttons/{buttonId}/status")    @Operation(operationId = "admPermissionUpdateButtonStatus", summary = "버튼 사용 여부 변경", description = "ADM 버튼/행위 사용/중지 상태를 변경하고 감사 로그를 남깁니다.")
    ...
    @GetMapping("/api-permissions")    @Operation(operationId = "admPermissionFindApiPermissions", summary = "API 권한 목록 조회", description = "ADM API 권한과 실제 API 경로 패턴을 조회합니다.")
    ...
    @GetMapping("/api-permissions/{apiPermissionId}")    @Operation(operationId = "admPermissionFindApiPermission", summary = "API 권한 상세 조회", description = "ADM API 권한 상세 정보를 조회합니다.")
    ...
    @PostMapping("/api-permissions")    @Operation(operationId = "admPermissionCreateApiPermission", summary = "API 권한 등록", description = "ADM API 권한을 등록하고 감사 로그를 남깁니다.")
    ...
    @PutMapping("/api-permissions/{apiPermissionId}")    @Operation(operationId = "admPermissionUpdateApiPermission", summary = "API 권한 수정", description = "ADM API 권한을 수정하고 감사 로그를 남깁니다.")
    ...
    @PutMapping("/api-permissions/{apiPermissionId}/status")    @Operation(operationId = "admPermissionUpdateApiPermissionStatus", summary = "API 권한 사용 여부 변경", description = "ADM API 권한 사용/중지 상태를 변경하고 감사 로그를 남깁니다.")
    ...
    @GetMapping("/api-matrix")    @Operation(operationId = "admPermissionFindApiPermissionMatrix", summary = "API 권한 매트릭스 조회", description = "역할별 ADM API 권한 허용 여부를 조회합니다.")
    ...
    @PutMapping("/roles/{roleId}/api-permissions/{apiPermissionId}")    @Operation(operationId = "admPermissionUpdateRoleApiPermission", summary = "역할별 API 권한 변경", description = "역할별 API 권한 허용 여부를 변경하고 감사 로그를 남깁니다.")
    ...
    @GetMapping("/menu-matrix")    @Operation(operationId = "admPermissionFindMenuMatrix", summary = "메뉴 권한 매트릭스 조회", description = "역할별 ADM 메뉴 조회/쓰기/삭제 권한을 조회합니다.")
    ...
    @GetMapping("/button-matrix")    @Operation(operationId = "admPermissionFindButtonMatrix", summary = "버튼 권한 매트릭스 조회", description = "역할별 ADM 버튼/행위 권한을 조회합니다.")
    ...
    @PutMapping("/roles/{roleId}/menus/{menuId}")    @Operation(operationId = "admPermissionUpdateMenuPermission", summary = "메뉴 권한 변경", description = "역할별 메뉴 권한을 변경하고 감사 로그를 남깁니다.")
    ...
    @PutMapping("/roles/{roleId}/buttons/{buttonId}")    @Operation(operationId = "admPermissionUpdateButtonPermission", summary = "버튼 권한 변경", description = "역할별 버튼/행위 권한을 변경하고 감사 로그를 남깁니다.")
