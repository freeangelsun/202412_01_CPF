...
import com.cpf.platform.operations.observability.api.logging.CpfTraceRecoveryPort;
...
public class AdmReliabilityController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    @CpfOnlineTransaction(id = "OADMRE0001", name = "ADMReliabilityIdempotencyList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMRE0002", name = "ADMReliabilityOutboxList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMRE0003", name = "ADMReliabilityInboxList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMRE0004", name = "ADMReliabilityDlqList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMRE0005", name = "ADMReliabilityDlqReplayApprovalRequest", ownerDomain="ADM")
    @Operation(
    ...
    public ResponseEntity<Map<String, Object>> replay(
            ...
            @Valid @RequestBody AdmReliabilityActionRequest request,
    ...
    @CpfOnlineTransaction(id = "OADMRE0006", name = "ADMReliabilityFileTransferList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMRE0007", name = "ADMReliabilityUnknownResultList", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id = "OADMRE0009", name = "ADMReliabilityBatchJobLogList", ownerDomain="ADM")
    @Operation(
    ...
    @CpfOnlineTransaction(id = "OADMRE0010", name = "ADMReliabilityBatchJobLogDetail", ownerDomain="ADM")
    @Operation(
    ...
    @CpfOnlineTransaction(id = "OADMRE0011", name = "ADMTransactionLogRecoveryStatus", ownerDomain="ADM")
    @Operation(
    ...
    @CpfOnlineTransaction(id = "OADMRE0012", name = "ADMTransactionLogRecoveryRun", ownerDomain="ADM")
    @Operation(
    ...
    @CpfOnlineTransaction(id = "OADMRE0013", name = "ADMTraceRecoveryPoisonRetry", ownerDomain="ADM")
    @Operation(
    ...
    @CpfOnlineTransaction(id = "OADMRE0008", name = "ADMReliabilityUnknownResultResolve", ownerDomain="ADM")
    @Operation(
