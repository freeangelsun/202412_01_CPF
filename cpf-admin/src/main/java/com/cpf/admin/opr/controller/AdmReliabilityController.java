...
public class AdmReliabilityController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    @GetMapping("/idempotency")    @Operation(operationId = "findAdmIdempotencyRecords", summary = "멱등 처리 목록 조회")
    ...
    @GetMapping("/broker/outbox")    @Operation(operationId = "findAdmBrokerOutbox", summary = "Broker outbox 목록 조회")
    ...
    @GetMapping("/broker/inbox")    @Operation(operationId = "findAdmBrokerInbox", summary = "Broker inbox 목록 조회")
    ...
    @GetMapping("/broker/dlq")    @Operation(operationId = "findAdmBrokerDlq", summary = "Broker DLQ 목록 조회")
    ...
    @PostMapping("/broker/dlq/{messageId}/replay")    @Operation(
    ...
    @GetMapping("/file-transfers")    @Operation(operationId = "findAdmFileTransferHistory", summary = "파일전송 이력 조회")
    ...
    @GetMapping("/unknown-results")    @Operation(operationId = "findAdmUnknownResults", summary = "결과 미확정 목록 조회")
    ...
    @GetMapping("/batch-job-logs")    @Operation(
    ...
    @GetMapping("/batch-job-logs/{businessDate}/{jobName}/{jobInstanceId}")    @Operation(
    ...
    @GetMapping("/transaction-log-recovery")    @Operation(
    ...
    @PostMapping("/transaction-log-recovery/run")    @Operation(
    ...
    @PostMapping("/transaction-log-recovery/poison/{target}/{recoveryEventId}/retry")    @Operation(
    ...
    @PostMapping("/unknown-results/{unknownId}/resolve")    @Operation(
