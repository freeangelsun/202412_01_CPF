...
import com.cpf.platform.operations.observability.api.remotelog.CpfRemoteLogBundleJob;
import com.cpf.platform.operations.observability.api.remotelog.CpfRemoteLogBundleJobPort;
import com.cpf.platform.operations.observability.api.remotelog.CpfRemoteLogDownloadGrant;
...
public class AdmRemoteLogController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    public ResponseEntity<FileSystemResource> download(
        ...
        auditLogService.record(
                CpfContexts.transactionId(), operatorId, "REMOTE_LOG_DOWNLOAD",
    ...
    public ResponseEntity<FileSystemResource> bundle(
        ...
        auditLogService.record(
                CpfContexts.transactionId(), operatorId, "REMOTE_LOG_BUNDLE_DOWNLOAD",
    ...
    public ResponseEntity<CpfRemoteLogBundleJob> createBundleJob(
        ...
        auditLogService.record(
                CpfContexts.transactionId(), operatorId, "REMOTE_LOG_BUNDLE_CREATE",
    ...
    public ResponseEntity<CpfRemoteLogDownloadGrant> issueDownloadToken(
        ...
        auditLogService.record(
                CpfContexts.transactionId(), operatorId, "REMOTE_LOG_DOWNLOAD_TOKEN_ISSUE",
