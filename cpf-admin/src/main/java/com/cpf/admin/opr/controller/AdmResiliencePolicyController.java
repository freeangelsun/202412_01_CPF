...
public final class AdmResiliencePolicyController {
    ...
    @CpfOnlineTransaction(id = "OADMRS0010", name = "ADMResiliencePolicySearch")
    ...
    @PreAuthorize("hasAuthority('ADM_RESILIENCE_READ')")
    @CpfOnlineTransaction(id = "OADMRS0011", name = "ADMResiliencePolicyDetail")
    ...
    @CpfOnlineTransaction(id = "OADMRS0020", name = "ADMResiliencePolicyRequest")
    ...
    @CpfOnlineTransaction(id = "OADMRS0021", name = "ADMResiliencePolicyApprove")
    ...
    @PreAuthorize("hasAuthority('ADM_RESILIENCE_APPROVE')")
    @CpfOnlineTransaction(id = "OADMRS0022", name = "ADMResiliencePolicyReject")
