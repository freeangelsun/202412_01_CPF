...
public class AdmSecretController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    @GetMapping("/providers")    @Operation(operationId="admSecretFindProviders", summary="Secret Provider 목록",description="Secret 원문이 아닌 Provider ID와 rotation 지원 여부만 반환합니다.")
    ...
    @GetMapping("/metadata")    @Operation(operationId="admSecretFindMetadata", summary="Secret Metadata 조회",description="원문 값을 반환하지 않고 존재/버전/만료/rotation metadata만 반환합니다.")
    ...
    @Hidden
    @PostMapping("/rotate")    @Operation(operationId="admSecretRotateDirectRejected", summary="Secret Rotation 직접 실행 거절")
