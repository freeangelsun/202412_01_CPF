...
public class AdmFileJobController {
    ...
    @GetMapping
    @CpfOnlineTransaction(id = "OADMFL0010", name = "AdmFileJobList")
    ...
    @GetMapping("/{jobId}")
    @CpfOnlineTransaction(id = "OADMFL0020", name = "AdmFileJobDetail")
    ...
    @CpfOnlineTransaction(id = "OADMFL0030", name = "AdmFileJobRows")
    ...
    @CpfOnlineTransaction(id = "OADMFL0050", name = "AdmFileJobApply")
    @Operation(operationId = "admFileJobApply", summary = "File Job 적용")
    ...
    @CpfOnlineTransaction(id = "OADMFL0060", name = "AdmFileJobRetry")
    @Operation(operationId = "admFileJobRetry", summary = "File Job 재시도")
    ...
    @CpfOnlineTransaction(id = "OADMFL0070", name = "AdmFileJobCancel")
    @Operation(operationId = "admFileJobCancel", summary = "File Job 취소")
    ...
    @CpfOnlineTransaction(id = "OADMFL0080", name = "AdmFileJobRollback")
    @Operation(operationId = "admFileJobRollback", summary = "File Job 롤백")
    ...
    @CpfOnlineTransaction(id = "OADMFL0085", name = "AdmFileJobResolveUnknown")
    @Operation(
            operationId = "admFileJobResolveUnknown",
            summary = "결과 불명 행 확정",
            description = "운영자가 외부/DB Side Effect를 확인한 뒤에만 결과 불명 행을 확정합니다.")
    ...
    @CpfOnlineTransaction(id = "OADMFL0090", name = "AdmFileJobArtifact")
