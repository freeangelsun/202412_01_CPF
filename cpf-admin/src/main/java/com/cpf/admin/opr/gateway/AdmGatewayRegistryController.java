...
public class AdmGatewayRegistryController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    /** AdmGatewayRegistryController 작업을 CPF 표준 계약에 따라 수행한다. */
    ...
    /** capability 작업을 CPF 표준 계약에 따라 수행한다. */
    ...
    private void record(HttpServletRequest req,String user,String action,String id,String reason,Object after) { audit.record(CpfContexts.transactionId(),user,action,
            "gateway_registry",id,reason,"",String.valueOf(after),"Gateway Registry",req.getRemoteAddr()); }
}
