...
public class AdmIncidentLifecycleController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    @GetMapping("/policies")    @Operation(operationId="admIncidentFindPolicies",summary="Incident 정책 Page 조회")
    ...
    @PostMapping("/policies")    @Operation(operationId="admIncidentCreatePolicy",summary="Incident 정책 등록")
    ...
    @PutMapping("/policies/{policyId}")    @Operation(operationId="admIncidentUpdatePolicy",summary="Incident 정책 수정")
    ...
    @PostMapping("/signals")    @Operation(operationId="admIncidentIngestSignal",summary="운영 Signal 수집 및 Threshold 평가")
    ...
    @GetMapping    @Operation(operationId="admIncidentFindIncidents",summary="Incident Page 조회")
    ...
    @GetMapping("/{incidentId}")    @Operation(operationId="admIncidentFindIncident",summary="Incident 상세 조회")
    ...
    @GetMapping("/{incidentId}/timeline")    @Operation(operationId="admIncidentFindTimeline",summary="Incident immutable Timeline 조회")
    ...
    @PostMapping("/{incidentId}/acknowledge")    @Operation(operationId="admIncidentAcknowledge",summary="Incident 접수")
    ...
    @PostMapping("/{incidentId}/resolve")    @Operation(operationId="admIncidentResolve",summary="Incident 해결")
    ...
    @PostMapping("/{incidentId}/reopen")    @Operation(operationId="admIncidentReopen",summary="Incident 재개방")
    ...
    @PostMapping("/{incidentId}/escalate")    @Operation(operationId="admIncidentEscalate",summary="Incident 수동 Escalation")
    ...
    @PostMapping("/{incidentId}/postmortem")    @Operation(operationId="admIncidentRecordPostmortem",summary="Incident Postmortem·Closure 기록")
    public ResponseEntity<IncidentResponse> postmortem(@PathVariable long incidentId,@RequestBody IncidentActionRequest body,HttpServletRequest request){
        return ResponseEntity.ok(service.recordPostmortem(incidentId, body, operator(request), request.getRemoteAddr()));
    }

    @GetMapping("/maintenance-windows")    @Operation(operationId="admIncidentFindMaintenance",summary="Maintenance Window Page 조회")
    ...
    @PostMapping("/maintenance-windows")    @Operation(operationId="admIncidentCreateMaintenance",summary="Maintenance Window 등록")
    ...
    @PutMapping("/maintenance-windows/{maintenanceId}")    @Operation(operationId="admIncidentUpdateMaintenance",summary="Maintenance Window 수정·취소")
