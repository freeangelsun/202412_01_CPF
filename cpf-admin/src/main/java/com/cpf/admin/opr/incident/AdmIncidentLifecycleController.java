...
public class AdmIncidentLifecycleController extends com.cpf.admin.common.base.AdmBaseController {
    ...
    @GetMapping("/policies")
    @CpfOnlineTransaction(id="OADMIC0010",name="ADMIncidentPolicyPage", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id="OADMIC0011",name="ADMIncidentPolicyCreate", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id="OADMIC0012",name="ADMIncidentPolicyUpdate", ownerDomain="ADM")
    ...
    @PostMapping("/signals")
    @CpfOnlineTransaction(id="OADMIC0013",name="ADMIncidentSignalIngest", ownerDomain="ADM")
    ...
    @GetMapping
    @CpfOnlineTransaction(id="OADMIC0020",name="ADMIncidentPage", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id="OADMIC0021",name="ADMIncidentDetail", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id="OADMIC0022",name="ADMIncidentTimeline", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id="OADMIC0030",name="ADMIncidentAcknowledge", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id="OADMIC0031",name="ADMIncidentResolve", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id="OADMIC0032",name="ADMIncidentReopen", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id="OADMIC0033",name="ADMIncidentEscalate", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id="OADMIC0034",name="ADMIncidentPostmortem", ownerDomain="ADM")
    @Operation(operationId="admIncidentRecordPostmortem",summary="Incident Postmortem·Closure 기록")
    ...
    @CpfOnlineTransaction(id="OADMIC0040",name="ADMMaintenancePage", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id="OADMIC0041",name="ADMMaintenanceCreate", ownerDomain="ADM")
    ...
    @CpfOnlineTransaction(id="OADMIC0042",name="ADMMaintenanceUpdate", ownerDomain="ADM")
