...
class AdmHealthInstanceRegistryTest {
 ...
 private static CpfRuntimeHealth h(String s,String i){return new CpfRuntimeHealth(s,i,CpfHealthStatus.UP,CpfHealthStatus.UP,CpfHealthStatus.UP,false,false,"v","sha",Instant.EPOCH,Instant.EPOCH,1,List.of(),List.of(),List.of(),Map.of());}
}
