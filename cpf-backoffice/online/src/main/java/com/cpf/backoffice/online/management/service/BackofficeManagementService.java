...
@CpfService
public class BackofficeManagementService extends com.cpf.backoffice.online.base.BackofficeBaseService {
    private final BackofficeManagementRepository repository;
    private final BackofficeBusinessAuditService auditService;

    public BackofficeManagementService(BackofficeManagementRepository repository, BackofficeBusinessAuditService auditService) {
    ...
    public Map<String, Object> saveOrganization(OrganizationRequest request, String operatorId) {
        ...
        audit(user,"ORGANIZATION_SAVE","mbw_organization",code,required(request.reason(),"reason"),null,values);
        return values;
    }
    ...
    @CpfTransactional(transactionManager="MBW_TRANSACTION_MANAGER")
    public BackofficeEmployeeRawContactResponse findEmployeeRaw(String employeeNo, String operatorId, String reason) {
        ...
        audit(actor, "EMPLOYEE_PII_RAW_VIEW", "mbw_employee", id, safeReason, null, Map.of("rawView", true));
        return new BackofficeEmployeeRawContactResponse(
    ...
    public Map<String, Object> saveEmployee(EmployeeRequest request, String operatorId) {
        ...
        String status=BackofficeEmploymentStatus.parse(defaultText(request.employmentStatus(),"EMPLOYED")).name();
        Map<String,Object> values=new LinkedHashMap<>();
        ...
        audit(user,"EMPLOYEE_SAVE","mbw_employee",employeeNo,required(request.reason(),"reason"),before,after);
    ...
    private String normalizeEmploymentStatusFilter(String value) {
        ...
        return BackofficeEmploymentStatus.parse(normalized).name();
    }
