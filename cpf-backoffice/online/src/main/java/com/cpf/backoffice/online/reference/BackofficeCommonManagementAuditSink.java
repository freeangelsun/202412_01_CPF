...
/** Common owner audit SPI를 MBW tamper-evident audit chain으로 연결하는 Adapter입니다. */
@Component
@Primary
public final class BackofficeCommonManagementAuditSink implements CpfCommonManagementAuditSink {
    private final BackofficeBusinessAuditService audit;
    public BackofficeCommonManagementAuditSink(BackofficeBusinessAuditService audit) { this.audit = audit; }
