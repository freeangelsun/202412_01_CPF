...
class BatchJobDefinitionTest {
 ...
 @Test void center_cut_requires_typed_reference(){assertThrows(IllegalArgumentException.class,()->new BatchJobDefinition("BAT.CEC",1,"cec",BatchJobDefinition.ExecutorType.CENTER_CUT,null,"BAT","",new BatchJobDefinition.Trigger(BatchJobDefinition.TriggerType.MANUAL,"","Asia/Seoul",null,true),List.of(),List.of(),null,null,null,"BAD","","tester","센터컷 실행 등록",null,null,0));}
}
