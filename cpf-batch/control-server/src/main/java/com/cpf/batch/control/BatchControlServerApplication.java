...
public class BatchControlServerApplication {
    public static void main(String[] args) {
        SpringApplication.run(BatchControlServerApplication.class, args);
    }

    @Bean
    RuntimeRegistration runtimeRegistration(Environment environment) {
        return RuntimeIdentityFactory.fromEnvironment(
                environment, RuntimeRole.CONTROL_SERVER, "cpf-batch-control-server", 8180);
    }
}
