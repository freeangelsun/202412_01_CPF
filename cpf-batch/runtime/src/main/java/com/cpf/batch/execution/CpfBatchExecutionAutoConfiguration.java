...
public class CpfBatchExecutionAutoConfiguration {
    ...
    @Bean
    CpfBatchExecutionListener cpfBatchExecutionListener(BatchExecutionLedgerPort ledger, BatchFencingPort fencing) {
    ...
    CpfBatchJobFactory cpfBatchJobFactory(
            ...
            CpfBatchStepHandlerRegistry handlers, BatchFencingPort fencing,
            CpfBatchExecutionListener listener, CpfBatchExecutionProperties properties,
        ...
        return new CpfBatchJobFactory(repository, transactionManager, taskExecutor, handlers,
                fencing, listener, properties, contextSupport);
    }

    @Bean @ConditionalOnMissingBean(BatchExecutionControlPort.class)
    BatchExecutionControlPort cpfSpringBatchExecutionControl(
            JobOperator operator, JobRepository repository, CpfBatchJobFactory jobs,
