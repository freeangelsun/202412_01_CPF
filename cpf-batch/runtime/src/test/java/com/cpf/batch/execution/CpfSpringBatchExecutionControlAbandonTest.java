...
class CpfSpringBatchExecutionControlAbandonTest {
    ...
    @Test
    void claimsLedgerBeforeSpringBatchAndConfirmsAfterSuccess() throws Exception {
    ...
    @Test
    void stateConflictPreventsSpringBatchSideEffect() throws Exception {
    ...
    @Test
    void ledgerConfirmationFailureDoesNotReportSuccess() throws Exception {
