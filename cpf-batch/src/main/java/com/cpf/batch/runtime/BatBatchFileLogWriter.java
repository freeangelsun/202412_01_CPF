...
public class BatBatchFileLogWriter {
    ...
    private final BatBatchLockManager writerLockManager;
    private final int writerLeaseSeconds;

    public BatBatchFileLogWriter(CpfFileLogWriter fileLogWriter) {
        this(
                fileLogWriter,
    ...
    public BatBatchFileLogWriter(
            ...
            TransactionIdGenerator transactionIdGenerator,
            Clock clock,
            BatBatchLockManager writerLockManager,
