 ...
 */
public class BatBatchHeartbeatService {
    ...
    public BatBatchHeartbeatService(
    ...
    public void recordStepStarted(StepExecution stepExecution) {
        ...
        BatBatchRuntimeProgress progress = BatBatchRuntimeProgress.of(
                0,
                0,
                0,
                0,
    ...
    public void recordStepFinished(StepExecution stepExecution) {
        ...
        BatBatchRuntimeProgress stepProgress = progressFromStep(stepExecution, stepExecution.getStatus().name(), null);
        BatBatchRuntimeProgress executionProgress = progressFromStep(stepExecution, "RUNNING", null);
    ...
    private BatBatchRuntimeProgress progressFromStep(StepExecution stepExecution, String status, String message) {
