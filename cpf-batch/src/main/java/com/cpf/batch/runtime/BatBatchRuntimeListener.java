 ...
 */
public class BatBatchRuntimeListener implements JobExecutionListener, StepExecutionListener {
    ...
    public BatBatchRuntimeListener(BatBatchHeartbeatService heartbeatService) {
        this(heartbeatService, null);
    }

    public BatBatchRuntimeListener(
    ...
    private void writeBatchFileLog(String eventType, JobExecution jobExecution, StepExecution stepExecution) {
        BatBatchFileLogWriter writer = batchFileLogWriterProvider != null ? batchFileLogWriterProvider.getIfAvailable() : null;
        if (writer != null) {
