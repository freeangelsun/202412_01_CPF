 ...
 */
public record BatBatchRuntimeProgress(
        long totalCount,
        long processedCount,
        long successCount,
        long failureCount,
    ...
    public static BatBatchRuntimeProgress of(
            long totalCount,
            long processedCount,
            long successCount,
            long failureCount,
        ...
        return new BatBatchRuntimeProgress(
                safeTotal,
                safeProcessed,
    ...
    public static BatBatchRuntimeProgress empty(String status) {
