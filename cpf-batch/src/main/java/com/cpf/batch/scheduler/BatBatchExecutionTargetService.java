 ...
 */
@Service
public class BatBatchExecutionTargetService {
    private final JdbcTemplate batJdbcTemplate;

    public BatBatchExecutionTargetService(@Qualifier("batJdbcTemplate") JdbcTemplate batJdbcTemplate) {
        this.batJdbcTemplate = batJdbcTemplate;
    }

    public long createWaitingTarget(BatBatchScheduleCandidate candidate, String requestUser) {
