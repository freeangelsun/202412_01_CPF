...
class BatBatchLockManagerTest {

    @Test
    void removesExpiredLeaseBeforeNewOwnerAcquiresLock() {
        JdbcTemplate jdbcTemplate = mock(JdbcTemplate.class);
        BatBatchLockManager manager = manager(jdbcTemplate);
    ...
    private BatBatchLockManager manager(JdbcTemplate jdbcTemplate) {
        ...
        return new BatBatchLockManager(jdbcProvider, dataSourceProvider);
    }
}
