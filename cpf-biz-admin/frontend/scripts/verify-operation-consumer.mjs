...
const hasRouteWorkbench=appSource.includes("RouteOperationWorkbench")&&workbenchSource.includes("bzaInvokeOperation")&&workbenchSource.includes("cpfOperationDescriptors");
