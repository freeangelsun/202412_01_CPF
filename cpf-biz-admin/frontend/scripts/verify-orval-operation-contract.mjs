...
for (const [route, pathItem] of Object.entries(openapi.paths || {})) {
  ...
  for (const [method, operation] of Object.entries(pathItem)) {
    ...
    const expectedBodyType = bodySchema?.$ref ? bodySchema.$ref.split("/").pop() : undefined;
    if (hasBody && !expectedBodyType && openapi["x-cpf-export-origin"] === "CONTROLLER_SOURCE_PRE_RUNTIME") {
