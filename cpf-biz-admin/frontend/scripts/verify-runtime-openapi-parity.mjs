...
const runtimePath=path.resolve(process.argv[3] || process.env.CPF_BZA_RUNTIME_OPENAPI_FILE || "");
...
const prefix=module==="ADM"?"/adm/api/":module==="BZA"?"/api/bza/":null; if(!prefix) throw new Error(`unsupported module: ${module}`);
