...
export const bzaRoutes: BzaRoute[] = [
  ...
  { id:"approvalInbox", label:"결재 처리", menuCode:"APPROVAL", group:"approval", description:"Snapshot 참여자 Inbox", expectedOperationIds: ["bzaApprovalInbox", "bzaBackofficeFindApprovals", "bzaBackofficeCreateApproval", "bzaBackofficeFindApproval", "bzaBackofficeActApproval"], load:()=>import("../features/approval-inbox/ApprovalInboxPage.vue") },
  ...
  { id:"sessions", label:"내 세션", menuCode:"AUTHORIZATION", group:"support", description:"Refresh session 관리", expectedOperationIds: [], load:()=>import("../features/sessions/SessionsPage.vue") },
