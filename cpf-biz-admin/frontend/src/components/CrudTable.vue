...
function requestRaw(row:Record<string,unknown>){rawRow.value=row;rawRecord.value={};rawReason.value="";rawError.value="";rawOpen.value=true;}
async function loadRaw(){
  ...
  }catch(e){rawError.value=e instanceof Error?e.message:String(e);}
...
onMounted(load);watch(()=>props.endpoint,()=>{page.value=0;load();});
</script>
