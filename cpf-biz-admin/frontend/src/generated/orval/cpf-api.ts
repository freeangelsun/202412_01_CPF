...
import type {
  ...
  BzaAuthChangePasswordParams,
  BzaAuthLoginHistoriesParams,
  BzaAuthMeParams,
  BzaAuthRevokeSessionParams,
  BzaAuthSessionsParams,
  BzaBackofficeActApprovalRequest,
  BzaBackofficeCreateApprovalRequest,
  BzaBackofficeFindApprovalsParams,
...
export const bzaSupportUploadAttachment = async (params: BzaSupportUploadAttachmentParams, options?: CpfOrvalGeneratedRequestOptions): Promise<bzaSupportUploadAttachmentResponse> => {
...
export const getBzaSupportUploadAttachmentMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof bzaSupportUploadAttachment>>, TError, {params: BzaSupportUploadAttachmentParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof bzaSupportUploadAttachment>>, TError, {params: BzaSupportUploadAttachmentParams}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof bzaSupportUploadAttachment>>, {params: BzaSupportUploadAttachmentParams}> = (props) => {
    const { params } = props;
    return bzaSupportUploadAttachment(params, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};

export type BzaSupportUploadAttachmentMutationResult = NonNullable<Awaited<ReturnType<typeof bzaSupportUploadAttachment>>>;
export type BzaSupportUploadAttachmentMutationBody = never;
...
export const useBzaSupportUploadAttachment = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof bzaSupportUploadAttachment>>, TError, {params: BzaSupportUploadAttachmentParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof bzaSupportUploadAttachment>>, TError, {params: BzaSupportUploadAttachmentParams}, TContext> => {
...
export const getBzaAuthLoginHistoriesQueryOptions = <TData = Awaited<ReturnType<typeof bzaAuthLoginHistories>>, TError = unknown>(
  ...
  return { queryKey, queryFn, enabled: computed(() => toValue(params) !== null && toValue(params) !== undefined), ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof bzaAuthLoginHistories>>, TError, TData>;
};
...
export const bzaAuthMe = async (params: BzaAuthMeParams, options?: CpfOrvalGeneratedRequestOptions): Promise<bzaAuthMeResponse> => {
...
export const getBzaAuthMeQueryKey = (params: MaybeRefOrGetter<BzaAuthMeParams>) => ["api", "bza", "auth", "me", toValue(params)] as const;

export const getBzaAuthMeQueryOptions = <TData = Awaited<ReturnType<typeof bzaAuthMe>>, TError = unknown>(
  params: MaybeRefOrGetter<BzaAuthMeParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof bzaAuthMe>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getBzaAuthMeQueryKey(toValue(params));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof bzaAuthMe>>> = ({ signal }) => bzaAuthMe(toValue(params), { signal, ...requestOptions });
  return { queryKey, queryFn, enabled: computed(() => toValue(params) !== null && toValue(params) !== undefined), ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof bzaAuthMe>>, TError, TData>;
};
...
export function useBzaAuthMe<TData = Awaited<ReturnType<typeof bzaAuthMe>>, TError = unknown>(
  ...
  const queryOptions = getBzaAuthMeQueryOptions(params, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
...
export const bzaAuthChangePassword = async (data: PasswordChangeRequest, params: BzaAuthChangePasswordParams, options?: CpfOrvalGeneratedRequestOptions): Promise<bzaAuthChangePasswordResponse> => {
  return cpfOrvalRequest<bzaAuthChangePasswordResponse>(getBzaAuthChangePasswordUrl(), {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', "authorization": params.authorization, ...options?.headers },
    data,
  });
};

export const getBzaAuthChangePasswordMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof bzaAuthChangePassword>>, TError, {data: PasswordChangeRequest; params: BzaAuthChangePasswordParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof bzaAuthChangePassword>>, TError, {data: PasswordChangeRequest; params: BzaAuthChangePasswordParams}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof bzaAuthChangePassword>>, {data: PasswordChangeRequest; params: BzaAuthChangePasswordParams}> = (props) => {
    const { data, params } = props;
    return bzaAuthChangePassword(data, params, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};
...
export const useBzaAuthChangePassword = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof bzaAuthChangePassword>>, TError, {data: PasswordChangeRequest; params: BzaAuthChangePasswordParams}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof bzaAuthChangePassword>>, TError, {data: PasswordChangeRequest; params: BzaAuthChangePasswordParams}, TContext> => {
...
export const getBzaAuthSessionsQueryOptions = <TData = Awaited<ReturnType<typeof bzaAuthSessions>>, TError = unknown>(
  ...
  return { queryKey, queryFn, enabled: computed(() => toValue(params) !== null && toValue(params) !== undefined), ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof bzaAuthSessions>>, TError, TData>;
};
...
// CPF PRE-RUNTIME FALLBACK START bzaBackofficeFindApprovals
...
export const getBzaBackofficeFindApprovalsUrl = () => `/api/bza/backoffice/approvals`;

export const bzaBackofficeFindApprovals = async (params?: BzaBackofficeFindApprovalsParams, options?: CpfOrvalGeneratedRequestOptions): Promise<bzaBackofficeFindApprovalsResponse> => {
  return cpfOrvalRequest<bzaBackofficeFindApprovalsResponse>(getBzaBackofficeFindApprovalsUrl(), {
    ...options,
    method: 'GET',
    params: { status: params?.status, employeeNo: params?.employeeNo, limit: params?.limit },
  });
};

export const getBzaBackofficeFindApprovalsQueryKey = (params?: MaybeRefOrGetter<BzaBackofficeFindApprovalsParams>) => ["api", "bza", "backoffice", "approvals", toValue(params)] as const;

export const getBzaBackofficeFindApprovalsQueryOptions = <TData = Awaited<ReturnType<typeof bzaBackofficeFindApprovals>>, TError = unknown>(
  params?: MaybeRefOrGetter<BzaBackofficeFindApprovalsParams>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof bzaBackofficeFindApprovals>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getBzaBackofficeFindApprovalsQueryKey(toValue(params));
  const queryFn: QueryFunction<Awaited<ReturnType<typeof bzaBackofficeFindApprovals>>> = ({ signal }) => bzaBackofficeFindApprovals(toValue(params), { signal, ...requestOptions });
...
export function useBzaBackofficeFindApprovals<TData = Awaited<ReturnType<typeof bzaBackofficeFindApprovals>>, TError = unknown>(
  ...
  const queryOptions = getBzaBackofficeFindApprovalsQueryOptions(params, options);
  const query = useQuery(queryOptions, queryClient) as UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
  query.queryKey = unref(queryOptions).queryKey as DataTag<QueryKey, TData, TError>;
  return query;
}
// CPF PRE-RUNTIME FALLBACK END bzaBackofficeFindApprovals


// CPF PRE-RUNTIME FALLBACK START bzaBackofficeCreateApproval
...
export const getBzaBackofficeCreateApprovalUrl = () => `/api/bza/backoffice/approvals`;

export const bzaBackofficeCreateApproval = async (data: BzaBackofficeCreateApprovalRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<bzaBackofficeCreateApprovalResponse> => {
...
export const getBzaBackofficeCreateApprovalMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof bzaBackofficeCreateApproval>>, TError, {data: BzaBackofficeCreateApprovalRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof bzaBackofficeCreateApproval>>, TError, {data: BzaBackofficeCreateApprovalRequest}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof bzaBackofficeCreateApproval>>, {data: BzaBackofficeCreateApprovalRequest}> = (props) => {
    const { data } = props;
    return bzaBackofficeCreateApproval(data, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};

export type BzaBackofficeCreateApprovalMutationResult = NonNullable<Awaited<ReturnType<typeof bzaBackofficeCreateApproval>>>;
export type BzaBackofficeCreateApprovalMutationBody = BzaBackofficeCreateApprovalRequest;
export type BzaBackofficeCreateApprovalMutationError = unknown;

export const useBzaBackofficeCreateApproval = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof bzaBackofficeCreateApproval>>, TError, {data: BzaBackofficeCreateApprovalRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof bzaBackofficeCreateApproval>>, TError, {data: BzaBackofficeCreateApprovalRequest}, TContext> => {
  return useMutation(getBzaBackofficeCreateApprovalMutationOptions(options), queryClient);
};
// CPF PRE-RUNTIME FALLBACK END bzaBackofficeCreateApproval


// CPF PRE-RUNTIME FALLBACK START bzaBackofficeFindApproval
...
export const getBzaBackofficeFindApprovalUrl = (approvalId: number) => `/api/bza/backoffice/approvals/${encodeURIComponent(String(approvalId))}`;

export const bzaBackofficeFindApproval = async (approvalId: number, options?: CpfOrvalGeneratedRequestOptions): Promise<bzaBackofficeFindApprovalResponse> => {
...
export const getBzaBackofficeFindApprovalQueryKey = (approvalId: MaybeRefOrGetter<number>) => ["api", "bza", "backoffice", "approvals", approvalId] as const;

export const getBzaBackofficeFindApprovalQueryOptions = <TData = Awaited<ReturnType<typeof bzaBackofficeFindApproval>>, TError = unknown>(
  approvalId: MaybeRefOrGetter<number>, options?: { query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof bzaBackofficeFindApproval>>, TError, TData>>, request?: SecondParameter<typeof cpfOrvalRequest> }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = getBzaBackofficeFindApprovalQueryKey(toValue(approvalId));
...
// CPF PRE-RUNTIME FALLBACK END bzaBackofficeFindApproval


// CPF PRE-RUNTIME FALLBACK START bzaBackofficeActApproval
...
export const getBzaBackofficeActApprovalUrl = (approvalId: number) => `/api/bza/backoffice/approvals/${encodeURIComponent(String(approvalId))}/actions`;

export const bzaBackofficeActApproval = async (approvalId: number, data: BzaBackofficeActApprovalRequest, options?: CpfOrvalGeneratedRequestOptions): Promise<bzaBackofficeActApprovalResponse> => {
...
export const getBzaBackofficeActApprovalMutationOptions = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof bzaBackofficeActApproval>>, TError, {approvalId: number; data: BzaBackofficeActApprovalRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> }
): UseMutationOptions<Awaited<ReturnType<typeof bzaBackofficeActApproval>>, TError, {approvalId: number; data: BzaBackofficeActApprovalRequest}, TContext> => {
  ...
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ...
      : { ...options, mutation: { ...options.mutation, mutationKey } }
    : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof bzaBackofficeActApproval>>, {approvalId: number; data: BzaBackofficeActApprovalRequest}> = (props) => {
    const { approvalId, data } = props;
    return bzaBackofficeActApproval(approvalId, data, requestOptions);
  };
  return { mutationFn, ...mutationOptions };
};

export type BzaBackofficeActApprovalMutationResult = NonNullable<Awaited<ReturnType<typeof bzaBackofficeActApproval>>>;
export type BzaBackofficeActApprovalMutationBody = BzaBackofficeActApprovalRequest;
export type BzaBackofficeActApprovalMutationError = unknown;

export const useBzaBackofficeActApproval = <TError = unknown, TContext = unknown>(
  options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof bzaBackofficeActApproval>>, TError, {approvalId: number; data: BzaBackofficeActApprovalRequest}, TContext>, request?: SecondParameter<typeof cpfOrvalRequest> },
  queryClient?: QueryClient
): UseMutationReturnType<Awaited<ReturnType<typeof bzaBackofficeActApproval>>, TError, {approvalId: number; data: BzaBackofficeActApprovalRequest}, TContext> => {
  return useMutation(getBzaBackofficeActApprovalMutationOptions(options), queryClient);
};
// CPF PRE-RUNTIME FALLBACK END bzaBackofficeActApproval
