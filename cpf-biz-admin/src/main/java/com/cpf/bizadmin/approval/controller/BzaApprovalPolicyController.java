...
public class BzaApprovalPolicyController extends com.cpf.bizadmin.common.base.BzaBaseController {
    ...
    @GetMapping("/policies")
    @CpfOnlineTransaction(id = "OBZAAP0101", name = "BzaApprovalPolicyList", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAP0102", name = "BzaApprovalPolicyDetail", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAP0103", name = "BzaApprovalPolicySave", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAP0104", name = "BzaApprovalPolicySimulation", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAP0105", name = "BzaApprovalDelegationList", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAP0106", name = "BzaApprovalDelegationSave", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAP0107", name = "BzaApprovalPolicySubmit", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAP0114", name = "BzaApprovalSubmissionList", ownerDomain="BZA")
    ...
    @GetMapping("/inbox")
    @CpfOnlineTransaction(id = "OBZAAP0115", name = "BzaApprovalInbox", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAP0108", name = "BzaApprovalPolicyDetail", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAP0109", name = "BzaApprovalPolicyDecision", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAP0110", name = "BzaApprovalWithdraw", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAP0111", name = "BzaApprovalCancel", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAP0112", name = "BzaApprovalResubmit", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAP0113", name = "BzaApprovalExpireDue", ownerDomain="BZA")
