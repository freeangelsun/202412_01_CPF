...
public class BzaApprovalPolicyController extends com.cpf.bizadmin.common.base.BzaBaseController {
    ...
    @GetMapping("/policies")    @Operation(operationId = "bzaApprovalPolicies", summary = "결재 정책 목록")
    ...
    @GetMapping("/policies/{policyCode}/{version}")    @Operation(operationId = "bzaApprovalPolicyDetail", summary = "결재 정책/단계 상세")
    ...
    @PostMapping("/policies")    @Operation(operationId = "bzaApprovalPolicySave", summary = "Versioned 결재 정책 저장",
    ...
    @PostMapping("/simulate")    @Operation(operationId = "bzaApprovalPolicySimulate", summary = "결재 정책 참여자 Simulation",
    ...
    @GetMapping("/delegations")    @Operation(operationId = "bzaApprovalDelegations", summary = "결재 위임 조회")
    ...
    @PostMapping("/delegations")    @Operation(operationId = "bzaApprovalDelegationSave", summary = "결재 위임/대결 유효기간 저장")
    @ApiResponse(responseCode = "422", description = "Validation failed")
    ...
    @PostMapping("/submissions")    @Operation(operationId = "bzaApprovalPolicySubmit", summary = "정책 기반 결재 상신",
    ...
    @GetMapping("/submissions")    @Operation(operationId = "bzaApprovalSubmissions", summary = "인증 사용자의 상신 문서 목록")
    ...
    @GetMapping("/inbox")    @Operation(operationId = "bzaApprovalInbox", summary = "인증 사용자의 결재 참여 문서 목록")
    ...
    @GetMapping("/submissions/{approvalId}")    @Operation(operationId = "bzaApprovalSubmissionDetail", summary = "정책 기반 결재/참여자 상세")
    ...
    @PostMapping("/{approvalId}/decisions")    @Operation(operationId = "bzaApprovalParticipantDecision", summary = "결재 참여자 결정",
    ...
    @PostMapping("/submissions/{approvalId}/withdraw")    @Operation(operationId = "bzaApprovalWithdraw", summary = "결재 철회")
    @ApiResponse(responseCode = "422", description = "Validation failed")
    ...
    @PostMapping("/submissions/{approvalId}/cancel")    @Operation(operationId = "bzaApprovalCancel", summary = "결재 취소")
    @ApiResponse(responseCode = "422", description = "Validation failed")
    ...
    @PostMapping("/submissions/{approvalId}/resubmit")    @Operation(operationId = "bzaApprovalResubmit", summary = "결재 재상신",
    ...
    @PostMapping("/submissions/expire-due")    @Operation(operationId = "bzaApprovalExpireDue", summary = "기한 경과 결재 만료 처리",
