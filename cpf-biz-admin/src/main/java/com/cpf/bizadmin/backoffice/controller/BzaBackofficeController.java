...
public class BzaBackofficeController extends com.cpf.bizadmin.common.base.BzaBaseController {
    ...
    @GetMapping("/organizations")    @Operation(operationId = "bzaBackofficeFindOrganizations", summary = "조직 목록 조회")
    public ResponseEntity<List<Map<String, Object>>> organizations() {
        return ResponseEntity.ok(backofficeService.findOrganizations());
    }

    @GetMapping("/organizations/page")    @Operation(operationId = "bzaBackofficeFindOrganizationsPage", summary = "조직 서버 Paging 조회")
    ...
    @PostMapping("/organizations")    @Operation(operationId = "bzaBackofficeSaveOrganization", summary = "조직 등록·수정",
    ...
    @GetMapping("/employees")    @Operation(operationId = "bzaBackofficeFindEmployees", summary = "직원 목록 조회")
    ...
    @GetMapping("/employees/page")    @Operation(operationId = "bzaBackofficeFindEmployeesPage", summary = "직원 서버 Paging 조회")
    ...
    @PostMapping("/employees/{employeeNo}/contacts/raw")    @Operation(operationId = "bzaBackofficeEmployeeRawContact", summary = "직원 연락처 원문 조회",
    ...
    @PostMapping("/employees")    @Operation(operationId = "bzaBackofficeSaveEmployee", summary = "직원 등록·수정",
    ...
    @GetMapping("/permissions/effective")    @Operation(operationId = "bzaBackofficeFindEffectivePermissions", summary = "사용자 실효 권한 조회",
    ...
    @Hidden    @Operation(operationId = "bzaBackofficeFindApprovals", summary = "Legacy 결재 목록 API(410)",
    ...
    @Hidden    @Operation(operationId = "bzaBackofficeCreateApproval", summary = "Legacy 결재 작성 API(410)", deprecated = true,
            description = "직접 결재 API는 영구 폐기되었습니다. 정책 기반 /api/bza/approvals/** API를 사용합니다.")
    ...
    @Hidden    @Operation(operationId = "bzaBackofficeFindApproval", summary = "Legacy 결재 상세 API(410)",
            description = "직접 결재 API는 영구 폐기되었습니다. 정책 기반 /api/bza/approvals/** API를 사용합니다.")
    ...
    @Hidden    @Operation(operationId = "bzaBackofficeActApproval", summary = "Legacy 결재 상태 변경 API(410)", deprecated = true,
            description = "직접 결재 API는 영구 폐기되었습니다. 정책 기반 /api/bza/approvals/** API를 사용합니다.")
    ...
    @GetMapping("/audits")    @Operation(operationId = "bzaBackofficeFindBusinessAudits", summary = "업무 감사 목록 조회")
