...
public class BzaBackofficeController extends com.cpf.bizadmin.common.base.BzaBaseController {
    ...
    @CpfOnlineTransaction(id = "OBZAOR0001", name = "BzaOrganizationList", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAOR1101", name = "BzaOrganizationPage", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAOR0002", name = "BzaOrganizationSave", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAEM0001", name = "BzaEmployeeList", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAEM1101", name = "BzaEmployeePage", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAEM1102", name = "BzaEmployeeRawContact", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAEM0002", name = "BzaEmployeeSave", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAPE0002", name = "BzaEffectivePermissionList", ownerDomain="BZA")
    ...
    @Hidden
    @CpfOnlineTransaction(id = "OBZAAP0001", name = "BzaApprovalList", ownerDomain="BZA")
    ...
    @Hidden
    @CpfOnlineTransaction(id = "OBZAAP0002", name = "BzaApprovalCreate", ownerDomain="BZA")
    ...
    @Hidden
    @CpfOnlineTransaction(id = "OBZAAP0003", name = "BzaApprovalDetail", ownerDomain="BZA")
    ...
    @Hidden
    @CpfOnlineTransaction(id = "OBZAAP0004", name = "BzaApprovalAction", ownerDomain="BZA")
    ...
    @GetMapping("/audits")
    @CpfOnlineTransaction(id = "OBZAUD0001", name = "BzaBusinessAuditList", ownerDomain="BZA")
