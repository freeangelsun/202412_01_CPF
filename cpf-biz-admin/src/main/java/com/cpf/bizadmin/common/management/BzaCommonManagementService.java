...
/** BZA는 Common owner table을 직접 접근하지 않고 Public Management API만 소비합니다. */
@CpfService
public final class BzaCommonManagementService extends com.cpf.bizadmin.common.base.BzaBaseService {
    ...
    public BzaCommonManagementService(CpfCommonManagementApi common) { this.common=common; }
