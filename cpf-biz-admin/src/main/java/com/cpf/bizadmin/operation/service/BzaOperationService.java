...
public class BzaOperationService extends com.cpf.bizadmin.common.base.BzaBaseService {
  ...
  public Map<String, Object> saveRole(RoleRequest r, String operatorId) {
    ...
    audit(actor, "ROLE_SAVE", "bza_role", key, required(r.reason(), "reason"), before, v);
    return v;
  }
  ...
  private void validateStatusTransition(String currentValue, String nextValue) {
    BzaAdminAccountStatus current = BzaAdminAccountStatus.parse(currentValue),
        next = BzaAdminAccountStatus.parse(nextValue);
    if (current == next) return;
    Map<BzaAdminAccountStatus, Set<BzaAdminAccountStatus>> allowed =
        Map.of(
            BzaAdminAccountStatus.PENDING_ACTIVATION,
                Set.of(BzaAdminAccountStatus.ACTIVE, BzaAdminAccountStatus.DISABLED),
            BzaAdminAccountStatus.ACTIVE,
                Set.of(
                    BzaAdminAccountStatus.LOCKED,
                    BzaAdminAccountStatus.SUSPENDED,
                    BzaAdminAccountStatus.DISABLED),
            BzaAdminAccountStatus.LOCKED,
                Set.of(
                    BzaAdminAccountStatus.ACTIVE,
                    BzaAdminAccountStatus.SUSPENDED,
