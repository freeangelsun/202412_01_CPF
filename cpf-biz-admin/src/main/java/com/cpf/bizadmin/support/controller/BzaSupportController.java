...
public class BzaSupportController extends com.cpf.bizadmin.common.base.BzaBaseController {
    ...
    @CpfOnlineTransaction(id = "OBZADS0001", name = "BzaDashboard", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZANT0001", name = "BzaNotificationList", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZANT0002", name = "BzaNotificationCreate", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZANT0003", name = "BzaNotificationRead", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZANT0004", name = "BzaNotificationReadAll", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAT0001", name = "BzaAttachmentList", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAT0002", name = "BzaAttachmentUpload", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAT0003", name = "BzaAttachmentDownload", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAT0004", name = "BzaAttachmentSecurityUpdate", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAAT0005", name = "BzaAttachmentRecheck", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZASC0001", name = "BzaSavedSearchList", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZASC0002", name = "BzaSavedSearchSave", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZASC0003", name = "BzaSavedSearchDisable", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZADW0002", name = "BzaDownloadAuditList", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAPE0003", name = "BzaRolePermissionCompare", ownerDomain="BZA")
    ...
    @CpfOnlineTransaction(id = "OBZAPE0004", name = "BzaPermissionSimulation", ownerDomain="BZA")
