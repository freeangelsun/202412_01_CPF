...
public class BzaSupportController extends com.cpf.bizadmin.common.base.BzaBaseController {
    ...
    @GetMapping("/dashboard")    @Operation(operationId = "bzaSupportDashboard", summary = "업무 백오피스 대시보드",
    ...
    @GetMapping("/notifications")    @Operation(operationId = "bzaSupportFindNotifications", summary = "내 알림 조회")
    ...
    @PostMapping("/notifications")    @Operation(operationId = "bzaSupportCreateNotification", summary = "업무 알림 등록",
    ...
    @PostMapping("/notifications/{notificationId}/read")    @Operation(operationId = "bzaSupportReadNotification", summary = "업무 알림 읽음 처리")
    ...
    @PostMapping("/notifications/read-all")    @Operation(operationId = "bzaSupportReadAllNotifications", summary = "전체 알림 읽음 처리")
    ...
    @GetMapping("/attachments")    @Operation(operationId = "bzaSupportFindAttachments", summary = "첨부파일 목록 조회")
    ...
    @PostMapping(value = "/attachments", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)    @Operation(operationId = "bzaSupportUploadAttachment", summary = "첨부파일 업로드",
    ...
    @GetMapping("/attachments/{attachmentId}/download")    @Operation(operationId = "bzaSupportDownloadAttachment", summary = "첨부파일 다운로드",
    ...
    @PostMapping("/attachments/{attachmentId}/security")    @Operation(operationId = "bzaSupportUpdateAttachmentSecurity", summary = "첨부 보안 상태 갱신")
    ...
    @PostMapping("/attachments/{attachmentId}/recheck")    @Operation(operationId = "bzaSupportRecheckAttachment", summary = "첨부 보안 재검사 요청")
    ...
    @GetMapping("/saved-searches")    @Operation(operationId = "bzaSupportFindSavedSearches", summary = "저장 검색 조회")
    ...
    @PostMapping("/saved-searches")    @Operation(operationId = "bzaSupportSaveSavedSearch", summary = "저장 검색 등록·수정",
    ...
    @PostMapping("/saved-searches/{savedSearchId}/disable")    @Operation(operationId = "bzaSupportDisableSavedSearch", summary = "저장 검색 비활성화")
    ...
    @GetMapping("/download-audits")    @Operation(operationId = "bzaSupportFindDownloadAudits", summary = "다운로드 감사 조회")
    ...
    @GetMapping("/permissions/compare")    @Operation(operationId = "bzaSupportCompareRolePermissions", summary = "역할 권한 비교",
    ...
    @PostMapping("/permissions/simulate")    @Operation(operationId = "bzaSupportSimulatePermission", summary = "권한 시뮬레이션",
