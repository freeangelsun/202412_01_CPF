...
class BzaApprovalPolicyServiceListTest {
    private final BzaApprovalPolicyRepository repository = mock(BzaApprovalPolicyRepository.class);
    private final BzaApprovalPolicyService service =
            new BzaApprovalPolicyService(repository, new ObjectMapper());
