...
public class CmnCpfResponseCodeResolver implements CpfResponseCodeResolver {
    ...
    private CpfResolvedResponse resolveFromCatalog(
        ...
        String externalMessage = CpfMessageFormatter.format(externalTemplate, arguments);
        String internalMessage = CpfMessageFormatter.format(internalTemplate, arguments);
