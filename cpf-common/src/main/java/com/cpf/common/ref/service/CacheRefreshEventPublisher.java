...
public class CacheRefreshEventPublisher {
    ...
    public CacheRefreshEventPublisher(CacheRefreshEventStore store){this.store=store;}
    ...
    private void success(){publishedCount.incrementAndGet();lastPublishedAt=Instant.now();lastFailureType=null;}
