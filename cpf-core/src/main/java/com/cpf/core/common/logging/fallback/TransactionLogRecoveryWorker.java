...
import com.cpf.core.api.logging.CpfLogRecoveryOperations;
import com.cpf.core.api.logging.CpfLogRecoveryRuntimeStatus;
...
public final class TransactionLogRecoveryWorker implements CpfLogRecoveryOperations, CpfLogRecoveryRuntimeStatus {
    ...
    private boolean writePoisonRetryAuditSafely(
        ...
        event.put("reason", com.cpf.core.api.security.CpfSensitiveData.sanitizeAuditReason(command.reason()));
