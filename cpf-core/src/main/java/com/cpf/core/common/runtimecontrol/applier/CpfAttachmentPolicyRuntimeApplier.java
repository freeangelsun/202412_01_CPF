    ...
    public CpfRuntimeApplyResult apply(CpfRuntimeDelivery delivery) {
        try {
            policy.replaceAttachment(
                    ...
                    number(CpfRuntimePayloadJson.value(delivery.payload(), "maxBytes"), 10_485_760L),
                    ...
                    number(CpfRuntimePayloadJson.value(delivery.payload(), "retentionDays"), 3650L),
                    bool(CpfRuntimePayloadJson.value(delivery.payload(), "quarantineOnFailure"), true),
                    bool(CpfRuntimePayloadJson.value(delivery.payload(), "watermarkOnStore"), false));
