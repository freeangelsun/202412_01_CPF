...
- `SliceResult`
- `CursorRequest/CursorResult`

최대 크기와 `max+1` overflow 검증, signed/versioned/expiring cursor, filter/sort allowlist를 적용합니다.

### DB 없는 Common

`cpf-common`은 DB-less 기본 사용을 보장합니다. Sample Table 기능은 명시적 Profile로만 켭니다.
...
Source 변경에는 적용 가능한 SQL/Migration, Security/Audit, Operations, Test, OpenAPI/JavaDoc/Guide와 최신 Evidence가 함께 따라야 합니다.

## 14. Cross-PC와 Requirement 연속성
