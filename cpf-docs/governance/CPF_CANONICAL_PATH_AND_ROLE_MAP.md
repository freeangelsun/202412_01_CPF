...
> 역할: **경로/Owner Navigation 전용**. Architecture 정책은 `CPF_FINAL_TARGET_REQUIREMENTS.md`만 정본으로 사용한다.
...
| 역할 | 위치 |
|---|---|
| 최상위 개발 정본 | `cpf-docs/governance/CPF_FINAL_TARGET_REQUIREMENTS.md` |
| Canonical Path/Owner Map | `cpf-docs/governance/CPF_CANONICAL_PATH_AND_ROLE_MAP.md` |
| 문서 역할 Index | `cpf-docs/governance/CPF_DOCUMENT_CANONICAL_INDEX.md` |
