# CPF 산출물 시각·레이아웃 표준 — Harness v2.13.0
...
## Architecture Visual Semantic Gate

- Figure의 Module 위치는 `CPF_FINAL_TARGET_REQUIREMENTS.md` Canonical Owner Map과 일치해야 합니다.
- `cpf-backoffice`는 **Optional Prebuilt Business Domain**이며 Operations/Edge/Control Plane 영역에 배치하지 않습니다.
