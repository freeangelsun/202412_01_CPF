...
def main():
    ...
    errs=[]
    if m.get('harnessVersion')!='2.12.0': errs.append('manifest harnessVersion must be 2.12.0')
    ...
    for aid in targets:
        ...
        if r.get('harnessVersion')!='2.12.0': errs.append(f'{aid}: review harnessVersion mismatch')
