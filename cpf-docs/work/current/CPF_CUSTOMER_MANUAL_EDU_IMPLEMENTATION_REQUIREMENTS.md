...
| 구분 | 허용 위치 | 금지 위치 |
|---|---|---|
| 온라인·연계 EDU 업무 Source | `cpf-reference/src/main/java/com/cpf/reference/edu/...` | `cpf-core`, `cpf-common`, Starter, Runtime 내부에 고객 업무 예제 삽입 |
| 온라인·연계 EDU Test | `cpf-reference/src/test/java/com/cpf/reference/edu/...` | 별도 Root Test Project, 임시 Script만으로 대체 |
| EDU Resource | `cpf-reference/src/main/resources/edu/<ID>/...` | Repository Root, `tmp`, `sample-data` 무분별 생성 |
| Batch EDU | `cpf-reference/src/main/java/com/cpf/reference/edu/batNN/...` | `com.cpf.batch.edu`, Batch Runtime Owner Module 안의 교육 Job |
| ADM 연동 EDU 고객 업무 | `cpf-reference/src/main/java/com/cpf/reference/edu/adm/admNN/...` | ADM Backend에 고객 지급·회원 업무 로직 직접 구현 |
| BZA 연동 EDU 고객 업무 | `cpf-reference/src/main/java/com/cpf/reference/edu/bza/bzaNN/...` | BZA 제품 내부에 고객 업무 원장 로직 삽입 |
| Gateway 대상 서비스 EDU | `cpf-reference/src/main/java/com/cpf/reference/edu/gateway/...` | Gateway Runtime에 Mock 고객 API 하드코딩 |
| Generator Template | `cpf-tools/generator`의 기존 Template 구조 | `cpf-reference`에 Generator Template 복사 |
...
- 교육 ID를 Package에 포함한다. 예: `com.cpf.reference.edu.dev05.idempotency`.
...
- 교육 전용 코드는 `cpf-reference` 밖에서 Public API처럼 노출하지 않는다.

권장 Slice 예시는 다음과 같다.

```text
com.cpf.reference.edu.dev05.idempotency
...
- 교육 SQL을 `cpf-reference/src/main/resources/schema.sql` 같은 Local Fallback으로 만들지 않는다.
...
- 권장 경로: `cpf-reference/src/main/resources/edu/catalog.json` 또는 현재 프로젝트의 기존 Catalog 표준 위치.
...
Generator 구현과 Template은 `cpf-tools/generator`의 기존 구조를 사용한다. 생성 결과 검증용 교육 Fixture만 `com.cpf.reference.edu.dev01.domain`에 둔다.

- Resource·Fixture: 생성 계획 Golden File과 충돌 Fixture는 `cpf-reference/src/main/resources/edu/dev01/`에 둔다.
...
`com.cpf.reference.edu.dev02.query` 아래 api/application/domain/persistence로 분리한다.
...
`com.cpf.reference.edu.dev03.command` 아래 상태 전이 Domain과 Command Use Case를 둔다.
...
`com.cpf.reference.edu.dev04.concurrency` 아래 Domain Version, Repository 조건부 Update, API 오류 변환을 둔다.
...
`com.cpf.reference.edu.dev05.idempotency` 아래 payment, operation, ledger를 분리한다.
...
계약 Public Port는 고객 업무 Package에 두고 `com.cpf.reference.edu.dev06.localremote`에 Local/Remote Adapter와 교육 설정을 둔다.
...
`com.cpf.reference.edu.dev07.messaging` 아래 producer/outbox/consumer/inbox/recovery로 분리한다. Starter 내부에 교육 Consumer를 두지 않는다.
...
`com.cpf.reference.edu.dev08.attachment` 아래 metadata/storage/scanner/link/download로 분리한다.
...
`com.cpf.reference.edu.dev09.externalrest` 아래 client/contract/attempt/reconcile/stub를 분리한다.
...
`com.cpf.reference.edu.dev10.fixedwidth` 아래 layout/codec/client/attempt/reconcile을 분리한다.
...
`com.cpf.reference.edu.dev11.security` 아래 authorization/datascope/masking/audit를 분리한다. 공통 재사용은 기존 Security Starter Public Extension 사용.
...
`com.cpf.reference.edu.dev12.runtimefeature` 아래 cache/featureflag/secret/client를 분리한다.
...
`com.cpf.reference.edu.dev13.exportnotification` 아래 request/job/file/notification/download를 분리한다.
...
Java Query·Mapping은 `com.cpf.reference.edu.dev14.dbmigration`; SQL은 중앙 `cpf-tools/db/vendor/<vendor>`의 기존 Install/Upgrade/Rollback/Verify 구조에 둔다.
...
`com.cpf.reference.edu.dev15.faultrecovery` 아래 scenario/failurepoint/reconcile/evidence를 둔다. Toxiproxy와 기존 Test Tool을 사용한다.
...
표준 Source `cpf-reference/src/main/java/com/cpf/reference/edu/bat01/tasklet/`. 고객 Job을 `cpf-batch` Runtime에 넣지 않는다.

- Resource·Fixture: Job Fixture·Parameter·대사 Query는 `cpf-reference/src/main/resources/edu/edu/bat/01/`와 중앙 Vendor Pack에 둔다.
...
표준 Source `cpf-reference/src/main/java/com/cpf/reference/edu/bat02/chunk/`. 고객 Job을 `cpf-batch` Runtime에 넣지 않는다.

- Resource·Fixture: Job Fixture·Parameter·대사 Query는 `cpf-reference/src/main/resources/edu/edu/bat/02/`와 중앙 Vendor Pack에 둔다.
...
표준 Source `cpf-reference/src/main/java/com/cpf/reference/edu/bat03/file/`. 고객 Job을 `cpf-batch` Runtime에 넣지 않는다.

- Resource·Fixture: Job Fixture·Parameter·대사 Query는 `cpf-reference/src/main/resources/edu/edu/bat/03/`와 중앙 Vendor Pack에 둔다.
...
표준 Source `cpf-reference/src/main/java/com/cpf/reference/edu/bat04/partition/`. 고객 Job을 `cpf-batch` Runtime에 넣지 않는다.

- Resource·Fixture: Job Fixture·Parameter·대사 Query는 `cpf-reference/src/main/resources/edu/edu/bat/04/`와 중앙 Vendor Pack에 둔다.
...
표준 Source `cpf-reference/src/main/java/com/cpf/reference/edu/bat05/remoteworker/`. 고객 Job을 `cpf-batch` Runtime에 넣지 않는다.

- Resource·Fixture: Job Fixture·Parameter·대사 Query는 `cpf-reference/src/main/resources/edu/edu/bat/05/`와 중앙 Vendor Pack에 둔다.
...
표준 Source `cpf-reference/src/main/java/com/cpf/reference/edu/bat06/centercut/`. 고객 Job을 `cpf-batch` Runtime에 넣지 않는다.

- Resource·Fixture: Job Fixture·Parameter·대사 Query는 `cpf-reference/src/main/resources/edu/edu/bat/06/`와 중앙 Vendor Pack에 둔다.
...
표준 Source `cpf-reference/src/main/java/com/cpf/reference/edu/bat07/scheduler/`. 고객 Job을 `cpf-batch` Runtime에 넣지 않는다.

- Resource·Fixture: Job Fixture·Parameter·대사 Query는 `cpf-reference/src/main/resources/edu/edu/bat/07/`와 중앙 Vendor Pack에 둔다.
...
표준 Source `cpf-reference/src/main/java/com/cpf/reference/edu/bat08/jobpack/`. 고객 Job을 `cpf-batch` Runtime에 넣지 않는다.

- Resource·Fixture: Job Fixture·Parameter·대사 Query는 `cpf-reference/src/main/resources/edu/edu/bat/08/`와 중앙 Vendor Pack에 둔다.
...
표준 Source `cpf-reference/src/main/java/com/cpf/reference/edu/bat09/restart/`. 고객 Job을 `cpf-batch` Runtime에 넣지 않는다.

- Resource·Fixture: Job Fixture·Parameter·대사 Query는 `cpf-reference/src/main/resources/edu/edu/bat/09/`와 중앙 Vendor Pack에 둔다.
...
표준 Source `cpf-reference/src/main/java/com/cpf/reference/edu/bat10/reconcile/`. 고객 Job을 `cpf-batch` Runtime에 넣지 않는다.

- Resource·Fixture: Job Fixture·Parameter·대사 Query는 `cpf-reference/src/main/resources/edu/edu/bat/10/`와 중앙 Vendor Pack에 둔다.
...
고객 업무 Source는 `cpf-reference/src/main/java/com/cpf/reference/edu/adm/adm01/reuse/`. ADM에는 기존 Owner Port·Generated Client·Feature Slice 규칙에 맞춘 Adapter와 화면 연결만 둔다. 고객 지급 원장 로직을 `cpf-admin`에 넣지 않는다.

- Resource·Fixture: 요청·응답 Fixture와 Browser Scenario는 `cpf-reference/src/main/resources/edu/edu/adm/01/` 및 `cpf-admin`의 기존 Test 구조에 둔다.
...
고객 업무 Source는 `cpf-reference/src/main/java/com/cpf/reference/edu/adm/adm02/query/`. ADM에는 기존 Owner Port·Generated Client·Feature Slice 규칙에 맞춘 Adapter와 화면 연결만 둔다. 고객 지급 원장 로직을 `cpf-admin`에 넣지 않는다.

- Resource·Fixture: 요청·응답 Fixture와 Browser Scenario는 `cpf-reference/src/main/resources/edu/edu/adm/02/` 및 `cpf-admin`의 기존 Test 구조에 둔다.
...
고객 업무 Source는 `cpf-reference/src/main/java/com/cpf/reference/edu/adm/adm03/command/`. ADM에는 기존 Owner Port·Generated Client·Feature Slice 규칙에 맞춘 Adapter와 화면 연결만 둔다. 고객 지급 원장 로직을 `cpf-admin`에 넣지 않는다.

- Resource·Fixture: 요청·응답 Fixture와 Browser Scenario는 `cpf-reference/src/main/resources/edu/edu/adm/03/` 및 `cpf-admin`의 기존 Test 구조에 둔다.
...
고객 업무 Source는 `cpf-reference/src/main/java/com/cpf/reference/edu/adm/adm04/approval/`. ADM에는 기존 Owner Port·Generated Client·Feature Slice 규칙에 맞춘 Adapter와 화면 연결만 둔다. 고객 지급 원장 로직을 `cpf-admin`에 넣지 않는다.

- Resource·Fixture: 요청·응답 Fixture와 Browser Scenario는 `cpf-reference/src/main/resources/edu/edu/adm/04/` 및 `cpf-admin`의 기존 Test 구조에 둔다.
...
고객 업무 Source는 `cpf-reference/src/main/java/com/cpf/reference/edu/adm/adm05/asyncoperation/`. ADM에는 기존 Owner Port·Generated Client·Feature Slice 규칙에 맞춘 Adapter와 화면 연결만 둔다. 고객 지급 원장 로직을 `cpf-admin`에 넣지 않는다.

- Resource·Fixture: 요청·응답 Fixture와 Browser Scenario는 `cpf-reference/src/main/resources/edu/edu/adm/05/` 및 `cpf-admin`의 기존 Test 구조에 둔다.
...
고객 업무 Source는 `cpf-reference/src/main/java/com/cpf/reference/edu/adm/adm06/partialrecovery/`. ADM에는 기존 Owner Port·Generated Client·Feature Slice 규칙에 맞춘 Adapter와 화면 연결만 둔다. 고객 지급 원장 로직을 `cpf-admin`에 넣지 않는다.

- Resource·Fixture: 요청·응답 Fixture와 Browser Scenario는 `cpf-reference/src/main/resources/edu/edu/adm/06/` 및 `cpf-admin`의 기존 Test 구조에 둔다.
...
고객 업무 Source는 `cpf-reference/src/main/java/com/cpf/reference/edu/adm/adm07/customscreen/`. ADM에는 기존 Owner Port·Generated Client·Feature Slice 규칙에 맞춘 Adapter와 화면 연결만 둔다. 고객 지급 원장 로직을 `cpf-admin`에 넣지 않는다.

- Resource·Fixture: 요청·응답 Fixture와 Browser Scenario는 `cpf-reference/src/main/resources/edu/edu/adm/07/` 및 `cpf-admin`의 기존 Test 구조에 둔다.
...
고객 연동 예제는 `cpf-reference/src/main/java/com/cpf/reference/edu/bza/bza01/organization/`. 재사용 가능한 BZA 제품 기능 변경만 `cpf-biz-admin` Owner Module에 반영한다. 고객 지급·계약 로직을 BZA에 넣지 않는다.

- Resource·Fixture: 조직·사용자·정책·결재 Fixture는 `cpf-reference/src/main/resources/edu/edu/bza/01/`와 중앙 Vendor Pack Seed에 둔다.
...
고객 연동 예제는 `cpf-reference/src/main/java/com/cpf/reference/edu/bza/bza02/authorization/`. 재사용 가능한 BZA 제품 기능 변경만 `cpf-biz-admin` Owner Module에 반영한다. 고객 지급·계약 로직을 BZA에 넣지 않는다.

- Resource·Fixture: 조직·사용자·정책·결재 Fixture는 `cpf-reference/src/main/resources/edu/edu/bza/02/`와 중앙 Vendor Pack Seed에 둔다.
...
고객 연동 예제는 `cpf-reference/src/main/java/com/cpf/reference/edu/bza/bza03/policysimulation/`. 재사용 가능한 BZA 제품 기능 변경만 `cpf-biz-admin` Owner Module에 반영한다. 고객 지급·계약 로직을 BZA에 넣지 않는다.

- Resource·Fixture: 조직·사용자·정책·결재 Fixture는 `cpf-reference/src/main/resources/edu/edu/bza/03/`와 중앙 Vendor Pack Seed에 둔다.
...
고객 연동 예제는 `cpf-reference/src/main/java/com/cpf/reference/edu/bza/bza04/approvalflow/`. 재사용 가능한 BZA 제품 기능 변경만 `cpf-biz-admin` Owner Module에 반영한다. 고객 지급·계약 로직을 BZA에 넣지 않는다.

- Resource·Fixture: 조직·사용자·정책·결재 Fixture는 `cpf-reference/src/main/resources/edu/edu/bza/04/`와 중앙 Vendor Pack Seed에 둔다.
...
고객 연동 예제는 `cpf-reference/src/main/java/com/cpf/reference/edu/bza/bza05/delegation/`. 재사용 가능한 BZA 제품 기능 변경만 `cpf-biz-admin` Owner Module에 반영한다. 고객 지급·계약 로직을 BZA에 넣지 않는다.

- Resource·Fixture: 조직·사용자·정책·결재 Fixture는 `cpf-reference/src/main/resources/edu/edu/bza/05/`와 중앙 Vendor Pack Seed에 둔다.
...
고객 연동 예제는 `cpf-reference/src/main/java/com/cpf/reference/edu/bza/bza06/evidence/`. 재사용 가능한 BZA 제품 기능 변경만 `cpf-biz-admin` Owner Module에 반영한다. 고객 지급·계약 로직을 BZA에 넣지 않는다.

- Resource·Fixture: 조직·사용자·정책·결재 Fixture는 `cpf-reference/src/main/resources/edu/edu/bza/06/`와 중앙 Vendor Pack Seed에 둔다.
...
대상 고객 API는 `cpf-reference/src/main/java/com/cpf/reference/edu/gateway/servergroup/`. Gateway Runtime에는 Mock 업무 로직을 넣지 않고 기존 Route·Policy·Publish Owner 구조를 사용한다.

- Resource·Fixture: Route Package, 인증 Fixture, Failure Stub은 `cpf-reference/src/main/resources/edu/edu/gw/01/`와 Gateway 기존 Test Fixture 구조에 둔다.
...
대상 고객 API는 `cpf-reference/src/main/java/com/cpf/reference/edu/gateway/route/`. Gateway Runtime에는 Mock 업무 로직을 넣지 않고 기존 Route·Policy·Publish Owner 구조를 사용한다.

- Resource·Fixture: Route Package, 인증 Fixture, Failure Stub은 `cpf-reference/src/main/resources/edu/edu/gw/02/`와 Gateway 기존 Test Fixture 구조에 둔다.
...
대상 고객 API는 `cpf-reference/src/main/java/com/cpf/reference/edu/gateway/security/`. Gateway Runtime에는 Mock 업무 로직을 넣지 않고 기존 Route·Policy·Publish Owner 구조를 사용한다.

- Resource·Fixture: Route Package, 인증 Fixture, Failure Stub은 `cpf-reference/src/main/resources/edu/edu/gw/03/`와 Gateway 기존 Test Fixture 구조에 둔다.
...
대상 고객 API는 `cpf-reference/src/main/java/com/cpf/reference/edu/gateway/resilience/`. Gateway Runtime에는 Mock 업무 로직을 넣지 않고 기존 Route·Policy·Publish Owner 구조를 사용한다.

- Resource·Fixture: Route Package, 인증 Fixture, Failure Stub은 `cpf-reference/src/main/resources/edu/edu/gw/04/`와 Gateway 기존 Test Fixture 구조에 둔다.
...
대상 고객 API는 `cpf-reference/src/main/java/com/cpf/reference/edu/gateway/publish/`. Gateway Runtime에는 Mock 업무 로직을 넣지 않고 기존 Route·Policy·Publish Owner 구조를 사용한다.

- Resource·Fixture: Route Package, 인증 Fixture, Failure Stub은 `cpf-reference/src/main/resources/edu/edu/gw/05/`와 Gateway 기존 Test Fixture 구조에 둔다.
...
대상 고객 API는 `cpf-reference/src/main/java/com/cpf/reference/edu/gateway/reconcile/`. Gateway Runtime에는 Mock 업무 로직을 넣지 않고 기존 Route·Policy·Publish Owner 구조를 사용한다.

- Resource·Fixture: Route Package, 인증 Fixture, Failure Stub은 `cpf-reference/src/main/resources/edu/edu/gw/06/`와 Gateway 기존 Test Fixture 구조에 둔다.
...
- 업무 Source: `com.cpf.reference.edu.dev16` 또는 같은 의미의 기존 표준 Slice
...
- 교육용 고객 업무를 `cpf-core`, `cpf-common`, Starter, Runtime 제품 내부에 삽입
...
- 업무 Source: `com.cpf.reference.edu.dev17` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev18` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev19` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev20` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev21` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev22` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev23` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev24` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev25` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev26` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev27` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev28` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev29` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev30` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev31` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev32` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev33` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev34` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev35` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev36` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev37` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev38` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev39` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev40` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev41` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev42` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev43` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev44` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.dev45` 또는 같은 의미의 기존 표준 Slice
...
- Owner: `cpf-reference + cpf-batch public contract`
- 구현 상태 목표: Source·SQL·API·Config·Test·운영 확인·매뉴얼 연결이 모두 완료
...
- 업무 Source: `com.cpf.reference.edu.bat11` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat12` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat13` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat14` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat15` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat16` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat17` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat18` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat19` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat20` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat21` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat22` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat23` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat24` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat25` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat26` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat27` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat28` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat29` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bat30` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.adm08` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.adm09` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.adm10` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.adm11` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.adm12` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.adm13` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.adm14` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.adm15` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.adm16` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.adm17` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bza07` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bza08` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bza09` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bza10` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bza11` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bza12` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bza13` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.bza14` 또는 같은 의미의 기존 표준 Slice
...
- Owner: `cpf-gateway + cpf-reference target service`
- 구현 상태 목표: Source·SQL·API·Config·Test·운영 확인·매뉴얼 연결이 모두 완료
...
- 업무 Source: `com.cpf.reference.edu.gateway07` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.gateway08` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.gateway09` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.gateway10` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.gateway11` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.gateway12` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.gateway13` 또는 같은 의미의 기존 표준 Slice
...
- 업무 Source: `com.cpf.reference.edu.gateway14` 또는 같은 의미의 기존 표준 Slice
