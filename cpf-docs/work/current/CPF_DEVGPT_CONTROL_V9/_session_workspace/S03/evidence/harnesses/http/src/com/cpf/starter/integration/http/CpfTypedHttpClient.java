...
public final class CpfTypedHttpClient {
    ...
    public CpfTypedHttpClient(HttpClient client, CpfHttpClientProperties properties) {
    ...
    public Result execute(
        ...
        HttpRequest.Builder builder = HttpRequest.newBuilder(uri)
                .timeout(timeout)
                .header("X-CPF-Transaction-Id", safeTransactionId)
        ...
        try {
            ...
            try (InputStream stream = response.body()) {
                ...
                throw new CpfUnknownHttpResultException("HTTP response body failed after dispatch", ex);
            }
            ...
            throw new CpfUnknownHttpResultException("HTTP result is unknown after request timeout", ex);
        } catch (InterruptedException ex) {
            Thread.currentThread().interrupt();
            throw new CpfUnknownHttpResultException("HTTP call interrupted after dispatch may have begun", ex);
        } catch (IOException ex) {
            if (isDeterministicPreDispatchFailure(ex)) {
                throw new CpfHttpPreDispatchException("HTTP transport failed before dispatch", ex);
            }
            throw new CpfUnknownHttpResultException("HTTP transport failed after dispatch may have begun", ex);
        }
    }
    ...
    public static final class CpfUnknownHttpResultException extends RuntimeException {
        ...
        public CpfUnknownHttpResultException(String message, Throwable cause) { super(message, cause); }
    }
