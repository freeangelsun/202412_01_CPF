# ADM-AGENT atomic adjudication evidence
...
## Actual Source
cpf-admin/src/main/java/com/cpf/admin/opr/controller/AdmBatchWorkbenchController.java; cpf-admin/src/main/java/com/cpf/admin/opr/controller/AdmServiceRegistryController.java

## Actual Consumer Call Path
ADM agent/worker view → worker/instance/heartbeat/drain APIs → workbench/registry services → runtime owner adapters
