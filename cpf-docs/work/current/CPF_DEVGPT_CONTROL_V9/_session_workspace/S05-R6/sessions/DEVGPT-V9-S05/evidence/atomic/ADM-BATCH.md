# ADM-BATCH atomic adjudication evidence
...
## Actual Source
cpf-admin/src/main/java/com/cpf/admin/opr/controller/AdmBatchController.java; cpf-admin/src/main/java/com/cpf/admin/opr/controller/AdmBatchWorkbenchController.java

## Actual Consumer Call Path
ADM batch workbench UI → batch execution/control APIs → controllers → batch owner ports/runtime

## Test and Assertion
cpf-admin/src/test/java/com/cpf/admin/opr/service/AdmBatchOperationServiceTest.java; cpf-admin/src/test/java/com/cpf/admin/opr/service/AdmBatchJobLogServiceTest.java; evidence/CANONICAL_SOURCE_TRACE.csv
