# ADM-EXS atomic adjudication evidence
...
## Actual Source
cpf-admin/src/main/java/com/cpf/admin/opr/gateway/AdmGatewayRegistryController.java; cpf-admin/src/main/java/com/cpf/admin/opr/gateway/RemoteCpfGatewayRegistryAdapter.java

## Actual Consumer Call Path
ADM external-system registry UI → gateway binding/connection/health APIs → gateway registry controller → remote adapter/owner API

## Test and Assertion
cpf-admin/src/test/java/com/cpf/admin/opr/gateway; evidence/CANONICAL_SOURCE_TRACE.csv
