# ADM-INCIDENT atomic adjudication evidence
...
## Actual Source
cpf-admin/src/main/java/com/cpf/admin/opr/incident/AdmIncidentLifecycleController.java; cpf-admin/src/main/java/com/cpf/admin/opr/incident/AdmIncidentLifecycleService.java

## Actual Consumer Call Path
ADM incident UI → incident lifecycle APIs → controller → lifecycle service/repository/runbook/audit
