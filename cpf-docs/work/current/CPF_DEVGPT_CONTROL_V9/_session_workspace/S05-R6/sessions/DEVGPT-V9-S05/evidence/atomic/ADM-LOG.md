# ADM-LOG atomic adjudication evidence
...
## Actual Source
cpf-admin/src/main/java/com/cpf/admin/opr/controller/AdmLogController.java; cpf-admin/src/main/java/com/cpf/admin/opr/controller/AdmDynamicLogLevelController.java; cpf-admin/src/main/java/com/cpf/admin/opr/service/AdmLogPolicyService.java

## Actual Consumer Call Path
ADM log search/export/policy UI → log APIs → log query/policy services → masked result/audit

## Test and Assertion
cpf-admin/src/test/java/com/cpf/admin/opr/service/AdmLogPolicyServiceTest.java; cpf-admin/src/test/java/com/cpf/admin/opr/service/AdmDynamicLogLevelRuleStoreTest.java; evidence/CANONICAL_SOURCE_TRACE.csv
