# ADM-RECOVERY atomic adjudication evidence
...
## Actual Source
cpf-admin/src/main/java/com/cpf/admin/opr/controller/AdmReliabilityController.java; cpf-admin/src/main/java/com/cpf/admin/opr/service/AdmReliabilityService.java; cpf-admin/src/main/java/com/cpf/admin/opr/reliability/AdmBrokerDlqReplayApprovalSnapshot.java

## Actual Consumer Call Path
ADM recovery/DLQ/UNKNOWN UI → reliability APIs → AdmReliabilityService → owner command/reconcile/audit

## Test and Assertion
cpf-admin/src/test/java/com/cpf/admin/opr/service/AdmReliabilityServiceTest.java; evidence/CANONICAL_SOURCE_TRACE.csv
