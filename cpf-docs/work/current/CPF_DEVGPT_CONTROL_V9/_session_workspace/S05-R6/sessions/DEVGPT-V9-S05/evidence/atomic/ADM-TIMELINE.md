# ADM-TIMELINE atomic adjudication evidence
...
## Actual Source
cpf-admin/src/main/java/com/cpf/admin/opr/controller/AdmTransactionGroupController.java; cpf-admin/src/main/java/com/cpf/admin/opr/controller/AdmObservabilityController.java

## Actual Consumer Call Path
ADM timeline/trace UI → timeline and trace APIs → transaction/observability services → local·remote·event·batch·gateway segment assembly

## Test and Assertion
cpf-admin/src/test/java/com/cpf/admin/opr/service/AdmObservabilityServiceTest.java; evidence/CANONICAL_SOURCE_TRACE.csv
