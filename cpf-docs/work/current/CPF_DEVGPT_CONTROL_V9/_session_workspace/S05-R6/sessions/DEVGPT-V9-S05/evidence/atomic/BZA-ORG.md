# BZA-ORG atomic adjudication evidence
...
## Actual Source
cpf-biz-admin/src/main/java/com/cpf/bizadmin/directory/controller/BzaDirectoryController.java; cpf-biz-admin/src/main/java/com/cpf/bizadmin/directory/service/BzaDirectoryService.java; cpf-biz-admin/src/main/java/com/cpf/bizadmin/backoffice/controller/BzaBackofficeController.java; cpf-biz-admin/frontend/src/features/organizations; cpf-biz-admin/frontend/src/features/employees; cpf-biz-admin/frontend/src/features/assignments

## Actual Consumer Call Path
BZA organization/employee/assignment pages → generated client → organization/backoffice controllers → services/repositories

## Test and Assertion
evidence/BZA_OPENAPI_VALIDATION.log; evidence/BZA_OPENAPI_LIFECYCLE.log; evidence/CANONICAL_SOURCE_TRACE.csv
