...
$runRoot = Join-Path $root 'cpf-docs/work/evidence/codex/current/runtime/F134-FRESH-RUNTIME-RERUN4'
...
$childEnvironment = @{
    ...
    CPF_LOG_ROOT = $logs
    CPF_RUNTIME_INSTANCE_ID = 'f134-runtime-rerun4'
}
$arguments = @(
    '-Xms250m', '-Xmx500m',
...
$result = [ordered]@{
    ...
    stdout = 'cpf-docs/work/evidence/codex/current/runtime/F134-FRESH-RUNTIME-RERUN4/stdout.log'
    stderr = 'cpf-docs/work/evidence/codex/current/runtime/F134-FRESH-RUNTIME-RERUN4/stderr.log'
}
