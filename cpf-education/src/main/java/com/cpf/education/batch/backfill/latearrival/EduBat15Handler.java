...
public final class EduBat15Handler extends AbstractEduCapabilityHandler {
    ...
    public EduBat15Handler() {
        super(new EduCapabilityDefinition(
                "EDU-BAT-15", "지연 도착 데이터·Backfill·재산출", EduCapabilityKind.BATCH, "cpf-education",
                "CPF_BATCH_OPERATOR", List.of("targetPeriod", "cutoffVersion", "backfillFrom", "reason"), List.of(EduWorkflowStep.VALIDATE, EduWorkflowStep.AUTHORIZE, EduWorkflowStep.SCOPE, EduWorkflowStep.DEDUPE, EduWorkflowStep.VERSION_CHECK, EduWorkflowStep.CLAIM_LEASE, EduWorkflowStep.PROTECT, EduWorkflowStep.MUTATE, EduWorkflowStep.COMMIT, EduWorkflowStep.CHECKPOINT, EduWorkflowStep.RECONCILE, EduWorkflowStep.AUDIT, EduWorkflowStep.OBSERVE),
    ...
    @Override public String implementationPackage() { return "com.cpf.education.batch.backfill.latearrival"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bat-15" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-15", EduConsumerType.SPRING_BATCH, "cpf-education",
                "eduBat15Job", "RECONCILED", "cpf-education optional Spring Batch Job/Step contract",
                "POST /api/education/edu-capabilities/EDU-BAT-15/executions", "cpf.education.features.batch.enabled", 3600, List.of("targetPeriod", "cutoffVersion", "backfillFrom", "reason"));
    }
