...
public final class EduBat22Handler extends AbstractEduCapabilityHandler {
    ...
    public EduBat22Handler() {
        super(new EduCapabilityDefinition(
                "EDU-BAT-22", "휴일 Calendar·영업일 순번 JobParameter", EduCapabilityKind.BATCH, "cpf-education",
                "CPF_BATCH_OPERATOR", List.of("calendarId", "businessDate", "sequence", "timezone"), List.of(EduWorkflowStep.VALIDATE, EduWorkflowStep.AUTHORIZE, EduWorkflowStep.SCOPE, EduWorkflowStep.DEDUPE, EduWorkflowStep.VERSION_CHECK, EduWorkflowStep.CLAIM_LEASE, EduWorkflowStep.PROTECT, EduWorkflowStep.MUTATE, EduWorkflowStep.COMMIT, EduWorkflowStep.CHECKPOINT, EduWorkflowStep.RECONCILE, EduWorkflowStep.AUDIT, EduWorkflowStep.OBSERVE),
    ...
    @Override public String implementationPackage() { return "com.cpf.education.batch.calendar.businessday"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bat-22" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-22", EduConsumerType.SPRING_BATCH, "cpf-education",
                "eduBat22Job", "NON_BUSINESS_SKIPPED", "cpf-education optional Spring Batch Job/Step contract",
                "POST /api/education/edu-capabilities/EDU-BAT-22/executions", "cpf.education.features.batch.enabled", 3600, List.of("calendarId", "businessDate", "sequence", "timezone"));
    }
