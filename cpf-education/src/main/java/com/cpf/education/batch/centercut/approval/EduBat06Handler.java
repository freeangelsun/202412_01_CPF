...
public final class EduBat06Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.batch.centercut.approval"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bat-06" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-06", EduConsumerType.SPRING_BATCH, "cpf-education",
                "eduBat06Job", "RECONCILED", "cpf-education optional Spring Batch Job/Step contract",
                "POST /api/education/edu-capabilities/EDU-BAT-06/executions", "cpf.education.features.batch.enabled", 3600, List.of("criteriaVersion", "snapshotId", "checksum", "approvalPolicyId"));
    }
