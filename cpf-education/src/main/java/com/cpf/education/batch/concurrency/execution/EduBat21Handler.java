...
public final class EduBat21Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.batch.concurrency.execution"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bat-21" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-21", EduConsumerType.SPRING_BATCH, "cpf-education",
                "eduBat21Job", "RELEASED", "cpf-education optional Spring Batch Job/Step contract",
                "POST /api/education/edu-capabilities/EDU-BAT-21/executions", "cpf.education.features.batch.enabled", 3600, List.of("jobKey", "businessDate", "scopeKey"));
    }
