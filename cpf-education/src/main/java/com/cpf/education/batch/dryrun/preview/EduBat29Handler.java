...
public final class EduBat29Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.batch.dryrun.preview"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bat-29" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-29", EduConsumerType.SPRING_BATCH, "cpf-education",
                "eduBat29Job", "EXECUTING", "cpf-education optional Spring Batch Job/Step contract",
                "POST /api/education/edu-capabilities/EDU-BAT-29/executions", "cpf.education.features.batch.enabled", 3600, List.of("criteria", "snapshotAt", "sampleSize"));
    }
