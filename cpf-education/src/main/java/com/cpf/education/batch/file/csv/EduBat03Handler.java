...
public final class EduBat03Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.batch.file.csv"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bat-03" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-03", EduConsumerType.SPRING_BATCH, "cpf-education",
                "eduBat03Job", "REJECTED", "cpf-education optional Spring Batch Job/Step contract",
                "POST /api/education/edu-capabilities/EDU-BAT-03/executions", "cpf.education.features.batch.enabled", 3600, List.of("fileId", "fileHash", "businessDate", "fileName", "contentLength", "checksum"));
    }
