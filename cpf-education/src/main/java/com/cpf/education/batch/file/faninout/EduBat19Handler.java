...
public final class EduBat19Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.batch.file.faninout"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bat-19" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-19", EduConsumerType.SPRING_BATCH, "cpf-education",
                "eduBat19Job", "COMPLETED", "cpf-education optional Spring Batch Job/Step contract",
                "POST /api/education/edu-capabilities/EDU-BAT-19/executions", "cpf.education.features.batch.enabled", 3600, List.of("expectedFiles", "deadline", "groupingKey", "fileName", "contentLength", "checksum"));
    }

    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "다중 파일 Fan-in·Fan-out");
