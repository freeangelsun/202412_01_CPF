package com.cpf.education.batch.flatfile;
...
public class SettlementFileJob {
 private final CpfFixedLengthOperations fixed; public SettlementFileJob(CpfFixedLengthOperations fixed){this.fixed=fixed;}
