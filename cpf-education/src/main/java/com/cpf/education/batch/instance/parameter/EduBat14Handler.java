...
public final class EduBat14Handler extends AbstractEduCapabilityHandler {
    ...
    public EduBat14Handler() {
        super(new EduCapabilityDefinition(
                "EDU-BAT-14", "JobParameter 식별·중복 실행·새 Instance", EduCapabilityKind.BATCH, "cpf-education",
                "CPF_BATCH_OPERATOR", List.of("businessDate", "jobVersion", "runType"), List.of(EduWorkflowStep.VALIDATE, EduWorkflowStep.AUTHORIZE, EduWorkflowStep.SCOPE, EduWorkflowStep.DEDUPE, EduWorkflowStep.VERSION_CHECK, EduWorkflowStep.CLAIM_LEASE, EduWorkflowStep.PROTECT, EduWorkflowStep.MUTATE, EduWorkflowStep.COMMIT, EduWorkflowStep.CHECKPOINT, EduWorkflowStep.RECONCILE, EduWorkflowStep.AUDIT, EduWorkflowStep.OBSERVE),
    ...
    @Override public String implementationPackage() { return "com.cpf.education.batch.instance.parameter"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bat-14" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-14", EduConsumerType.SPRING_BATCH, "cpf-education",
                "eduBat14Job", "DUPLICATE_REJECTED", "cpf-education optional Spring Batch Job/Step contract",
                "POST /api/education/edu-capabilities/EDU-BAT-14/executions", "cpf.education.features.batch.enabled", 3600, List.of("businessDate", "jobVersion", "runType"));
    }
