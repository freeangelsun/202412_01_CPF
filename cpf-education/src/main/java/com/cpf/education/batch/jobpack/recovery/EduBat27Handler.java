...
public final class EduBat27Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.batch.jobpack.recovery"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bat-27" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-27", EduConsumerType.SPRING_BATCH, "cpf-education",
                "eduBat27Job", "ROLLED_BACK", "cpf-education optional Spring Batch Job/Step contract",
                "POST /api/education/edu-capabilities/EDU-BAT-27/executions", "cpf.education.features.batch.enabled", 3600, List.of("artifactVersion", "checksum", "compatibleRuntime", "fileName", "contentLength"));
    }

    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "Job Pack Checksum·호환성·이전 Version 복구");
