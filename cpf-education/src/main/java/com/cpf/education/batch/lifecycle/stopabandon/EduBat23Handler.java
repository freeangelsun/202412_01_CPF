...
public final class EduBat23Handler extends AbstractEduCapabilityHandler {
    ...
    public EduBat23Handler() {
        super(new EduCapabilityDefinition(
                "EDU-BAT-23", "Stop·Abandon·Restart 의미 분리", EduCapabilityKind.BATCH, "cpf-education",
                "CPF_BATCH_OPERATOR", List.of("executionId", "action", "reason", "endpointAlias", "institutionRequestId"), List.of(EduWorkflowStep.VALIDATE, EduWorkflowStep.AUTHORIZE, EduWorkflowStep.SCOPE, EduWorkflowStep.DEDUPE, EduWorkflowStep.VERSION_CHECK, EduWorkflowStep.CLAIM_LEASE, EduWorkflowStep.PROTECT, EduWorkflowStep.MUTATE, EduWorkflowStep.COMMIT, EduWorkflowStep.CHECKPOINT, EduWorkflowStep.RECONCILE, EduWorkflowStep.AUDIT, EduWorkflowStep.OBSERVE),
    ...
    @Override public String implementationPackage() { return "com.cpf.education.batch.lifecycle.stopabandon"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bat-23" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-23", EduConsumerType.SPRING_BATCH, "cpf-education",
                "eduBat23Job", "ABANDONED", "cpf-education optional Spring Batch Job/Step contract",
                "POST /api/education/edu-capabilities/EDU-BAT-23/executions", "cpf.education.features.batch.enabled", 3600, List.of("executionId", "action", "reason", "endpointAlias", "institutionRequestId"));
    }
