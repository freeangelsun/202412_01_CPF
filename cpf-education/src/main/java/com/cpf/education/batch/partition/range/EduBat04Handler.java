...
public final class EduBat04Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.batch.partition.range"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bat-04" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-04", EduConsumerType.SPRING_BATCH, "cpf-education",
                "eduBat04Job", "COMPLETED", "cpf-education optional Spring Batch Job/Step contract",
                "POST /api/education/edu-capabilities/EDU-BAT-04/executions", "cpf.education.features.batch.enabled", 3600, List.of("rangeStart", "rangeEnd", "gridSize", "ownerInstanceId"));
    }
