...
public final class EduBat30Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.batch.performance.backpressure"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bat-30" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-30", EduConsumerType.SPRING_BATCH, "cpf-education",
                "eduBat30Job", "COMPLETED", "cpf-education optional Spring Batch Job/Step contract",
                "POST /api/education/edu-capabilities/EDU-BAT-30/executions", "cpf.education.features.batch.enabled", 3600, List.of("volume", "chunkSize", "gridSize", "throttleLimit"));
    }
