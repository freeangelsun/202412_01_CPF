...
public final class EduBat20Handler extends AbstractEduCapabilityHandler {
    ...
    public EduBat20Handler() {
        super(new EduCapabilityDefinition(
                "EDU-BAT-20", "Scheduler Misfire·Catch-up·건너뛰기", EduCapabilityKind.BATCH, "cpf-education",
                "CPF_BATCH_OPERATOR", List.of("scheduleId", "misfirePolicy", "recoveryWindow"), List.of(EduWorkflowStep.VALIDATE, EduWorkflowStep.AUTHORIZE, EduWorkflowStep.SCOPE, EduWorkflowStep.DEDUPE, EduWorkflowStep.VERSION_CHECK, EduWorkflowStep.CLAIM_LEASE, EduWorkflowStep.PROTECT, EduWorkflowStep.MUTATE, EduWorkflowStep.COMMIT, EduWorkflowStep.CHECKPOINT, EduWorkflowStep.RECONCILE, EduWorkflowStep.AUDIT, EduWorkflowStep.OBSERVE),
    ...
    @Override public String implementationPackage() { return "com.cpf.education.batch.scheduler.misfire"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bat-20" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-20", EduConsumerType.SPRING_BATCH, "cpf-education",
                "eduBat20Job", "NEXT_SCHEDULED", "cpf-education optional Spring Batch Job/Step contract",
                "POST /api/education/edu-capabilities/EDU-BAT-20/executions", "cpf.education.features.batch.enabled", 3600, List.of("scheduleId", "misfirePolicy", "recoveryWindow"));
    }
