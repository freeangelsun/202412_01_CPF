...
public final class EduBat01Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.batch.tasklet.close"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bat-01" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-01", EduConsumerType.SPRING_BATCH, "cpf-education",
                "eduBat01Job", "FAILED", "cpf-education optional Spring Batch Job/Step contract",
                "POST /api/education/edu-capabilities/EDU-BAT-01/executions", "cpf.education.features.batch.enabled", 3600, List.of("businessDate", "force", "reason"));
    }
