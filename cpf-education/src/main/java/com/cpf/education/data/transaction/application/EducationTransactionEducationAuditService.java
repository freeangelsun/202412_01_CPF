package com.cpf.education.data.transaction.application;
...
/**
 * EDU 트랜잭션 교육에서 감사성 보조 처리를 분리해서 보여주는 서비스입니다.
 *
 ...
 */
@Service
public class EducationTransactionEducationAuditService extends com.cpf.education.base.EducationBaseService {
     ...
     */
    @CpfTx(id = "EDU-AUDITSERVICE-01", name = "EducationTransactionEducationAuditServiceTx1", ownerDomain = "EDU", transactionManager = "educationReferenceFixtureTransactionManager", propagation = Propagation.REQUIRES_NEW)
