...
@CpfRestController
@RequestMapping("/edu/online/04-validation")
public class Online04ValidationErrorExample {
    private final CpfMessageSource messages;

    public Online04ValidationErrorExample(CpfMessageSource messages) {
        this.messages = messages;
    }

    @PostMapping
    @Operation(operationId = "EDU-ONLINE-04", summary = "Validation·표준 오류")
    @CpfOnlineTransaction(
            operationId = "EDU-ONLINE-04",
