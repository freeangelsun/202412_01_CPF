...
@CpfRestController
@RequestMapping("/edu/online/15-messaging")
public class Online15MessagingExample {
    private final CpfMessagingTemplate messaging;

    public Online15MessagingExample(CpfMessagingTemplate messaging) {
        this.messaging = messaging;
    }

    @PostMapping
    @Operation(operationId = "EDU-ONLINE-15", summary = "Messaging·비동기 거래")
    @CpfOnlineTransaction(
            operationId = "EDU-ONLINE-15",
