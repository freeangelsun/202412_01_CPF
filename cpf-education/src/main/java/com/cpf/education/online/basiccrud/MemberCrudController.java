package com.cpf.education.online.basiccrud;
...
@CpfRestController
@RequestMapping("/edu/online/members")
public class MemberCrudController {
    private final MemberService service;

    public MemberCrudController(MemberService service) {
        this.service = service;
    }

    @PostMapping
    @Operation(operationId = "EDU_MEMBER_CRUD", summary = "기본 CRUD 거래")
    @CpfOnlineTransaction(
            operationId = "EDU_MEMBER_CRUD",
            name = "기본 CRUD 거래",
