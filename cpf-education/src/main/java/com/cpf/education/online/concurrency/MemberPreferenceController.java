package com.cpf.education.online.concurrency;
...
public class MemberPreferenceController {
    ...
    public MemberPreferenceController(ObjectProvider<CpfCrudRepository<MemberVersion, String>> repositories) {
        this.repositories = repositories;
    }

    @PutMapping
    @CpfTransactional
    @Operation(operationId = "EDU_MEMBER_OPTIMISTIC_UPDATE", summary = "동시성·Optimistic Lock 거래")
    @CpfOnlineTransaction(
            operationId = "EDU_MEMBER_OPTIMISTIC_UPDATE",
