package com.cpf.education.online.internalservice;
...
public class MemberProcessingController {
    ...
    public MemberProcessingController(EntryService entryService) {
    ...
    @CpfOnlineTransaction(
            operationId = "EDU_LOCAL_MEMBER_PROCESS",
