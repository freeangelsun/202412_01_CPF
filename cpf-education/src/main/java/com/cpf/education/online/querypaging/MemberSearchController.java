package com.cpf.education.online.querypaging;
...
public class MemberSearchController {
    ...
    public MemberSearchController(ObjectProvider<CpfPagingAndSortingRepository<MemberView, MemberSearch>> repositories) {
