...
public final class EduAdm01Handler extends AbstractEduCapabilityHandler {
    ...
    public EduAdm01Handler() {
        super(new EduCapabilityDefinition(
                "EDU-ADM-01", "기존 ADM 기능 재사용 판단", EduCapabilityKind.OPERATIONS, "cpf-education",
                ...
                Set.of(EduFailurePoint.TIMEOUT, EduFailurePoint.RESPONSE_LOST),
                true, false,
                false, false,
                false, false,
                3, "EDU-ADM-01"));
    ...
    @Override public String implementationPackage() { return "com.cpf.education.operations.admin.reuse"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-adm-01" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-ADM-01", EduConsumerType.JDBC_COMMAND, "cpf-education",
                "CPF_EDU_BUSINESS_RECORD", "RECONCILED", "cpf-education EDU fixture DB backoffice/operations contract",
                "POST /api/education/edu-capabilities/EDU-ADM-01/executions", "cpf.education.features.operations.enabled", 60, List.of("businessId", "approvalId"));
    }
