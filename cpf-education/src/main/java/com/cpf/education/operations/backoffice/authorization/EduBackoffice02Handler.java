...
public final class EduBackoffice02Handler extends AbstractEduCapabilityHandler {
    ...
    public EduBackoffice02Handler() {
        super(new EduCapabilityDefinition(
                "EDU-BZA-02", "사용자·역할·권한·실효 권한", EduCapabilityKind.BACKOFFICE, "cpf-education",
                "CPF_BZA_OPERATOR", List.of("userId", "roleId", "validFrom", "to", "organizationId", "subjectId"), List.of(EduWorkflowStep.VALIDATE, EduWorkflowStep.AUTHORIZE, EduWorkflowStep.SCOPE, EduWorkflowStep.DEDUPE, EduWorkflowStep.VERSION_CHECK, EduWorkflowStep.PROTECT, EduWorkflowStep.MUTATE, EduWorkflowStep.COMMIT, EduWorkflowStep.RECONCILE, EduWorkflowStep.AUDIT, EduWorkflowStep.OBSERVE),
    ...
    @Override public String implementationPackage() { return "com.cpf.education.operations.backoffice.authorization"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bza-02" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BZA-02", EduConsumerType.JDBC_COMMAND, "cpf-education",
                "CPF_EDU_BUSINESS_RECORD", "CANCELLED", "cpf-education EDU fixture DB backoffice/operations contract",
                "POST /api/education/edu-capabilities/EDU-BZA-02/executions", "cpf.education.features.backoffice.enabled", 60, List.of("userId", "roleId", "validFrom", "to", "organizationId", "subjectId"));
    }
