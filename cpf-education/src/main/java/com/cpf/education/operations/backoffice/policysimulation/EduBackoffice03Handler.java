...
public final class EduBackoffice03Handler extends AbstractEduCapabilityHandler {
    ...
    public EduBackoffice03Handler() {
        super(new EduCapabilityDefinition(
                "EDU-BZA-03", "결재정책 Version·경로 사전 계산", EduCapabilityKind.BACKOFFICE, "cpf-education",
                "CPF_BZA_OPERATOR", List.of("policyVersion", "businessType", "amount", "organizationId", "approvalPolicyId"), List.of(EduWorkflowStep.VALIDATE, EduWorkflowStep.AUTHORIZE, EduWorkflowStep.SCOPE, EduWorkflowStep.DEDUPE, EduWorkflowStep.VERSION_CHECK, EduWorkflowStep.PREVIEW, EduWorkflowStep.PROTECT, EduWorkflowStep.MUTATE, EduWorkflowStep.COMMIT, EduWorkflowStep.RECONCILE, EduWorkflowStep.AUDIT, EduWorkflowStep.OBSERVE),
    ...
    @Override public String implementationPackage() { return "com.cpf.education.operations.backoffice.policysimulation"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-bza-03" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BZA-03", EduConsumerType.JDBC_COMMAND, "cpf-education",
                "CPF_EDU_BUSINESS_RECORD", "CANCELLED", "cpf-education EDU fixture DB backoffice/operations contract",
                "POST /api/education/edu-capabilities/EDU-BZA-03/executions", "cpf.education.features.backoffice.enabled", 60, List.of("policyVersion", "businessType", "amount", "organizationId", "approvalPolicyId"));
    }
