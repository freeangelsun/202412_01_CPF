...
public final class EduGw04Handler extends AbstractEduCapabilityHandler {
    ...
    public EduGw04Handler() {
        super(new EduCapabilityDefinition(
                "EDU-GW-04", "Timeout·Retry·Circuit Breaker·Bulkhead", EduCapabilityKind.GATEWAY, "cpf-education",
                "CPF_GATEWAY_OPERATOR", List.of("connect", "read", "retry", "circuit", "bulkhead"), List.of(EduWorkflowStep.VALIDATE, EduWorkflowStep.AUTHORIZE, EduWorkflowStep.SCOPE, EduWorkflowStep.DEDUPE, EduWorkflowStep.VERSION_CHECK, EduWorkflowStep.PROTECT, EduWorkflowStep.MUTATE, EduWorkflowStep.COMMIT, EduWorkflowStep.OUTBOX, EduWorkflowStep.EXTERNAL_SEND, EduWorkflowStep.ACK, EduWorkflowStep.RECONCILE, EduWorkflowStep.AUDIT, EduWorkflowStep.OBSERVE),
    ...
    @Override public String implementationPackage() { return "com.cpf.education.operations.gateway.resilience"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-gw-04" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-GW-04", EduConsumerType.REFERENCE_GATEWAY, "cpf-education",
                "CPF_EDU_BUSINESS_RECORD", "ROLLED_BACK", "cpf-education EDU Gateway simulator + cpfDB contract",
                "POST /api/education/edu-capabilities/EDU-GW-04/executions", "cpf.education.features.gateway.enabled", 60, List.of("connect", "read", "retry", "circuit", "bulkhead"));
    }
