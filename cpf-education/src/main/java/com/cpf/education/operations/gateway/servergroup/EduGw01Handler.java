 ...
 */
public final class EduGw01Handler extends AbstractEduCapabilityHandler {
    ...
    private static final List<String> EXCEPTION_SCENARIOS = List.of("Health 실패", "늦은 복귀", "모든 Member Down", "Weight 불균형");
    ...
    @Override public String implementationPackage() { return "com.cpf.education.operations.gateway.servergroup"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-gw-01" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-GW-01", EduConsumerType.REFERENCE_GATEWAY, "cpf-education",
                "CPF_EDU_BUSINESS_RECORD", "ROLLED_BACK", "cpf-education EDU Gateway simulator + cpfDB contract",
                "POST /api/education/edu-capabilities/EDU-GW-01/executions", "cpf.education.features.gateway.enabled", 60, List.of("serverGroupId", "weight", "routeId", "targetGroup"));
    }

    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "Server Group·Health·Load Balancing");
