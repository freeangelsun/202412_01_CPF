...
public final class EduGw11Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.operations.gateway.version"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-gw-11" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-GW-11", EduConsumerType.REFERENCE_GATEWAY, "cpf-education",
                "CPF_EDU_BUSINESS_RECORD", "RECONCILED", "cpf-education EDU Gateway simulator + cpfDB contract",
                "POST /api/education/edu-capabilities/EDU-GW-11/executions", "cpf.education.features.gateway.enabled", 60, List.of("requestHash", "routeVersion"));
    }
