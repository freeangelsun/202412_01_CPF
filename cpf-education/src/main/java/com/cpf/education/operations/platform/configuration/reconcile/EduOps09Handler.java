...
public final class EduOps09Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.operations.platform.configuration.reconcile"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-ops-09" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-09", EduConsumerType.PROCESS, "cpf-education",
                ...
                "POST /api/education/edu-capabilities/EDU-OPS-09/executions", "cpf.repository-root", 600, List.of("configVersion", "checksum", "targets"));
    }

    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "설정 변경 Partial Apply·Reconcile");
