...
public final class EduOps04Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.operations.platform.database.lifecycle"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-ops-04" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-04", EduConsumerType.PROCESS, "cpf-education",
                "cpf-education/src/main/scripts/edu/invoke-education.ps1", "ROLLED_BACK", "cpf-education allowlisted platform operation simulation contract",
                "POST /api/education/edu-capabilities/EDU-OPS-04/executions", "cpf.repository-root", 600, List.of("vendor", "versionFrom", "versionTo", "schema"));
    }
