...
public final class EduOps08Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.operations.platform.deployment.bluegreen"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-ops-08" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-08", EduConsumerType.PROCESS, "cpf-education",
                ...
                "POST /api/education/edu-capabilities/EDU-OPS-08/executions", "cpf.repository-root", 600, List.of("blueVersion", "greenVersion", "trafficWeight"));
    }
