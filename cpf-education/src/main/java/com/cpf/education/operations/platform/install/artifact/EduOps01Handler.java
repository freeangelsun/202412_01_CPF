...
public final class EduOps01Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.operations.platform.install.artifact"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-ops-01" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-01", EduConsumerType.PROCESS, "cpf-education",
                "cpf-education/src/main/scripts/edu/invoke-education.ps1", "READY", "cpf-education allowlisted platform operation simulation contract",
                "POST /api/education/edu-capabilities/EDU-OPS-01/executions", "cpf.repository-root", 600, List.of("artifactPath", "manifest", "installDir", "serviceAccount", "fileName", "contentLength", "checksum"));
    }
