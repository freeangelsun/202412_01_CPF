...
public final class EduOps05Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.operations.platform.messaging.kafka"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-ops-05" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-05", EduConsumerType.PROCESS, "cpf-education",
                ...
                "POST /api/education/edu-capabilities/EDU-OPS-05/executions", "cpf.repository-root", 600, List.of("topicSpec", "aclSpec", "consumerGroup", "destination", "messageKey"));
    }
