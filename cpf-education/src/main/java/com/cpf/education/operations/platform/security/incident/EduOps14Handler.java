...
public final class EduOps14Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.operations.platform.security.incident"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-ops-14" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-14", EduConsumerType.PROCESS, "cpf-education",
                ...
                "POST /api/education/edu-capabilities/EDU-OPS-14/executions", "cpf.repository-root", 600, List.of("incidentId", "subjects", "secretVersions", "routes"));
    }
