...
public final class EduOps03Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.operations.platform.security.secretrotation"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-ops-03" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-03", EduConsumerType.PROCESS, "cpf-education",
                "cpf-education/src/main/scripts/edu/invoke-education.ps1", "RETIRED", "cpf-education allowlisted platform operation simulation contract",
                "POST /api/education/edu-capabilities/EDU-OPS-03/executions", "cpf.repository-root", 600, List.of("secretRef", "certChain", "activationAt", "secretAlias"));
    }
