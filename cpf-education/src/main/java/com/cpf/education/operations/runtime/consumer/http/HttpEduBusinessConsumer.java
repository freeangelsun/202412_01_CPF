package com.cpf.education.operations.runtime.consumer.http;
...
import java.util.*;
/** Fail-closed HTTP consumer for the independent cpf-education counterparty simulator or an explicitly configured external institution. */
/** HttpEduBusinessConsumer 타입의 역할과 책임을 정의하며 CPF 계약 경계를 명확히 유지한다. */
