...
public final class EduDev39Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev39Handler() {
        super(new EduCapabilityDefinition(
                "EDU-DEV-39", "업무일자·시간대·휴일 Calendar", EduCapabilityKind.ONLINE, "cpf-education",
    ...
    @Override public String implementationPackage() { return "com.cpf.education.scenarios.online.calendar.businessday"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-dev-39" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-39", EduConsumerType.JDBC_COMMAND, "cpf-education",
                "CPF_EDU_BUSINESS_RECORD", "DATE_RESOLVED", "cpf-education EDU fixture DB business record contract",
                "POST /api/education/edu-capabilities/EDU-DEV-39/executions", "", 60, List.of("businessDate", "zoneId", "calendarId", "cutoffTime", "timezone"));
    }
