...
public final class EduDev27Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev27Handler() {
        super(new EduCapabilityDefinition(
                "EDU-DEV-27", "SOAP·XML 외부기관 연계와 Fault 처리", EduCapabilityKind.ONLINE, "cpf-education",
    ...
    @Override public String implementationPackage() { return "com.cpf.education.scenarios.online.counterparty.soap"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-dev-27" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-27", EduConsumerType.HTTP, "cpf-education",
                "/external/27", "UNKNOWN_RESULT", "cpf-education counterparty simulator HTTP contract",
                "POST /api/education/edu-capabilities/EDU-DEV-27/executions", "cpf.edu.counterparty.base-url", 60, List.of("payload", "endpointAlias", "institutionRequestId"));
    }
