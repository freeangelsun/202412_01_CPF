...
public final class EduDev17Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev17Handler() {
        super(new EduCapabilityDefinition(
                "EDU-DEV-17", "대량 등록 사전검증·부분 오류 보고·재업로드", EduCapabilityKind.ONLINE, "cpf-education",
    ...
    @Override public String implementationPackage() { return "com.cpf.education.scenarios.online.file.bulkimport"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-dev-17" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-17", EduConsumerType.JDBC_COMMAND, "cpf-education",
                "CPF_EDU_BUSINESS_RECORD", "RECONCILED", "cpf-education EDU fixture DB business record contract",
                "POST /api/education/edu-capabilities/EDU-DEV-17/executions", "", 60, List.of("dryRun"));
    }
