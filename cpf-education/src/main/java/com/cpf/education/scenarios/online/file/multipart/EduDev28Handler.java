...
public final class EduDev28Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev28Handler() {
        super(new EduCapabilityDefinition(
                "EDU-DEV-28", "대용량 Multipart 업로드·중단 재개", EduCapabilityKind.ONLINE, "cpf-education",
    ...
    @Override public String implementationPackage() { return "com.cpf.education.scenarios.online.file.multipart"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-dev-28" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-28", EduConsumerType.FILE, "cpf-education",
                "cpf-education EDU file store", "ABORTED", "cpf-education safe file/checksum contract",
                "POST /api/education/edu-capabilities/EDU-DEV-28/executions", "cpf.edu.business-file-root", 120, List.of("uploadId", "partNo", "partChecksum", "totalParts", "fileName", "contentLength", "checksum"));
    }
