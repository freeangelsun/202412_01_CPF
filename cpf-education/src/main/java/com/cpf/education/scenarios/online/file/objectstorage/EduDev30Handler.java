...
public final class EduDev30Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.scenarios.online.file.objectstorage"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-dev-30" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-30", EduConsumerType.FILE, "cpf-education",
                "cpf-education EDU file store", "DELETED", "cpf-education safe file/checksum contract",
                "POST /api/education/edu-capabilities/EDU-DEV-30/executions", "cpf.edu.business-file-root", 120, List.of("objectKey", "versionId", "retentionUntil", "legalHold", "fileName", "contentLength", "checksum"));
    }

    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "Object Storage 보존·버전·법적 보류");
