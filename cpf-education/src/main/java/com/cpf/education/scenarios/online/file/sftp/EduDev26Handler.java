...
public final class EduDev26Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.scenarios.online.file.sftp"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-dev-26" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-26", EduConsumerType.FILE, "cpf-education",
                "cpf-education EDU file store", "ARCHIVED", "cpf-education safe file/checksum contract",
                "POST /api/education/edu-capabilities/EDU-DEV-26/executions", "cpf.edu.business-file-root", 120, List.of("remotePath", "filePattern", "expectedChecksum", "partnerId", "fileName", "contentLength", "checksum"));
    }

    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "SFTP 수신·송신·완료 파일 원자 처리");
