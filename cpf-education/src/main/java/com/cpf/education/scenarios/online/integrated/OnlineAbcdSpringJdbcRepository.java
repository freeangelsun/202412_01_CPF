...
/**
 * Spring transaction-bound Connection을 사용하는 Online education JDBC Repository입니다.
 * begin/commit/rollback은 Domain port 호환용 no-op이며 실제 commit/rollback은 PlatformTransactionManager가 소유합니다.
 */
public final class OnlineAbcdSpringJdbcRepository implements OnlineAbcdEducationFlow.Repository {
     ...
     * @param table 검증된 education table 이름
