...
public final class EduDev18Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev18Handler() {
        super(new EduCapabilityDefinition(
                "EDU-DEV-18", "논리 삭제·복원·보존기간 만료", EduCapabilityKind.ONLINE, "cpf-education",
    ...
    @Override public String implementationPackage() { return "com.cpf.education.scenarios.online.lifecycle.softdelete"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-dev-18" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-18", EduConsumerType.JDBC_COMMAND, "cpf-education",
                "CPF_EDU_BUSINESS_RECORD", "PURGED", "cpf-education EDU fixture DB business record contract",
                "POST /api/education/edu-capabilities/EDU-DEV-18/executions", "", 60, List.of("customerId", "reason", "retentionUntil"));
    }
