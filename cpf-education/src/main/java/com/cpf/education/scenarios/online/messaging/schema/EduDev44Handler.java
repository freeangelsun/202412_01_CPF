...
public final class EduDev44Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev44Handler() {
        super(new EduCapabilityDefinition(
                "EDU-DEV-44", "Event Schema 진화·호환성·Dead Letter", EduCapabilityKind.ONLINE, "cpf-education",
    ...
    @Override public String implementationPackage() { return "com.cpf.education.scenarios.online.messaging.schema"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-dev-44" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-44", EduConsumerType.OUTBOX, "cpf-education",
                "CPF_EDU_OUTBOX", "QUARANTINED", "cpf-education durable outbox/inbox contract",
                "POST /api/education/edu-capabilities/EDU-DEV-44/executions", "", 60, List.of("schemaVersion", "eventType", "payload", "destination", "messageKey"));
    }
