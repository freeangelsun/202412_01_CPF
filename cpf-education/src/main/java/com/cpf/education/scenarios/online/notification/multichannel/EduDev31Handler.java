...
public final class EduDev31Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev31Handler() {
        super(new EduCapabilityDefinition(
                "EDU-DEV-31", "다중 채널 알림 선호·재시도·대체 채널", EduCapabilityKind.ONLINE, "cpf-education",
    ...
    @Override public String implementationPackage() { return "com.cpf.education.scenarios.online.notification.multichannel"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-dev-31" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-31", EduConsumerType.OUTBOX, "cpf-education",
                "CPF_EDU_OUTBOX", "FAILED", "cpf-education durable outbox/inbox contract",
                "POST /api/education/edu-capabilities/EDU-DEV-31/executions", "", 60, List.of("recipientId", "templateId", "channels", "locale", "consentVersion", "destination", "messageKey"));
    }
