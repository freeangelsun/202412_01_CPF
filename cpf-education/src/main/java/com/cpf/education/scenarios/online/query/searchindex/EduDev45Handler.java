...
public final class EduDev45Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public String implementationPackage() { return "com.cpf.education.scenarios.online.query.searchindex"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-dev-45" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-45", EduConsumerType.JDBC_QUERY, "cpf-education",
                "CPF_EDU_BUSINESS_RECORD", "REINDEXED", "cpf-education EDU fixture DB business record contract",
                "POST /api/education/edu-capabilities/EDU-DEV-45/executions", "", 60, List.of("aggregateId", "eventOffset", "indexVersion", "organizationId", "pageSize", "destination", "messageKey"));
    }

    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "조회 모델·검색색인 Eventual Consistency");
