...
public final class EduDev35Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev35Handler() {
        super(new EduCapabilityDefinition(
                "EDU-DEV-35", "기능 전환 Canary·Kill Switch·사용자 Segment", EduCapabilityKind.ONLINE, "cpf-education",
    ...
    @Override public String implementationPackage() { return "com.cpf.education.scenarios.online.runtime.featuretoggle"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-dev-35" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-35", EduConsumerType.JDBC_COMMAND, "cpf-education",
                "CPF_EDU_BUSINESS_RECORD", "ROLLED_BACK", "cpf-education EDU fixture DB business record contract",
                "POST /api/education/edu-capabilities/EDU-DEV-35/executions", "", 60, List.of("featureKey", "environment", "percentage", "segment"));
    }
