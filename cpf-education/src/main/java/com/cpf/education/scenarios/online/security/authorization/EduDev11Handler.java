...
public final class EduDev11Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev11Handler() {
        super(new EduCapabilityDefinition(
                "EDU-DEV-11", "권한·데이터 범위·개인정보 가림·감사", EduCapabilityKind.ONLINE, "cpf-education",
    ...
    @Override public String implementationPackage() { return "com.cpf.education.scenarios.online.security.authorization"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-dev-11" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-11", EduConsumerType.JDBC_COMMAND, "cpf-education",
                "CPF_EDU_BUSINESS_RECORD", "REVEALED", "cpf-education EDU fixture DB business record contract",
                "POST /api/education/edu-capabilities/EDU-DEV-11/executions", "", 60, List.of("organizationId", "subjectId"));
    }
