...
public final class EduDev32Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev32Handler() {
        super(new EduCapabilityDefinition(
                "EDU-DEV-32", "개인정보 암호화·Tokenization·Key Rotation", EduCapabilityKind.ONLINE, "cpf-education",
    ...
    @Override public String implementationPackage() { return "com.cpf.education.scenarios.online.security.cryptography"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-dev-32" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-32", EduConsumerType.JDBC_COMMAND, "cpf-education",
                "CPF_EDU_BUSINESS_RECORD", "REVOKED", "cpf-education EDU fixture DB business record contract",
                "POST /api/education/edu-capabilities/EDU-DEV-32/executions", "", 60, List.of("subjectId", "plaintext", "via", "secure", "input", "keyVersion", "reason", "secretAlias", "sessionId"));
    }
