...
public final class EduDev20Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev20Handler() {
        super(new EduCapabilityDefinition(
                "EDU-DEV-20", "다단계 고객 업무 상태기계와 취소·재개", EduCapabilityKind.ONLINE, "cpf-education",
    ...
    @Override public String implementationPackage() { return "com.cpf.education.scenarios.online.workflow.statemachine"; }
    ...
    @Override public List<String> targetKeys(EduExecutionCommand command) {
        return List.of("edu-dev-20" + "-" + command.businessKey());
    }

    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-20", EduConsumerType.JDBC_COMMAND, "cpf-education",
                "CPF_EDU_BUSINESS_RECORD", "ON_HOLD", "cpf-education EDU fixture DB business record contract",
                "POST /api/education/edu-capabilities/EDU-DEV-20/executions", "", 60, List.of("applicationId", "action", "reason"));
    }
