package com.cpf.education.web.crud.controller;
 ...
 * `/api/education/items`는 신규 표준 경로이고, 기존 문서/샘플 호환을 위해 `/api/education/crud-items`도 함께 제공합니다.</p>
 */
@Validated
@RestController
@RequestMapping({"/api/education", "/education/edu"})
@Tag(name = "EDU Education 01. CRUD 교육", description = "목록, 상세, 등록, 수정, 상태 변경, 논리 삭제 API 작성 기준")
public class EducationCrudEducationController extends com.cpf.education.base.EducationBaseController {
    private final EducationCrudEducationService crudEducationService;

    /** EducationCrudEducationController 작업을 CPF 표준 계약에 따라 수행한다. */
    public EducationCrudEducationController(EducationCrudEducationService crudEducationService) {
    ...
    @CpfOnlineTransaction(id = "OEDUAA0001", name = "EDU교육CRUD목록조회", ownerDomain="EDU")
    ...
    public ResponseEntity<List<EducationCrudEducationResponse>> findEducationItems(
    ...
    @CpfOnlineTransaction(id = "OEDUAA0002", name = "EDU교육CRUD상세조회", ownerDomain="EDU")
    ...
    public ResponseEntity<EducationCrudEducationResponse> getEducationItemByPath(
    ...
    @CpfOnlineTransaction(id = "OEDUAA0003", name = "EDU교육CRUD상세조회호환", ownerDomain="EDU")
    ...
    public ResponseEntity<EducationCrudEducationResponse> getEducationItem(
    ...
    @CpfOnlineTransaction(id = "OEDUAA0004", name = "EDU교육CRUD등록", ownerDomain="EDU")
    ...
    public ResponseEntity<EducationCrudEducationResponse> createEducationItem(
            @Valid @RequestBody EducationCrudEducationRequest request) {
    ...
    @CpfOnlineTransaction(id = "OEDUAA0005", name = "EDU교육CRUD수정", ownerDomain="EDU")
    ...
    public ResponseEntity<EducationCrudEducationResponse> updateEducationItemByPath(
            @PathVariable @Min(1) Long educationItemId,
            @Valid @RequestBody EducationCrudEducationRequest request) {
    ...
    @CpfOnlineTransaction(id = "OEDUAA0006", name = "EDU교육CRUD수정호환", ownerDomain="EDU")
    ...
    public ResponseEntity<EducationCrudEducationResponse> updateEducationItem(
            @RequestParam @Min(1) Long educationItemId,
            @Valid @RequestBody EducationCrudEducationRequest request) {
        return ResponseEntity.ok(crudEducationService.updateEducationItem(educationItemId, request));
    }
    ...
    @CpfOnlineTransaction(id = "OEDUAA0007", name = "EDU교육CRUD상태변경", ownerDomain="EDU")
    ...
    public ResponseEntity<EducationCrudEducationResponse> changeEducationItemStatus(
            @PathVariable @Min(1) Long educationItemId,
            @Valid @RequestBody EducationCrudEducationStatusRequest request) {
    ...
    @CpfOnlineTransaction(id = "OEDUAA0008", name = "EDU교육CRUD삭제", ownerDomain="EDU")
    ...
    @CpfOnlineTransaction(id = "OEDUAA0009", name = "EDU교육CRUD삭제호환", ownerDomain="EDU")
