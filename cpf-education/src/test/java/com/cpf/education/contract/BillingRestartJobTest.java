...
import com.cpf.education.batch.restart.job.BillingRestartJob;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;

/** EDU-BATCH-07 Source가 실제 CPF Batch Job 계약을 소비하는지 검증합니다. */
class BillingRestartJobTest {
 @Test void canonicalBatchMetadataIsPresent() {
   CpfBatchJob job=BillingRestartJob.class.getAnnotation(CpfBatchJob.class);
