...
import com.cpf.education.batch.scheduler.job.BusinessDateSchedulerJob;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;

/** EDU-BATCH-06 Source가 실제 CPF Batch Job 계약을 소비하는지 검증합니다. */
class BusinessDateSchedulerJobTest {
 @Test void canonicalBatchMetadataIsPresent() {
   CpfBatchJob job=BusinessDateSchedulerJob.class.getAnnotation(CpfBatchJob.class);
