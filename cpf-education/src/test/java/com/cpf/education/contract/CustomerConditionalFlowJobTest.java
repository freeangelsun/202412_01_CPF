...
/** EDU-BATCH-10 Source가 실제 CPF Batch Job 계약을 소비하는지 검증합니다. */
class CustomerConditionalFlowJobTest {
 @Test void canonicalBatchMetadataIsPresent() {
   CpfBatchJob job=CustomerConditionalFlowJob.class.getAnnotation(CpfBatchJob.class);
