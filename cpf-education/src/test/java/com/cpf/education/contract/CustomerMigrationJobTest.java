...
import com.cpf.education.batch.chunk.job.CustomerMigrationChunkJob;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;

/** EDU-BATCH-02 Source가 실제 CPF Batch Job 계약을 소비하는지 검증합니다. */
class CustomerMigrationJobTest {
 @Test void canonicalBatchMetadataIsPresent() {
   CpfBatchJob job=CustomerMigrationChunkJob.class.getAnnotation(CpfBatchJob.class);
