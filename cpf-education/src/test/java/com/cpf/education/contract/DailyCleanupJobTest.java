...
import com.cpf.education.batch.tasklet.job.DailyCleanupTaskletJob;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;

/** EDU-BATCH-01 Source가 실제 CPF Batch Job 계약을 소비하는지 검증합니다. */
class DailyCleanupJobTest {
 @Test void canonicalBatchMetadataIsPresent() {
   CpfBatchJob job=DailyCleanupTaskletJob.class.getAnnotation(CpfBatchJob.class);
