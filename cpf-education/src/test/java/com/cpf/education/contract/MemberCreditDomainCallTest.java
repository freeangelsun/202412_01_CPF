...
import com.cpf.education.online.domaincall.controller.MemberCreditController;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;

/** EDU-ONLINE-06 Source가 실제 CPF Online Operation 계약을 소비하는지 검증합니다. */
class MemberCreditDomainCallTest {
 @Test void canonicalOperationMetadataIsPresent() {
   var operations=java.util.Arrays.stream(MemberCreditController.class.getDeclaredMethods())
