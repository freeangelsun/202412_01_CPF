...
import com.cpf.education.online.ondemandbatch.controller.MemberExportController;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;

/** EDU-ONLINE-12 Source가 실제 CPF Online Operation 계약을 소비하는지 검증합니다. */
class MemberExportContractTest {
 @Test void canonicalOperationMetadataIsPresent() {
   var operations=java.util.Arrays.stream(MemberExportController.class.getDeclaredMethods())
