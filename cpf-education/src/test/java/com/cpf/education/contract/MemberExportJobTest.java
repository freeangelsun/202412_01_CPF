...
import com.cpf.education.batch.ondemand.job.MemberExportJob;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;

/** EDU-BATCH-15 Source가 실제 CPF Batch Job 계약을 소비하는지 검증합니다. */
class MemberExportJobTest {
 @Test void canonicalBatchMetadataIsPresent() {
   CpfBatchJob job=MemberExportJob.class.getAnnotation(CpfBatchJob.class);
