...
/** EDU-BATCH-04 Source가 실제 CPF Batch Job 계약을 소비하는지 검증합니다. */
class MemberPartitionJobTest {
 @Test void canonicalBatchMetadataIsPresent() {
   CpfBatchJob job=MemberPartitionJob.class.getAnnotation(CpfBatchJob.class);
