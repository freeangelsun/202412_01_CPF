...
import com.cpf.education.online.concurrency.controller.MemberPreferenceController;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;

/** EDU-ONLINE-19 Source가 실제 CPF Online Operation 계약을 소비하는지 검증합니다. */
class MemberPreferenceConcurrencyTest {
 @Test void canonicalOperationMetadataIsPresent() {
   var operations=java.util.Arrays.stream(MemberPreferenceController.class.getDeclaredMethods())
