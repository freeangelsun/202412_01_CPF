...
/** EDU-ONLINE-03 Source가 실제 CPF Online Operation 계약을 소비하는지 검증합니다. */
class MemberReferenceContractTest {
 @Test void canonicalOperationMetadataIsPresent() {
   var operations=java.util.Arrays.stream(MemberReferenceController.class.getDeclaredMethods())
