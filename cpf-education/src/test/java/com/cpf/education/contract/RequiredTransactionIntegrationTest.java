...
import com.cpf.education.online.transaction.required.controller.MemberRegistrationController;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;

/** EDU-ONLINE-09 Source가 실제 CPF Online Operation 계약을 소비하는지 검증합니다. */
class RequiredTransactionIntegrationTest {
 @Test void canonicalOperationMetadataIsPresent() {
   var operations=java.util.Arrays.stream(MemberRegistrationController.class.getDeclaredMethods())
