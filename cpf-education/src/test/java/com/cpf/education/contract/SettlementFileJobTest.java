...
import com.cpf.education.batch.flatfile.job.SettlementFileJob;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;

/** EDU-BATCH-03 Source가 실제 CPF Batch Job 계약을 소비하는지 검증합니다. */
class SettlementFileJobTest {
 @Test void canonicalBatchMetadataIsPresent() {
   CpfBatchJob job=SettlementFileJob.class.getAnnotation(CpfBatchJob.class);
