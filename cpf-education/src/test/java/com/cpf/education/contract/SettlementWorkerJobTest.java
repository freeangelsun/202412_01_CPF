...
import com.cpf.education.batch.distributedworker.job.SettlementWorkerJob;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;

/** EDU-BATCH-08 Source가 실제 CPF Batch Job 계약을 소비하는지 검증합니다. */
class SettlementWorkerJobTest {
 @Test void canonicalBatchMetadataIsPresent() {
   CpfBatchJob job=SettlementWorkerJob.class.getAnnotation(CpfBatchJob.class);
