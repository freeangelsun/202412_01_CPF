...
class EducationGatewayEntryEducationSampleTest {
    @Test
    void exposesOnlyStateVersionAndAggregateTelemetry() {
        ...
        EducationGatewayEntryEducationSample.EntryStatus status =
                new EducationGatewayEntryEducationSample(port).status();
