...
public class DomainAuditLogger {
    ...
    public void success(String action, String transactionId, String entityId) {
        log.info("cpfAudit domain=external system=EXS action={} transactionId={} entityId={} result=SUCCESS", action, transactionId, entityId);
    }
    public void replay(String transactionId, String entityId) {
        log.info("cpfAudit domain=external system=EXS action=IDEMPOTENT_REPLAY transactionId={} entityId={} result=SUCCESS", transactionId, entityId);
    }
}
