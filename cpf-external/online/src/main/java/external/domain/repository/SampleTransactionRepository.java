package external.domain.repository;

import external.domain.base.ExternalBaseRepository;
import external.domain.mapper.SampleTransactionMapper;
import external.domain.model.SampleIdempotencyRecord;
import external.domain.model.SampleItem;
...
@CpfRepository
public class SampleTransactionRepository extends ExternalBaseRepository {
