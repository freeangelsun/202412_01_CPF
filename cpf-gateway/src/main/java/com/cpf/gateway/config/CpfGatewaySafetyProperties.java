...
public class CpfGatewaySafetyProperties {
    ...
    private int maxConcurrentRequestsCap = 1_000;
    ...
    public void validate() {
        ...
        if (maxConcurrentRequestsCap < 1 || maxConcurrentRequestsCap > 1_000_000) throw new IllegalStateException("maxConcurrentRequestsCap out of range");
    ...
    public int getMaxConcurrentRequestsCap(){return maxConcurrentRequestsCap;} public void setMaxConcurrentRequestsCap(int v){maxConcurrentRequestsCap=v;}
