...
import member.domain.base.MemberBaseRepository;
import member.domain.mapper.SampleTransactionMapper;
import member.domain.model.SampleIdempotencyRecord;
import member.domain.model.SampleItem;
