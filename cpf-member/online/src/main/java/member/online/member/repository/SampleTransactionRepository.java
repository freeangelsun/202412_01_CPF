package member.online.member.repository;

import member.online.base.MemberBaseRepository;
import member.online.member.repository.SampleTransactionMapper;
import member.online.member.model.SampleIdempotencyRecord;
