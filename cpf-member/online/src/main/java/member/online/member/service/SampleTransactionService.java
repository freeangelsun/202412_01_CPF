package member.online.member.service;

import member.online.member.service.DomainAuditLogger;
import member.online.base.MemberBaseService;
import member.online.member.repository.SampleTransactionRepository;
import member.online.member.model.*;
import member.online.member.dto.*;
import member.online.member.service.SampleTransactionPolicy;
