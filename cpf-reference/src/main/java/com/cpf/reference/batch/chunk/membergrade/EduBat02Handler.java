...
public final class EduBat02Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-02", EduConsumerType.SPRING_BATCH, "cpf-reference",
                "eduBat02Job", "STOPPED", "cpf-reference optional Spring Batch Job/Step contract",
                "POST /api/reference/edu-capabilities/EDU-BAT-02/executions", "cpf.reference.features.batch.enabled", 3600, List.of("businessDate", "criteriaVersion", "chunkSize"));
    }
