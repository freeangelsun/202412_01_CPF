...
public final class EduBat21Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-21", EduConsumerType.SPRING_BATCH, "cpf-reference",
                "eduBat21Job", "RELEASED", "cpf-reference optional Spring Batch Job/Step contract",
                "POST /api/reference/edu-capabilities/EDU-BAT-21/executions", "cpf.reference.features.batch.enabled", 3600, List.of("jobKey", "businessDate", "scopeKey"));
    }
    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "중복 실행 방지·동시 실행 허용 범위");
