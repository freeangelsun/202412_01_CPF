...
public final class EduBat29Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-29", EduConsumerType.SPRING_BATCH, "cpf-reference",
                "eduBat29Job", "EXECUTING", "cpf-reference optional Spring Batch Job/Step contract",
                "POST /api/reference/edu-capabilities/EDU-BAT-29/executions", "cpf.reference.features.batch.enabled", 3600, List.of("criteria", "snapshotAt", "sampleSize"));
    }
    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "Dry Run·건수 Preview·표본 확인");
