...
public final class EduBat19Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-19", EduConsumerType.SPRING_BATCH, "cpf-reference",
                "eduBat19Job", "COMPLETED", "cpf-reference optional Spring Batch Job/Step contract",
                "POST /api/reference/edu-capabilities/EDU-BAT-19/executions", "cpf.reference.features.batch.enabled", 3600, List.of("expectedFiles", "deadline", "groupingKey", "fileName", "contentLength", "checksum"));
    }
