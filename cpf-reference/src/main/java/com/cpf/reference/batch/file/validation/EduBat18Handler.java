...
public final class EduBat18Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-18", EduConsumerType.SPRING_BATCH, "cpf-reference",
                "eduBat18Job", "REJECTED", "cpf-reference optional Spring Batch Job/Step contract",
                "POST /api/reference/edu-capabilities/EDU-BAT-18/executions", "cpf.reference.features.batch.enabled", 3600, List.of("filePath", "layoutVersion", "partnerId", "fileName", "contentLength", "checksum"));
    }
