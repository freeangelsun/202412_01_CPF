...
public final class EduBat11Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-11", EduConsumerType.SPRING_BATCH, "cpf-reference",
                "eduBat11Job", "STOPPED", "cpf-reference optional Spring Batch Job/Step contract",
                "POST /api/reference/edu-capabilities/EDU-BAT-11/executions", "cpf.reference.features.batch.enabled", 3600, List.of("businessDate", "mode", "threshold"));
    }
