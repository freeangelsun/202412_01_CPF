...
public final class EduBat27Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-27", EduConsumerType.SPRING_BATCH, "cpf-reference",
                "eduBat27Job", "ROLLED_BACK", "cpf-reference optional Spring Batch Job/Step contract",
                "POST /api/reference/edu-capabilities/EDU-BAT-27/executions", "cpf.reference.features.batch.enabled", 3600, List.of("artifactVersion", "checksum", "compatibleRuntime", "fileName", "contentLength"));
    }
