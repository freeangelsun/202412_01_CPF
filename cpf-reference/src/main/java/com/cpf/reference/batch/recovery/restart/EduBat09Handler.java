...
public final class EduBat09Handler extends AbstractEduCapabilityHandler {
    ...
    public EduBat09Handler() {
        super(new EduCapabilityDefinition(
            "EDU-BAT-09", "중지·재시작·실패건 재처리", EduCapabilityKind.BATCH, "cpf-reference", "CPF_REFERENCE_BATCH_OPERATOR",
            List.of("executionId", "restartMode", "reprocessScope"), List.of(EduWorkflowStep.VALIDATE, EduWorkflowStep.AUTHORIZE, EduWorkflowStep.SCOPE, EduWorkflowStep.DEDUPE, EduWorkflowStep.VERSION_CHECK, EduWorkflowStep.CLAIM_LEASE, EduWorkflowStep.CHECKSUM, EduWorkflowStep.MUTATE, EduWorkflowStep.COMMIT, EduWorkflowStep.CHECKPOINT, EduWorkflowStep.RECONCILE, EduWorkflowStep.AUDIT, EduWorkflowStep.OBSERVE), Set.of(EduFailurePoint.BEFORE_COMMIT, EduFailurePoint.AFTER_COMMIT, EduFailurePoint.TIMEOUT, EduFailurePoint.PROCESS_KILL, EduFailurePoint.LEASE_LOST),
            true, true, true, false, false, false, 5, "EDU-BAT-09"));
    }
    @Override public String implementationPackage() { return "com.cpf.reference.batch.recovery.restart"; }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-09", EduConsumerType.SPRING_BATCH, "cpf-reference",
                "eduBat09Job", "COMPLETED", "cpf-reference optional Spring Batch Job/Step contract",
                "POST /api/reference/edu-capabilities/EDU-BAT-09/executions", "cpf.reference.features.batch.enabled", 3600, List.of("executionId", "restartMode", "reprocessScope"));
    }
