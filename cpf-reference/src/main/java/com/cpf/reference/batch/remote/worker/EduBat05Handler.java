...
public final class EduBat05Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-05", EduConsumerType.SPRING_BATCH, "cpf-reference",
                "eduBat05Job", "EXPIRED", "cpf-reference optional Spring Batch Job/Step contract",
                "POST /api/reference/edu-capabilities/EDU-BAT-05/executions", "cpf.reference.features.batch.enabled", 3600, List.of("executionId", "partitionId", "leaseDuration", "ownerInstanceId"));
    }
