...
public final class EduBat07Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BAT-07", EduConsumerType.SPRING_BATCH, "cpf-reference",
                "eduBat07Job", "MISFIRED", "cpf-reference optional Spring Batch Job/Step contract",
                "POST /api/reference/edu-capabilities/EDU-BAT-07/executions", "cpf.reference.features.batch.enabled", 3600, List.of("scheduleId", "calendarId", "misfirePolicy", "businessDate", "timezone"));
    }
