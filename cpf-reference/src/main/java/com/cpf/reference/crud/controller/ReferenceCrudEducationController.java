package cpf.xyz.crud.controller;
 ...
 * `/api/xyz/reference/items`는 신규 표준 경로이고, 기존 문서/샘플 호환을 위해 `/api/xyz/reference/crud-items`도 함께 제공합니다.</p>
 */
@Validated
@RestController
@RequestMapping({"/api/xyz/reference", "/xyz/edu"})
@Tag(name = "XYZ Reference 01. CRUD 교육", description = "목록, 상세, 등록, 수정, 상태 변경, 논리 삭제 API 작성 기준")
public class XyzCrudEducationController extends cpf.xyz.common.base.XyzBaseController {
    ...
    @CpfOnlineTransaction(id = "OXYZAA0001", name = "XYZ교육CRUD목록조회")
    ...
    @CpfOnlineTransaction(id = "OXYZAA0002", name = "XYZ교육CRUD상세조회")
    ...
    @CpfOnlineTransaction(id = "OXYZAA0003", name = "XYZ교육CRUD상세조회호환")
    ...
    @CpfOnlineTransaction(id = "OXYZAA0004", name = "XYZ교육CRUD등록")
    ...
    @CpfOnlineTransaction(id = "OXYZAA0005", name = "XYZ교육CRUD수정")
    ...
    @CpfOnlineTransaction(id = "OXYZAA0006", name = "XYZ교육CRUD수정호환")
    ...
    @CpfOnlineTransaction(id = "OXYZAA0007", name = "XYZ교육CRUD상태변경")
    ...
    @CpfOnlineTransaction(id = "OXYZAA0008", name = "XYZ교육CRUD삭제")
    ...
    @CpfOnlineTransaction(id = "OXYZAA0009", name = "XYZ교육CRUD삭제호환")
