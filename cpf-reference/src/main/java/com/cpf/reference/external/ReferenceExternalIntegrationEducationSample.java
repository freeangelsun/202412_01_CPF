...
/**
 * 외부 장애 시뮬레이터를 CPF Service Call Engine 경계로 실행하는 고급 샘플입니다.
 *
 * <p>업무 입력은 시뮬레이션 조건만 전달하며 timeout과 retry는 중앙 endpoint 정책을 사용합니다.</p>
 */
@Component
public class ReferenceExternalIntegrationEducationSample {
    private final CpfWebClient webClient;

    public ReferenceExternalIntegrationEducationSample(CpfWebClient webClient) {
