...
public final class EduDev24Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev24Handler() {
        super(new EduCapabilityDefinition(
            "EDU-DEV-24", "장시간 비동기 Operation 조회·취소", EduCapabilityKind.ONLINE, "cpf-reference", "CPF_REFERENCE_DEVELOPER",
            ...
            true, true, false, false, true, true, 3, "EDU-DEV-24"));
    }
    @Override public String implementationPackage() { return "com.cpf.reference.online.asyncoperation.lifecycle"; }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-24", EduConsumerType.JDBC_COMMAND, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "FAILED", "cpf-reference REF DB business record contract",
                "POST /api/reference/edu-capabilities/EDU-DEV-24/executions", "", 60, List.of("requestHash", "cancelReason", "pollingCursor"));
    }
