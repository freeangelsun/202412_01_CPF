...
public final class EduDev37Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev37Handler() {
        super(new EduCapabilityDefinition(
            "EDU-DEV-37", "온라인 분산 Lease·Fencing·소유권 상실", EduCapabilityKind.ONLINE, "cpf-reference", "CPF_REFERENCE_DEVELOPER",
            ...
            true, true, true, false, false, false, 3, "EDU-DEV-37"));
    }
    @Override public String implementationPackage() { return "com.cpf.reference.online.concurrency.lease"; }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-37", EduConsumerType.JDBC_COMMAND, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "EXPIRED", "cpf-reference REF DB business record contract",
                "POST /api/reference/edu-capabilities/EDU-DEV-37/executions", "", 60, List.of("resourceId", "ownerId", "leaseDuration", "fencingToken", "ownerInstanceId"));
    }
