...
public final class EduDev04Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev04Handler() {
        super(new EduCapabilityDefinition(
            "EDU-DEV-04", "동시 수정과 예상 Version 충돌", EduCapabilityKind.ONLINE, "cpf-reference", "CPF_REFERENCE_DEVELOPER",
            List.of("limitId"), List.of(EduWorkflowStep.VALIDATE, EduWorkflowStep.AUTHORIZE, EduWorkflowStep.SCOPE, EduWorkflowStep.DEDUPE, EduWorkflowStep.VERSION_CHECK, EduWorkflowStep.MUTATE, EduWorkflowStep.COMMIT, EduWorkflowStep.RECONCILE, EduWorkflowStep.AUDIT, EduWorkflowStep.OBSERVE), Set.of(EduFailurePoint.BEFORE_COMMIT, EduFailurePoint.AFTER_COMMIT),
            true, true, false, false, false, false, 3, "EDU-DEV-04"));
    }
    @Override public String implementationPackage() { return "com.cpf.reference.online.concurrency.optimisticlock"; }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-04", EduConsumerType.JDBC_COMMAND, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "VERSION_CONFLICT", "cpf-reference REF DB business record contract",
                "POST /api/reference/edu-capabilities/EDU-DEV-04/executions", "", 60, List.of("limitId"));
    }
