...
public final class EduDev27Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-27", EduConsumerType.HTTP, "cpf-reference",
                "/external/27", "UNKNOWN_RESULT", "cpf-reference counterparty simulator HTTP contract",
                "POST /api/reference/edu-capabilities/EDU-DEV-27/executions", "cpf.edu.counterparty.base-url", 60, List.of("payload", "endpointAlias", "institutionRequestId"));
    }
    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "SOAP·XML 외부기관 연계와 Fault 처리");
