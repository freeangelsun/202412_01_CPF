...
public final class EduDev30Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev30Handler() {
        super(new EduCapabilityDefinition(
            "EDU-DEV-30", "Object Storage 보존·버전·법적 보류", EduCapabilityKind.ONLINE, "cpf-reference", "CPF_REFERENCE_DEVELOPER",
            ...
            true, true, false, false, false, false, 3, "EDU-DEV-30"));
    }
    @Override public String implementationPackage() { return "com.cpf.reference.online.file.objectstorage"; }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-30", EduConsumerType.FILE, "cpf-reference",
                "cpf-reference EDU file store", "DELETED", "cpf-reference safe file/checksum contract",
                "POST /api/reference/edu-capabilities/EDU-DEV-30/executions", "cpf.edu.business-file-root", 120, List.of("objectKey", "versionId", "retentionUntil", "legalHold", "fileName", "contentLength", "checksum"));
    }
