...
public final class EduDev26Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev26Handler() {
        super(new EduCapabilityDefinition(
            "EDU-DEV-26", "SFTP 수신·송신·완료 파일 원자 처리", EduCapabilityKind.ONLINE, "cpf-reference", "CPF_REFERENCE_DEVELOPER",
            ...
            true, false, false, true, false, false, 5, "EDU-DEV-26"));
    }
    @Override public String implementationPackage() { return "com.cpf.reference.online.file.sftp"; }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-26", EduConsumerType.FILE, "cpf-reference",
                "cpf-reference EDU file store", "ARCHIVED", "cpf-reference safe file/checksum contract",
                "POST /api/reference/edu-capabilities/EDU-DEV-26/executions", "cpf.edu.business-file-root", 120, List.of("remotePath", "filePattern", "expectedChecksum", "partnerId", "fileName", "contentLength", "checksum"));
    }
