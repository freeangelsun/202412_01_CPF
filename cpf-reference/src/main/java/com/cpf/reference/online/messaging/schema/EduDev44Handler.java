...
public final class EduDev44Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-44", EduConsumerType.OUTBOX, "cpf-reference",
                "CPF_EDU_OUTBOX", "QUARANTINED", "cpf-reference durable outbox/inbox contract",
                "POST /api/reference/edu-capabilities/EDU-DEV-44/executions", "", 60, List.of("schemaVersion", "eventType", "payload", "destination", "messageKey"));
    }
    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "Event Schema 진화·호환성·Dead Letter");
