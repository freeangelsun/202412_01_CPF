...
public final class EduDev31Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-31", EduConsumerType.OUTBOX, "cpf-reference",
                "CPF_EDU_OUTBOX", "FAILED", "cpf-reference durable outbox/inbox contract",
                "POST /api/reference/edu-capabilities/EDU-DEV-31/executions", "", 60, List.of("recipientId", "templateId", "channels", "locale", "consentVersion", "destination", "messageKey"));
    }
    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "다중 채널 알림 선호·재시도·대체 채널");
