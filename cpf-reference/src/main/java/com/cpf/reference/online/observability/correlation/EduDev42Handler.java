...
public final class EduDev42Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev42Handler() {
        super(new EduCapabilityDefinition(
            "EDU-DEV-42", "로그·Metric·Trace 상관관계와 Sampling", EduCapabilityKind.ONLINE, "cpf-reference", "CPF_REFERENCE_DEVELOPER",
            ...
            true, true, false, false, false, false, 3, "EDU-DEV-42"));
    }
    @Override public String implementationPackage() { return "com.cpf.reference.online.observability.correlation"; }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-42", EduConsumerType.JDBC_COMMAND, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "METRIC_RECORDED", "cpf-reference REF DB business record contract",
                "POST /api/reference/edu-capabilities/EDU-DEV-42/executions", "", 60, List.of("transactionId", "traceparent"));
    }
