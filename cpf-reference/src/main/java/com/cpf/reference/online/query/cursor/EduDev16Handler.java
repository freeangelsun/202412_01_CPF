...
public final class EduDev16Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev16Handler() {
        super(new EduCapabilityDefinition(
            "EDU-DEV-16", "대용량 목록 검색·정렬·Cursor Paging", EduCapabilityKind.ONLINE, "cpf-reference", "CPF_REFERENCE_DEVELOPER",
            List.of("pageSize", "cursor", "organizationId"), List.of(EduWorkflowStep.VALIDATE, EduWorkflowStep.AUTHORIZE, EduWorkflowStep.SCOPE, EduWorkflowStep.DEDUPE, EduWorkflowStep.READ_SNAPSHOT, EduWorkflowStep.PROTECT, EduWorkflowStep.RECONCILE, EduWorkflowStep.AUDIT, EduWorkflowStep.OBSERVE), Set.of(EduFailurePoint.TIMEOUT, EduFailurePoint.RESPONSE_LOST, EduFailurePoint.PARTIAL_TARGET_FAILURE, EduFailurePoint.PROCESS_KILL),
            true, false, false, false, false, false, 3, "EDU-DEV-16"));
    }
    @Override public String implementationPackage() { return "com.cpf.reference.online.query.cursor"; }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-16", EduConsumerType.JDBC_QUERY, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "PAGE_RETURNED", "cpf-reference REF DB business record contract",
                "POST /api/reference/edu-capabilities/EDU-DEV-16/executions", "", 60, List.of("pageSize", "cursor", "organizationId"));
    }
