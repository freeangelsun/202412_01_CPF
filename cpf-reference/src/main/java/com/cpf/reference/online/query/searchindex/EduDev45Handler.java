...
public final class EduDev45Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev45Handler() {
        super(new EduCapabilityDefinition(
            "EDU-DEV-45", "조회 모델·검색색인 Eventual Consistency", EduCapabilityKind.ONLINE, "cpf-reference", "CPF_REFERENCE_DEVELOPER",
            ...
            true, true, false, false, false, false, 3, "EDU-DEV-45"));
    }
    @Override public String implementationPackage() { return "com.cpf.reference.online.query.searchindex"; }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-45", EduConsumerType.JDBC_QUERY, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "REINDEXED", "cpf-reference REF DB business record contract",
                "POST /api/reference/edu-capabilities/EDU-DEV-45/executions", "", 60, List.of("aggregateId", "eventOffset", "indexVersion", "organizationId", "pageSize", "destination", "messageKey"));
    }
