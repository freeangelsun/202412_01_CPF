...
public final class EduDev22Handler extends AbstractEduCapabilityHandler {
    ...
    public EduDev22Handler() {
        super(new EduCapabilityDefinition(
            "EDU-DEV-22", "서비스 간 Saga 보상·수동 확정", EduCapabilityKind.ONLINE, "cpf-reference", "CPF_REFERENCE_DEVELOPER",
            ...
            true, true, false, true, true, false, 5, "EDU-DEV-22"));
    }
    @Override public String implementationPackage() { return "com.cpf.reference.online.workflow.saga"; }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-DEV-22", EduConsumerType.OUTBOX, "cpf-reference",
                "CPF_EDU_OUTBOX", "UNKNOWN_RESULT", "cpf-reference durable outbox/inbox contract",
                "POST /api/reference/edu-capabilities/EDU-DEV-22/executions", "", 60, List.of("sagaId", "orderId", "amount", "steps", "timeoutBudget"));
    }
