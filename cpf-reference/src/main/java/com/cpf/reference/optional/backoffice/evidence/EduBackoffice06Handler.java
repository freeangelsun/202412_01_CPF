...
public final class EduBackoffice06Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BZA-06", EduConsumerType.JDBC_COMMAND, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "CANCELLED", "cpf-reference REF DB backoffice/operations contract",
                "POST /api/reference/edu-capabilities/EDU-BZA-06/executions", "cpf.reference.features.backoffice.enabled", 60, List.of("approvalId", "attachmentId", "notificationId", "fileName", "contentLength", "checksum", "destination", "messageKey"));
    }
