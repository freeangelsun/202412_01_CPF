...
public final class EduBackoffice01Handler extends AbstractEduCapabilityHandler {
    ...
    public EduBackoffice01Handler() {
        super(new EduCapabilityDefinition(
            "EDU-BZA-01", "조직·직원·발령·기준일", EduCapabilityKind.BACKOFFICE, "cpf-reference", "CPF_REFERENCE_BACKOFFICE_OPERATOR",
            List.of("organizationId", "employeeId", "effectiveFrom", "to", "businessDate", "timezone"), List.of(EduWorkflowStep.VALIDATE, EduWorkflowStep.AUTHORIZE, EduWorkflowStep.SCOPE, EduWorkflowStep.DEDUPE, EduWorkflowStep.VERSION_CHECK, EduWorkflowStep.PROTECT, EduWorkflowStep.MUTATE, EduWorkflowStep.COMMIT, EduWorkflowStep.RECONCILE, EduWorkflowStep.AUDIT, EduWorkflowStep.OBSERVE), Set.of(EduFailurePoint.BEFORE_COMMIT, EduFailurePoint.AFTER_COMMIT),
            true, true, false, false, false, false, 3, "EDU-BZA-01"));
    }
    @Override public String implementationPackage() { return "com.cpf.reference.optional.backoffice.organization"; }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BZA-01", EduConsumerType.JDBC_COMMAND, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "CANCELLED", "cpf-reference REF DB backoffice/operations contract",
                "POST /api/reference/edu-capabilities/EDU-BZA-01/executions", "cpf.reference.features.backoffice.enabled", 60, List.of("organizationId", "employeeId", "effectiveFrom", "to", "businessDate", "timezone"));
    }
