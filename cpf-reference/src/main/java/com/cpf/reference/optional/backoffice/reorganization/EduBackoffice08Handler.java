...
public final class EduBackoffice08Handler extends AbstractEduCapabilityHandler {
    ...
    public EduBackoffice08Handler() {
        super(new EduCapabilityDefinition(
            "EDU-BZA-08", "조직 개편·기준일·과거 이력 유지", EduCapabilityKind.BACKOFFICE, "cpf-reference", "CPF_REFERENCE_BACKOFFICE_OPERATOR",
            List.of("orgChanges", "effectiveDate", "reason", "businessDate", "timezone"), List.of(EduWorkflowStep.VALIDATE, EduWorkflowStep.AUTHORIZE, EduWorkflowStep.SCOPE, EduWorkflowStep.DEDUPE, EduWorkflowStep.VERSION_CHECK, EduWorkflowStep.PROTECT, EduWorkflowStep.MUTATE, EduWorkflowStep.COMMIT, EduWorkflowStep.RECONCILE, EduWorkflowStep.AUDIT, EduWorkflowStep.OBSERVE), Set.of(EduFailurePoint.BEFORE_COMMIT, EduFailurePoint.AFTER_COMMIT, EduFailurePoint.PARTIAL_TARGET_FAILURE),
            true, true, false, false, false, false, 3, "EDU-BZA-08"));
    }
    @Override public String implementationPackage() { return "com.cpf.reference.optional.backoffice.reorganization"; }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BZA-08", EduConsumerType.JDBC_COMMAND, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "EFFECTIVE", "cpf-reference REF DB backoffice/operations contract",
                "POST /api/reference/edu-capabilities/EDU-BZA-08/executions", "cpf.reference.features.backoffice.enabled", 60, List.of("orgChanges", "effectiveDate", "reason", "businessDate", "timezone"));
    }
