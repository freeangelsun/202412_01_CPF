...
public final class EduBackoffice14Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-BZA-14", EduConsumerType.JDBC_COMMAND, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "COMPENSATED", "cpf-reference REF DB backoffice/operations contract",
                "POST /api/reference/edu-capabilities/EDU-BZA-14/executions", "cpf.reference.features.backoffice.enabled", 60, List.of("approvalId", "businessOperationId", "approvalPolicyId"));
    }
