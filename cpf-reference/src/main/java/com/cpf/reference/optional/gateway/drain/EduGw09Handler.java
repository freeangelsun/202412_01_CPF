...
public final class EduGw09Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-GW-09", EduConsumerType.REFERENCE_GATEWAY, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "TRANSFORMING", "cpf-reference REF Gateway simulator + refDB contract",
                "POST /api/reference/edu-capabilities/EDU-GW-09/executions", "cpf.reference.features.gateway.enabled", 60, List.of("routeId", "rewriteRule", "headerPolicy"));
    }
    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "Header 정리·경로·요청·응답 변환");
