...
public final class EduGw12Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-GW-12", EduConsumerType.REFERENCE_GATEWAY, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "CONSISTENT", "cpf-reference REF Gateway simulator + refDB contract",
                "POST /api/reference/edu-capabilities/EDU-GW-12/executions", "cpf.reference.features.gateway.enabled", 60, List.of("packageVersion", "checksum", "instanceIds", "ownerInstanceId"));
    }
