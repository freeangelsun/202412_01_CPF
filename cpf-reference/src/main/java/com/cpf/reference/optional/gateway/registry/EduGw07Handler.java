...
public final class EduGw07Handler extends AbstractEduCapabilityHandler {
    ...
    public EduGw07Handler() {
        super(new EduCapabilityDefinition(
            "EDU-GW-07", "Service Discovery·Target Failover·복귀", EduCapabilityKind.GATEWAY, "cpf-reference", "CPF_REFERENCE_GATEWAY_OPERATOR",
            ...
            true, true, false, true, false, false, 5, "EDU-GW-07"));
    }
    @Override public String implementationPackage() { return "com.cpf.reference.optional.gateway.registry"; }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-GW-07", EduConsumerType.REFERENCE_GATEWAY, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "ACTIVE", "cpf-reference REF Gateway simulator + refDB contract",
                "POST /api/reference/edu-capabilities/EDU-GW-07/executions", "cpf.reference.features.gateway.enabled", 60, List.of("serviceId", "healthPolicy", "warmup", "routeId", "targetGroup"));
    }
