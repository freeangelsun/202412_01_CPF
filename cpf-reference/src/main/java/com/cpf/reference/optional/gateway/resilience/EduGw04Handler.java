 ...
 */
public final class EduGw04Handler extends AbstractEduCapabilityHandler {
    ...
    private static final List<String> EXCEPTION_SCENARIOS = List.of("Connect Timeout", "Read Timeout", "5xx", "Circuit Open", "Queue Full");
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-GW-04", EduConsumerType.REFERENCE_GATEWAY, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "ROLLED_BACK", "cpf-reference REF Gateway simulator + refDB contract",
                "POST /api/reference/edu-capabilities/EDU-GW-04/executions", "cpf.reference.features.gateway.enabled", 60, List.of("connect", "read", "retry", "circuit", "bulkhead"));
    }
    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "Timeout·Retry·Circuit Breaker·Bulkhead");
