 ...
 */
public final class EduGw02Handler extends AbstractEduCapabilityHandler {
    ...
    private static final List<String> EXCEPTION_SCENARIOS = List.of("Route 중복", "Path 변수 불일치", "금지 Header", "잘못된 Target");
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-GW-02", EduConsumerType.REFERENCE_GATEWAY, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "ROLLED_BACK", "cpf-reference REF Gateway simulator + refDB contract",
                "POST /api/reference/edu-capabilities/EDU-GW-02/executions", "cpf.reference.features.gateway.enabled", 60, List.of("host", "path", "method", "apiVersion", "targetGroup", "routeId"));
    }
    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "Route·Predicate·Path Rewrite");
