...
public final class EduAdm05Handler extends AbstractEduCapabilityHandler {
    ...
    public EduAdm05Handler() {
        super(new EduCapabilityDefinition(
            "EDU-ADM-05", "비동기 작업·응답 유실", EduCapabilityKind.OPERATIONS, "cpf-reference", "CPF_REFERENCE_PLATFORM_OPERATOR",
            ...
            true, true, false, true, false, false, 5, "EDU-ADM-05"));
    }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-ADM-05", EduConsumerType.JDBC_COMMAND, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "RECONCILED", "cpf-reference REF DB backoffice/operations contract",
                "POST /api/reference/edu-capabilities/EDU-ADM-05/executions", "cpf.reference.features.operations.enabled", 60, List.of("businessId", "approvalId"));
    }
