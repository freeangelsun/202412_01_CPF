...
/**
 * EDU-ADM-15 is intentionally non-executable.
 ...
 */
public final class EduAdm15Handler {
    public static final EduAdmRedirectMetadata REDIRECT = new EduAdmRedirectMetadata(
            "EDU-ADM-15", "PRODUCT_ADM", "cpf-admin", "CPF_ADM_OPERATOR", false);

    private EduAdm15Handler() { }
}
