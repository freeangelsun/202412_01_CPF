...
public final class EduAdm07Handler extends AbstractEduCapabilityHandler {
    ...
    public EduAdm07Handler() {
        super(new EduCapabilityDefinition(
            "EDU-ADM-07", "고객 전용 화면 추가의 마지막 선택", EduCapabilityKind.OPERATIONS, "cpf-reference", "CPF_REFERENCE_PLATFORM_OPERATOR",
            ...
            true, true, false, false, false, false, 3, "EDU-ADM-07"));
    }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-ADM-07", EduConsumerType.JDBC_COMMAND, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "RECONCILED", "cpf-reference REF DB backoffice/operations contract",
                "POST /api/reference/edu-capabilities/EDU-ADM-07/executions", "cpf.reference.features.operations.enabled", 60, List.of("businessId", "approvalId"));
    }
