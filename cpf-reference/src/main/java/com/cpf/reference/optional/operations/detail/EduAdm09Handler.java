...
/**
 * EDU-ADM-09 is intentionally non-executable.
 ...
 */
public final class EduAdm09Handler {
    public static final EduAdmRedirectMetadata REDIRECT = new EduAdmRedirectMetadata(
            "EDU-ADM-09", "MERGE_EDU", "cpf-reference:merged-edu", "CPF_ADM_OPERATOR", false);

    private EduAdm09Handler() { }
}
