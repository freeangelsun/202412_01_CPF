...
public final class EduAdm09Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-ADM-09", EduConsumerType.JDBC_QUERY, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "ABORTED", "cpf-reference REF DB backoffice/operations contract",
                "POST /api/reference/edu-capabilities/EDU-ADM-09/executions", "cpf.reference.features.operations.enabled", 60, List.of("resourceId", "action", "reason"));
    }
