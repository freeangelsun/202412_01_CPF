...
/**
 * EDU-ADM-16 is intentionally non-executable.
 ...
 */
public final class EduAdm16Handler {
    public static final EduAdmRedirectMetadata REDIRECT = new EduAdmRedirectMetadata(
            "EDU-ADM-16", "PRODUCT_ADM", "cpf-admin", "CPF_ADM_OPERATOR", false);

    private EduAdm16Handler() { }
}
