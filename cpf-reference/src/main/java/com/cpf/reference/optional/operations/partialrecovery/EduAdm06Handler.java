...
public final class EduAdm06Handler extends AbstractEduCapabilityHandler {
    ...
    public EduAdm06Handler() {
        super(new EduCapabilityDefinition(
            "EDU-ADM-06", "부분 성공·대상별 복구", EduCapabilityKind.OPERATIONS, "cpf-reference", "CPF_REFERENCE_PLATFORM_OPERATOR",
    ...
    @Override public String implementationPackage() { return "com.cpf.reference.optional.operations.partialrecovery"; }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-ADM-06", EduConsumerType.JDBC_COMMAND, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "RECONCILED", "cpf-reference REF DB backoffice/operations contract",
                "POST /api/reference/edu-capabilities/EDU-ADM-06/executions", "cpf.reference.features.operations.enabled", 60, List.of("businessId", "approvalId"));
    }
