...
public final class EduAdm02Handler extends AbstractEduCapabilityHandler {
    ...
    public EduAdm02Handler() {
        super(new EduCapabilityDefinition(
            "EDU-ADM-02", "고객 업무 조회 연동", EduCapabilityKind.OPERATIONS, "cpf-reference", "CPF_REFERENCE_PLATFORM_OPERATOR",
            ...
            true, false, false, false, false, false, 3, "EDU-ADM-02"));
    }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-ADM-02", EduConsumerType.JDBC_QUERY, "cpf-reference",
                "CPF_EDU_BUSINESS_RECORD", "RECONCILED", "cpf-reference REF DB backoffice/operations contract",
                "POST /api/reference/edu-capabilities/EDU-ADM-02/executions", "cpf.reference.features.operations.enabled", 60, List.of("businessId", "approvalId"));
    }
