...
/**
 * EDU-ADM-08 is intentionally non-executable.
 ...
 */
public final class EduAdm08Handler {
    public static final EduAdmRedirectMetadata REDIRECT = new EduAdmRedirectMetadata(
            "EDU-ADM-08", "PRODUCT_ADM", "cpf-admin", "CPF_ADM_OPERATOR", false);

    private EduAdm08Handler() { }
}
