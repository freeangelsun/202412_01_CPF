...
/**
 * EDU-ADM-17 is intentionally non-executable.
 ...
 */
public final class EduAdm17Handler {
    public static final EduAdmRedirectMetadata REDIRECT = new EduAdmRedirectMetadata(
            "EDU-ADM-17", "PRODUCT_ADM", "cpf-admin", "CPF_ADM_OPERATOR", false);

    private EduAdm17Handler() { }
}
