...
/**
 * EDU-ADM-14 is intentionally non-executable.
 ...
 */
public final class EduAdm14Handler {
    public static final EduAdmRedirectMetadata REDIRECT = new EduAdmRedirectMetadata(
            "EDU-ADM-14", "PRODUCT_ADM", "cpf-admin", "CPF_ADM_OPERATOR", false);

    private EduAdm14Handler() { }
}
