...
public final class EduOps09Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-09", EduConsumerType.PROCESS, "cpf-reference",
                ...
                "POST /api/reference/edu-capabilities/EDU-OPS-09/executions", "cpf.repository-root", 600, List.of("configVersion", "checksum", "targets"));
    }
