...
public final class EduOps07Handler extends AbstractEduCapabilityHandler {
    ...
    @Override protected void validateBusinessInput(EduExecutionCommand command) {
        super.validateBusinessInput(command);
                requireLongRange(command, "batchSize", 1L, 1000000L);
        requireLongRange(command, "maxUnavailable", 1L, 1000L);
    }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-07", EduConsumerType.PROCESS, "cpf-reference",
                "cpf-reference/src/main/scripts/edu/invoke-reference-edu.ps1", "ACTIVE", "cpf-reference allowlisted platform operation simulation contract",
                "POST /api/reference/edu-capabilities/EDU-OPS-07/executions", "cpf.repository-root", 600, List.of("artifactVersion", "batchSize", "maxUnavailable", "sessionId"));
    }
