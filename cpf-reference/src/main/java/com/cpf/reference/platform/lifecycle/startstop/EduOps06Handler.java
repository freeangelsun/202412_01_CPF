...
public final class EduOps06Handler extends AbstractEduCapabilityHandler {
    ...
    @Override protected void validateBusinessInput(EduExecutionCommand command) {
        super.validateBusinessInput(command);
                requireLongRange(command, "timeout", 1L, 1000L);
    }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-06", EduConsumerType.PROCESS, "cpf-reference",
                "cpf-reference/src/main/scripts/edu/invoke-reference-edu.ps1", "STOPPED", "cpf-reference allowlisted platform operation simulation contract",
                "POST /api/reference/edu-capabilities/EDU-OPS-06/executions", "cpf.repository-root", 600, List.of("targetServices", "timeout", "drainPolicy"));
    }
