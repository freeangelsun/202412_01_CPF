...
public final class EduOps05Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-05", EduConsumerType.PROCESS, "cpf-reference",
                ...
                "POST /api/reference/edu-capabilities/EDU-OPS-05/executions", "cpf.repository-root", 600, List.of("topicSpec", "aclSpec", "consumerGroup", "destination", "messageKey"));
    }
    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "Kafka Topic·ACL·Consumer Group Lifecycle");
