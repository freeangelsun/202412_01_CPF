...
public final class EduOps10Handler extends AbstractEduCapabilityHandler {
    ...
    @Override protected void validateBusinessInput(EduExecutionCommand command) {
        super.validateBusinessInput(command);
                requireLongRange(command, "queueSize", 1L, 1000000L);
    }
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-10", EduConsumerType.PROCESS, "cpf-reference",
                ...
                "POST /api/reference/edu-capabilities/EDU-OPS-10/executions", "cpf.repository-root", 600, List.of("collectorEndpoints", "queueSize", "retention"));
    }
