...
public final class EduOps11Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-11", EduConsumerType.PROCESS, "cpf-reference",
                "cpf-reference/src/main/scripts/edu/invoke-reference-edu.ps1", "RECONCILED", "cpf-reference allowlisted platform operation simulation contract",
                "POST /api/reference/edu-capabilities/EDU-OPS-11/executions", "cpf.repository-root", 600, List.of("backupSetId", "targetTime", "restoreTarget", "endpointAlias", "institutionRequestId", "recoveryPoint"));
    }
