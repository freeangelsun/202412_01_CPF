...
public final class EduOps12Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-12", EduConsumerType.PROCESS, "cpf-reference",
                "cpf-reference/src/main/scripts/edu/invoke-reference-edu.ps1", "FAILING_BACK", "cpf-reference allowlisted platform operation simulation contract",
                "POST /api/reference/edu-capabilities/EDU-OPS-12/executions", "cpf.repository-root", 600, List.of("incidentId", "primary", "dr", "fencingEpoch", "backupSetId", "recoveryPoint"));
    }
