...
public final class EduOps03Handler extends AbstractEduCapabilityHandler {
    ...
    @Override public EduConsumerBinding consumerBinding() {
        return new EduConsumerBinding(
                "EDU-OPS-03", EduConsumerType.PROCESS, "cpf-reference",
                "cpf-reference/src/main/scripts/edu/invoke-reference-edu.ps1", "RETIRED", "cpf-reference allowlisted platform operation simulation contract",
                "POST /api/reference/edu-capabilities/EDU-OPS-03/executions", "cpf.repository-root", 600, List.of("secretRef", "certChain", "activationAt", "secretAlias"));
    }
    @Override public Map<String,Object> buildBusinessResult(EduExecutionCommand command,long fencingToken) {
        Map<String,Object> result = new LinkedHashMap<>(super.buildBusinessResult(command,fencingToken));
        result.put("scenarioTitle", "Secret·Certificate 배포·교체·만료 대응");
