...
@Tag(name = "XYZ Reference 06. Fixed Length", description = "Fixed length telegram parse and write samples")
public class XyzTelegramEducationController extends cpf.xyz.common.base.XyzBaseController {
