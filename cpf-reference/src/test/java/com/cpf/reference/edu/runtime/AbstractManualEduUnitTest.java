...
public abstract class AbstractManualEduUnitTest extends AbstractManualEduTestSupport {
    ...
    @Test void rejectsMissingRoleAndDataScope() {
        ...
        var noRole = new com.cpf.reference.edu.runtime.model.EduExecutionCommand(valid.businessKey(),
        ...
        assertThrows(com.cpf.reference.edu.runtime.application.EduAuthorizationException.class,
