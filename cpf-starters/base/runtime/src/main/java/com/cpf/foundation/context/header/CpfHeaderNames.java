...
public final class CpfHeaderNames {
    ...
    // Canonical online transaction System lineage. Exactly these five plus TRANSACTION_ID form the six-header protocol.
    ...
    // Optional Channel policy/context. These are not aliases for System Code and are not part of the Canonical 6.
