...
public final class JdbcCpfCommonManagementService implements CpfCommonManagementApi {
    ...
    private final CpfCommonCacheRefreshPublisher invalidation;
    ...
    public JdbcCpfCommonManagementService(@Qualifier("cpfCommonJdbcTemplate") JdbcTemplate cpfCommonJdbcTemplate, CpfCommonCacheRefreshPublisher invalidation, CpfCommonManagementAuditSink audit, ObjectProvider<CpfParameterValueCodec> parameterCodec) {
        this(cpfCommonJdbcTemplate, invalidation, audit, parameterCodec, Clock.systemUTC());
    }

    @org.springframework.beans.factory.annotation.Autowired
    public JdbcCpfCommonManagementService(@Qualifier("cpfCommonJdbcTemplate") JdbcTemplate cpfCommonJdbcTemplate, CpfCommonCacheRefreshPublisher invalidation, CpfCommonManagementAuditSink audit, ObjectProvider<CpfParameterValueCodec> parameterCodec, Clock clock) {
    ...
    @Override
    @Transactional(transactionManager = CpfCommonJdbcAutoConfiguration.TX_MANAGER_BEAN)
