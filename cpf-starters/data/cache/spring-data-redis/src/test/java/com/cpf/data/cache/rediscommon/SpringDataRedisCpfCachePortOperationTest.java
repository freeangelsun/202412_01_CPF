...
class SpringDataRedisCpfCachePortOperationTest {
    ...
    void putGetEvictAndMetricsUseTheSharedRuntime() {
        ...
        var port = new SpringDataRedisCpfCachePort("REDIS", template, properties, true);
    ...
    void missAndInvalidPayloadLimitsAreFailClosed() {
        ...
        var port = new SpringDataRedisCpfCachePort("VALKEY", template, properties, true);
        var key = new CpfCacheKey("member", "42", "tenant-a");
