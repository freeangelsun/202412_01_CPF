...
/**
 * JDBC/MyBatis 등 Class 기반 DAO 계층의 Framework 공통 확장점입니다.
 *
 * <p>Domain Common Base가 이 타입을 확장하고 Business DAO가 Domain Base를 확장합니다.
 * JPA에는 DAO 계층을 강제하지 않으며 Context, Validation, statement/paging guard를 제공합니다.</p>
 */
public abstract class CpfBaseDao {
    protected CpfBaseDao() { }
    ...
    /** requireRule 작업을 CPF 표준 계약에 따라 수행한다. */
