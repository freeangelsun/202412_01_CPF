...
/** CpfLockStore 타입의 역할과 책임을 정의하며 CPF 계약 경계를 명확히 유지한다. */
public interface CpfLockStore {
    ...
    /** CapacitySnapshot 타입의 역할과 책임을 정의하며 CPF 계약 경계를 명확히 유지한다. */
    record CapacitySnapshot(
        ...
        /** unbounded 작업을 CPF 표준 계약에 따라 수행한다. */
    ...
    final class ResourceExhaustedException extends RuntimeException {
        ...
        /** ResourceExhaustedException 작업을 CPF 표준 계약에 따라 수행한다. */
    ...
    record StoredLock(
        ...
        /** StoredLock 작업을 CPF 표준 계약에 따라 수행한다. */
        public StoredLock(
                String key,
                String ownerId,
                String requestId,
    ...
    /** UpdateResult 타입의 역할과 책임을 정의하며 CPF 계약 경계를 명확히 유지한다. */
