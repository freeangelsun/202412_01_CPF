...
public final class CpfXaCrashRecoveryHarness {
    ...
    private static void runPrepareKill(XADataSource ds1, XADataSource ds2, String txId, String sql, Path marker) throws Exception {
        ...
        try (XAConnection xa1 = ds1.getXAConnection(); XAConnection xa2 = ds2.getXAConnection();
             Connection c1 = xa1.getConnection(); Connection c2 = xa2.getConnection()) {
    ...
    private static long count(XADataSource dataSource, String sql, String txId) throws Exception {
        try (XAConnection xa = dataSource.getXAConnection(); Connection c = xa.getConnection(); PreparedStatement ps = c.prepareStatement(sql)) {
            ps.setString(1, txId);
