...
import com.cpf.integration.api.servicecall.CpfServiceCallAttempt;
import com.cpf.integration.api.servicecall.CpfServiceCallAttemptObserver;
import com.cpf.integration.api.servicecall.CpfServiceCallCommand;
import com.cpf.integration.api.servicecall.CpfServiceCallExecutor;
import com.cpf.integration.api.servicecall.CpfServiceCallOutcome;
import com.cpf.integration.api.servicecall.CpfServiceCallTarget;
...
public final class CpfServiceCallExecutorAdapter implements CpfServiceCallExecutor {
    ...
    public <T> CpfServiceCallOutcome<T> invoke(
        ...
        return new CpfServiceCallOutcome<>(result.status(),toPublic(result.target()),result.responseBody(),result.httpStatus(),
                ...
                result.recoveryId(),result.recoveryAction());
    }
