...
public class CpfSoapAutoConfiguration {
 ...
 CpfSoapClient cpfSoapClient(WebServiceTemplateBuilder builder,CpfSoapProperties p,CpfContextExecutionFactory contextFactory){
   ...
   return new CpfSoapClient(builder.httpMessageSenderFactory(WebServiceMessageSenderFactory.http(settings)).build(),contextFactory);
 }
}
