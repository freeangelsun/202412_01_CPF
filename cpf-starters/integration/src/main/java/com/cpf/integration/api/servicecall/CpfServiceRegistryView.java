...
public final class CpfServiceRegistryView {
    ...
    /** Endpoint 타입의 역할과 책임을 정의하며 CPF 계약 경계를 명확히 유지한다. */
    ...
    /** Instance 타입의 역할과 책임을 정의하며 CPF 계약 경계를 명확히 유지한다. */
    ...
    /** RoutingPolicy 타입의 역할과 책임을 정의하며 CPF 계약 경계를 명확히 유지한다. */
    ...
    /** CircuitState 타입의 역할과 책임을 정의하며 CPF 계약 경계를 명확히 유지한다. */
    ...
    /** CallHistory 타입의 역할과 책임을 정의하며 CPF 계약 경계를 명확히 유지한다. */
    ...
    /** MutationResult 타입의 역할과 책임을 정의하며 CPF 계약 경계를 명확히 유지한다. */
    public record MutationResult(
        ...
        /** applied 작업을 CPF 표준 계약에 따라 수행한다. */
        ...
        /** stateChanged 작업을 CPF 표준 계약에 따라 수행한다. */
    ...
    /** ContractException 타입의 역할과 책임을 정의하며 CPF 계약 경계를 명확히 유지한다. */
