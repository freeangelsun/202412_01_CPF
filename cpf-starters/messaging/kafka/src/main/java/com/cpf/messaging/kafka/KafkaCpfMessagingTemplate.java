...
public final class KafkaCpfMessagingTemplate implements CpfMessagingTemplate {
    ...
    public KafkaCpfMessagingTemplate(KafkaTemplate<String, byte[]> kafkaTemplate, CpfKafkaProperties properties) {
        this(kafkaTemplate, properties, Clock.systemUTC());
    }
    KafkaCpfMessagingTemplate(KafkaTemplate<String, byte[]> kafkaTemplate, CpfKafkaProperties properties, Clock clock) {
