...
public final class KafkaCpfBrokerClient implements CpfBrokerClient {
    ...
    public CpfBrokerPublishResult enqueue(CpfBrokerPublishRequest request) {
        ...
        catch(ExecutionException e){throw unknown("Kafka broker rejected or failed the publish",e.getCause()==null?e:e.getCause());}
        catch(RuntimeException e){throw unknown("Kafka publish failed before acknowledgement",e);}
    }
