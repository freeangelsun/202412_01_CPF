...
final class CpfFeatureFlagRuntimeChangeApplier implements CpfRuntimeChangeApplier {
    ...
    private Command parse(CpfRuntimeDelivery delivery) {
        ...
        String flagKeyValue = delivery.payload().textStrict("flagKey", null);
        ...
        boolean enabled = delivery.payload().booleanStrict("enabled", false);

        String reasonValue = delivery.payload().textStrict(
