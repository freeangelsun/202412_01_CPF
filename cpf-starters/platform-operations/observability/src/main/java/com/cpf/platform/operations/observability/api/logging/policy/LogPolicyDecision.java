...
import static com.cpf.platform.operations.observability.api.logging.policy.LogCaptureMode.CaptureArea;
...
public record LogPolicyDecision(
    ...
    /** cpfDefault 작업을 CPF 표준 계약에 따라 수행한다. */
    ...
    /** withSource 작업을 CPF 표준 계약에 따라 수행한다. */
    ...
    /** requestBodySave 작업을 CPF 표준 계약에 따라 수행한다. */
    ...
    /** normalizeLevel 작업을 CPF 표준 계약에 따라 수행한다. */
    ...
    /** normalizeTargetId 작업을 CPF 표준 계약에 따라 수행한다. */
