...
import com.cpf.platform.operations.observability.api.logging.CpfDynamicLogLevelCommandOperations;
import com.cpf.platform.operations.observability.api.logging.CpfDynamicLogLevelOperations;
import com.cpf.platform.operations.observability.api.logging.CpfDynamicLogLevelRuntimeStatus;
import com.cpf.platform.operations.observability.api.logging.CpfLogLevel;
import com.cpf.platform.operations.observability.api.logging.DynamicLogLevelAuditRecord;
...
import com.cpf.platform.operations.observability.api.logging.DynamicLogLevelRuntimeSnapshot;
import com.cpf.platform.operations.observability.api.logging.DynamicLogLevelVersionConflictException;
...
public final class DefaultCpfDynamicLogLevelOperations implements
    ...
    private String maskedReason(String value) {
        return CpfMaskingRuntime.truncate(
                CpfMaskingRuntime.mask(requiredText(value, "reason", MAX_REASON_LENGTH)),
                MAX_REASON_LENGTH);
    }
