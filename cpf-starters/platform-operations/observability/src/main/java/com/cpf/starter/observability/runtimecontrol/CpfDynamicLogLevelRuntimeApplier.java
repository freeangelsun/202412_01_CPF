...
public final class CpfDynamicLogLevelRuntimeApplier implements CpfRuntimeChangeApplier {
    ...
    public CpfDynamicLogLevelRuntimeApplier(DynamicTransactionLogLevelService service, Clock clock) {
    ...
    public CpfRuntimeApplyResult apply(CpfRuntimeDelivery delivery) {
        ...
        try {
            for (JsonNode item : rawRules) {
                ...
                if (!expiresAt.isAfter(createdAt) || !expiresAt.isAfter(LocalDateTime.now(clock))) continue;
