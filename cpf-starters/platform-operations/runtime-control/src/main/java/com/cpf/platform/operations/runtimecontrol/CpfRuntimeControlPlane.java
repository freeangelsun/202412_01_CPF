...
public interface CpfRuntimeControlPlane extends CpfRuntimeAgentPort {
    ...
    CpfManagedServerPage findManagedServers(String environment, String status, String keyword, int page, int size);
    ...
    CpfRuntimeInventoryPage findRuntimeInventory(String environment, String capability, String status, String keyword, int page, int size);
}
