...
public final class CpfNetworkEndpointPolicy {
    ...
    /** CpfNetworkEndpointPolicy 작업을 CPF 표준 계약에 따라 수행한다. */
    ...
    /** secureDefault 작업을 CPF 표준 계약에 따라 수행한다. */
    ...
    /** validateResolvedAddresses 작업을 CPF 표준 계약에 따라 수행한다. */
    ...
    /** contains 작업을 CPF 표준 계약에 따라 수행한다. */
    ...
    /** EndpointDecision 타입의 역할과 책임을 정의하며 CPF 계약 경계를 명확히 유지한다. */
    ...
    /** Address 타입의 역할과 책임을 정의하며 CPF 계약 경계를 명확히 유지한다. */
    public record Address(byte[] bytes) {
        ...
        /** canonical 작업을 CPF 표준 계약에 따라 수행한다. */
        ...
        /** specialUseDenied 작업을 CPF 표준 계약에 따라 수행한다. */
        ...
        @Deprecated
        /** blockedByDefault 작업을 CPF 표준 계약에 따라 수행한다. */
