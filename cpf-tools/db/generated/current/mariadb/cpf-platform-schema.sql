...
CREATE INDEX IX_CPF_FIELD_ENC_TOKEN ON CPF_FIELD_ENCRYPTION_LEDGER (FIELD_NAME, SEARCH_TOKEN(64));
...
ALTER TABLE SPRING_SESSION COMMENT = '서버 세션 저장소(Spring Session JDBC 표준 규격)';
...
ALTER TABLE SPRING_SESSION_ATTRIBUTES COMMENT = '서버 세션 속성 저장소(Spring Session JDBC 표준 규격)';
