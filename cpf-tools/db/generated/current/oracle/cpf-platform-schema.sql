...
CREATE TABLE BAT_RECONCILIATION_AUDIT (
    reconciliation_audit_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    ...
    reason_text VARCHAR2(1000 CHAR) NOT NULL,
    idempotency_key VARCHAR2(200 CHAR) NOT NULL,
    expected_attempt NUMBER(10) NULL,
    expected_version NUMBER(19) NULL,
    created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
...
CREATE TABLE CPF_MASKING_POLICY_COMMAND (
    ...
    result_reason VARCHAR2(1000 CHAR) NULL,
...
CREATE TABLE CPF_TRANSACTION_SEGMENT (
    ...
    transaction_id CHAR(34 CHAR) NOT NULL,
    execution_id VARCHAR2(160 CHAR) NULL,
...
CREATE TABLE SPRING_SESSION (
    ...
    PRINCIPAL_NAME VARCHAR2(100 CHAR) NULL,
