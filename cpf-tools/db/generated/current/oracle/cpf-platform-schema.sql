...
CREATE TABLE CPF_TRANSACTION_LINEAGE (
    ...
    channel_code VARCHAR2(64 CHAR) NULL,
...
CREATE TABLE CPF_TRANSACTION_LOG (
    ...
    CLIENT_APP_ID VARCHAR2(80 CHAR) NULL,
    CLIENT_VERSION VARCHAR2(50 CHAR) NULL,
    CALLER_SERVICE VARCHAR2(120 CHAR) NULL,
    ...
    ORIGINAL_CHANNEL_CODE VARCHAR2(20 CHAR) NULL,
    CHANNEL_CODE VARCHAR2(20 CHAR) NULL,
    ...
    SERVER_INSTANCE_ID VARCHAR2(160 CHAR) NULL,
...
CREATE TABLE CPF_TRANSACTION_SEGMENT (
    ...
    channel_code VARCHAR2(30 CHAR) NULL,
    original_channel_code VARCHAR2(30 CHAR) NULL,
    client_app_id VARCHAR2(100 CHAR) NULL,
    caller_service VARCHAR2(100 CHAR) NULL,
