...
CREATE TABLE OPS_CHANNEL_EXECUTION_POLICY (
    ...
    operation_id VARCHAR2(160 CHAR) NOT NULL,
    caller_channel VARCHAR2(30 CHAR) NOT NULL,
    ...
    CONSTRAINT fk_ops_channel_execution_policy_caller FOREIGN KEY (caller_channel) REFERENCES OPS_CHANNEL_REGISTRY (channel_code)
);
...
COMMENT ON COLUMN OPS_CHANNEL_EXECUTION_POLICY.caller_channel IS '직전 Hop의 Canonical Caller Channel 또는 ANY';
