...
USING (SELECT 'ANY' AS channel_code, '전체 채널' AS channel_name, 'SYSTEM' AS channel_type, 'INTERNAL' AS trust_level, 'N' AS client_channel_yn, 'Y' AS internal_channel_yn, 'N' AS authentication_required_yn, 'N' AS signature_required_yn, 'Y' AS active_yn, '정책 와일드카드 전용 채널' AS description, 0 AS policy_version, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
...
MERGE INTO CMN_CODE tgt
USING (SELECT (SELECT code_id FROM (SELECT code_id FROM CMN_CODE WHERE code_key = 'CODE_GROUP' AND code_value = 'MODULE') p) AS parent_id, 'MODULE' AS code_key, 'BZA' AS code_value, '업무 백오피스 서비스' AS description, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.code_key=src.code_key AND tgt.code_value=src.code_value)
WHEN MATCHED THEN UPDATE SET tgt.parent_id=src.parent_id, tgt.description=src.description, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (parent_id, code_key, code_value, description, created_by, updated_by) VALUES (src.parent_id, src.code_key, src.code_value, src.description, src.created_by, src.updated_by);
...
MERGE INTO CMN_MESSAGE tgt
USING (SELECT 'MBZA000000' AS message_code, 'ko' AS locale, 'FIXED' AS message_format_type, '성공' AS external_message, 'BZA 요청이 정상 처리되었습니다.' AS internal_message, 0 AS parameter_count, NULL AS parameter_sample, 'BZA 성공 메시지' AS description, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.message_code=src.message_code AND tgt.locale=src.locale)
WHEN MATCHED THEN UPDATE SET tgt.message_format_type=src.message_format_type, tgt.external_message=src.external_message, tgt.internal_message=src.internal_message, tgt.parameter_count=src.parameter_count, tgt.parameter_sample=src.parameter_sample, tgt.description=src.description, tgt.use_yn='Y', tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (message_code, locale, message_format_type, external_message, internal_message, parameter_count, parameter_sample, description, created_by, updated_by) VALUES (src.message_code, src.locale, src.message_format_type, src.external_message, src.internal_message, src.parameter_count, src.parameter_sample, src.description, src.created_by, src.updated_by);

MERGE INTO CMN_MESSAGE tgt
USING (SELECT 'MBZA010001' AS message_code, 'ko' AS locale, 'INDEXED' AS message_format_type, '업무 요청 값이 올바르지 않습니다.' AS external_message, 'BZA 입력값 검증에 실패했습니다. field={0}' AS internal_message, 1 AS parameter_count, '["field"]' AS parameter_sample, 'BZA 입력값 오류 메시지' AS description, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.message_code=src.message_code AND tgt.locale=src.locale)
WHEN MATCHED THEN UPDATE SET tgt.message_format_type=src.message_format_type, tgt.external_message=src.external_message, tgt.internal_message=src.internal_message, tgt.parameter_count=src.parameter_count, tgt.parameter_sample=src.parameter_sample, tgt.description=src.description, tgt.use_yn='Y', tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (message_code, locale, message_format_type, external_message, internal_message, parameter_count, parameter_sample, description, created_by, updated_by) VALUES (src.message_code, src.locale, src.message_format_type, src.external_message, src.internal_message, src.parameter_count, src.parameter_sample, src.description, src.created_by, src.updated_by);

MERGE INTO CMN_MESSAGE tgt
USING (SELECT 'MBZA010002' AS message_code, 'ko' AS locale, 'FIXED' AS message_format_type, '처리 권한이 없습니다.' AS external_message, 'BZA 서버 권한 검사에 실패했습니다.' AS internal_message, 0 AS parameter_count, NULL AS parameter_sample, 'BZA 권한 오류 메시지' AS description, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.message_code=src.message_code AND tgt.locale=src.locale)
WHEN MATCHED THEN UPDATE SET tgt.message_format_type=src.message_format_type, tgt.external_message=src.external_message, tgt.internal_message=src.internal_message, tgt.parameter_count=src.parameter_count, tgt.parameter_sample=src.parameter_sample, tgt.description=src.description, tgt.use_yn='Y', tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (message_code, locale, message_format_type, external_message, internal_message, parameter_count, parameter_sample, description, created_by, updated_by) VALUES (src.message_code, src.locale, src.message_format_type, src.external_message, src.internal_message, src.parameter_count, src.parameter_sample, src.description, src.created_by, src.updated_by);
...
MERGE INTO CMN_RESPONSE_CODE tgt
USING (SELECT 'SBZA000000' AS response_code, 'MBZA000000' AS message_code, 'S' AS result_type, 'BZA' AS module_id, '00' AS response_group, '0000' AS sequence_no, 200 AS http_status, 'BZA 성공' AS description, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.response_code=src.response_code)
WHEN MATCHED THEN UPDATE SET tgt.message_code=src.message_code, tgt.result_type=src.result_type, tgt.module_id=src.module_id, tgt.response_group=src.response_group, tgt.sequence_no=src.sequence_no, tgt.http_status=src.http_status, tgt.description=src.description, tgt.use_yn='Y', tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (response_code, message_code, result_type, module_id, response_group, sequence_no, http_status, description, created_by, updated_by) VALUES (src.response_code, src.message_code, src.result_type, src.module_id, src.response_group, src.sequence_no, src.http_status, src.description, src.created_by, src.updated_by);

MERGE INTO CMN_RESPONSE_CODE tgt
USING (SELECT 'EBZA010001' AS response_code, 'MBZA010001' AS message_code, 'E' AS result_type, 'BZA' AS module_id, '01' AS response_group, '0001' AS sequence_no, 400 AS http_status, 'BZA 입력값 오류' AS description, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.response_code=src.response_code)
WHEN MATCHED THEN UPDATE SET tgt.message_code=src.message_code, tgt.result_type=src.result_type, tgt.module_id=src.module_id, tgt.response_group=src.response_group, tgt.sequence_no=src.sequence_no, tgt.http_status=src.http_status, tgt.description=src.description, tgt.use_yn='Y', tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (response_code, message_code, result_type, module_id, response_group, sequence_no, http_status, description, created_by, updated_by) VALUES (src.response_code, src.message_code, src.result_type, src.module_id, src.response_group, src.sequence_no, src.http_status, src.description, src.created_by, src.updated_by);

MERGE INTO CMN_RESPONSE_CODE tgt
USING (SELECT 'EBZA010002' AS response_code, 'MBZA010002' AS message_code, 'E' AS result_type, 'BZA' AS module_id, '01' AS response_group, '0002' AS sequence_no, 403 AS http_status, 'BZA 권한 오류' AS description, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.response_code=src.response_code)
WHEN MATCHED THEN UPDATE SET tgt.message_code=src.message_code, tgt.result_type=src.result_type, tgt.module_id=src.module_id, tgt.response_group=src.response_group, tgt.sequence_no=src.sequence_no, tgt.http_status=src.http_status, tgt.description=src.description, tgt.use_yn='Y', tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (response_code, message_code, result_type, module_id, response_group, sequence_no, http_status, description, created_by, updated_by) VALUES (src.response_code, src.message_code, src.result_type, src.module_id, src.response_group, src.sequence_no, src.http_status, src.description, src.created_by, src.updated_by);
...
MERGE INTO CMN_PARAMETER tgt
USING (SELECT 'CPF.BZA.SECURITY.MAX_LOGIN_FAIL_COUNT' AS config_key, '5' AS config_value, 'NUMBER' AS config_type, 'BZA 로그인 실패 잠금 기준' AS description, 'N' AS encrypted_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.config_key=src.config_key)
WHEN MATCHED THEN UPDATE SET tgt.config_value=src.config_value, tgt.config_type=src.config_type, tgt.description=src.description, tgt.encrypted_yn=src.encrypted_yn, tgt.use_yn='Y', tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (config_key, config_value, config_type, description, encrypted_yn, created_by, updated_by) VALUES (src.config_key, src.config_value, src.config_type, src.description, src.encrypted_yn, src.created_by, src.updated_by);

MERGE INTO CMN_PARAMETER tgt
USING (SELECT 'CPF.BZA.SECURITY.ACCESS_TOKEN_TTL_SECONDS' AS config_key, '600' AS config_value, 'NUMBER' AS config_type, 'BZA Access Token TTL' AS description, 'N' AS encrypted_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.config_key=src.config_key)
WHEN MATCHED THEN UPDATE SET tgt.config_value=src.config_value, tgt.config_type=src.config_type, tgt.description=src.description, tgt.encrypted_yn=src.encrypted_yn, tgt.use_yn='Y', tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (config_key, config_value, config_type, description, encrypted_yn, created_by, updated_by) VALUES (src.config_key, src.config_value, src.config_type, src.description, src.encrypted_yn, src.created_by, src.updated_by);

MERGE INTO CMN_PARAMETER tgt
USING (SELECT 'CPF.BZA.SECURITY.REFRESH_TOKEN_TTL_SECONDS' AS config_key, '7200' AS config_value, 'NUMBER' AS config_type, 'BZA Refresh Token TTL' AS description, 'N' AS encrypted_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.config_key=src.config_key)
WHEN MATCHED THEN UPDATE SET tgt.config_value=src.config_value, tgt.config_type=src.config_type, tgt.description=src.description, tgt.encrypted_yn=src.encrypted_yn, tgt.use_yn='Y', tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (config_key, config_value, config_type, description, encrypted_yn, created_by, updated_by) VALUES (src.config_key, src.config_value, src.config_type, src.description, src.encrypted_yn, src.created_by, src.updated_by);
...
MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-ADM-01-1001' AS legacy_execution_id, 'OBZAAD1001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-ADM-03-1002' AS legacy_execution_id, 'OBZAAD1002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-APR-01-0001' AS legacy_execution_id, 'OBZAAP0001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-APR-01-0003' AS legacy_execution_id, 'OBZAAP0003' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-APR-02-0002' AS legacy_execution_id, 'OBZAAP0002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-APR-05-0004' AS legacy_execution_id, 'OBZAAP0004' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-ATC-01-0001' AS legacy_execution_id, 'OBZAAT0001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-ATC-02-0002' AS legacy_execution_id, 'OBZAAT0002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-ATC-DL-0003' AS legacy_execution_id, 'OBZAAT0003' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-AUD-01-0001' AS legacy_execution_id, 'OBZAUD0001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-AUT-01-0004' AS legacy_execution_id, 'OBZAAU0004' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-AUT-01-0005' AS legacy_execution_id, 'OBZAAU0005' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-AUT-01-0007' AS legacy_execution_id, 'OBZAAU0007' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-AUT-02-0001' AS legacy_execution_id, 'OBZAAU0001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-AUT-02-0002' AS legacy_execution_id, 'OBZAAU0002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-AUT-02-0003' AS legacy_execution_id, 'OBZAAU0003' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-AUT-03-0006' AS legacy_execution_id, 'OBZAAU0006' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-AUT-04-0008' AS legacy_execution_id, 'OBZAAU0008' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-CUS-01-1001' AS legacy_execution_id, 'OBZACU1001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-DSH-01-0001' AS legacy_execution_id, 'OBZADS0001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-DWN-01-0002' AS legacy_execution_id, 'OBZADW0002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-DWN-01-1001' AS legacy_execution_id, 'OBZADW1001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-EMP-01-0001' AS legacy_execution_id, 'OBZAEM0001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-EMP-03-0002' AS legacy_execution_id, 'OBZAEM0002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-MNU-01-1001' AS legacy_execution_id, 'OBZAMN1001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-MNU-03-1002' AS legacy_execution_id, 'OBZAMN1002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-MSK-02-1001' AS legacy_execution_id, 'OBZAMS1001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-NTF-01-0001' AS legacy_execution_id, 'OBZANT0001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-NTF-02-0002' AS legacy_execution_id, 'OBZANT0002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-NTF-03-0003' AS legacy_execution_id, 'OBZANT0003' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-ORD-01-1001' AS legacy_execution_id, 'OBZAOR1001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-ORG-01-0001' AS legacy_execution_id, 'OBZAOR0001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-ORG-03-0002' AS legacy_execution_id, 'OBZAOR0002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-PER-01-0002' AS legacy_execution_id, 'OBZAPE0002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-PER-01-0003' AS legacy_execution_id, 'OBZAPE0003' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-PER-01-1001' AS legacy_execution_id, 'OBZAPE1001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-PER-02-0004' AS legacy_execution_id, 'OBZAPE0004' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-PER-03-1002' AS legacy_execution_id, 'OBZAPE1002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-PRD-01-1001' AS legacy_execution_id, 'OBZAPR1001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-ROL-01-1001' AS legacy_execution_id, 'OBZARO1001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-ROL-03-1002' AS legacy_execution_id, 'OBZARO1002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-SCH-01-0001' AS legacy_execution_id, 'OBZASC0001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-SCH-03-0002' AS legacy_execution_id, 'OBZASC0002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-SCH-04-0003' AS legacy_execution_id, 'OBZASC0003' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-SET-01-1001' AS legacy_execution_id, 'OBZASE1001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-USR-QY-0000' AS legacy_execution_id, 'OBZAUS0001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);

MERGE INTO CPF_STANDARD_EXECUTION_ALIAS tgt
USING (SELECT 'OBZA-USR-QY-0001' AS legacy_execution_id, 'OBZAUS0002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual) src
ON (tgt.legacy_execution_id=src.legacy_execution_id)
WHEN MATCHED THEN UPDATE SET tgt.standard_execution_id=src.standard_execution_id, tgt.migration_reason=src.migration_reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (legacy_execution_id, standard_execution_id, migration_reason, created_by, updated_by) VALUES (src.legacy_execution_id, src.standard_execution_id, src.migration_reason, src.created_by, src.updated_by);
...
MERGE INTO ADM_BUTTON tgt
USING (SELECT 'REMOTE_LOG_BUNDLE_DOWNLOAD' AS BUTTON_ID, 'REMOTE_LOG' AS MENU_ID, 'DOWNLOAD' AS ACTION_CODE, '동기 로그 ZIP 다운로드' AS BUTTON_NAME, 'POST' AS HTTP_METHOD, '/adm/api/remote-logs/bundles' AS API_PATTERN, 30 AS SORT_ORDER, 'Y' AS USE_YN, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.BUTTON_ID=src.BUTTON_ID)
WHEN MATCHED THEN UPDATE SET tgt.MENU_ID=src.MENU_ID, tgt.ACTION_CODE=src.ACTION_CODE, tgt.BUTTON_NAME=src.BUTTON_NAME, tgt.HTTP_METHOD=src.HTTP_METHOD, tgt.API_PATTERN=src.API_PATTERN, tgt.SORT_ORDER=src.SORT_ORDER, tgt.USE_YN=src.USE_YN, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (BUTTON_ID, MENU_ID, ACTION_CODE, BUTTON_NAME, HTTP_METHOD, API_PATTERN, SORT_ORDER, USE_YN, created_by, updated_by) VALUES (src.BUTTON_ID, src.MENU_ID, src.ACTION_CODE, src.BUTTON_NAME, src.HTTP_METHOD, src.API_PATTERN, src.SORT_ORDER, src.USE_YN, src.created_by, src.updated_by);
...
MERGE INTO ADM_BUTTON tgt
USING (SELECT 'REMOTE_LOG_JOB_DOWNLOAD' AS BUTTON_ID, 'REMOTE_LOG' AS MENU_ID, 'DOWNLOAD' AS ACTION_CODE, '비동기 로그 ZIP 다운로드' AS BUTTON_NAME, 'GET' AS HTTP_METHOD, '/adm/api/remote-logs/bundle-jobs/*/download' AS API_PATTERN, 60 AS SORT_ORDER, 'Y' AS USE_YN, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.BUTTON_ID=src.BUTTON_ID)
WHEN MATCHED THEN UPDATE SET tgt.MENU_ID=src.MENU_ID, tgt.ACTION_CODE=src.ACTION_CODE, tgt.BUTTON_NAME=src.BUTTON_NAME, tgt.HTTP_METHOD=src.HTTP_METHOD, tgt.API_PATTERN=src.API_PATTERN, tgt.SORT_ORDER=src.SORT_ORDER, tgt.USE_YN=src.USE_YN, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (BUTTON_ID, MENU_ID, ACTION_CODE, BUTTON_NAME, HTTP_METHOD, API_PATTERN, SORT_ORDER, USE_YN, created_by, updated_by) VALUES (src.BUTTON_ID, src.MENU_ID, src.ACTION_CODE, src.BUTTON_NAME, src.HTTP_METHOD, src.API_PATTERN, src.SORT_ORDER, src.USE_YN, src.created_by, src.updated_by);
...
MERGE INTO BAT_JOB tgt
USING (SELECT 'CPF_EDU_CHUNK_JOB' AS job_id, 'CPF 교육 Chunk Job' AS job_name, 'CHUNK' AS job_type, '대용량 읽기/처리/쓰기 샘플을 위한 Chunk Job입니다.' AS description, 'Y' AS restartable_yn, 'Y' AS use_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.job_id=src.job_id)
WHEN MATCHED THEN UPDATE SET tgt.job_name=src.job_name, tgt.job_type=src.job_type, tgt.description=src.description, tgt.restartable_yn=src.restartable_yn, tgt.use_yn=src.use_yn, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (job_id, job_name, job_type, description, restartable_yn, use_yn, created_by, updated_by) VALUES (src.job_id, src.job_name, src.job_type, src.description, src.restartable_yn, src.use_yn, src.created_by, src.updated_by);

MERGE INTO BAT_JOB tgt
USING (SELECT 'CPF_EDU_RETRY_JOB' AS job_id, 'CPF 교육 재처리 Job' AS job_name, 'RETRY' AS job_type, '실패 재처리와 checkpoint/restart 교육을 위한 Job입니다.' AS description, 'Y' AS restartable_yn, 'Y' AS use_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.job_id=src.job_id)
WHEN MATCHED THEN UPDATE SET tgt.job_name=src.job_name, tgt.job_type=src.job_type, tgt.description=src.description, tgt.restartable_yn=src.restartable_yn, tgt.use_yn=src.use_yn, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (job_id, job_name, job_type, description, restartable_yn, use_yn, created_by, updated_by) VALUES (src.job_id, src.job_name, src.job_type, src.description, src.restartable_yn, src.use_yn, src.created_by, src.updated_by);
...
MERGE INTO BAT_SCHEDULE tgt
USING (SELECT 'CPF_EDU_CHUNK_DAILY' AS schedule_id, 'CPF_EDU_CHUNK_JOB' AS job_id, '0 30 2 * * *' AS cron_expression, 'DEFAULT' AS calendar_id, 'Y' AS business_day_only_yn, 'SKIP' AS holiday_policy, '02:30:00' AS available_start_time, '05:30:00' AS available_end_time, 'D+0' AS run_date_pattern, 'Asia/Seoul' AS timezone, 'N' AS enabled_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.schedule_id=src.schedule_id)
WHEN MATCHED THEN UPDATE SET tgt.job_id=src.job_id, tgt.cron_expression=src.cron_expression, tgt.calendar_id=src.calendar_id, tgt.business_day_only_yn=src.business_day_only_yn, tgt.holiday_policy=src.holiday_policy, tgt.available_start_time=src.available_start_time, tgt.available_end_time=src.available_end_time, tgt.run_date_pattern=src.run_date_pattern, tgt.timezone=src.timezone, tgt.enabled_yn=src.enabled_yn, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (schedule_id, job_id, cron_expression, calendar_id, business_day_only_yn, holiday_policy, available_start_time, available_end_time, run_date_pattern, timezone, enabled_yn, created_by, updated_by) VALUES (src.schedule_id, src.job_id, src.cron_expression, src.calendar_id, src.business_day_only_yn, src.holiday_policy, src.available_start_time, src.available_end_time, src.run_date_pattern, src.timezone, src.enabled_yn, src.created_by, src.updated_by);

MERGE INTO BAT_JOB_RELATION tgt
USING (SELECT 'CPF_EDU_CHUNK_JOB' AS job_id, 'CPF_EDU_TASKLET_JOB' AS related_job_id, 'PREDECESSOR' AS relation_type, 'COMPLETED' AS trigger_condition, 'COMPLETED' AS required_status, 10 AS sort_order, 'Y' AS use_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
...
MERGE INTO BAT_JOB_RELATION tgt
USING (SELECT 'CPF_EDU_TASKLET_JOB' AS job_id, 'CPF_EDU_CHUNK_JOB' AS related_job_id, 'TRIGGER' AS relation_type, 'COMPLETED' AS trigger_condition, 'COMPLETED' AS required_status, 20 AS sort_order, 'Y' AS use_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.job_id=src.job_id AND tgt.related_job_id=src.related_job_id AND tgt.relation_type=src.relation_type)
WHEN MATCHED THEN UPDATE SET tgt.trigger_condition=src.trigger_condition, tgt.required_status=src.required_status, tgt.sort_order=src.sort_order, tgt.use_yn=src.use_yn, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (job_id, related_job_id, relation_type, trigger_condition, required_status, sort_order, use_yn, created_by, updated_by) VALUES (src.job_id, src.related_job_id, src.relation_type, src.trigger_condition, src.required_status, src.sort_order, src.use_yn, src.created_by, src.updated_by);
...
USING (SELECT 'DEFAULT' AS calendar_id, CURRENT_DATE AS business_date, 'Y' AS business_day_yn, 'BUSINESS' AS day_type, NULL AS institution_code, '로컬 smoke 검증용 기본 영업일' AS reason, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
...
MERGE INTO CMN_BUSINESS_CALENDAR_DAY tgt
USING (SELECT 'DEFAULT' AS calendar_id, DATE_ADD(CURRENT_DATE, INTERVAL 1 DAY) AS business_date, 'Y' AS business_day_yn, 'BUSINESS' AS day_type, NULL AS institution_code, '로컬 smoke 검증용 다음 영업일' AS reason, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.calendar_id=src.calendar_id AND tgt.business_date=src.business_date)
WHEN MATCHED THEN UPDATE SET tgt.business_day_yn=src.business_day_yn, tgt.day_type=src.day_type, tgt.institution_code=src.institution_code, tgt.reason=src.reason, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (calendar_id, business_date, business_day_yn, day_type, institution_code, reason, created_by, updated_by) VALUES (src.calendar_id, src.business_date, src.business_day_yn, src.day_type, src.institution_code, src.reason, src.created_by, src.updated_by);
...
USING (SELECT 'CPF_BAT_CENTER_CUT_JOB' AS center_cut_job_id, 'businessDatePattern' AS parameter_key, 'D+0' AS parameter_value, 'N' AS encrypted_yn, 'Y' AS use_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
...
MERGE INTO BAT_CENTER_CUT_PARAMETER tgt
USING (SELECT 'CPF_BAT_CENTER_CUT_JOB' AS center_cut_job_id, 'defaultLimit' AS parameter_key, '10' AS parameter_value, 'N' AS encrypted_yn, 'Y' AS use_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.center_cut_job_id=src.center_cut_job_id AND tgt.parameter_key=src.parameter_key)
WHEN MATCHED THEN UPDATE SET tgt.parameter_value=src.parameter_value, tgt.encrypted_yn=src.encrypted_yn, tgt.use_yn=src.use_yn, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (center_cut_job_id, parameter_key, parameter_value, encrypted_yn, use_yn, created_by, updated_by) VALUES (src.center_cut_job_id, src.parameter_key, src.parameter_value, src.encrypted_yn, src.use_yn, src.created_by, src.updated_by);

MERGE INTO OPS_SERVICE tgt
USING (SELECT 'BZA' AS service_id, '업무 백오피스 서비스' AS service_name, 'INTERNAL' AS service_type, 'BZA' AS owner_module_code, 'CPF 업무 운영 백오피스 서비스 호출 대상' AS description, 'Y' AS use_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.service_id=src.service_id)
...
MERGE INTO OPS_SERVICE_ENDPOINT tgt
USING (SELECT 'BZA_API' AS endpoint_code, 'BZA' AS service_id, 'BZA API Endpoint' AS endpoint_name, 'HTTP' AS endpoint_type, 'http://localhost:8091' AS base_url, '/api/bza' AS context_path, 3000 AS default_timeout_ms, 0 AS default_retry_count, 'Y' AS use_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.endpoint_code=src.endpoint_code)
...
MERGE INTO OPS_SERVICE_ENDPOINT tgt
USING (SELECT 'EDU_API' AS endpoint_code, 'EDU' AS service_id, 'EDU API Endpoint' AS endpoint_name, 'HTTP' AS endpoint_type, 'http://localhost:8099' AS base_url, '/education' AS context_path, 3000 AS default_timeout_ms, 0 AS default_retry_count, 'Y' AS use_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.endpoint_code=src.endpoint_code)
WHEN MATCHED THEN UPDATE SET tgt.service_id=src.service_id, tgt.endpoint_name=src.endpoint_name, tgt.endpoint_type=src.endpoint_type, tgt.base_url=src.base_url, tgt.context_path=src.context_path, tgt.default_timeout_ms=src.default_timeout_ms, tgt.default_retry_count=src.default_retry_count, tgt.use_yn=src.use_yn, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (endpoint_code, service_id, endpoint_name, endpoint_type, base_url, context_path, default_timeout_ms, default_retry_count, use_yn, created_by, updated_by) VALUES (src.endpoint_code, src.service_id, src.endpoint_name, src.endpoint_type, src.base_url, src.context_path, src.default_timeout_ms, src.default_retry_count, src.use_yn, src.created_by, src.updated_by);

MERGE INTO OPS_SERVICE_ENDPOINT tgt
USING (SELECT 'BAT_API' AS endpoint_code, 'BAT' AS service_id, 'BAT API Endpoint' AS endpoint_name, 'HTTP' AS endpoint_type, 'http://localhost:8093' AS base_url, '/bat' AS context_path, 5000 AS default_timeout_ms, 0 AS default_retry_count, 'Y' AS use_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.endpoint_code=src.endpoint_code)
WHEN MATCHED THEN UPDATE SET tgt.service_id=src.service_id, tgt.endpoint_name=src.endpoint_name, tgt.endpoint_type=src.endpoint_type, tgt.base_url=src.base_url, tgt.context_path=src.context_path, tgt.default_timeout_ms=src.default_timeout_ms, tgt.default_retry_count=src.default_retry_count, tgt.use_yn=src.use_yn, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (endpoint_code, service_id, endpoint_name, endpoint_type, base_url, context_path, default_timeout_ms, default_retry_count, use_yn, created_by, updated_by) VALUES (src.endpoint_code, src.service_id, src.endpoint_name, src.endpoint_type, src.base_url, src.context_path, src.default_timeout_ms, src.default_retry_count, src.use_yn, src.created_by, src.updated_by);

MERGE INTO OPS_SERVICE_ENDPOINT tgt
USING (SELECT 'ADM_API' AS endpoint_code, 'ADM' AS service_id, 'ADM API Endpoint' AS endpoint_name, 'HTTP' AS endpoint_type, 'http://localhost:8090' AS base_url, '/adm' AS context_path, 3000 AS default_timeout_ms, 0 AS default_retry_count, 'Y' AS use_yn, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.endpoint_code=src.endpoint_code)
WHEN MATCHED THEN UPDATE SET tgt.service_id=src.service_id, tgt.endpoint_name=src.endpoint_name, tgt.endpoint_type=src.endpoint_type, tgt.base_url=src.base_url, tgt.context_path=src.context_path, tgt.default_timeout_ms=src.default_timeout_ms, tgt.default_retry_count=src.default_retry_count, tgt.use_yn=src.use_yn, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (endpoint_code, service_id, endpoint_name, endpoint_type, base_url, context_path, default_timeout_ms, default_retry_count, use_yn, created_by, updated_by) VALUES (src.endpoint_code, src.service_id, src.endpoint_name, src.endpoint_type, src.base_url, src.context_path, src.default_timeout_ms, src.default_retry_count, src.use_yn, src.created_by, src.updated_by);
...
MERGE INTO OPS_SERVICE_INSTANCE tgt
USING (SELECT 'EDU-local-01' AS instance_id, 'EDU' AS service_id, 'EDU_API' AS endpoint_code, 'EDU local instance' AS instance_name, 'http://localhost:8099' AS base_url, 'localhost' AS host_name, 8099 AS port_no, 'UP' AS instance_status, 100 AS weight, 'Y' AS active_yn, CURRENT_TIMESTAMP(3) AS last_heartbeat_at, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.instance_id=src.instance_id)
WHEN MATCHED THEN UPDATE SET tgt.service_id=src.service_id, tgt.endpoint_code=src.endpoint_code, tgt.instance_name=src.instance_name, tgt.base_url=src.base_url, tgt.host_name=src.host_name, tgt.port_no=src.port_no, tgt.instance_status=src.instance_status, tgt.weight=src.weight, tgt.active_yn=src.active_yn, tgt.last_heartbeat_at=src.last_heartbeat_at, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (instance_id, service_id, endpoint_code, instance_name, base_url, host_name, port_no, instance_status, weight, active_yn, last_heartbeat_at, created_by, updated_by) VALUES (src.instance_id, src.service_id, src.endpoint_code, src.instance_name, src.base_url, src.host_name, src.port_no, src.instance_status, src.weight, src.active_yn, src.last_heartbeat_at, src.created_by, src.updated_by);

MERGE INTO OPS_SERVICE_INSTANCE tgt
USING (SELECT 'BAT-local-01' AS instance_id, 'BAT' AS service_id, 'BAT_API' AS endpoint_code, 'BAT local instance' AS instance_name, 'http://localhost:8093' AS base_url, 'localhost' AS host_name, 8093 AS port_no, 'UP' AS instance_status, 100 AS weight, 'Y' AS active_yn, CURRENT_TIMESTAMP(3) AS last_heartbeat_at, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.instance_id=src.instance_id)
WHEN MATCHED THEN UPDATE SET tgt.service_id=src.service_id, tgt.endpoint_code=src.endpoint_code, tgt.instance_name=src.instance_name, tgt.base_url=src.base_url, tgt.host_name=src.host_name, tgt.port_no=src.port_no, tgt.instance_status=src.instance_status, tgt.weight=src.weight, tgt.active_yn=src.active_yn, tgt.last_heartbeat_at=src.last_heartbeat_at, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (instance_id, service_id, endpoint_code, instance_name, base_url, host_name, port_no, instance_status, weight, active_yn, last_heartbeat_at, created_by, updated_by) VALUES (src.instance_id, src.service_id, src.endpoint_code, src.instance_name, src.base_url, src.host_name, src.port_no, src.instance_status, src.weight, src.active_yn, src.last_heartbeat_at, src.created_by, src.updated_by);

MERGE INTO OPS_SERVICE_INSTANCE tgt
USING (SELECT 'ADM-local-01' AS instance_id, 'ADM' AS service_id, 'ADM_API' AS endpoint_code, 'ADM local instance' AS instance_name, 'http://localhost:8090' AS base_url, 'localhost' AS host_name, 8090 AS port_no, 'UP' AS instance_status, 100 AS weight, 'Y' AS active_yn, CURRENT_TIMESTAMP(3) AS last_heartbeat_at, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.instance_id=src.instance_id)
WHEN MATCHED THEN UPDATE SET tgt.service_id=src.service_id, tgt.endpoint_code=src.endpoint_code, tgt.instance_name=src.instance_name, tgt.base_url=src.base_url, tgt.host_name=src.host_name, tgt.port_no=src.port_no, tgt.instance_status=src.instance_status, tgt.weight=src.weight, tgt.active_yn=src.active_yn, tgt.last_heartbeat_at=src.last_heartbeat_at, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (instance_id, service_id, endpoint_code, instance_name, base_url, host_name, port_no, instance_status, weight, active_yn, last_heartbeat_at, created_by, updated_by) VALUES (src.instance_id, src.service_id, src.endpoint_code, src.instance_name, src.base_url, src.host_name, src.port_no, src.instance_status, src.weight, src.active_yn, src.last_heartbeat_at, src.created_by, src.updated_by);

MERGE INTO OPS_SERVICE_ROUTING_POLICY tgt
USING (SELECT 'BZA' AS service_id, 'BZA_API' AS endpoint_code, 'PRIMARY' AS routing_mode, 'WEIGHT' AS load_balance_type, 'Y' AS failover_enabled_yn, 'Y' AS health_check_required_yn, 'Y' AS active_yn, 100 AS priority, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.service_id=src.service_id AND tgt.endpoint_code=src.endpoint_code AND tgt.priority=src.priority)
WHEN MATCHED THEN UPDATE SET tgt.routing_mode=src.routing_mode, tgt.load_balance_type=src.load_balance_type, tgt.failover_enabled_yn=src.failover_enabled_yn, tgt.health_check_required_yn=src.health_check_required_yn, tgt.active_yn=src.active_yn, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (service_id, endpoint_code, routing_mode, load_balance_type, failover_enabled_yn, health_check_required_yn, active_yn, priority, created_by, updated_by) VALUES (src.service_id, src.endpoint_code, src.routing_mode, src.load_balance_type, src.failover_enabled_yn, src.health_check_required_yn, src.active_yn, src.priority, src.created_by, src.updated_by);
...
USING (SELECT 'BZA' AS service_id, 'BZA_API' AS endpoint_code, 'BZA-local-01' AS instance_id, 'CLOSED' AS circuit_state, 0 AS failure_count, 0 AS success_count, CURRENT_TIMESTAMP(3) AS closed_at, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
...
MERGE INTO OPS_SERVICE_CIRCUIT_STATE tgt
USING (SELECT 'EDU' AS service_id, 'EDU_API' AS endpoint_code, 'EDU-local-01' AS instance_id, 'CLOSED' AS circuit_state, 0 AS failure_count, 0 AS success_count, CURRENT_TIMESTAMP(3) AS closed_at, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.service_id=src.service_id AND tgt.endpoint_code=src.endpoint_code AND tgt.instance_id=src.instance_id)
WHEN MATCHED THEN UPDATE SET tgt.circuit_state=src.circuit_state, tgt.failure_count=src.failure_count, tgt.success_count=src.success_count, tgt.closed_at=src.closed_at, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (service_id, endpoint_code, instance_id, circuit_state, failure_count, success_count, closed_at, created_by, updated_by) VALUES (src.service_id, src.endpoint_code, src.instance_id, src.circuit_state, src.failure_count, src.success_count, src.closed_at, src.created_by, src.updated_by);

MERGE INTO OPS_SERVICE_CIRCUIT_STATE tgt
USING (SELECT 'BAT' AS service_id, 'BAT_API' AS endpoint_code, 'BAT-local-01' AS instance_id, 'CLOSED' AS circuit_state, 0 AS failure_count, 0 AS success_count, CURRENT_TIMESTAMP(3) AS closed_at, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.service_id=src.service_id AND tgt.endpoint_code=src.endpoint_code AND tgt.instance_id=src.instance_id)
WHEN MATCHED THEN UPDATE SET tgt.circuit_state=src.circuit_state, tgt.failure_count=src.failure_count, tgt.success_count=src.success_count, tgt.closed_at=src.closed_at, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (service_id, endpoint_code, instance_id, circuit_state, failure_count, success_count, closed_at, created_by, updated_by) VALUES (src.service_id, src.endpoint_code, src.instance_id, src.circuit_state, src.failure_count, src.success_count, src.closed_at, src.created_by, src.updated_by);

MERGE INTO OPS_SERVICE_CIRCUIT_STATE tgt
USING (SELECT 'ADM' AS service_id, 'ADM_API' AS endpoint_code, 'ADM-local-01' AS instance_id, 'CLOSED' AS circuit_state, 0 AS failure_count, 0 AS success_count, CURRENT_TIMESTAMP(3) AS closed_at, 'SYSTEM' AS created_by, 'SYSTEM' AS updated_by FROM dual) src
ON (tgt.service_id=src.service_id AND tgt.endpoint_code=src.endpoint_code AND tgt.instance_id=src.instance_id)
WHEN MATCHED THEN UPDATE SET tgt.circuit_state=src.circuit_state, tgt.failure_count=src.failure_count, tgt.success_count=src.success_count, tgt.closed_at=src.closed_at, tgt.updated_by=src.updated_by, tgt.updated_at=CURRENT_TIMESTAMP
WHEN NOT MATCHED THEN INSERT (service_id, endpoint_code, instance_id, circuit_state, failure_count, success_count, closed_at, created_by, updated_by) VALUES (src.service_id, src.endpoint_code, src.instance_id, src.circuit_state, src.failure_count, src.success_count, src.closed_at, src.created_by, src.updated_by);
