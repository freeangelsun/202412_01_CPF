...
CREATE TABLE REF_CENTER_CUT_SAMPLE_TARGET (
    ...
    target_payload CLOB NULL,
    status_code VARCHAR2(30 CHAR) DEFAULT 'READY' NOT NULL,
    ...
    created_by VARCHAR2(100 CHAR) DEFAULT 'REF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'REF' NOT NULL,
...
CREATE TABLE REF_CMN_SAMPLE_ITEM (
    ...
    category_code VARCHAR2(30 CHAR) DEFAULT 'GENERAL' NOT NULL,
    status_code VARCHAR2(30 CHAR) DEFAULT 'ACTIVE' NOT NULL,
    searchable_text VARCHAR2(500 CHAR) NULL,
    owner_reference VARCHAR2(100 CHAR) NULL,
    sort_order NUMBER(19) DEFAULT 0 NOT NULL,
...
CREATE TABLE REF_SAMPLE_ITEM (
    ...
    deleted_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    transaction_id CHAR(34 CHAR) NULL,
    idempotency_key VARCHAR2(100 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) NOT NULL,
    created_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    updated_by VARCHAR2(100 CHAR) NOT NULL,
    updated_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE REF_CENTER_CUT_SAMPLE_RESULT (
    result_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    target_id VARCHAR2(80 CHAR) NOT NULL,
    center_cut_job_id VARCHAR2(100 CHAR) NOT NULL,
    business_key VARCHAR2(200 CHAR) NOT NULL,
...
CREATE OR REPLACE TRIGGER TRG_REF_CMN_SAMPLE_ITEM_TOUCH
BEFORE UPDATE ON REF_CMN_SAMPLE_ITEM
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
