...
CREATE TABLE CPF_TRANSACTION_LOG (
    ...
    CLIENT_APP_ID VARCHAR(80) NULL,
    CLIENT_VERSION VARCHAR(50) NULL,
    CALLER_SERVICE VARCHAR(120) NULL,
    ...
    SERVER_INSTANCE_ID VARCHAR(160) NULL,
...
CREATE TABLE CPF_TRANSACTION_SEGMENT (
    ...
    original_channel_code VARCHAR(30) NULL,
    client_app_id VARCHAR(100) NULL,
    caller_service VARCHAR(100) NULL,
