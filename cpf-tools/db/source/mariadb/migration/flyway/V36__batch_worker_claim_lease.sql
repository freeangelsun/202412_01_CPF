...
CREATE INDEX IF NOT EXISTS ix_cpf_batch_worker_control
    ON cpf_batch_worker (control_status, active_yn, last_heartbeat_at);
...
CREATE INDEX IF NOT EXISTS ix_cpf_batch_execution_claim
    ON cpf_batch_execution (execution_status, required_worker_version, required_capability, execution_id);
