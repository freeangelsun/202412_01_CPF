...
MEMBER_DOMAIN_BASE = ROOT / "cpf-member/online/src/main/java/member/base/MemberBaseService.java"
MEMBER_SERVICE = ROOT / "cpf-member/online/src/main/java/member/sample/service/SampleTransactionService.java"
