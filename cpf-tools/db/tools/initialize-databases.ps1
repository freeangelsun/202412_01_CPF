...
$platform = Join-Path $Root "cpf-tools/db/tools/initialize-cpf-database.ps1"
$generated = Join-Path $Root "cpf-tools/generator/tools/initialize-generated-domain-databases.ps1"
