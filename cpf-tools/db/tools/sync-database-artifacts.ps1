...
Invoke-CpfDatabaseArtifactStep "sync-platform-seed-currentization.ps1" "Platform seed currentization generation failed." @("-Apply")
Invoke-CpfDatabaseArtifactStep "generate-migration-checksums.ps1" "DB migration checksum generation failed." @("-Apply")
Invoke-CpfDatabaseArtifactStep "sync-platform-seed-currentization.ps1" "Platform seed currentization checksum/parity check failed."
