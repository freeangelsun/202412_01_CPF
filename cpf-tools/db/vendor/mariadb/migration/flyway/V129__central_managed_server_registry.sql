...
CREATE TABLE OPS_MANAGED_SERVER (
    ...
    registered_at DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
ALTER TABLE OPS_SERVICE_INSTANCE
    ADD COLUMN managed_server_id VARCHAR(80) NULL,
    ADD COLUMN system_code VARCHAR(16) NULL,
    ADD COLUMN application_name VARCHAR(150) NULL,
    ADD COLUMN application_role VARCHAR(80) NULL,
    ADD COLUMN runtime_hostname VARCHAR(200) NULL,
    ADD COLUMN process_id VARCHAR(80) NULL,
    ADD COLUMN java_version VARCHAR(80) NULL,
    ADD COLUMN cpf_version VARCHAR(80) NULL,
    ADD COLUMN application_version VARCHAR(100) NULL,
    ADD COLUMN started_at DATETIME(3) NULL;
ALTER TABLE OPS_SERVICE_INSTANCE
    ADD CONSTRAINT fk_cpf_service_instance_managed_server FOREIGN KEY (managed_server_id) REFERENCES OPS_MANAGED_SERVER (managed_server_id);
