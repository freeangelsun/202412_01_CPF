...
ON DUPLICATE KEY UPDATE parent_menu_id=VALUES(parent_menu_id),menu_name=VALUES(menu_name),menu_path=VALUES(menu_path),sort_order=VALUES(sort_order),use_yn=VALUES(use_yn),updated_by='SYSTEM',updated_at=CURRENT_TIMESTAMP;
