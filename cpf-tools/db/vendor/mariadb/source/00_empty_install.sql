...
ALTER TABLE OPS_MANAGED_SERVER COMMENT = 'Central managed server master; runtime instances reference this stable identity';
...
ALTER TABLE OPS_TRANSACTION_SUBJECT COMMENT = 'Protected Subject identifier와 transactionId의 Canonical 검색 관계';
