...
CREATE TABLE IF NOT EXISTS adm_approval_request (
    APPROVAL_REQUEST_ID BIGINT AUTO_INCREMENT NOT NULL COMMENT '위험조치 승인 요청 순번',
...
CREATE TABLE IF NOT EXISTS adm_approval_history (
    APPROVAL_HISTORY_ID BIGINT AUTO_INCREMENT NOT NULL COMMENT '승인 이력 순번',
    APPROVAL_REQUEST_ID BIGINT NOT NULL COMMENT '승인 요청 순번',
...
CREATE TABLE IF NOT EXISTS adm_approval_participant (
    APPROVAL_PARTICIPANT_ID BIGINT AUTO_INCREMENT NOT NULL COMMENT '승인 참여자 순번',
    APPROVAL_REQUEST_ID BIGINT NOT NULL COMMENT '승인 요청 순번',
    STEP_NO INT NOT NULL COMMENT '승인 단계',
...
CREATE TABLE IF NOT EXISTS adm_audit_delivery (
    DELIVERY_ID BIGINT AUTO_INCREMENT NOT NULL COMMENT 'Delivery identifier',
...
CREATE TABLE IF NOT EXISTS adm_audit_log (
    AUDIT_ID BIGINT AUTO_INCREMENT NOT NULL COMMENT '감사 로그 순번',
...
CREATE TABLE IF NOT EXISTS adm_download_audit_log (
    DOWNLOAD_ID BIGINT AUTO_INCREMENT NOT NULL COMMENT '다운로드 감사 로그 순번',
...
CREATE TABLE IF NOT EXISTS adm_incident (
    incident_id BIGINT AUTO_INCREMENT NOT NULL COMMENT 'Incident identifier',
...
CREATE TABLE IF NOT EXISTS adm_ip_allowlist (
    ALLOW_ID BIGINT AUTO_INCREMENT NOT NULL COMMENT 'IP 허용 목록 순번',
...
CREATE TABLE IF NOT EXISTS adm_maintenance_action (
    action_id BIGINT AUTO_INCREMENT NOT NULL COMMENT 'Action identifier',
...
CREATE TABLE IF NOT EXISTS adm_password_history (
    HISTORY_ID BIGINT AUTO_INCREMENT NOT NULL COMMENT '비밀번호 이력 순번',
    OPERATOR_ID VARCHAR(50) NOT NULL COMMENT '운영자 ID',
