...
-- authority=cpf-tools/db/generated/current/oracle/cpf-platform-schema.sql
...
CREATE TABLE ADM_APPROVAL_CAPABILITY_NONCE (
    ...
    CONSUMED_BY VARCHAR2(80 CHAR) NULL,
    created_by VARCHAR2(50 CHAR) DEFAULT 'ADM' NOT NULL,
    created_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    updated_by VARCHAR2(50 CHAR) DEFAULT 'ADM' NOT NULL,
...
CREATE TABLE ADM_APPROVAL_POLICY (
    ...
    BREAK_GLASS_ALLOWED_YN CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
...
CREATE TABLE ADM_AUDIT_DELIVERY (
    DELIVERY_ID NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    ...
    TARGET_TYPE VARCHAR2(100 CHAR) NULL,
    TARGET_ID VARCHAR2(255 CHAR) NULL,
    REASON VARCHAR2(1000 CHAR) NOT NULL,
    BEFORE_DATA CLOB NULL,
    AFTER_DATA CLOB NULL,
    DIFF_DATA CLOB NULL,
    CLIENT_IP VARCHAR2(64 CHAR) NULL,
    OPERATION_STATUS VARCHAR2(20 CHAR) DEFAULT 'REQUESTED' NOT NULL,
    DELIVERY_STATUS VARCHAR2(20 CHAR) DEFAULT 'PENDING' NOT NULL,
    ATTEMPT_COUNT NUMBER(10) DEFAULT 0 NOT NULL,
    MAX_ATTEMPTS NUMBER(10) DEFAULT 10 NOT NULL,
    NEXT_ATTEMPT_AT TIMESTAMP(3) NULL,
    LAST_ERROR VARCHAR2(1000 CHAR) NULL,
    AUDIT_ID NUMBER(19) NULL,
...
CREATE TABLE ADM_AUDIT_LOG (
    ...
    TRACE_ID VARCHAR2(80 CHAR) NULL,
    OPERATOR_ID VARCHAR2(50 CHAR) NOT NULL,
    MENU_ID VARCHAR2(50 CHAR) NULL,
    BUTTON_ID VARCHAR2(80 CHAR) NULL,
    ACTION_TYPE VARCHAR2(30 CHAR) NOT NULL,
    TARGET_TYPE VARCHAR2(50 CHAR) NULL,
    TARGET_ID VARCHAR2(100 CHAR) NULL,
    ...
    IMMUTABLE_YN CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    created_by VARCHAR2(50 CHAR) DEFAULT 'ADM' NOT NULL,
...
CREATE TABLE ADM_BREAK_GLASS_SESSION (
    ...
    close_reason VARCHAR2(1000 CHAR) NULL,
    post_review_status VARCHAR2(20 CHAR) DEFAULT 'PENDING' NOT NULL,
    reviewed_by VARCHAR2(100 CHAR) NULL,
    reviewed_at TIMESTAMP(3) NULL,
    review_reason VARCHAR2(1000 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) NOT NULL,
    created_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    updated_by VARCHAR2(100 CHAR) NOT NULL,
    updated_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE ADM_DOWNLOAD_AUDIT_LOG (
    DOWNLOAD_ID NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    ADMIN_ID VARCHAR2(50 CHAR) NOT NULL,
    MENU_ID VARCHAR2(50 CHAR) NULL,
    SCREEN_ID VARCHAR2(100 CHAR) NULL,
    DOWNLOAD_TYPE VARCHAR2(50 CHAR) NOT NULL,
    TARGET_TYPE VARCHAR2(50 CHAR) NULL,
    SEARCH_CONDITION_SUMMARY CLOB NULL,
    ROW_COUNT NUMBER(10) DEFAULT 0 NOT NULL,
    MASKED_YN CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    INCLUDE_SENSITIVE_YN CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    REASON VARCHAR2(500 CHAR) NOT NULL,
    CLIENT_IP VARCHAR2(50 CHAR) NULL,
    USER_AGENT VARCHAR2(500 CHAR) NULL,
    CSV_POLICY_VERSION VARCHAR2(30 CHAR) DEFAULT 'CPF-CSV-1' NOT NULL,
    REQUESTED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    COMPLETED_AT TIMESTAMP NULL,
    STATUS VARCHAR2(20 CHAR) DEFAULT 'REQUESTED' NOT NULL,
    FAILURE_REASON VARCHAR2(1000 CHAR) NULL,
    FILE_NAME VARCHAR2(300 CHAR) NULL,
    created_by VARCHAR2(50 CHAR) DEFAULT 'ADM' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(50 CHAR) DEFAULT 'ADM' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE ADM_DYNAMIC_LOG_LEVEL_RULE (
    ...
    TRANSACTION_ID CHAR(34 CHAR) NULL,
    BUSINESS_TRANSACTION_ID VARCHAR2(20 CHAR) NULL,
    MODULE_ID VARCHAR2(10 CHAR) NULL,
    LOG_LEVEL VARCHAR2(10 CHAR) NOT NULL,
    EXPIRE_AT TIMESTAMP NOT NULL,
    REASON VARCHAR2(500 CHAR) NULL,
...
CREATE TABLE ADM_FILE_JOB (
    ...
    source_path VARCHAR2(1000 CHAR) NULL,
    result_path VARCHAR2(1000 CHAR) NULL,
    source_sha256 VARCHAR2(64 CHAR) NULL,
    result_sha256 VARCHAR2(64 CHAR) NULL,
    total_rows NUMBER(19) DEFAULT 0 NOT NULL,
    success_rows NUMBER(19) DEFAULT 0 NOT NULL,
    failed_rows NUMBER(19) DEFAULT 0 NOT NULL,
    lease_owner VARCHAR2(100 CHAR) NULL,
    ...
    reason VARCHAR2(500 CHAR) NOT NULL,
    client_ip VARCHAR2(64 CHAR) NULL,
    error_code VARCHAR2(80 CHAR) NULL,
    error_message VARCHAR2(1000 CHAR) NULL,
    created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
    updated_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
    approval_id VARCHAR2(120 CHAR) NULL,
    applied_by VARCHAR2(100 CHAR) NULL,
    resolved_by VARCHAR2(100 CHAR) NULL,
    control_by VARCHAR2(100 CHAR) NULL,
...
CREATE TABLE ADM_INCIDENT (
    incident_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    incident_no VARCHAR2(64 CHAR) NOT NULL,
    severity VARCHAR2(16 CHAR) NOT NULL,
    title VARCHAR2(300 CHAR) NOT NULL,
    summary VARCHAR2(2000 CHAR) NULL,
    source_type VARCHAR2(40 CHAR) DEFAULT 'MANUAL' NOT NULL,
    source_id VARCHAR2(200 CHAR) NULL,
    status VARCHAR2(32 CHAR) DEFAULT 'OPEN' NOT NULL,
    detected_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    acknowledged_at TIMESTAMP(3) NULL,
    mitigated_at TIMESTAMP(3) NULL,
...
CREATE TABLE ADM_INCIDENT_COMMAND (
    command_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    command_type VARCHAR2(80 CHAR) NOT NULL,
    idempotency_key VARCHAR2(160 CHAR) NOT NULL,
    request_hash VARCHAR2(64 CHAR) NOT NULL,
    status VARCHAR2(30 CHAR) NOT NULL,
    result_ref VARCHAR2(200 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) NOT NULL,
    created_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    updated_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE ADM_INCIDENT_POLICY (
    policy_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    policy_code VARCHAR2(100 CHAR) NOT NULL,
    event_type VARCHAR2(80 CHAR) NOT NULL,
    event_sub_type VARCHAR2(80 CHAR) NULL,
...
CREATE TABLE ADM_IP_ALLOWLIST (
    ALLOW_ID NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE ADM_MAINTENANCE_ACTION (
    action_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    ...
    before_status VARCHAR2(40 CHAR) NULL,
    after_status VARCHAR2(40 CHAR) NULL,
    result_status VARCHAR2(20 CHAR) NOT NULL,
    reason VARCHAR2(1000 CHAR) NOT NULL,
    requested_by VARCHAR2(100 CHAR) NOT NULL,
    requested_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    result_detail CLOB NULL,
...
CREATE TABLE ADM_MAINTENANCE_WINDOW (
    maintenance_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE ADM_MENU (
    ...
    PARENT_MENU_ID VARCHAR2(50 CHAR) NULL,
...
CREATE TABLE ADM_OPERATOR (
    ...
    LOCKED_YN CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    FAIL_COUNT NUMBER(10) DEFAULT 0 NOT NULL,
    PASSWORD_CHANGED_AT TIMESTAMP NULL,
    PASSWORD_EXPIRE_AT TIMESTAMP NULL,
    PASSWORD_CHANGE_REQUIRED_YN CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    LAST_LOGIN_AT TIMESTAMP NULL,
    LAST_LOGIN_IP VARCHAR2(50 CHAR) NULL,
    USE_YN CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    created_by VARCHAR2(50 CHAR) DEFAULT 'ADM' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(50 CHAR) DEFAULT 'ADM' NOT NULL,
...
CREATE TABLE ADM_OPERATOR_SESSION (
    ...
    OPERATOR_ID VARCHAR2(50 CHAR) NOT NULL,
    ROLE_IDS VARCHAR2(1000 CHAR) NULL,
...
CREATE TABLE ADM_PASSWORD_POLICY (
    ...
    MIN_LENGTH NUMBER(10) DEFAULT 12 NOT NULL,
    REQUIRE_UPPER_YN CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    REQUIRE_LOWER_YN CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    REQUIRE_DIGIT_YN CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    REQUIRE_SPECIAL_YN CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    MAX_FAIL_COUNT NUMBER(10) DEFAULT 5 NOT NULL,
    EXPIRE_DAYS NUMBER(10) DEFAULT 90 NOT NULL,
    HISTORY_LIMIT NUMBER(10) DEFAULT 5 NOT NULL,
    USE_YN CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    created_by VARCHAR2(50 CHAR) DEFAULT 'ADM' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(50 CHAR) DEFAULT 'ADM' NOT NULL,
...
CREATE TABLE ADM_ROLE (
    ...
    ROLE_TYPE VARCHAR2(30 CHAR) DEFAULT 'BUSINESS_OPERATOR' NOT NULL,
    DESCRIPTION VARCHAR2(500 CHAR) NULL,
    USE_YN CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    created_by VARCHAR2(50 CHAR) DEFAULT 'ADM' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_DEPLOYMENT_CELL (
    cell_id VARCHAR2(120 CHAR) NULL,
    ...
    desired_instance_count NUMBER(10) DEFAULT 1 NOT NULL,
    row_version NUMBER(19) DEFAULT 0 NOT NULL,
    created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
    updated_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
...
CREATE TABLE BAT_EXECUTION_CONTROL (
    ...
    fencing_token NUMBER(19) NOT NULL,
    job_instance_id NUMBER(19) NULL,
    job_execution_id NUMBER(19) NULL,
    control_status VARCHAR2(40 CHAR) NOT NULL,
    unknown_reason VARCHAR2(100 CHAR) NULL,
    unknown_detail VARCHAR2(4000 CHAR) NULL,
    created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
    updated_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
    ...
    reconcile_after TIMESTAMP(6) NULL,
    last_error_code VARCHAR2(100 CHAR) NULL,
    last_error_detail VARCHAR2(4000 CHAR) NULL,
...
CREATE TABLE BAT_INSTANCE (
    ...
    host_name VARCHAR2(150 CHAR) NULL,
    server_port NUMBER(10) NULL,
    active_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    last_heartbeat_at TIMESTAMP(3) NULL,
    description VARCHAR2(500 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'BAT' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'BAT' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_JOB_DEFINITION_AUDIT (
    ...
    from_state VARCHAR2(20 CHAR) NULL,
    to_state VARCHAR2(20 CHAR) NULL,
    reason VARCHAR2(1000 CHAR) NOT NULL,
    operator_id VARCHAR2(100 CHAR) NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_JOB_DEFINITION_VERSION (
    ...
    trigger_expression VARCHAR2(500 CHAR) NULL,
    timezone_id VARCHAR2(60 CHAR) DEFAULT 'Asia/Seoul' NOT NULL,
    misfire_policy VARCHAR2(30 CHAR) NOT NULL,
    agent_pool VARCHAR2(100 CHAR) NOT NULL,
    zone_id VARCHAR2(80 CHAR) NULL,
    max_concurrency NUMBER(10) DEFAULT 1 NOT NULL,
    timeout_seconds NUMBER(19) DEFAULT 3600 NOT NULL,
    restartable_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    max_attempts NUMBER(10) DEFAULT 1 NOT NULL,
    initial_backoff_seconds NUMBER(19) DEFAULT 0 NOT NULL,
    backoff_multiplier NUMBER(10,4) DEFAULT 1 NOT NULL,
    max_backoff_seconds NUMBER(19) DEFAULT 0 NOT NULL,
    skip_limit NUMBER(10) DEFAULT 0 NOT NULL,
    unknown_result_policy VARCHAR2(30 CHAR) NOT NULL,
    compensation_reference VARCHAR2(200 CHAR) NULL,
    alert_delay_seconds NUMBER(19) DEFAULT 0 NOT NULL,
    sla_seconds NUMBER(19) DEFAULT 0 NOT NULL,
    notify_failure_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    notify_missed_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    executor_reference VARCHAR2(300 CHAR) NOT NULL,
    definition_json CLOB NOT NULL,
    checksum VARCHAR2(128 CHAR) NULL,
...
CREATE TABLE BAT_JOB_PACK (
    ...
    artifact_checksum VARCHAR2(128 CHAR) NULL,
    signature_present_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    platform_range VARCHAR2(120 CHAR) NULL,
    manifest_json CLOB NOT NULL,
...
CREATE TABLE BAT_ON_DEMAND_REQUEST (
    ...
    request_status VARCHAR2(30 CHAR) DEFAULT 'REQUESTED' NOT NULL,
    parameters_json CLOB NULL,
    request_reason VARCHAR2(500 CHAR) NOT NULL,
    request_user VARCHAR2(100 CHAR) NOT NULL,
    cpf_execution_id NUMBER(19) NULL,
    spring_batch_execution_id NUMBER(19) NULL,
    result_json CLOB NULL,
    failure_code VARCHAR2(100 CHAR) NULL,
    failure_message VARCHAR2(1000 CHAR) NULL,
    requested_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE BAT_OPERATION_LOG (
    operation_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    job_id VARCHAR2(100 CHAR) NOT NULL,
    execution_id NUMBER(19) NULL,
    operation_type VARCHAR2(30 CHAR) NOT NULL,
    operator_id VARCHAR2(100 CHAR) NOT NULL,
    reason VARCHAR2(500 CHAR) NOT NULL,
    before_data CLOB NULL,
    after_data CLOB NULL,
    result_type CHAR(1 CHAR) DEFAULT 'S' NOT NULL,
    result_message VARCHAR2(1000 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'BAT' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'BAT' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_OPERATION_LOG_ARCHIVE (
    ...
    archived_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE BAT_OPERATION_REQUEST (
    ...
    request_state VARCHAR2(30 CHAR) DEFAULT 'RESERVED' NOT NULL,
    result_payload CLOB NULL,
    failure_code VARCHAR2(80 CHAR) NULL,
    failure_message VARCHAR2(1000 CHAR) NULL,
    completed_at TIMESTAMP(3) NULL,
    created_by VARCHAR2(50 CHAR) DEFAULT 'BAT' NOT NULL,
    created_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    updated_by VARCHAR2(50 CHAR) DEFAULT 'BAT' NOT NULL,
    updated_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE BAT_REMOTE_MESSAGE_LEDGER (
    ...
    last_error_cd VARCHAR2(100 CHAR) DEFAULT NULL NULL,
...
CREATE TABLE BAT_RUNTIME_COMMAND (
    command_id VARCHAR2(80 CHAR) NULL,
    idempotency_key VARCHAR2(160 CHAR) NOT NULL,
    command_type VARCHAR2(80 CHAR) NOT NULL,
    target_type VARCHAR2(40 CHAR) NOT NULL,
    target_snapshot CLOB NULL,
    target_snapshot_hash VARCHAR2(128 CHAR) NULL,
    expected_version NUMBER(19) NULL,
    requested_by VARCHAR2(120 CHAR) NOT NULL,
    reason_text VARCHAR2(1000 CHAR) NOT NULL,
    approval_policy_version VARCHAR2(80 CHAR) NULL,
    approval_request_id VARCHAR2(80 CHAR) NULL,
    approved_by VARCHAR2(120 CHAR) NULL,
    command_state VARCHAR2(40 CHAR) NOT NULL,
    execution_attempt NUMBER(10) DEFAULT 0 NOT NULL,
    result_text CLOB NULL,
    failure_stage VARCHAR2(80 CHAR) NULL,
    before_state CLOB NULL,
    after_state CLOB NULL,
    result_code VARCHAR2(80 CHAR) NULL,
    requested_at TIMESTAMP(6) NOT NULL,
    expires_at TIMESTAMP(6) NULL,
    updated_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
    transaction_id CHAR(34 CHAR) NULL,
    evidence_ref VARCHAR2(500 CHAR) NULL,
...
CREATE TABLE BAT_RUNTIME_INSTANCE (
    instance_id VARCHAR2(160 CHAR) NULL,
    runtime_role VARCHAR2(40 CHAR) NOT NULL,
    service_id VARCHAR2(120 CHAR) NOT NULL,
    was_id VARCHAR2(120 CHAR) NULL,
    host_alias VARCHAR2(160 CHAR) NULL,
    zone_id VARCHAR2(80 CHAR) NULL,
    pool_id VARCHAR2(80 CHAR) NULL,
    artifact_version VARCHAR2(80 CHAR) NOT NULL,
    git_sha VARCHAR2(64 CHAR) NULL,
    artifact_checksum VARCHAR2(128 CHAR) NULL,
    profile_name VARCHAR2(80 CHAR) NULL,
    desired_state VARCHAR2(32 CHAR) DEFAULT 'RUNNING' NOT NULL,
    actual_state VARCHAR2(32 CHAR) DEFAULT 'UNKNOWN' NOT NULL,
    config_version VARCHAR2(80 CHAR) NULL,
    schema_compatibility VARCHAR2(120 CHAR) NULL,
...
CREATE TABLE BAT_SCHEDULER_LEASE (
    scheduler_key VARCHAR2(100 CHAR) NULL,
...
CREATE TABLE BAT_VERSION_COMPATIBILITY (
    compatibility_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    environment_id VARCHAR2(80 CHAR) DEFAULT '*' NOT NULL,
    provider_coordinate VARCHAR2(200 CHAR) NOT NULL,
    consumer_coordinate VARCHAR2(200 CHAR) DEFAULT '*' NOT NULL,
    min_version VARCHAR2(80 CHAR) NULL,
    max_version VARCHAR2(80 CHAR) NULL,
    schema_range VARCHAR2(120 CHAR) NULL,
    required_capability VARCHAR2(80 CHAR) NULL,
    enabled_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
...
CREATE TABLE BAT_WORKER (
    ...
    thread_name VARCHAR2(160 CHAR) NULL,
    worker_version VARCHAR2(80 CHAR) DEFAULT 'unknown' NOT NULL,
    capabilities_json CLOB NULL,
    max_concurrency NUMBER(10) DEFAULT 1 NOT NULL,
    queue_capacity NUMBER(10) DEFAULT 1 NOT NULL,
    control_status VARCHAR2(30 CHAR) DEFAULT 'RUNNING' NOT NULL,
    worker_status VARCHAR2(30 CHAR) DEFAULT 'IDLE' NOT NULL,
    active_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    last_heartbeat_at TIMESTAMP(3) NULL,
    current_job_id VARCHAR2(100 CHAR) NULL,
    current_execution_id NUMBER(19) NULL,
    description VARCHAR2(500 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'BAT' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'BAT' NOT NULL,
...
CREATE TABLE CMN_BUSINESS_CALENDAR_DAY (
    ...
    day_type VARCHAR2(30 CHAR) DEFAULT 'BUSINESS' NOT NULL,
...
CREATE TABLE CMN_CACHE_REFRESH_CHECKPOINT (
    ...
    last_applied_at TIMESTAMP(3) NULL,
...
CREATE TABLE CMN_CACHE_REFRESH_EVENT (
    event_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    cache_name VARCHAR2(50 CHAR) NOT NULL,
    event_type VARCHAR2(30 CHAR) NOT NULL,
    event_key VARCHAR2(200 CHAR) NULL,
    source_was_id VARCHAR2(50 CHAR) NULL,
    published_by VARCHAR2(100 CHAR) DEFAULT 'SYSTEM' NOT NULL,
    published_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE CMN_MESSAGE (
    message_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    message_code VARCHAR2(20 CHAR) NOT NULL,
    locale VARCHAR2(10 CHAR) DEFAULT 'ko' NOT NULL,
    message_format_type VARCHAR2(20 CHAR) DEFAULT 'FIXED' NOT NULL,
    external_message VARCHAR2(2000 CHAR) NOT NULL,
    internal_message VARCHAR2(4000 CHAR) NOT NULL,
    parameter_count NUMBER(10) DEFAULT 0 NOT NULL,
    parameter_sample VARCHAR2(1000 CHAR) NULL,
    description VARCHAR2(500 CHAR) NULL,
    use_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    parameter_schema_json CLOB NULL,
    escape_html_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    mask_arguments_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    effective_from TIMESTAMP NULL,
    effective_to TIMESTAMP NULL,
    catalog_version NUMBER(19) DEFAULT 1 NOT NULL,
...
CREATE TABLE CMN_PARAMETER (
    config_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    config_key VARCHAR2(150 CHAR) NOT NULL,
    config_value VARCHAR2(2000 CHAR) NOT NULL,
    config_type VARCHAR2(30 CHAR) DEFAULT 'STRING' NOT NULL,
    description VARCHAR2(500 CHAR) NULL,
    encrypted_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    use_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
...
CREATE TABLE CMN_RESPONSE_CODE (
    ...
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    category VARCHAR2(32 CHAR) DEFAULT 'BUSINESS' NOT NULL,
    retry_disposition VARCHAR2(16 CHAR) DEFAULT 'NEVER' NOT NULL,
    exposure VARCHAR2(32 CHAR) DEFAULT 'SAFE_MESSAGE_ONLY' NOT NULL,
    effective_from TIMESTAMP NULL,
    effective_to TIMESTAMP NULL,
    catalog_version NUMBER(19) DEFAULT 1 NOT NULL,
...
CREATE TABLE CPF_BROKER_DLQ (
    dlq_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    message_id VARCHAR2(120 CHAR) NOT NULL,
    topic VARCHAR2(160 CHAR) NOT NULL,
    transaction_id CHAR(34 CHAR) NULL,
    segment_id VARCHAR2(120 CHAR) NULL,
    failure_reason VARCHAR2(1000 CHAR) NULL,
    replay_status VARCHAR2(30 CHAR) DEFAULT 'WAITING' NOT NULL,
    replay_count NUMBER(10) DEFAULT 0 NOT NULL,
    replay_requested_at TIMESTAMP(3) NULL,
    replay_completed_at TIMESTAMP(3) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE CPF_BROKER_INBOX (
    inbox_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    message_id VARCHAR2(120 CHAR) NOT NULL,
    consumer_identity VARCHAR2(120 CHAR) DEFAULT 'default' NOT NULL,
    idempotency_key VARCHAR2(160 CHAR) NULL,
    inbox_status VARCHAR2(30 CHAR) DEFAULT 'RECEIVED' NOT NULL,
    result_detail VARCHAR2(1000 CHAR) NULL,
    lease_version NUMBER(19) DEFAULT 0 NOT NULL,
    received_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    consumed_at TIMESTAMP(3) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
...
CREATE TABLE CPF_BROKER_OUTBOX (
    outbox_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    message_id VARCHAR2(120 CHAR) NOT NULL,
    topic VARCHAR2(160 CHAR) NOT NULL,
    message_key VARCHAR2(200 CHAR) NULL,
    transaction_id CHAR(34 CHAR) NULL,
    segment_id VARCHAR2(120 CHAR) NULL,
    producer_module VARCHAR2(20 CHAR) NULL,
    consumer_module VARCHAR2(20 CHAR) NULL,
    idempotency_key VARCHAR2(160 CHAR) NULL,
    payload BLOB NULL,
    content_type VARCHAR2(100 CHAR) NULL,
    header_json CLOB NULL,
    attribute_json CLOB NULL,
    outbox_status VARCHAR2(30 CHAR) DEFAULT 'PENDING' NOT NULL,
    worker_id VARCHAR2(120 CHAR) NULL,
    attempt_count NUMBER(10) DEFAULT 0 NOT NULL,
    max_attempts NUMBER(10) DEFAULT 5 NOT NULL,
    next_attempt_at TIMESTAMP(3) NULL,
    lease_until TIMESTAMP(3) NULL,
    broker_name VARCHAR2(80 CHAR) NULL,
    partition_key VARCHAR2(200 CHAR) NULL,
    failure_message VARCHAR2(1000 CHAR) NULL,
...
CREATE TABLE CPF_CACHE_INVALIDATION_EVENT (
    ...
    cache_key VARCHAR2(512 CHAR) NULL,
...
CREATE TABLE CPF_DATA_QUALITY_QUARANTINE (
    ...
    CORRECTED_PAYLOAD BLOB NULL,
    QUARANTINE_STATE VARCHAR2(64 CHAR) NOT NULL,
    VIOLATION_SUMMARY VARCHAR2(1000 CHAR) NOT NULL,
    ROW_VERSION NUMBER(19) NOT NULL,
    UPDATED_BY VARCHAR2(64 CHAR) NULL,
    UPDATE_REASON VARCHAR2(1000 CHAR) NULL,
    UPDATED_AT TIMESTAMP(6) NOT NULL,
    VIOLATION_PAYLOAD BLOB NULL,
...
CREATE TABLE CPF_FIELD_ENCRYPTION_LEDGER (
    ...
    SEARCH_TOKEN VARCHAR2(1000 CHAR) NULL,
...
CREATE TABLE CPF_FILE_TRANSFER_HISTORY (
    history_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    ...
    local_path VARCHAR2(1000 CHAR) NULL,
    remote_path VARCHAR2(1000 CHAR) NULL,
    checksum VARCHAR2(128 CHAR) NULL,
...
CREATE TABLE CPF_IDEMPOTENCY_RECORD (
    idempotency_seq NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    scope VARCHAR2(40 CHAR) NOT NULL,
    idempotency_key VARCHAR2(160 CHAR) NOT NULL,
    request_hash VARCHAR2(128 CHAR) NULL,
    payload_hash VARCHAR2(128 CHAR) NULL,
    record_status VARCHAR2(30 CHAR) DEFAULT 'PROCESSING' NOT NULL,
    stored_response CLOB NULL,
    retry_allowed_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    completed_at TIMESTAMP(3) NULL,
...
CREATE TABLE CPF_NOTIFICATION_RULE (
    rule_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    event_type VARCHAR2(80 CHAR) NOT NULL,
    event_sub_type VARCHAR2(80 CHAR) NULL,
    channel_code VARCHAR2(30 CHAR) DEFAULT 'ADM' NOT NULL,
    template_code VARCHAR2(80 CHAR) NULL,
    severity VARCHAR2(20 CHAR) DEFAULT 'INFO' NOT NULL,
    receiver_group VARCHAR2(100 CHAR) NULL,
    use_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
...
CREATE TABLE CPF_SAGA_EXECUTION (
    ...
    business_key VARCHAR2(200 CHAR) NULL,
    transaction_id CHAR(34 CHAR) NULL,
...
CREATE TABLE CPF_STANDARD_EXECUTION (
    ...
    operation_id VARCHAR2(150 CHAR) NULL,
    description VARCHAR2(1000 CHAR) NULL,
    required_permission VARCHAR2(150 CHAR) NULL,
    audit_reason_required_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    visibility VARCHAR2(20 CHAR) DEFAULT 'INTERNAL' NOT NULL,
    direct_allowed_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    gateway_allowed_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    source_version VARCHAR2(100 CHAR) NOT NULL,
    registration_status VARCHAR2(30 CHAR) DEFAULT 'REGISTERED' NOT NULL,
    first_registered_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    last_discovered_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE CPF_STANDARD_EXECUTION_ALIAS (
    ...
    retired_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE CPF_TRANSACTION_LINEAGE (
    ...
    parent_segment_id VARCHAR2(128 CHAR) NULL,
    attempt_no NUMBER(10) DEFAULT 1 NOT NULL,
    trace_id VARCHAR2(128 CHAR) NULL,
    span_id VARCHAR2(128 CHAR) NULL,
    ...
    was_id VARCHAR2(128 CHAR) NULL,
    agent_id VARCHAR2(128 CHAR) NULL,
    worker_id VARCHAR2(128 CHAR) NULL,
    target_channel VARCHAR2(128 CHAR) NULL,
    operation_id VARCHAR2(160 CHAR) NULL,
    message_id VARCHAR2(160 CHAR) NULL,
    consumer_group VARCHAR2(160 CHAR) NULL,
    dlq_id VARCHAR2(160 CHAR) NULL,
    batch_job_instance_id VARCHAR2(128 CHAR) NULL,
    batch_job_execution_id VARCHAR2(128 CHAR) NULL,
    batch_step_execution_id VARCHAR2(128 CHAR) NULL,
    partition_id VARCHAR2(128 CHAR) NULL,
    file_id VARCHAR2(160 CHAR) NULL,
    source_type VARCHAR2(32 CHAR) NOT NULL,
    source_ref_id VARCHAR2(256 CHAR) NULL,
    lifecycle_state VARCHAR2(32 CHAR) NOT NULL,
    failure_stage VARCHAR2(128 CHAR) NULL,
    unknown_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    reconcile_state VARCHAR2(32 CHAR) NULL,
    occurred_at TIMESTAMP(6) NOT NULL,
...
CREATE TABLE CPF_TRANSACTION_LOG (
    ...
    LOG_IDX NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    RECOVERY_EVENT_ID VARCHAR2(64 CHAR) NULL,
    transaction_id CHAR(34 CHAR) NULL,
    TRACE_ID VARCHAR2(100 CHAR) NULL,
    SPAN_ID VARCHAR2(100 CHAR) NULL,
    PARENT_SPAN_ID VARCHAR2(100 CHAR) NULL,
    SEQUENCE_NO NUMBER(10) DEFAULT 1 NULL,
    MODULE_ID VARCHAR2(20 CHAR) DEFAULT 'N/A' NULL,
    MENU_ID VARCHAR2(50 CHAR) NULL,
    BUSINESS_TRANSACTION_ID VARCHAR2(20 CHAR) NULL,
    BUSINESS_TRANSACTION_NAME VARCHAR2(150 CHAR) NULL,
    LOG_TYPE VARCHAR2(20 CHAR) DEFAULT 'N/A' NULL,
    ...
    CALLER_INSTANCE_ID VARCHAR2(120 CHAR) NULL,
    CORRELATION_ID VARCHAR2(120 CHAR) NULL,
    IDEMPOTENCY_KEY VARCHAR2(120 CHAR) NULL,
    LOCALE VARCHAR2(20 CHAR) NULL,
    TIMEZONE VARCHAR2(50 CHAR) NULL,
    REQUEST_TYPE VARCHAR2(20 CHAR) NULL,
    ORIGINAL_CHANNEL VARCHAR2(20 CHAR) NULL,
    CURRENT_CHANNEL VARCHAR2(20 CHAR) NULL,
    MEMBER_NO VARCHAR2(50 CHAR) NULL,
    CUSTOMER_NO VARCHAR2(50 CHAR) NULL,
    SCREEN_ID VARCHAR2(50 CHAR) NULL,
    DEVICE_ID VARCHAR2(100 CHAR) NULL,
    CLIENT_REQUEST_TIME VARCHAR2(30 CHAR) NULL,
    WAS_ID VARCHAR2(50 CHAR) NULL,
    INSTANCE_ID VARCHAR2(160 CHAR) NULL,
    HOST_NAME VARCHAR2(120 CHAR) NULL,
    HOST_IP VARCHAR2(128 CHAR) NULL,
    PROCESS_ID VARCHAR2(80 CHAR) NULL,
    THREAD_NAME VARCHAR2(160 CHAR) NULL,
    RESERVED_FIELD_1 VARCHAR2(255 CHAR) NULL,
    RESERVED_FIELD_2 VARCHAR2(255 CHAR) NULL,
    RESERVED_FIELD_3 VARCHAR2(255 CHAR) NULL,
    RESERVED_FIELD_4 VARCHAR2(255 CHAR) NULL,
    RESERVED_FIELD_5 VARCHAR2(255 CHAR) NULL,
    HTTP_METHOD VARCHAR2(10 CHAR) NULL,
    URI VARCHAR2(500 CHAR) DEFAULT 'N/A' NULL,
    CONTROLLER VARCHAR2(255 CHAR) NULL,
    EXECUTION_PACKAGE VARCHAR2(255 CHAR) NULL,
    EXECUTION_CLASS VARCHAR2(255 CHAR) NULL,
    EXECUTION_METHOD VARCHAR2(100 CHAR) NULL,
    EXECUTION_SIGNATURE VARCHAR2(1000 CHAR) NULL,
    WORKFLOW_ID VARCHAR2(50 CHAR) NULL,
    WORKFLOW_NAME VARCHAR2(100 CHAR) NULL,
    WORKFLOW_INSTANCE_ID VARCHAR2(100 CHAR) NULL,
    WORKFLOW_STEP_ID VARCHAR2(50 CHAR) NULL,
    WORKFLOW_STEP_NAME VARCHAR2(100 CHAR) NULL,
    WORKFLOW_STATUS VARCHAR2(30 CHAR) NULL,
    WORKFLOW_FAILURE_POLICY VARCHAR2(30 CHAR) NULL,
    COMPENSATION_YN CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    COMPENSATION_TRANSACTION_ID VARCHAR2(20 CHAR) NULL,
    COMPENSATION_TARGET_TRANSACTION_ID VARCHAR2(20 CHAR) NULL,
    COMPENSATION_STATUS VARCHAR2(30 CHAR) NULL,
    PARAMETERS CLOB NULL,
    REQUEST_BODY CLOB NULL,
    RESPONSE CLOB NULL,
    HTTP_STATUS NUMBER(10) NULL,
    RESPONSE_CODE VARCHAR2(20 CHAR) NULL,
    MESSAGE_CODE VARCHAR2(20 CHAR) NULL,
    MESSAGE_CONTENT VARCHAR2(1000 CHAR) NULL,
    ERROR_MESSAGE CLOB NULL,
    ERROR_CODE VARCHAR2(100 CHAR) NULL,
    EXTERNAL_MESSAGE VARCHAR2(1000 CHAR) NULL,
    INTERNAL_MESSAGE CLOB NULL,
    EXEC_USER VARCHAR2(100 CHAR) DEFAULT 'N/A' NOT NULL,
    CLIENT_IP VARCHAR2(100 CHAR) NULL,
    USER_AGENT VARCHAR2(500 CHAR) NULL,
...
CREATE TABLE CPF_TRANSACTION_SEGMENT (
    ...
    transaction_id CHAR(34 CHAR) NOT NULL,
    parent_segment_id VARCHAR2(120 CHAR) NULL,
    transaction_role VARCHAR2(40 CHAR) NOT NULL,
    module_code VARCHAR2(20 CHAR) NOT NULL,
    source_module_code VARCHAR2(20 CHAR) NULL,
    target_module_code VARCHAR2(20 CHAR) NULL,
    direction VARCHAR2(20 CHAR) NOT NULL,
    call_depth NUMBER(10) DEFAULT 0 NOT NULL,
    sequence_no NUMBER(10) DEFAULT 1 NOT NULL,
    api_path VARCHAR2(500 CHAR) NULL,
    transaction_name VARCHAR2(200 CHAR) NULL,
    started_at TIMESTAMP(6) NOT NULL,
    ended_at TIMESTAMP(6) NULL,
    duration_ms NUMBER(19) NULL,
    status VARCHAR2(30 CHAR) DEFAULT 'RUNNING' NOT NULL,
    failure_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    failure_code VARCHAR2(100 CHAR) NULL,
    failure_message_masked VARCHAR2(1000 CHAR) NULL,
    request_header_snapshot_masked CLOB NULL,
    response_header_snapshot_masked CLOB NULL,
    extension_header_snapshot_masked CLOB NULL,
    customer_no_masked VARCHAR2(80 CHAR) NULL,
    ...
    caller_channel VARCHAR2(100 CHAR) NULL,
    target_channel VARCHAR2(32 CHAR) NULL,
    target_operation_id VARCHAR2(160 CHAR) NULL,
    external_institution_code VARCHAR2(50 CHAR) NULL,
    external_transaction_id VARCHAR2(120 CHAR) NULL,
    selected_instance_id VARCHAR2(100 CHAR) NULL,
    attempt_no NUMBER(10) NULL,
    retry_yn CHAR(1 CHAR) NULL,
    failover_yn CHAR(1 CHAR) NULL,
    circuit_state VARCHAR2(20 CHAR) NULL,
    downstream_http_status NUMBER(10) NULL,
    result_state VARCHAR2(30 CHAR) NULL,
    unknown_result_id VARCHAR2(100 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
...
CREATE TABLE CPF_UNKNOWN_RESULT (
    ...
    unknown_status VARCHAR2(40 CHAR) DEFAULT 'CHECK_PENDING' NOT NULL,
    transaction_id CHAR(34 CHAR) NULL,
    segment_id VARCHAR2(120 CHAR) NULL,
    external_key VARCHAR2(200 CHAR) NULL,
    failure_code VARCHAR2(100 CHAR) NULL,
    failure_message VARCHAR2(1000 CHAR) NULL,
    next_action VARCHAR2(100 CHAR) NULL,
    detected_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    resolved_at TIMESTAMP(3) NULL,
    resolved_by VARCHAR2(100 CHAR) NULL,
    audit_reason VARCHAR2(500 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE GW_CONTROL_SECURITY_AUDIT (
    ...
    audience VARCHAR2(160 CHAR) NULL,
    key_id VARCHAR2(80 CHAR) NULL,
    caller_service VARCHAR2(80 CHAR) NULL,
    operator_id VARCHAR2(100 CHAR) NULL,
    http_method VARCHAR2(16 CHAR) NULL,
    request_target VARCHAR2(1000 CHAR) NULL,
    remote_address VARCHAR2(128 CHAR) NULL,
    result_code VARCHAR2(80 CHAR) NOT NULL,
    safe_message VARCHAR2(1000 CHAR) NULL,
...
CREATE TABLE GW_SERVER_GROUP (
    ...
    hash_key_source VARCHAR2(200 CHAR) NULL,
    health_policy_id VARCHAR2(100 CHAR) NULL,
    failover_group_id VARCHAR2(100 CHAR) NULL,
    group_status VARCHAR2(30 CHAR) DEFAULT 'DRAFT' NOT NULL,
    direct_allowed_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE GW_SPOOL_CHECKPOINT (
    ...
    last_written_sequence NUMBER(19) DEFAULT 0 NOT NULL,
    last_ingested_sequence NUMBER(19) DEFAULT 0 NOT NULL,
    backlog_count NUMBER(19) DEFAULT 0 NOT NULL,
    backlog_bytes NUMBER(19) DEFAULT 0 NOT NULL,
    last_error_code VARCHAR2(100 CHAR) NULL,
...
CREATE TABLE OPS_CHANNEL_EXECUTION_POLICY (
    ...
    authentication_required_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    signature_required_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    max_tps NUMBER(10) DEFAULT 0 NOT NULL,
    effective_from TIMESTAMP(3) NULL,
    effective_to TIMESTAMP(3) NULL,
    active_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    policy_version NUMBER(19) DEFAULT 0 NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE OPS_CHANNEL_POLICY_VERSION (
    version_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    ...
    applied_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE OPS_CHANNEL_REGISTRY (
    ...
    client_channel_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    internal_channel_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    authentication_required_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    signature_required_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    active_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    description VARCHAR2(500 CHAR) NULL,
...
CREATE TABLE OPS_CONTROL_OPERATION (
    ...
    command_type VARCHAR2(80 CHAR) NOT NULL,
    request_hash VARCHAR2(64 CHAR) NOT NULL,
    entity_id VARCHAR2(100 CHAR) NULL,
    result_state VARCHAR2(30 CHAR) DEFAULT 'PROCESSING' NOT NULL,
    result_json CLOB NULL,
    expires_at TIMESTAMP(3) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE OPS_FEATURE_FLAG_AUDIT (
    ...
    actor_id VARCHAR2(100 CHAR) NULL,
    reason_code VARCHAR2(500 CHAR) NULL,
    sanitized_attributes VARCHAR2(2000 CHAR) NULL,
    occurred_at TIMESTAMP(3) NOT NULL,
...
CREATE TABLE OPS_FEATURE_FLAG_KILL_SWITCH (
    flag_key VARCHAR2(200 CHAR) NOT NULL,
    enabled_flag CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
...
CREATE TABLE OPS_FEATURE_FLAG_OVERRIDE (
    ...
    revision NUMBER(19) NOT NULL,
    active_flag_key VARCHAR2(200 CHAR) NULL,
    created_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    updated_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE OPS_FEATURE_FLAG_OVERRIDE_REQUEST (
    ...
    approver_id VARCHAR2(100 CHAR) NULL,
    approval_reason VARCHAR2(500 CHAR) NULL,
    active_flag_key VARCHAR2(200 CHAR) NULL,
    created_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    updated_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE OPS_LOG_POLICY (
    ...
    log_level VARCHAR2(20 CHAR) DEFAULT 'INFO' NOT NULL,
    db_log_enabled_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    file_log_enabled_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    policy_schema_version NUMBER(10) DEFAULT 2 NOT NULL,
    query_capture_mode VARCHAR2(30 CHAR) DEFAULT 'NONE' NOT NULL,
    request_header_capture_mode VARCHAR2(30 CHAR) DEFAULT 'ALLOWLIST' NOT NULL,
    response_header_capture_mode VARCHAR2(30 CHAR) DEFAULT 'ALLOWLIST' NOT NULL,
    request_body_capture_mode VARCHAR2(30 CHAR) DEFAULT 'NONE' NOT NULL,
    response_body_capture_mode VARCHAR2(30 CHAR) DEFAULT 'NONE' NOT NULL,
    error_stack_capture_mode VARCHAR2(30 CHAR) DEFAULT 'SUMMARY' NOT NULL,
    query_allowlist VARCHAR2(2000 CHAR) NULL,
    header_allowlist VARCHAR2(2000 CHAR) NULL,
    field_allowlist VARCHAR2(2000 CHAR) NULL,
    max_query_bytes NUMBER(10) DEFAULT 4096 NOT NULL,
    max_header_bytes NUMBER(10) DEFAULT 8192 NOT NULL,
    max_request_body_bytes NUMBER(10) DEFAULT 65536 NOT NULL,
    max_response_body_bytes NUMBER(10) DEFAULT 65536 NOT NULL,
    max_stack_bytes NUMBER(10) DEFAULT 32768 NOT NULL,
    policy_checksum VARCHAR2(64 CHAR) NULL,
    request_body_log_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    response_body_log_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    error_stack_log_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    masking_policy_key VARCHAR2(120 CHAR) DEFAULT 'DEFAULT' NOT NULL,
    retention_days NUMBER(10) DEFAULT 90 NOT NULL,
    sampling_rate NUMBER(5,2) DEFAULT 100.00 NOT NULL,
...
CREATE TABLE OPS_MANAGED_SERVER (
    ...
    tags_json CLOB NULL,
    registered_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE OPS_RESILIENCE_AUDIT (
    ...
    actor_id VARCHAR2(100 CHAR) NULL,
    reason_code VARCHAR2(256 CHAR) NULL,
    sanitized_attributes VARCHAR2(2000 CHAR) NULL,
    occurred_at TIMESTAMP(3) NOT NULL,
...
CREATE TABLE OPS_RESILIENCE_POLICY (
    ...
    idempotent_flag CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    reconcile_flag CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    policy_status VARCHAR2(20 CHAR) NOT NULL,
    active_operation_key VARCHAR2(200 CHAR) NULL,
    updated_by VARCHAR2(100 CHAR) NOT NULL,
    updated_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE OPS_RUNTIME_INSTANCE_GROUP (
    ...
    parent_group_id VARCHAR2(80 CHAR) NULL,
    environment_code VARCHAR2(40 CHAR) NULL,
    description VARCHAR2(500 CHAR) NULL,
    active_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    row_version NUMBER(19) DEFAULT 0 NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
...
CREATE TABLE OPS_RUNTIME_LOCK (
    ...
    last_reason VARCHAR2(1000 CHAR) NULL,
    updated_at TIMESTAMP(6) NOT NULL,
...
CREATE TABLE OPS_RUNTIME_POLICY_EVENT (
    ...
    payload_checksum VARCHAR2(128 CHAR) NULL,
    metadata_text CLOB NULL,
    reason VARCHAR2(1000 CHAR) NOT NULL,
    requested_by VARCHAR2(100 CHAR) NOT NULL,
    occurred_at TIMESTAMP(3) NOT NULL,
...
CREATE TABLE OPS_RUNTIME_RATE_BUCKET (
    ...
    request_count NUMBER(10) DEFAULT 0 NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE OPS_SCHEMA_INSTALLATION (
    ...
    installed_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF_INSTALLER' NOT NULL,
    created_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF_INSTALLER' NOT NULL,
    updated_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE OPS_SERVICE (
    ...
    service_type VARCHAR2(30 CHAR) DEFAULT 'INTERNAL' NOT NULL,
...
CREATE TABLE SEC_BFF_CREDENTIAL_VAULT (
    ...
    refresh_iv RAW(32) DEFAULT NULL NULL,
    refresh_cipher_text BLOB DEFAULT NULL NULL,
...
COMMENT ON TABLE SEC_BFF_CREDENTIAL_VAULT IS 'ADM/MBW BFF Access/Refresh Token 암호화 Vault';
...
CREATE TABLE SEC_JWT_KEY (
    ...
    ALGORITHM VARCHAR2(20 CHAR) DEFAULT 'HS256' NOT NULL,
    SECRET_REF VARCHAR2(500 CHAR) NOT NULL,
    ACTIVE_YN CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    EXPIRE_AT TIMESTAMP NULL,
    created_by VARCHAR2(50 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(50 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE SEC_TOKEN_AUDIT_LOG (
    TOKEN_AUDIT_ID NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    TRANSACTION_ID CHAR(34 CHAR) NULL,
    TRACE_ID VARCHAR2(80 CHAR) NULL,
    TOKEN_HASH VARCHAR2(512 CHAR) NULL,
    TOKEN_TYPE VARCHAR2(30 CHAR) DEFAULT 'Bearer' NOT NULL,
    ISSUER VARCHAR2(100 CHAR) NULL,
    SUBJECT VARCHAR2(200 CHAR) NULL,
    AUDIENCE VARCHAR2(200 CHAR) NULL,
    ACTIVE_YN CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    EXPIRE_AT TIMESTAMP NULL,
    FAILURE_REASON VARCHAR2(1000 CHAR) NULL,
    CLIENT_IP VARCHAR2(50 CHAR) NULL,
...
CREATE TABLE ADM_APPROVAL_REQUEST (
    APPROVAL_REQUEST_ID NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    ...
    COMMAND_PAYLOAD_SNAPSHOT CLOB NULL,
    APPROVAL_STATUS VARCHAR2(30 CHAR) DEFAULT 'PENDING' NOT NULL,
    CURRENT_STEP_NO NUMBER(10) DEFAULT 1 NOT NULL,
...
CREATE TABLE ADM_FILE_JOB_ROW (
    ...
    error_code VARCHAR2(80 CHAR) NULL,
    error_message VARCHAR2(1000 CHAR) NULL,
    rollback_token VARCHAR2(1000 CHAR) NULL,
    created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
    updated_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
...
CREATE TABLE ADM_INCIDENT_LIFECYCLE (
    ...
    correlation_id VARCHAR2(100 CHAR) NULL,
    transaction_id VARCHAR2(100 CHAR) NULL,
    ...
    active_key VARCHAR2(400 CHAR) NULL,
    version NUMBER(19) DEFAULT 0 NOT NULL,
    created_by VARCHAR2(100 CHAR) NOT NULL,
    created_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    updated_by VARCHAR2(100 CHAR) NOT NULL,
...
CREATE TABLE ADM_INCIDENT_SIGNAL (
    signal_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    policy_id NUMBER(19) NOT NULL,
    source_type VARCHAR2(80 CHAR) NOT NULL,
    source_id VARCHAR2(160 CHAR) NOT NULL,
    correlation_id VARCHAR2(100 CHAR) NULL,
    ...
    summary VARCHAR2(2000 CHAR) NULL,
    occurred_at TIMESTAMP(3) NOT NULL,
    suppressed_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    idempotency_key VARCHAR2(160 CHAR) NOT NULL,
    created_by VARCHAR2(100 CHAR) NOT NULL,
    created_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE ADM_MFA_OTP_SECRET (
    OPERATOR_ID VARCHAR2(50 CHAR) NOT NULL,
    SECRET_REF VARCHAR2(500 CHAR) NOT NULL,
    ENABLED_YN CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
...
CREATE TABLE ADM_ORGANIZATION (
    ...
    MANAGER_OPERATOR_ID VARCHAR2(50 CHAR) NULL,
...
CREATE TABLE ADM_PASSWORD_HISTORY (
    ...
    OPERATOR_ID VARCHAR2(50 CHAR) NOT NULL,
    PASSWORD_HASH VARCHAR2(512 CHAR) NOT NULL,
    CHANGED_REASON VARCHAR2(500 CHAR) NULL,
    created_by VARCHAR2(50 CHAR) DEFAULT 'ADM' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(50 CHAR) DEFAULT 'ADM' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE ADM_ROLE_MENU (
    ROLE_ID VARCHAR2(50 CHAR) NOT NULL,
    MENU_ID VARCHAR2(50 CHAR) NOT NULL,
    READ_YN CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    WRITE_YN CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    DELETE_YN CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    created_by VARCHAR2(50 CHAR) DEFAULT 'ADM' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(50 CHAR) DEFAULT 'ADM' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_DEPLOYMENT_EXECUTION (
    ...
    expected_version NUMBER(19) NULL,
    approval_request_id VARCHAR2(120 CHAR) NULL,
    reconcile_requested_by VARCHAR2(120 CHAR) NULL,
    reconcile_approved_by VARCHAR2(120 CHAR) NULL,
    reconcile_approval_request_id VARCHAR2(120 CHAR) NULL,
    reconcile_reason VARCHAR2(1000 CHAR) NULL,
...
CREATE TABLE BAT_DEPLOYMENT_INSTANCE (
    ...
    config_ref VARCHAR2(1000 CHAR) NULL,
    desired_state VARCHAR2(32 CHAR) NOT NULL,
...
CREATE TABLE BAT_EXECUTION_LINK (
    ...
    spring_step_execution_id NUMBER(19) NULL,
...
CREATE TABLE BAT_JOB (
    ...
    job_type VARCHAR2(30 CHAR) DEFAULT 'TASKLET' NOT NULL,
    description VARCHAR2(500 CHAR) NULL,
    restartable_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    use_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'BAT' NOT NULL,
...
CREATE TABLE BAT_JOB_DEPENDENCY (
    ...
    timeout_seconds NUMBER(19) DEFAULT 0 NOT NULL,
    required_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    sort_order NUMBER(10) DEFAULT 0 NOT NULL,
...
CREATE TABLE BAT_JOB_PARAMETER_DEFINITION (
    ...
    label_text VARCHAR2(200 CHAR) NULL,
    description_text VARCHAR2(1000 CHAR) NULL,
    required_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    sensitive_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    default_value VARCHAR2(1000 CHAR) NULL,
    allowed_values CLOB NULL,
    validation_pattern VARCHAR2(1000 CHAR) NULL,
    min_value NUMBER(38,10) NULL,
    max_value NUMBER(38,10) NULL,
    min_length NUMBER(10) NULL,
    max_length NUMBER(10) NULL,
    reference_type VARCHAR2(80 CHAR) NULL,
    alias_required_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    runtime_override_allowed_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    sort_order NUMBER(10) DEFAULT 0 NOT NULL,
...
CREATE TABLE BAT_JOB_RUNTIME_PROJECTION (
    ...
    projection_status VARCHAR2(30 CHAR) DEFAULT 'ACTIVE' NOT NULL,
    executor_type VARCHAR2(40 CHAR) NOT NULL,
    executor_reference VARCHAR2(300 CHAR) NOT NULL,
    trigger_type VARCHAR2(30 CHAR) NOT NULL,
    trigger_expression VARCHAR2(500 CHAR) NULL,
...
CREATE TABLE BAT_JOB_PACK_JOB (
    ...
    center_cut_provider_key VARCHAR2(100 CHAR) NULL,
    center_cut_handler_key VARCHAR2(100 CHAR) NULL,
...
CREATE TABLE BAT_RUNTIME_COMMAND_ATTEMPT (
    attempt_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE BAT_RUNTIME_HEARTBEAT (
    heartbeat_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    instance_id VARCHAR2(120 CHAR) NOT NULL,
    heartbeat_at TIMESTAMP(6) NOT NULL,
    ready_yn CHAR(1 CHAR) NOT NULL,
    available_capacity NUMBER(10) DEFAULT 0 NOT NULL,
    queue_depth NUMBER(19) DEFAULT 0 NOT NULL,
    draining_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    current_execution_count NUMBER(10) DEFAULT 0 NOT NULL,
    active_lease_count NUMBER(10) DEFAULT 0 NOT NULL,
    last_error_code VARCHAR2(80 CHAR) NULL,
    deployment_version VARCHAR2(80 CHAR) NULL,
...
CREATE TABLE BAT_SB_JOB_EXECUTION (
    ...
    START_TIME TIMESTAMP(6) DEFAULT NULL NULL,
    END_TIME TIMESTAMP(6) DEFAULT NULL NULL,
    STATUS VARCHAR2(10 CHAR) NULL,
    EXIT_CODE VARCHAR2(2500 CHAR) NULL,
    EXIT_MESSAGE VARCHAR2(2500 CHAR) NULL,
...
CREATE TABLE CPF_NOTIFICATION_DELIVERY_LOG (
    delivery_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    rule_id NUMBER(19) NULL,
    event_type VARCHAR2(80 CHAR) NOT NULL,
    target_type VARCHAR2(80 CHAR) NULL,
    target_id VARCHAR2(120 CHAR) NULL,
    receiver VARCHAR2(200 CHAR) NULL,
    delivery_status VARCHAR2(30 CHAR) DEFAULT 'READY' NOT NULL,
    delivery_message VARCHAR2(2000 CHAR) NULL,
    requested_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    delivered_at TIMESTAMP(3) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE CPF_SAGA_STEP_EXECUTION (
    ...
    result_code VARCHAR2(100 CHAR) NULL,
    result_snapshot CLOB NULL,
    error_message VARCHAR2(2000 CHAR) NULL,
    execute_attempts NUMBER(10) DEFAULT 0 NOT NULL,
    compensation_attempts NUMBER(10) DEFAULT 0 NOT NULL,
    created_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    updated_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE CPF_TRANSACTION_LOG_DETAIL (
    DETAIL_ID NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    LOG_IDX NUMBER(19) NOT NULL,
    DETAIL_KEY VARCHAR2(100 CHAR) DEFAULT 'N/A' NOT NULL,
...
CREATE TABLE GW_BINDING (
    ...
    http_method VARCHAR2(20 CHAR) DEFAULT '*' NOT NULL,
    ...
    tls_policy_id VARCHAR2(100 CHAR) NULL,
    authentication_policy_id VARCHAR2(100 CHAR) NULL,
    authorization_policy_id VARCHAR2(100 CHAR) NULL,
    header_policy_id VARCHAR2(100 CHAR) NULL,
    rate_limit_policy_id VARCHAR2(100 CHAR) NULL,
    health_policy_id VARCHAR2(100 CHAR) NULL,
    ...
    idempotent_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    failover_group_id VARCHAR2(100 CHAR) NULL,
    gateway_allowed_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    direct_allowed_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    binding_status VARCHAR2(30 CHAR) DEFAULT 'DRAFT' NOT NULL,
    approval_id VARCHAR2(100 CHAR) NULL,
    effective_from TIMESTAMP NULL,
    effective_to TIMESTAMP NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    row_version NUMBER(19) DEFAULT 1 NOT NULL,
    binding_checksum VARCHAR2(64 CHAR) NULL,
    retired_by VARCHAR2(100 CHAR) NULL,
    retired_at TIMESTAMP NULL,
...
CREATE TABLE GW_SERVER_GROUP_MEMBER (
    ...
    enabled_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    effective_status VARCHAR2(30 CHAR) DEFAULT 'UNKNOWN' NOT NULL,
    fencing_token NUMBER(19) DEFAULT 0 NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    canary_percent NUMBER(10) DEFAULT 0 NOT NULL,
    probe_owner_id VARCHAR2(100 CHAR) NULL,
    probe_lease_until TIMESTAMP NULL,
    last_probe_at TIMESTAMP NULL,
    last_probe_code VARCHAR2(100 CHAR) NULL,
    consecutive_successes NUMBER(10) DEFAULT 0 NOT NULL,
    consecutive_failures NUMBER(10) DEFAULT 0 NOT NULL,
    active_requests NUMBER(19) DEFAULT 0 NOT NULL,
    ewma_latency_ms NUMBER(18,4) DEFAULT 0 NOT NULL,
...
CREATE TABLE OPS_RUNTIME_CHANGE (
    ...
    payload_schema_version NUMBER(10) DEFAULT 1 NOT NULL,
    request_hash VARCHAR2(64 CHAR) NOT NULL,
    payload_hash VARCHAR2(64 CHAR) NOT NULL,
    payload_json CLOB NOT NULL,
    rollback_payload_json CLOB NULL,
    target_snapshot_json CLOB NOT NULL,
    desired_version NUMBER(19) NOT NULL,
    rollout_mode VARCHAR2(30 CHAR) DEFAULT 'ALL_AT_ONCE' NOT NULL,
    wave_size NUMBER(10) DEFAULT 100 NOT NULL,
    quorum_percent NUMBER(10) DEFAULT 100 NOT NULL,
    change_state VARCHAR2(30 CHAR) DEFAULT 'APPLYING' NOT NULL,
    scheduled_at TIMESTAMP(3) NULL,
    expires_at TIMESTAMP(3) NULL,
    reason VARCHAR2(1000 CHAR) NOT NULL,
    approval_id VARCHAR2(100 CHAR) NULL,
    break_glass_id VARCHAR2(100 CHAR) NULL,
    requested_by VARCHAR2(100 CHAR) NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
...
CREATE TABLE OPS_LOG_POLICY_OVERRIDE (
    override_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    policy_id NUMBER(19) NULL,
    target_type VARCHAR2(30 CHAR) NOT NULL,
    target_id VARCHAR2(150 CHAR) NOT NULL,
    override_reason VARCHAR2(500 CHAR) NOT NULL,
    log_level VARCHAR2(20 CHAR) NULL,
    db_log_enabled_yn CHAR(1 CHAR) NULL,
    file_log_enabled_yn CHAR(1 CHAR) NULL,
    policy_schema_version NUMBER(10) NULL,
    query_capture_mode VARCHAR2(30 CHAR) NULL,
    request_header_capture_mode VARCHAR2(30 CHAR) NULL,
    response_header_capture_mode VARCHAR2(30 CHAR) NULL,
    request_body_capture_mode VARCHAR2(30 CHAR) NULL,
    response_body_capture_mode VARCHAR2(30 CHAR) NULL,
    error_stack_capture_mode VARCHAR2(30 CHAR) NULL,
    query_allowlist VARCHAR2(2000 CHAR) NULL,
    header_allowlist VARCHAR2(2000 CHAR) NULL,
    field_allowlist VARCHAR2(2000 CHAR) NULL,
    max_query_bytes NUMBER(10) NULL,
    max_header_bytes NUMBER(10) NULL,
    max_request_body_bytes NUMBER(10) NULL,
    max_response_body_bytes NUMBER(10) NULL,
    max_stack_bytes NUMBER(10) NULL,
    policy_checksum VARCHAR2(64 CHAR) NULL,
    request_body_log_yn CHAR(1 CHAR) NULL,
    response_body_log_yn CHAR(1 CHAR) NULL,
    error_stack_log_yn CHAR(1 CHAR) NULL,
...
CREATE TABLE OPS_SERVICE_ENDPOINT (
    ...
    endpoint_type VARCHAR2(30 CHAR) DEFAULT 'HTTP' NOT NULL,
    base_url VARCHAR2(500 CHAR) NOT NULL,
    context_path VARCHAR2(200 CHAR) NULL,
    default_timeout_ms NUMBER(10) DEFAULT 3000 NOT NULL,
    default_retry_count NUMBER(10) DEFAULT 0 NOT NULL,
    use_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
...
CREATE TABLE ADM_APPROVAL_PARTICIPANT (
    ...
    IDEMPOTENCY_KEY VARCHAR2(120 CHAR) NULL,
    DECISION_REASON VARCHAR2(1000 CHAR) NULL,
...
CREATE TABLE ADM_INCIDENT_TIMELINE (
    timeline_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    incident_id NUMBER(19) NOT NULL,
    action_type VARCHAR2(40 CHAR) NOT NULL,
    before_status VARCHAR2(30 CHAR) NULL,
    after_status VARCHAR2(30 CHAR) NOT NULL,
    reason VARCHAR2(1000 CHAR) NULL,
    approval_request_id VARCHAR2(160 CHAR) NULL,
    actor_id VARCHAR2(100 CHAR) NOT NULL,
    created_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE ADM_OPERATOR_PROFILE (
    OPERATOR_ID VARCHAR2(50 CHAR) NOT NULL,
    DISPLAY_NAME VARCHAR2(100 CHAR) NULL,
    EMPLOYEE_NO VARCHAR2(50 CHAR) NULL,
    EXTERNAL_SUBJECT VARCHAR2(200 CHAR) NULL,
    ORGANIZATION_CODE VARCHAR2(50 CHAR) NULL,
    POSITION_CODE VARCHAR2(50 CHAR) NULL,
    POSITION_NAME VARCHAR2(100 CHAR) NULL,
    JOB_TITLE_CODE VARCHAR2(50 CHAR) NULL,
    JOB_TITLE_NAME VARCHAR2(100 CHAR) NULL,
...
CREATE TABLE BAT_DEPLOYMENT_INSTANCE_RESULT (
    deployment_result_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    deployment_id VARCHAR2(80 CHAR) NOT NULL,
...
CREATE TABLE BAT_CENTER_CUT_JOB (
    ...
    batch_job_id VARCHAR2(100 CHAR) NULL,
    ...
    chunk_size NUMBER(10) DEFAULT 100 NOT NULL,
    retry_limit NUMBER(10) DEFAULT 3 NOT NULL,
    use_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    description VARCHAR2(500 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'BAT' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_EXECUTION (
    execution_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    job_id VARCHAR2(100 CHAR) NOT NULL,
    schedule_id VARCHAR2(100 CHAR) NULL,
    job_parameters VARCHAR2(2000 CHAR) NULL,
    execution_status VARCHAR2(30 CHAR) DEFAULT 'READY' NOT NULL,
    spring_batch_execution_id NUMBER(19) NULL,
    spring_batch_job_instance_id NUMBER(19) NULL,
    business_date DATE NULL,
    run_id VARCHAR2(120 CHAR) NULL,
    rerun_id VARCHAR2(120 CHAR) NULL,
    original_job_execution_id NUMBER(19) NULL,
    restart_attempt NUMBER(10) DEFAULT 0 NOT NULL,
    batch_instance_id VARCHAR2(100 CHAR) NULL,
    instance_id VARCHAR2(160 CHAR) NULL,
    worker_id VARCHAR2(160 CHAR) NULL,
    required_worker_version VARCHAR2(80 CHAR) NULL,
    required_capability VARCHAR2(120 CHAR) NULL,
    transaction_id CHAR(34 CHAR) NULL,
    transaction_segment_id VARCHAR2(120 CHAR) NULL,
    parent_segment_id VARCHAR2(120 CHAR) NULL,
    job_log_relative_path VARCHAR2(1000 CHAR) NULL,
    start_time TIMESTAMP(3) NULL,
    end_time TIMESTAMP(3) NULL,
    read_count NUMBER(19) DEFAULT 0 NOT NULL,
    write_count NUMBER(19) DEFAULT 0 NOT NULL,
    skip_count NUMBER(19) DEFAULT 0 NOT NULL,
    total_count NUMBER(19) DEFAULT 0 NOT NULL,
    processed_count NUMBER(19) DEFAULT 0 NOT NULL,
    success_count NUMBER(19) DEFAULT 0 NOT NULL,
    failure_count NUMBER(19) DEFAULT 0 NOT NULL,
    retry_count NUMBER(19) DEFAULT 0 NOT NULL,
    stop_requested_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    progress_rate NUMBER(5,2) DEFAULT 0.00 NOT NULL,
    tps NUMBER(18,4) DEFAULT 0.0000 NOT NULL,
    avg_elapsed_ms NUMBER(19) DEFAULT 0 NOT NULL,
    max_elapsed_ms NUMBER(19) DEFAULT 0 NOT NULL,
    last_heartbeat_at TIMESTAMP(3) NULL,
    current_step_name VARCHAR2(150 CHAR) NULL,
    error_message CLOB NULL,
    requested_by VARCHAR2(100 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'BAT' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    row_version NUMBER(19) DEFAULT 0 NOT NULL,
    definition_version NUMBER(19) NULL,
    definition_checksum VARCHAR2(128 CHAR) NULL,
...
CREATE TABLE BAT_JOB_RELATION (
    relation_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    job_id VARCHAR2(100 CHAR) NOT NULL,
    related_job_id VARCHAR2(100 CHAR) NOT NULL,
    relation_type VARCHAR2(30 CHAR) NOT NULL,
    trigger_condition VARCHAR2(50 CHAR) DEFAULT 'COMPLETED' NOT NULL,
    required_status VARCHAR2(30 CHAR) DEFAULT 'COMPLETED' NOT NULL,
    sort_order NUMBER(10) DEFAULT 0 NOT NULL,
    use_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'BAT' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_SCHEDULE (
    ...
    calendar_id VARCHAR2(50 CHAR) DEFAULT 'DEFAULT' NOT NULL,
    business_day_only_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    holiday_policy VARCHAR2(30 CHAR) DEFAULT 'SKIP' NOT NULL,
    available_start_time VARCHAR2(15 CHAR) NULL,
    available_end_time VARCHAR2(15 CHAR) NULL,
    run_date_pattern VARCHAR2(80 CHAR) NULL,
    timezone VARCHAR2(50 CHAR) DEFAULT 'Asia/Seoul' NOT NULL,
    enabled_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
...
CREATE TABLE BAT_SB_JOB_EXECUTION_PARAMS (
    ...
    PARAMETER_VALUE VARCHAR2(2500 CHAR) NULL,
...
CREATE TABLE CPF_NOTIFICATION_DELIVERY_ATTEMPT (
    ...
    provider_status VARCHAR2(80 CHAR) NULL,
    provider_message VARCHAR2(2000 CHAR) NULL,
...
CREATE TABLE GW_APPLY_STATUS (
    ...
    applied_version VARCHAR2(100 CHAR) NULL,
...
CREATE TABLE GW_CONNECTION_TEST (
    ...
    binding_id VARCHAR2(100 CHAR) NOT NULL,
    gateway_instance_id VARCHAR2(100 CHAR) NULL,
    instance_id VARCHAR2(100 CHAR) NULL,
    test_type VARCHAR2(50 CHAR) NOT NULL,
    test_status VARCHAR2(30 CHAR) NOT NULL,
    failure_stage VARCHAR2(50 CHAR) NULL,
    duration_ms NUMBER(19) DEFAULT 0 NOT NULL,
    trace_id VARCHAR2(100 CHAR) NULL,
...
CREATE TABLE GW_CONNECTION_TEST_OPERATION (
    ...
    binding_id VARCHAR2(100 CHAR) NOT NULL,
    test_type VARCHAR2(50 CHAR) NOT NULL,
    operation_status VARCHAR2(30 CHAR) DEFAULT 'REQUESTED' NOT NULL,
    requested_by VARCHAR2(100 CHAR) NOT NULL,
    request_reason VARCHAR2(1000 CHAR) NOT NULL,
    request_payload_hash VARCHAR2(64 CHAR) NOT NULL,
    expires_at TIMESTAMP NOT NULL,
    cancel_requested_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    result_summary VARCHAR2(2000 CHAR) NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE GW_TRANSACTION (
    ...
    channel_id VARCHAR2(100 CHAR) NULL,
    source_ip VARCHAR2(100 CHAR) NULL,
    source_port NUMBER(10) NULL,
    gateway_instance_id VARCHAR2(100 CHAR) NOT NULL,
    binding_id VARCHAR2(100 CHAR) NOT NULL,
    route_id VARCHAR2(100 CHAR) NOT NULL,
    route_version VARCHAR2(100 CHAR) NOT NULL,
    server_group_id VARCHAR2(100 CHAR) NOT NULL,
    final_instance_id VARCHAR2(100 CHAR) NULL,
    result_status VARCHAR2(30 CHAR) NOT NULL,
    protocol_status VARCHAR2(30 CHAR) NULL,
    business_code VARCHAR2(100 CHAR) NULL,
    failure_stage VARCHAR2(50 CHAR) NULL,
    unknown_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    binding_version NUMBER(19) DEFAULT 0 NOT NULL,
    config_checksum VARCHAR2(64 CHAR) NULL,
    request_method VARCHAR2(20 CHAR) NULL,
    request_path VARCHAR2(1000 CHAR) NULL,
    completed_at TIMESTAMP NULL,
...
CREATE TABLE OPS_RUNTIME_CHANGE_AUDIT (
    ...
    actor_id VARCHAR2(100 CHAR) NOT NULL,
    reason VARCHAR2(500 CHAR) NULL,
    evidence_hash VARCHAR2(64 CHAR) NULL,
...
CREATE TABLE OPS_SERVICE_INSTANCE (
    ...
    base_url VARCHAR2(500 CHAR) NOT NULL,
    host_name VARCHAR2(150 CHAR) NULL,
    port_no NUMBER(10) NULL,
    instance_status VARCHAR2(30 CHAR) DEFAULT 'UP' NOT NULL,
    ...
    environment_code VARCHAR2(40 CHAR) DEFAULT 'default' NOT NULL,
    zone_code VARCHAR2(60 CHAR) NULL,
    cell_code VARCHAR2(60 CHAR) NULL,
    priority_no NUMBER(10) DEFAULT 100 NOT NULL,
    maintenance_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    drain_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    drain_deadline_at TIMESTAMP(3) NULL,
...
CREATE TABLE OPS_SERVICE_ROUTING_POLICY (
    ...
    service_id VARCHAR2(40 CHAR) NOT NULL,
    endpoint_code VARCHAR2(80 CHAR) NOT NULL,
    routing_mode VARCHAR2(30 CHAR) DEFAULT 'PRIMARY' NOT NULL,
    load_balance_type VARCHAR2(30 CHAR) DEFAULT 'WEIGHT' NOT NULL,
    failover_enabled_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    health_check_required_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    active_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    priority NUMBER(10) DEFAULT 100 NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_CENTER_CUT_EXECUTION (
    ...
    target_cursor VARCHAR2(1000 CHAR) NULL,
    target_complete_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    target_count NUMBER(19) DEFAULT 0 NOT NULL,
    tps_limit NUMBER(10) DEFAULT 0 NOT NULL,
    concurrency_limit NUMBER(10) DEFAULT 1 NOT NULL,
    processed_count NUMBER(19) DEFAULT 0 NOT NULL,
    success_count NUMBER(19) DEFAULT 0 NOT NULL,
    failure_count NUMBER(19) DEFAULT 0 NOT NULL,
    unknown_count NUMBER(19) DEFAULT 0 NOT NULL,
    transaction_id CHAR(34 CHAR) NULL,
    parent_segment_id VARCHAR2(120 CHAR) NULL,
    requested_by VARCHAR2(120 CHAR) NOT NULL,
    reason_text VARCHAR2(1000 CHAR) NOT NULL,
    last_error_message VARCHAR2(1000 CHAR) NULL,
    created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
    updated_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
...
CREATE TABLE BAT_CENTER_CUT_PARAMETER (
    parameter_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    center_cut_job_id VARCHAR2(100 CHAR) NOT NULL,
    parameter_key VARCHAR2(100 CHAR) NOT NULL,
    parameter_value VARCHAR2(1000 CHAR) NULL,
    encrypted_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    use_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'BAT' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_EXECUTION_ATTEMPT (
    ...
    executor_type VARCHAR2(40 CHAR) NULL,
    exit_code NUMBER(10) NULL,
    stdout_text CLOB NULL,
    stderr_text CLOB NULL,
    output_truncated_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    duration_ms NUMBER(19) NULL,
    artifact_hash VARCHAR2(128 CHAR) NULL,
...
CREATE TABLE BAT_EXECUTION_LEASE (
    lease_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    execution_id NUMBER(19) NOT NULL,
    worker_id VARCHAR2(160 CHAR) NOT NULL,
    lease_token VARCHAR2(80 CHAR) NOT NULL,
    lease_status VARCHAR2(30 CHAR) DEFAULT 'CLAIMED' NOT NULL,
    claimed_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    lease_until TIMESTAMP(3) NOT NULL,
    last_heartbeat_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    attempt_no NUMBER(10) DEFAULT 1 NOT NULL,
    takeover_count NUMBER(10) DEFAULT 0 NOT NULL,
    fencing_token NUMBER(19) DEFAULT 0 NOT NULL,
...
CREATE TABLE BAT_EXECUTION_RESULT_DETAIL (
    execution_id NUMBER(19) NOT NULL,
    definition_version NUMBER(19) NULL,
    definition_checksum VARCHAR2(64 CHAR) NULL,
    executor_status VARCHAR2(40 CHAR) NOT NULL,
    exit_code NUMBER(10) NULL,
    timeout_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    unknown_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    output_truncated_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    output_hash VARCHAR2(64 CHAR) NULL,
    artifact_hash VARCHAR2(64 CHAR) NULL,
    parameter_snapshot_hash VARCHAR2(64 CHAR) NULL,
    result_message VARCHAR2(2000 CHAR) NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_GHOST_EVENT (
    ghost_event_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    execution_id NUMBER(19) NULL,
    spring_batch_execution_id NUMBER(19) NULL,
    job_id VARCHAR2(100 CHAR) NOT NULL,
    instance_id VARCHAR2(160 CHAR) NULL,
    worker_id VARCHAR2(160 CHAR) NULL,
    ghost_status VARCHAR2(30 CHAR) DEFAULT 'DETECTED' NOT NULL,
    detected_reason VARCHAR2(1000 CHAR) NOT NULL,
    action_type VARCHAR2(30 CHAR) NULL,
    action_reason VARCHAR2(1000 CHAR) NULL,
    action_by VARCHAR2(100 CHAR) NULL,
    detected_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    action_at TIMESTAMP(3) NULL,
    lock_released_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    retryable_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    before_data CLOB NULL,
    after_data CLOB NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'BAT' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_STEP_EXECUTION (
    step_execution_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    execution_id NUMBER(19) NOT NULL,
    spring_batch_step_execution_id NUMBER(19) NULL,
    worker_id VARCHAR2(160 CHAR) NULL,
...
CREATE TABLE BAT_EXECUTION_TARGET (
    target_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    execution_id NUMBER(19) NULL,
    job_id VARCHAR2(100 CHAR) NOT NULL,
    schedule_id VARCHAR2(100 CHAR) NULL,
    target_instance_id VARCHAR2(100 CHAR) NULL,
    business_date DATE NULL,
    planned_run_at TIMESTAMP(3) NULL,
    dispatch_status VARCHAR2(30 CHAR) DEFAULT 'WAITING' NOT NULL,
    dispatch_reason VARCHAR2(500 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'BAT' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'BAT' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_SCHEDULE_TRIGGER (
    ...
    idempotency_key VARCHAR2(200 CHAR) NOT NULL,
    dispatch_owner VARCHAR2(160 CHAR) NULL,
    dispatch_token NUMBER(19) NULL,
    dispatch_lease_until TIMESTAMP(6) NULL,
    attempt_count NUMBER(10) DEFAULT 0 NOT NULL,
    last_error_code VARCHAR2(100 CHAR) NULL,
...
CREATE TABLE GW_ATTEMPT (
    ...
    attempt_no NUMBER(10) NOT NULL,
    instance_id VARCHAR2(100 CHAR) NOT NULL,
    target_host VARCHAR2(300 CHAR) NULL,
    target_port NUMBER(10) NULL,
    target_protocol VARCHAR2(30 CHAR) NOT NULL,
    ...
    gateway_instance_id VARCHAR2(100 CHAR) NULL,
    selection_reason VARCHAR2(100 CHAR) NULL,
    unknown_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
...
CREATE TABLE GW_TRANSACTION_CAPTURE_SEGMENT (
    ...
    truncated_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    metadata_only_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    observed_bytes NUMBER(19) DEFAULT 0 NOT NULL,
...
CREATE TABLE OPS_RUNTIME_DELIVERY (
    ...
    sequence_no NUMBER(10) NOT NULL,
    desired_version NUMBER(19) NOT NULL,
    delivery_state VARCHAR2(30 CHAR) DEFAULT 'PENDING' NOT NULL,
    attempt_no NUMBER(10) DEFAULT 0 NOT NULL,
    next_attempt_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    fencing_token NUMBER(19) NULL,
    claimed_at TIMESTAMP(3) NULL,
    acknowledged_at TIMESTAMP(3) NULL,
    actual_hash VARCHAR2(64 CHAR) NULL,
    error_code VARCHAR2(80 CHAR) NULL,
    error_message VARCHAR2(900 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE OPS_RUNTIME_INSTANCE_FEATURE_STATE (
    instance_id VARCHAR2(120 CHAR) NOT NULL,
    change_type VARCHAR2(80 CHAR) NOT NULL,
    desired_version NUMBER(19) DEFAULT 0 NOT NULL,
    actual_version NUMBER(19) DEFAULT 0 NOT NULL,
    desired_hash VARCHAR2(64 CHAR) NULL,
    actual_hash VARCHAR2(64 CHAR) NULL,
    drift_state VARCHAR2(30 CHAR) DEFAULT 'UNKNOWN' NOT NULL,
    source_delivery_id VARCHAR2(80 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE OPS_RUNTIME_INSTANCE_STATE (
    ...
    desired_hash VARCHAR2(64 CHAR) NULL,
    actual_hash VARCHAR2(64 CHAR) NULL,
    drift_state VARCHAR2(30 CHAR) DEFAULT 'IN_SYNC' NOT NULL,
    capabilities_json CLOB NULL,
    labels_json CLOB NULL,
    artifact_version VARCHAR2(100 CHAR) NULL,
    artifact_commit VARCHAR2(64 CHAR) NULL,
    runtime_role VARCHAR2(40 CHAR) NULL,
    registration_source VARCHAR2(120 CHAR) NULL,
    schema_version VARCHAR2(100 CHAR) NULL,
    config_hash VARCHAR2(64 CHAR) NULL,
    clock_skew_ms NUMBER(19) DEFAULT 0 NOT NULL,
    desired_runtime_state VARCHAR2(32 CHAR) DEFAULT 'RUNNING' NOT NULL,
    actual_runtime_state VARCHAR2(32 CHAR) DEFAULT 'UNKNOWN' NOT NULL,
    control_row_version NUMBER(19) DEFAULT 0 NOT NULL,
    last_ack_change_id VARCHAR2(80 CHAR) NULL,
    last_ack_at TIMESTAMP(3) NULL,
    heartbeat_at TIMESTAMP(3) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
...
CREATE TABLE OPS_SERVICE_CALL_HISTORY (
    call_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    transaction_id CHAR(34 CHAR) NULL,
    trace_id VARCHAR2(100 CHAR) NULL,
    service_id VARCHAR2(40 CHAR) NOT NULL,
    endpoint_code VARCHAR2(80 CHAR) NULL,
    instance_id VARCHAR2(120 CHAR) NULL,
    http_method VARCHAR2(10 CHAR) DEFAULT 'GET' NOT NULL,
    request_path VARCHAR2(500 CHAR) DEFAULT '/' NOT NULL,
    call_status VARCHAR2(30 CHAR) NOT NULL,
    http_status NUMBER(10) NULL,
    duration_ms NUMBER(19) NULL,
    timeout_ms NUMBER(10) NULL,
...
CREATE TABLE OPS_SERVICE_CIRCUIT_STATE (
    circuit_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    service_id VARCHAR2(40 CHAR) NOT NULL,
    endpoint_code VARCHAR2(80 CHAR) NOT NULL,
    instance_id VARCHAR2(120 CHAR) NULL,
    circuit_state VARCHAR2(30 CHAR) DEFAULT 'CLOSED' NOT NULL,
    failure_count NUMBER(10) DEFAULT 0 NOT NULL,
    success_count NUMBER(10) DEFAULT 0 NOT NULL,
    opened_at TIMESTAMP(3) NULL,
    half_opened_at TIMESTAMP(3) NULL,
    closed_at TIMESTAMP(3) NULL,
    last_failure_message VARCHAR2(1000 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE OPS_SERVICE_HEALTH_STATUS (
    health_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    service_id VARCHAR2(40 CHAR) NOT NULL,
    endpoint_code VARCHAR2(80 CHAR) NOT NULL,
    instance_id VARCHAR2(120 CHAR) NULL,
    health_status VARCHAR2(30 CHAR) NOT NULL,
    http_status NUMBER(10) NULL,
    response_time_ms NUMBER(19) NULL,
    failure_message VARCHAR2(1000 CHAR) NULL,
    checked_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_CENTER_CUT_ITEM (
    center_cut_item_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    center_cut_job_id VARCHAR2(100 CHAR) NOT NULL,
    center_cut_execution_id VARCHAR2(80 CHAR) NULL,
    business_key VARCHAR2(200 CHAR) NOT NULL,
    business_date DATE NULL,
    item_status VARCHAR2(30 CHAR) DEFAULT 'READY' NOT NULL,
    transaction_id CHAR(34 CHAR) NULL,
    transaction_segment_id VARCHAR2(120 CHAR) NULL,
    parent_segment_id VARCHAR2(120 CHAR) NULL,
    item_payload CLOB NULL,
...
CREATE TABLE BAT_CENTER_CUT_RATE_WINDOW (
    ...
    admitted_count NUMBER(10) DEFAULT 0 NOT NULL,
    updated_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
...
CREATE TABLE BAT_CENTER_CUT_CLAIM (
    center_cut_item_id NUMBER(19) NULL,
...
CREATE TABLE BAT_CENTER_CUT_RESULT (
    center_cut_result_id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE OR REPLACE TRIGGER TRG_ADM_APPROVAL_CAPABILITY_NONCE_TOUCH
BEFORE UPDATE ON ADM_APPROVAL_CAPABILITY_NONCE
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER TRG_ADM_APPROVAL_POLICY_LOCK_TOUCH
BEFORE UPDATE ON ADM_APPROVAL_POLICY_LOCK
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_ADM_FILE_JOB_TOUCH
BEFORE UPDATE ON ADM_FILE_JOB
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_BAT_EXECUTION_CONTROL_TOUCH
BEFORE UPDATE ON BAT_EXECUTION_CONTROL
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_BAT_EXECUTION_EPOCH_TOUCH
BEFORE UPDATE ON BAT_EXECUTION_EPOCH
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_CMN_CACHE_REFRESH_CHECKPOINT_TOUCH
BEFORE UPDATE ON CMN_CACHE_REFRESH_CHECKPOINT
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_CMN_CACHE_REFRESH_EVENT_TOUCH
BEFORE UPDATE ON CMN_CACHE_REFRESH_EVENT
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_CMN_CODE_TOUCH
BEFORE UPDATE ON CMN_CODE
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_CMN_MESSAGE_TOUCH
BEFORE UPDATE ON CMN_MESSAGE
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_CMN_PARAMETER_TOUCH
BEFORE UPDATE ON CMN_PARAMETER
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_CMN_RESPONSE_CODE_TOUCH
BEFORE UPDATE ON CMN_RESPONSE_CODE
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_CMN_TEMPLATE_DEFINITION_TOUCH
BEFORE UPDATE ON CMN_TEMPLATE_DEFINITION
FOR EACH ROW
BEGIN
  :NEW.UPDATED_AT := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_CPF_CACHE_INVALIDATION_CHECKPOINT_TOUCH
BEFORE UPDATE ON CPF_CACHE_INVALIDATION_CHECKPOINT
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_GW_SERVER_GROUP_TOUCH
BEFORE UPDATE ON GW_SERVER_GROUP
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_GW_SPOOL_CHECKPOINT_TOUCH
BEFORE UPDATE ON GW_SPOOL_CHECKPOINT
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_CHANNEL_EXECUTION_POLICY_TOUCH
BEFORE UPDATE ON OPS_CHANNEL_EXECUTION_POLICY
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_CHANNEL_POLICY_VERSION_TOUCH
BEFORE UPDATE ON OPS_CHANNEL_POLICY_VERSION
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_CHANNEL_REGISTRY_TOUCH
BEFORE UPDATE ON OPS_CHANNEL_REGISTRY
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_CONTROL_OPERATION_TOUCH
BEFORE UPDATE ON OPS_CONTROL_OPERATION
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_LOG_POLICY_TOUCH
BEFORE UPDATE ON OPS_LOG_POLICY
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_MANAGED_SERVER_TOUCH
BEFORE UPDATE ON OPS_MANAGED_SERVER
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_RUNTIME_CONTROLLER_LEASE_TOUCH
BEFORE UPDATE ON OPS_RUNTIME_CONTROLLER_LEASE
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_RUNTIME_INSTANCE_GROUP_TOUCH
BEFORE UPDATE ON OPS_RUNTIME_INSTANCE_GROUP
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_RUNTIME_RATE_BUCKET_TOUCH
BEFORE UPDATE ON OPS_RUNTIME_RATE_BUCKET
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_RUNTIME_VERSION_TOUCH
BEFORE UPDATE ON OPS_RUNTIME_VERSION
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_SCHEMA_INSTALLATION_TOUCH
BEFORE UPDATE ON OPS_SCHEMA_INSTALLATION
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_SERVICE_TOUCH
BEFORE UPDATE ON OPS_SERVICE
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_TRANSACTION_SUBJECT_TOUCH
BEFORE UPDATE ON OPS_TRANSACTION_SUBJECT
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_SEC_JWT_KEY_TOUCH
BEFORE UPDATE ON SEC_JWT_KEY
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_SEC_TOKEN_AUDIT_LOG_TOUCH
BEFORE UPDATE ON SEC_TOKEN_AUDIT_LOG
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_ADM_FILE_JOB_ROW_TOUCH
BEFORE UPDATE ON ADM_FILE_JOB_ROW
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_BAT_EXECUTION_LINK_TOUCH
BEFORE UPDATE ON BAT_EXECUTION_LINK
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_GW_BINDING_TOUCH
...
CREATE OR REPLACE TRIGGER TRG_GW_SERVER_GROUP_MEMBER_TOUCH
BEFORE UPDATE ON GW_SERVER_GROUP_MEMBER
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_RUNTIME_CHANGE_TOUCH
BEFORE UPDATE ON OPS_RUNTIME_CHANGE
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_LOG_POLICY_OVERRIDE_TOUCH
BEFORE UPDATE ON OPS_LOG_POLICY_OVERRIDE
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_RUNTIME_POLICY_DELIVERY_TOUCH
BEFORE UPDATE ON OPS_RUNTIME_POLICY_DELIVERY
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_SERVICE_ENDPOINT_TOUCH
BEFORE UPDATE ON OPS_SERVICE_ENDPOINT
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_LOG_POLICY_AUDIT_TOUCH
BEFORE UPDATE ON OPS_LOG_POLICY_AUDIT
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_SERVICE_INSTANCE_TOUCH
BEFORE UPDATE ON OPS_SERVICE_INSTANCE
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_SERVICE_ROUTING_POLICY_TOUCH
BEFORE UPDATE ON OPS_SERVICE_ROUTING_POLICY
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_BAT_EXECUTION_RESULT_DETAIL_TOUCH
BEFORE UPDATE ON BAT_EXECUTION_RESULT_DETAIL
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_RUNTIME_DELIVERY_TOUCH
BEFORE UPDATE ON OPS_RUNTIME_DELIVERY
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_RUNTIME_GROUP_MEMBER_TOUCH
BEFORE UPDATE ON OPS_RUNTIME_GROUP_MEMBER
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_RUNTIME_INSTANCE_FEATURE_STATE_TOUCH
BEFORE UPDATE ON OPS_RUNTIME_INSTANCE_FEATURE_STATE
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_RUNTIME_INSTANCE_STATE_TOUCH
BEFORE UPDATE ON OPS_RUNTIME_INSTANCE_STATE
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_SERVICE_CALL_HISTORY_TOUCH
BEFORE UPDATE ON OPS_SERVICE_CALL_HISTORY
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_SERVICE_CIRCUIT_STATE_TOUCH
BEFORE UPDATE ON OPS_SERVICE_CIRCUIT_STATE
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_SERVICE_HEALTH_STATUS_TOUCH
BEFORE UPDATE ON OPS_SERVICE_HEALTH_STATUS
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
COMMENT ON TABLE MBW_ATTACHMENT IS 'MBW 첨부파일 메타';
...
COMMENT ON TABLE MBW_AUDIT_CHAIN_LOCK IS 'MBW 감사 체인 동시성/무결성 head';
...
COMMENT ON TABLE MBW_BOOTSTRAP_APPROVAL IS 'MBW 최초 특권 운영자 Bootstrap 승인 및 복구 원장';
...
COMMENT ON COLUMN MBW_BOOTSTRAP_APPROVAL.admin_user_id IS '생성된 MBW 관리자 사용자 순번';
...
COMMENT ON TABLE MBW_DOWNLOAD_AUDIT IS 'MBW 다운로드 감사';
...
COMMENT ON TABLE MBW_JOB_TITLE IS 'MBW 직책 기준정보';
...
COMMENT ON COLUMN MBW_NOTIFICATION.recipient_login_id IS '수신 MBW 로그인 ID';
...
COMMENT ON TABLE MBW_ORGANIZATION IS 'MBW 조직';
...
COMMENT ON TABLE MBW_POSITION IS 'MBW 직급 기준정보';
...
COMMENT ON TABLE MBW_PROJECT_SETTING IS 'MBW 프로젝트 설정';
...
COMMENT ON TABLE MBW_SAVED_SEARCH IS 'MBW 저장 검색';
...
COMMENT ON TABLE MBW_LOGIN_OPERATION IS 'MBW 로그인 멱등 처리 이력';
...
COMMENT ON TABLE MBW_EMPLOYEE IS 'MBW 직원 프로필';
...
COMMENT ON TABLE MBW_USER_ROLE IS 'MBW 사용자 다중 역할 이력';
...
COMMENT ON TABLE MBW_EMPLOYEE_ASSIGNMENT IS 'MBW 직원 유효기간 기반 조직/직급/직책 Assignment';
...
COMMENT ON TABLE MBW_ORGANIZATION_RESPONSIBILITY IS 'MBW 조직 책임자/대행/결재 책임자 유효기간 모델';
