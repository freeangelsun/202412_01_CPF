...
CREATE TABLE OPS_RUNTIME_INSTANCE_STATE (
    ...
    desired_runtime_state VARCHAR2(32 CHAR) NOT NULL DEFAULT 'RUNNING',
    actual_runtime_state VARCHAR2(32 CHAR) NOT NULL DEFAULT 'UNKNOWN',
    control_row_version NUMBER(19) NOT NULL DEFAULT 0,
