...
-- AUTO-GENERATED DERIVED COMPATIBILITY SOURCE
-- authority=cpf-tools/db/generated/current/oracle/bza-schema.sql
...
CREATE TABLE BZA_MENU (
    ...
    module_code VARCHAR2(20 CHAR) DEFAULT 'BZA' NOT NULL,
...
CREATE TABLE BZA_LOGIN_HISTORY (
    ...
    admin_user_id NUMBER(19) NULL,
    login_domain VARCHAR2(30 CHAR) DEFAULT 'BZA' NOT NULL,
    admin_login_id VARCHAR2(80 CHAR) NOT NULL,
    ...
    user_agent VARCHAR2(500 CHAR) NULL,
    transaction_id CHAR(34 CHAR) NULL,
    module_id VARCHAR2(3 CHAR) NULL,
    was_id VARCHAR2(7 CHAR) NULL,
