...
CREATE TABLE OPS_SYSTEM_REGISTRY (
    ...
    policy_version NUMBER(19) DEFAULT 1 NOT NULL,
    ...
    last_instance_id VARCHAR2(160 CHAR) NULL,
...
CREATE TABLE OPS_OPERATION_CATALOG (
    ...
    system_code VARCHAR2(32 CHAR) NOT NULL,
    domain_code VARCHAR2(50 CHAR) NULL,
    application_code VARCHAR2(100 CHAR) NULL,
    ...
    openapi_operation_id VARCHAR2(160 CHAR) NULL,
    source_fingerprint VARCHAR2(64 CHAR) NULL,
    discovery_status VARCHAR2(30 CHAR) DEFAULT 'ACTIVE' NOT NULL,
    first_seen_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    last_seen_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    last_instance_id VARCHAR2(160 CHAR) NULL,
    metadata_version NUMBER(19) DEFAULT 1 NOT NULL,
...
CREATE TABLE OPS_OPERATION_DISCOVERY_INSTANCE (
    ...
    system_code VARCHAR2(32 CHAR) NOT NULL,
    application_code VARCHAR2(100 CHAR) NULL,
    artifact_version VARCHAR2(120 CHAR) NULL,
    artifact_commit VARCHAR2(120 CHAR) NULL,
    discovered_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    last_reported_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE OPS_SYSTEM_DOMAIN_ACCESS (
    ...
    allowed_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    policy_version NUMBER(19) DEFAULT 1 NOT NULL,
    change_reason VARCHAR2(500 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE OPS_OPERATION_POLICY (
    operation_id VARCHAR2(160 CHAR) NOT NULL,
    enabled_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    all_callers_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    channel_policy_required_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    policy_version NUMBER(19) DEFAULT 1 NOT NULL,
    seed_source VARCHAR2(80 CHAR) NULL,
    seed_revision VARCHAR2(120 CHAR) NULL,
    seeded_at TIMESTAMP(3) NULL,
    change_reason VARCHAR2(500 CHAR) NULL,
    created_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(100 CHAR) DEFAULT 'CPF' NOT NULL,
...
CREATE OR REPLACE TRIGGER TRG_OPS_SYSTEM_REGISTRY_TOUCH
BEFORE UPDATE ON OPS_SYSTEM_REGISTRY
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER TRG_OPS_OPERATION_CATALOG_TOUCH
BEFORE UPDATE ON OPS_OPERATION_CATALOG
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_OPERATION_DISCOVERY_INSTANCE_TOUCH
BEFORE UPDATE ON OPS_OPERATION_DISCOVERY_INSTANCE
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_SYSTEM_DOMAIN_ACCESS_TOUCH
BEFORE UPDATE ON OPS_SYSTEM_DOMAIN_ACCESS
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_OPERATION_POLICY_TOUCH
BEFORE UPDATE ON OPS_OPERATION_POLICY
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRG_OPS_OPERATION_CALLER_POLICY_TOUCH
BEFORE UPDATE ON OPS_OPERATION_CALLER_POLICY
FOR EACH ROW
BEGIN
  :NEW.updated_at := CURRENT_TIMESTAMP;
END;
...
SELECT transaction_id, active_yn, 'N', 'N', 1, 'MIGRATION', 'V121', CURRENT_TIMESTAMP,
