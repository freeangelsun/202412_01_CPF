...
RENAME cpf_channel_registry TO OPS_CHANNEL_REGISTRY;
RENAME cpf_channel_execution_policy TO OPS_CHANNEL_EXECUTION_POLICY;
RENAME cpf_channel_policy_version TO OPS_CHANNEL_POLICY_VERSION;
...
ALTER TABLE OPS_CHANNEL_EXECUTION_POLICY MODIFY operation_id VARCHAR2(160 CHAR);
ALTER TABLE OPS_CHANNEL_EXECUTION_POLICY ADD CONSTRAINT ck_ops_channel_execution_policy_operation
  CHECK (operation_id = '*' OR REGEXP_LIKE(operation_id, '^[A-Za-z][A-Za-z0-9_.:-]{2,159}$'));
