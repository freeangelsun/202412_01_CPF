...
CREATE TABLE OPS_RETENTION_POLICY (
    ...
    action_name VARCHAR2(16 CHAR) DEFAULT 'KEEP' NOT NULL,
    retention_days NUMBER(10) DEFAULT 90 NOT NULL,
    schedule_expression VARCHAR2(100 CHAR) NULL,
    maintenance_start VARCHAR2(8 CHAR) NULL,
    maintenance_end VARCHAR2(8 CHAR) NULL,
    enabled_yn CHAR(1 CHAR) DEFAULT 'Y' NOT NULL,
    paused_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    legal_hold_yn CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    chunk_size NUMBER(10) DEFAULT 1000 NOT NULL,
    throttle_millis NUMBER(19) DEFAULT 0 NOT NULL,
    max_rows_per_run NUMBER(19) DEFAULT 100000 NOT NULL,
    max_runtime_seconds NUMBER(19) DEFAULT 300 NOT NULL,
    lease_seconds NUMBER(10) DEFAULT 60 NOT NULL,
    policy_version NUMBER(19) DEFAULT 1 NOT NULL,
    next_run_at TIMESTAMP(3) NULL,
    last_run_at TIMESTAMP(3) NULL,
    lease_owner VARCHAR2(128 CHAR) NULL,
...
CREATE TABLE OPS_RETENTION_RUN (
    ...
    cutoff_at TIMESTAMP(3) NULL,
    started_at TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    completed_at TIMESTAMP(3) NULL,
    matched_count NUMBER(19) DEFAULT 0 NOT NULL,
    archived_count NUMBER(19) DEFAULT 0 NOT NULL,
    deleted_count NUMBER(19) DEFAULT 0 NOT NULL,
    processed_count NUMBER(19) DEFAULT 0 NOT NULL,
