DROP TABLE cpf_gateway_transaction_capture_segment CASCADE CONSTRAINTS;
...
DROP TABLE cpf_gateway_health_history CASCADE CONSTRAINTS;
DROP TABLE cpf_gateway_connection_test_operation CASCADE CONSTRAINTS;
DROP TABLE cpf_gateway_spool_checkpoint CASCADE CONSTRAINTS;
DROP TABLE cpf_gateway_operation_idempotency CASCADE CONSTRAINTS;
