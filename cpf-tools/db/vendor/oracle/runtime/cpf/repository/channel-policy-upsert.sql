...
USING (
    SELECT ? policy_key, ? operation_id, ? caller_channel, ? allowed_yn,
...
WHEN MATCHED THEN UPDATE SET
    ...
    target.caller_channel = source.caller_channel,
...
WHEN NOT MATCHED THEN INSERT (
    ...
    source.policy_key, source.operation_id, source.caller_channel, source.allowed_yn,
