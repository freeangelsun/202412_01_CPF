...
USING (
  SELECT 'BADM-RLG-EX-0001' AS legacy_execution_id, 'BADMRL0001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  ...
  UNION ALL
  SELECT 'OADM-MBR-01-0010' AS legacy_execution_id, 'OADMMB0010' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OADM-MBR-01-0011' AS legacy_execution_id, 'OADMMB0011' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OADM-MBR-02-0012' AS legacy_execution_id, 'OADMMB0012' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OADM-MBR-02-0015' AS legacy_execution_id, 'OADMMB0015' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OADM-MBR-03-0013' AS legacy_execution_id, 'OADMMB0013' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OADM-MBR-03-0014' AS legacy_execution_id, 'OADMMB0014' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OADM-MBR-04-0016' AS legacy_execution_id, 'OADMMB0016' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  ...
  UNION ALL
  SELECT 'OMBR-AUT-01-0004' AS legacy_execution_id, 'OMBRAU0004' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OMBR-AUT-01-0005' AS legacy_execution_id, 'OMBRAU0005' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OMBR-AUT-02-0001' AS legacy_execution_id, 'OMBRAU0001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OMBR-AUT-02-0002' AS legacy_execution_id, 'OMBRAU0002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OMBR-AUT-02-0003' AS legacy_execution_id, 'OMBRAU0003' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OMBR-BSE-01-0001' AS legacy_execution_id, 'OMBRMB0001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OMBR-BSE-01-0002' AS legacy_execution_id, 'OMBRMB0002' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OMBR-BSE-01-0003' AS legacy_execution_id, 'OMBRMB0003' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OMBR-BSE-02-0001' AS legacy_execution_id, 'OMBRMB0004' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OMBR-BSE-03-0001' AS legacy_execution_id, 'OMBRMB0005' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OMBR-BSE-04-0001' AS legacy_execution_id, 'OMBRMB0006' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  SELECT 'OREF-EDU-01-0001' AS legacy_execution_id, 'OREFAA0001' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
  UNION ALL
  ...
  UNION ALL
  SELECT 'OREF-QRY-01-0005' AS legacy_execution_id, 'OREFQR0005' AS standard_execution_id, 'CPF O/S/B 10자리 표준 전환' AS migration_reason, 'CPF_SEED' AS created_by, 'CPF_SEED' AS updated_by FROM dual
) src
