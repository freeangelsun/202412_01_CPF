...
INSERT INTO CPF_TRANSACTION_LOG_DETAIL (LOG_IDX, DETAIL_KEY, DETAIL_VALUE, created_by, updated_by) SELECT &&sample_log_idx, 'headers', '{"X-Client-Id":"cpf-seed-client","X-Request-Type":"NORMAL","X-Client-Version":"1.0.0"}', 'SYSTEM', 'SYSTEM'
...
SELECT 'sample-rule-001' RULE_ID, NULL TRANSACTION_ID, 'OEDUAA0001' BUSINESS_TRANSACTION_ID, 'EDU' MODULE_ID, 'DEBUG' LOG_LEVEL, (SYSTIMESTAMP + INTERVAL '30' MINUTE) EXPIRE_AT, 'ADM 화면 smoke 검증용 동적 로그 규칙입니다.' REASON, 'Y' USE_YN, 'SYSTEM' created_by, 'SYSTEM' updated_by FROM dual
