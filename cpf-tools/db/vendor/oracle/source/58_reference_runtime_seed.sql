...
SELECT 'local-batch-01' worker_id, 'local-batch-01' instance_id, 'localhost' host_name, 'seed' process_id, 'seed-main' thread_name, 'IDLE' worker_status, 'Y' active_yn, SYSTIMESTAMP last_heartbeat_at, NULL current_job_id, NULL current_execution_id, '로컬 smoke 검증용 배치 worker heartbeat' description, 'SYSTEM' created_by, 'SYSTEM' updated_by FROM dual
