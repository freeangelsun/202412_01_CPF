...
SELECT 'local-batch-01' instance_id, '로컬 배치 인스턴스' instance_name, 'localhost' host_name, 8099 server_port, 'Y' active_yn, SYSTIMESTAMP last_heartbeat_at, 'REF EDU 배치와 ADM 관제 연동을 확인하는 로컬 인스턴스' description, 'SYSTEM' created_by, 'SYSTEM' updated_by FROM dual
...
UNION ALL
SELECT 'REF' service_id, '온라인 교육 서비스' service_name, 'INTERNAL' service_type, 'REF' owner_module_code, 'CPF 온라인 교육 및 검증 서비스 호출 대상' description, 'Y' use_yn, 'SYSTEM' created_by, 'SYSTEM' updated_by FROM dual
UNION ALL
...
UNION ALL
SELECT 'REF_API' endpoint_code, 'REF' service_id, 'REF API Endpoint' endpoint_name, 'HTTP' endpoint_type, 'http://localhost:8099' base_url, '/ref' context_path, 3000 default_timeout_ms, 0 default_retry_count, 'Y' use_yn, 'SYSTEM' created_by, 'SYSTEM' updated_by FROM dual
UNION ALL
...
UNION ALL
SELECT 'REF-local-01' instance_id, 'REF' service_id, 'REF_API' endpoint_code, 'REF local instance' instance_name, 'http://localhost:8099' base_url, 'localhost' host_name, 8099 port_no, 'UP' instance_status, 100 weight, 'Y' active_yn, SYSTIMESTAMP last_heartbeat_at, 'SYSTEM' created_by, 'SYSTEM' updated_by FROM dual
UNION ALL
...
UNION ALL
SELECT 'REF' service_id, 'REF_API' endpoint_code, 'PRIMARY' routing_mode, 'WEIGHT' load_balance_type, 'Y' failover_enabled_yn, 'Y' health_check_required_yn, 'Y' active_yn, 100 priority, 'SYSTEM' created_by, 'SYSTEM' updated_by FROM dual
UNION ALL
...
MERGE INTO cpf_service_circuit_state tgt USING (
...
UNION ALL
SELECT 'REF' service_id, 'REF_API' endpoint_code, 'REF-local-01' instance_id, 'CLOSED' circuit_state, 0 failure_count, 0 success_count, SYSTIMESTAMP closed_at, 'SYSTEM' created_by, 'SYSTEM' updated_by FROM dual
UNION ALL
...
INSERT INTO cpf_service_health_status (service_id, endpoint_code, instance_id, health_status, http_status, response_time_ms, failure_message, checked_at, created_by, updated_by) SELECT 'BZA', 'BZA_API', 'BZA-local-01', 'UP', 200, 0, NULL, SYSTIMESTAMP, 'SYSTEM', 'SYSTEM'
WHERE NOT EXISTS (
...
INSERT INTO cpf_service_health_status (service_id, endpoint_code, instance_id, health_status, http_status, response_time_ms, failure_message, checked_at, created_by, updated_by) SELECT 'REF', 'REF_API', 'REF-local-01', 'UP', 200, 0, NULL, SYSTIMESTAMP, 'SYSTEM', 'SYSTEM'
WHERE NOT EXISTS (
    SELECT 1 FROM cpf_service_health_status
    WHERE service_id = 'REF' AND endpoint_code = 'REF_API' AND instance_id = 'REF-local-01' AND created_by = 'SYSTEM'
);
INSERT INTO cpf_service_health_status (service_id, endpoint_code, instance_id, health_status, http_status, response_time_ms, failure_message, checked_at, created_by, updated_by) SELECT 'BAT', 'BAT_API', 'BAT-local-01', 'UP', 200, 0, NULL, SYSTIMESTAMP, 'SYSTEM', 'SYSTEM'
WHERE NOT EXISTS (
    SELECT 1 FROM cpf_service_health_status
    WHERE service_id = 'BAT' AND endpoint_code = 'BAT_API' AND instance_id = 'BAT-local-01' AND created_by = 'SYSTEM'
);
INSERT INTO cpf_service_health_status (service_id, endpoint_code, instance_id, health_status, http_status, response_time_ms, failure_message, checked_at, created_by, updated_by) SELECT 'ADM', 'ADM_API', 'ADM-local-01', 'UP', 200, 0, NULL, SYSTIMESTAMP, 'SYSTEM', 'SYSTEM'
WHERE NOT EXISTS (
    SELECT 1 FROM cpf_service_health_status
