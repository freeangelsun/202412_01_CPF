...
CREATE TABLE ADM_APPROVAL_CAPABILITY_NONCE (
    ...
    CONSUMED_AT TIMESTAMP(3) WITHOUT TIME ZONE NULL,
...
CREATE TABLE ADM_AUDIT_DELIVERY (
    ...
    NEXT_ATTEMPT_AT TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    LAST_ERROR VARCHAR(1000) NULL,
    AUDIT_ID BIGINT NULL,
    REQUESTED_AT TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    DELIVERED_AT TIMESTAMP(3) WITHOUT TIME ZONE NULL,
...
CREATE TABLE ADM_BREAK_GLASS_SESSION (
    ...
    expires_at TIMESTAMP(3) WITHOUT TIME ZONE NOT NULL,
    closed_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    close_reason VARCHAR(1000) NULL,
    post_review_status VARCHAR(20) DEFAULT 'PENDING' NOT NULL,
    reviewed_by VARCHAR(100) NULL,
    reviewed_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
...
CREATE TABLE ADM_DOWNLOAD_AUDIT_LOG (
    ...
    TARGET_TYPE VARCHAR(50) NULL,
    SEARCH_CONDITION_SUMMARY TEXT NULL,
...
CREATE TABLE ADM_FILE_JOB (
    ...
    control_updated_at TIMESTAMP(6) WITHOUT TIME ZONE NULL,
...
CREATE TABLE ADM_INCIDENT (
    ...
    detected_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    acknowledged_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    mitigated_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    resolved_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    reason VARCHAR(1000) NOT NULL,
...
CREATE TABLE ADM_LOG_EXPORT_ARTIFACT (
    ...
    downloaded_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
...
CREATE TABLE ADM_PASSWORD_POLICY (
    ...
    MAX_FAIL_COUNT INTEGER DEFAULT 5 NOT NULL,
    EXPIRE_DAYS INTEGER DEFAULT 90 NOT NULL,
    HISTORY_LIMIT INTEGER DEFAULT 5 NOT NULL,
    USE_YN CHAR(1) DEFAULT 'Y' NOT NULL,
    created_by VARCHAR(50) DEFAULT 'ADM' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(50) DEFAULT 'ADM' NOT NULL,
...
CREATE TABLE BAT_APPROVED_LAUNCH (
    ...
    effective_until TIMESTAMP(6) WITHOUT TIME ZONE NULL,
...
CREATE TABLE BAT_DEPLOYMENT_CELL (
    ...
    desired_instance_count INTEGER DEFAULT 1 NOT NULL,
    row_version BIGINT DEFAULT 0 NOT NULL,
    created_at TIMESTAMP(6) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
    updated_at TIMESTAMP(6) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
...
CREATE TABLE BAT_EXECUTION_CONTROL (
    ...
    reconcile_after TIMESTAMP(6) WITHOUT TIME ZONE NULL,
...
CREATE TABLE BAT_INSTANCE (
    ...
    last_heartbeat_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    description VARCHAR(500) NULL,
...
CREATE TABLE BAT_JOB_DEFINITION_VERSION (
    ...
    skip_limit INTEGER DEFAULT 0 NOT NULL,
    ...
    effective_until TIMESTAMP WITHOUT TIME ZONE NULL,
...
CREATE TABLE BAT_LOCK (
    ...
    locked_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE BAT_OPERATION_LOG_ARCHIVE (
    ...
    archived_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE BAT_RUNTIME_INSTANCE (
    ...
    last_heartbeat_at TIMESTAMP(6) WITHOUT TIME ZONE NULL,
    fencing_token BIGINT DEFAULT 0 NOT NULL,
    row_version BIGINT DEFAULT 0 NOT NULL,
    created_at TIMESTAMP(6) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
    updated_at TIMESTAMP(6) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
...
CREATE TABLE BAT_WORKER (
    ...
    max_concurrency INTEGER DEFAULT 1 NOT NULL,
    queue_capacity INTEGER DEFAULT 1 NOT NULL,
...
CREATE TABLE CMN_CACHE_REFRESH_CHECKPOINT (
    ...
    last_applied_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
...
CREATE TABLE CMN_CACHE_REFRESH_EVENT (
    ...
    published_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    created_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE CMN_TEMPLATE_DEFINITION (
    ...
    APPROVED_AT TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    CREATED_BY VARCHAR(100) NOT NULL,
    CREATED_AT TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    UPDATED_BY VARCHAR(100) NOT NULL,
    UPDATED_AT TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE CPF_BROKER_DLQ (
    ...
    replay_requested_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    replay_completed_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    created_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE CPF_BROKER_INBOX (
    ...
    received_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    consumed_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    created_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
...
CREATE TABLE CPF_BROKER_OUTBOX (
    ...
    failure_message VARCHAR(1000) NULL,
    occurred_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    claimed_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    published_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    created_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE CPF_IDEMPOTENCY_RECORD (
    ...
    stored_response TEXT NULL,
    retry_allowed_yn CHAR(1) DEFAULT 'N' NOT NULL,
    completed_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    expires_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    created_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE CPF_STANDARD_EXECUTION (
    ...
    last_discovered_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    created_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE CPF_STANDARD_EXECUTION_ALIAS (
    ...
    retired_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    created_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE CPF_TRANSACTION_LINEAGE (
    ...
    occurred_at TIMESTAMP(6) WITHOUT TIME ZONE NOT NULL,
    freshness_at TIMESTAMP(6) WITHOUT TIME ZONE NOT NULL,
...
CREATE TABLE CPF_TRANSACTION_LOG (
    ...
    SEQUENCE_NO INTEGER DEFAULT 1 NULL,
    ...
    END_TIME TIMESTAMP(3) WITHOUT TIME ZONE NULL,
...
CREATE TABLE CPF_TRANSACTION_SEGMENT (
    ...
    request_header_snapshot_masked TEXT NULL,
    response_header_snapshot_masked TEXT NULL,
    extension_header_snapshot_masked TEXT NULL,
    ...
    downstream_http_status INTEGER NULL,
...
CREATE TABLE CPF_UNKNOWN_RESULT (
    ...
    updated_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    attempt_count INTEGER DEFAULT 0 NOT NULL,
    next_check_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
...
CREATE TABLE GW_SPOOL_CHECKPOINT (
    ...
    last_error_code VARCHAR(100) NULL,
    last_error_at TIMESTAMP WITHOUT TIME ZONE NULL,
    updated_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE OPS_CHANNEL_POLICY_VERSION (
    ...
    applied_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    created_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE OPS_LOG_POLICY (
    ...
    policy_schema_version INTEGER DEFAULT 2 NOT NULL,
    ...
    max_query_bytes INTEGER DEFAULT 4096 NOT NULL,
    max_header_bytes INTEGER DEFAULT 8192 NOT NULL,
    max_request_body_bytes INTEGER DEFAULT 65536 NOT NULL,
    max_response_body_bytes INTEGER DEFAULT 65536 NOT NULL,
    max_stack_bytes INTEGER DEFAULT 32768 NOT NULL,
...
CREATE TABLE OPS_RUNTIME_CONTROLLER_LEASE (
    ...
    fencing_token BIGINT DEFAULT 0 NOT NULL,
    lease_until TIMESTAMP(3) WITHOUT TIME ZONE NOT NULL,
    last_reconciled_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    created_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE OPS_SCHEMA_INSTALLATION (
    ...
    installed_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE SEC_BFF_CREDENTIAL_VAULT (
    ...
    refresh_iv BYTEA DEFAULT NULL NULL,
    refresh_cipher_text BYTEA DEFAULT NULL NULL,
...
CREATE TABLE ADM_INCIDENT_LIFECYCLE (
    ...
    first_occurred_at TIMESTAMP(3) WITHOUT TIME ZONE NOT NULL,
    last_occurred_at TIMESTAMP(3) WITHOUT TIME ZONE NOT NULL,
    acknowledged_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    resolved_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
...
CREATE TABLE BAT_JOB (
    ...
    definition_published_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
...
CREATE TABLE BAT_JOB_RUNTIME_PROJECTION_OUTBOX (
    ...
    lease_owner VARCHAR(100) NULL,
    lease_until TIMESTAMP WITHOUT TIME ZONE NULL,
    fencing_token BIGINT DEFAULT 0 NOT NULL,
    attempt_count INTEGER DEFAULT 0 NOT NULL,
...
CREATE TABLE BAT_RUNTIME_HEARTBEAT (
    ...
    instance_id VARCHAR(120) NOT NULL,
    heartbeat_at TIMESTAMP(6) WITHOUT TIME ZONE NOT NULL,
...
CREATE TABLE BAT_SB_JOB_EXECUTION (
    ...
    START_TIME TIMESTAMP(6) WITHOUT TIME ZONE DEFAULT NULL NULL,
    END_TIME TIMESTAMP(6) WITHOUT TIME ZONE DEFAULT NULL NULL,
    STATUS VARCHAR(10) NULL,
    EXIT_CODE VARCHAR(2500) NULL,
    EXIT_MESSAGE VARCHAR(2500) NULL,
    LAST_UPDATED TIMESTAMP(6) WITHOUT TIME ZONE NULL,
...
CREATE TABLE CPF_SAGA_STEP_EXECUTION (
    ...
    error_message VARCHAR(2000) NULL,
    execute_attempts INTEGER DEFAULT 0 NOT NULL,
    compensation_attempts INTEGER DEFAULT 0 NOT NULL,
    created_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    updated_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE GW_RATE_LIMIT_REQUEST (
    ...
    limiting_index INTEGER DEFAULT -1 NOT NULL,
...
CREATE TABLE GW_SERVER_GROUP_MEMBER (
    ...
    probe_lease_until TIMESTAMP WITHOUT TIME ZONE NULL,
    last_probe_at TIMESTAMP WITHOUT TIME ZONE NULL,
...
CREATE TABLE OPS_RUNTIME_CHANGE (
    ...
    payload_hash VARCHAR(64) NOT NULL,
    payload_json TEXT NOT NULL,
    rollback_payload_json TEXT NULL,
    target_snapshot_json TEXT NOT NULL,
    desired_version BIGINT NOT NULL,
    rollout_mode VARCHAR(30) DEFAULT 'ALL_AT_ONCE' NOT NULL,
    wave_size INTEGER DEFAULT 100 NOT NULL,
    quorum_percent INTEGER DEFAULT 100 NOT NULL,
    change_state VARCHAR(30) DEFAULT 'APPLYING' NOT NULL,
    scheduled_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    expires_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    reason VARCHAR(1000) NOT NULL,
    approval_id VARCHAR(100) NULL,
...
CREATE TABLE OPS_LOG_POLICY_OVERRIDE (
    ...
    policy_schema_version INTEGER NULL,
    ...
    max_header_bytes INTEGER NULL,
    max_request_body_bytes INTEGER NULL,
    max_response_body_bytes INTEGER NULL,
    max_stack_bytes INTEGER NULL,
    policy_checksum VARCHAR(64) NULL,
    ...
    effective_start_at TIMESTAMP(3) WITHOUT TIME ZONE NOT NULL,
    effective_end_at TIMESTAMP(3) WITHOUT TIME ZONE NOT NULL,
    requested_by VARCHAR(100) NOT NULL,
    approved_by VARCHAR(100) NULL,
    active_yn CHAR(1) DEFAULT 'Y' NOT NULL,
    created_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
...
CREATE TABLE OPS_RUNTIME_POLICY_DELIVERY (
    ...
    attempt_count INTEGER DEFAULT 0 NOT NULL,
    fencing_token BIGINT DEFAULT 0 NOT NULL,
    leased_until TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    error_code VARCHAR(100) NULL,
    error_message VARCHAR(1000) NULL,
    acknowledged_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    created_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE OPS_SERVICE_ENDPOINT (
    ...
    default_timeout_ms INTEGER DEFAULT 3000 NOT NULL,
    default_retry_count INTEGER DEFAULT 0 NOT NULL,
    use_yn CHAR(1) DEFAULT 'Y' NOT NULL,
    created_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
...
CREATE TABLE ADM_APPROVAL_EXECUTION (
    ...
    LEASE_OWNER VARCHAR(120) NULL,
    LEASE_EXPIRES_AT TIMESTAMP(3) WITHOUT TIME ZONE NULL,
...
CREATE TABLE BAT_SCHEDULE (
    ...
    enabled_yn CHAR(1) DEFAULT 'Y' NOT NULL,
    last_fire_at TIMESTAMP WITHOUT TIME ZONE NULL,
    next_fire_at TIMESTAMP WITHOUT TIME ZONE NULL,
    created_by VARCHAR(100) DEFAULT 'BAT' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(100) DEFAULT 'BAT' NOT NULL,
    updated_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE GW_CONNECTION_TEST (
    ...
    tested_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_CENTER_CUT_EXECUTION (
    ...
    tps_limit INTEGER DEFAULT 0 NOT NULL,
...
CREATE TABLE BAT_EXECUTION_ATTEMPT (
    ...
    finished_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
...
CREATE TABLE BAT_EXECUTION_LEASE (
    ...
    claimed_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    lease_until TIMESTAMP(3) WITHOUT TIME ZONE NOT NULL,
    last_heartbeat_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    attempt_no INTEGER DEFAULT 1 NOT NULL,
    takeover_count INTEGER DEFAULT 0 NOT NULL,
    fencing_token BIGINT DEFAULT 0 NOT NULL,
    released_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    failure_message VARCHAR(1000) NULL,
    created_by VARCHAR(100) DEFAULT 'BAT' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(100) DEFAULT 'BAT' NOT NULL,
...
CREATE TABLE BAT_GHOST_EVENT (
    ...
    detected_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    action_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
...
CREATE TABLE BAT_EXECUTION_TARGET (
    ...
    business_date DATE NULL,
    planned_run_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
...
CREATE TABLE BAT_SCHEDULE_TRIGGER (
    schedule_id VARCHAR(100) NOT NULL,
    scheduled_fire_at TIMESTAMP(6) WITHOUT TIME ZONE NOT NULL,
    fencing_token BIGINT NOT NULL,
    execution_id BIGINT NULL,
    ...
    dispatch_lease_until TIMESTAMP(6) WITHOUT TIME ZONE NULL,
    attempt_count INTEGER DEFAULT 0 NOT NULL,
    last_error_code VARCHAR(100) NULL,
    last_error_at TIMESTAMP(6) WITHOUT TIME ZONE NULL,
    dispatched_at TIMESTAMP(6) WITHOUT TIME ZONE NULL,
    updated_at TIMESTAMP(6) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
...
CREATE TABLE OPS_RUNTIME_DELIVERY (
    ...
    next_attempt_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
...
CREATE TABLE OPS_RUNTIME_INSTANCE_STATE (
    ...
    last_ack_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    heartbeat_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    created_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
...
CREATE TABLE OPS_SERVICE_CIRCUIT_STATE (
    ...
    opened_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    half_opened_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
    closed_at TIMESTAMP(3) WITHOUT TIME ZONE NULL,
...
CREATE TABLE OPS_SERVICE_HEALTH_STATUS (
    ...
    failure_message VARCHAR(1000) NULL,
    checked_at TIMESTAMP(3) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(3) NOT NULL,
    created_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(100) DEFAULT 'CPF' NOT NULL,
    updated_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE BAT_CENTER_CUT_CLAIM (
    ...
    attempt_no INTEGER DEFAULT 1 NOT NULL,
    takeover_count INTEGER DEFAULT 0 NOT NULL,
    released_at TIMESTAMP(6) WITHOUT TIME ZONE NULL,
    updated_at TIMESTAMP(6) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
...
CREATE TRIGGER TRG_ADM_APPROVAL_CAPABILITY_NONCE_TOUCH BEFORE UPDATE ON ADM_APPROVAL_CAPABILITY_NONCE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_APPROVAL_POLICY_TOUCH BEFORE UPDATE ON ADM_APPROVAL_POLICY FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_APPROVAL_POLICY_LOCK_TOUCH BEFORE UPDATE ON ADM_APPROVAL_POLICY_LOCK FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_AUDIT_LOG_TOUCH BEFORE UPDATE ON ADM_AUDIT_LOG FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_BREAK_GLASS_SESSION_TOUCH BEFORE UPDATE ON ADM_BREAK_GLASS_SESSION FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_DOWNLOAD_AUDIT_LOG_TOUCH BEFORE UPDATE ON ADM_DOWNLOAD_AUDIT_LOG FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_DYNAMIC_LOG_LEVEL_RULE_TOUCH BEFORE UPDATE ON ADM_DYNAMIC_LOG_LEVEL_RULE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_FILE_JOB_TOUCH BEFORE UPDATE ON ADM_FILE_JOB FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_IP_ALLOWLIST_TOUCH BEFORE UPDATE ON ADM_IP_ALLOWLIST FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_MENU_TOUCH BEFORE UPDATE ON ADM_MENU FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_OPERATOR_TOUCH BEFORE UPDATE ON ADM_OPERATOR FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_OPERATOR_SESSION_TOUCH BEFORE UPDATE ON ADM_OPERATOR_SESSION FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_PASSWORD_POLICY_TOUCH BEFORE UPDATE ON ADM_PASSWORD_POLICY FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_ROLE_TOUCH BEFORE UPDATE ON ADM_ROLE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_DEPLOYMENT_CELL_TOUCH BEFORE UPDATE ON BAT_DEPLOYMENT_CELL FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_DEPLOYMENT_PLAN_TOUCH BEFORE UPDATE ON BAT_DEPLOYMENT_PLAN FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_EXECUTION_CONTROL_TOUCH BEFORE UPDATE ON BAT_EXECUTION_CONTROL FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_EXECUTION_EPOCH_TOUCH BEFORE UPDATE ON BAT_EXECUTION_EPOCH FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_INSTANCE_TOUCH BEFORE UPDATE ON BAT_INSTANCE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_LOCK_TOUCH BEFORE UPDATE ON BAT_LOCK FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_ON_DEMAND_REQUEST_TOUCH BEFORE UPDATE ON BAT_ON_DEMAND_REQUEST FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_OPERATION_LOG_TOUCH BEFORE UPDATE ON BAT_OPERATION_LOG FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_RUNTIME_COMMAND_TOUCH BEFORE UPDATE ON BAT_RUNTIME_COMMAND FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_RUNTIME_INSTANCE_TOUCH BEFORE UPDATE ON BAT_RUNTIME_INSTANCE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_SCHEDULER_LEASE_TOUCH BEFORE UPDATE ON BAT_SCHEDULER_LEASE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_WORKER_TOUCH BEFORE UPDATE ON BAT_WORKER FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CMN_BUSINESS_CALENDAR_DAY_TOUCH BEFORE UPDATE ON CMN_BUSINESS_CALENDAR_DAY FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CMN_CACHE_REFRESH_CHECKPOINT_TOUCH BEFORE UPDATE ON CMN_CACHE_REFRESH_CHECKPOINT FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CMN_CACHE_REFRESH_EVENT_TOUCH BEFORE UPDATE ON CMN_CACHE_REFRESH_EVENT FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CMN_CODE_TOUCH BEFORE UPDATE ON CMN_CODE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CMN_MESSAGE_TOUCH BEFORE UPDATE ON CMN_MESSAGE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CMN_PARAMETER_TOUCH BEFORE UPDATE ON CMN_PARAMETER FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CMN_RESPONSE_CODE_TOUCH BEFORE UPDATE ON CMN_RESPONSE_CODE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CMN_TEMPLATE_DEFINITION_TOUCH BEFORE UPDATE ON CMN_TEMPLATE_DEFINITION FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CPF_BROKER_DLQ_TOUCH BEFORE UPDATE ON CPF_BROKER_DLQ FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CPF_BROKER_INBOX_TOUCH BEFORE UPDATE ON CPF_BROKER_INBOX FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CPF_BROKER_OUTBOX_TOUCH BEFORE UPDATE ON CPF_BROKER_OUTBOX FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CPF_CACHE_INVALIDATION_CHECKPOINT_TOUCH BEFORE UPDATE ON CPF_CACHE_INVALIDATION_CHECKPOINT FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CPF_FILE_TRANSFER_HISTORY_TOUCH BEFORE UPDATE ON CPF_FILE_TRANSFER_HISTORY FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CPF_IDEMPOTENCY_RECORD_TOUCH BEFORE UPDATE ON CPF_IDEMPOTENCY_RECORD FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CPF_NOTIFICATION_RULE_TOUCH BEFORE UPDATE ON CPF_NOTIFICATION_RULE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CPF_STANDARD_EXECUTION_TOUCH BEFORE UPDATE ON CPF_STANDARD_EXECUTION FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CPF_STANDARD_EXECUTION_ALIAS_TOUCH BEFORE UPDATE ON CPF_STANDARD_EXECUTION_ALIAS FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();
...
CREATE TRIGGER TRG_GW_SERVER_GROUP_TOUCH BEFORE UPDATE ON GW_SERVER_GROUP FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();
...
CREATE TRIGGER TRG_OPS_RUNTIME_INSTANCE_GROUP_TOUCH BEFORE UPDATE ON OPS_RUNTIME_INSTANCE_GROUP FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_OPS_RUNTIME_RATE_BUCKET_TOUCH BEFORE UPDATE ON OPS_RUNTIME_RATE_BUCKET FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_OPS_RUNTIME_VERSION_TOUCH BEFORE UPDATE ON OPS_RUNTIME_VERSION FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();
...
CREATE TRIGGER TRG_SEC_TOKEN_AUDIT_LOG_TOUCH BEFORE UPDATE ON SEC_TOKEN_AUDIT_LOG FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_APPROVAL_POLICY_STEP_TOUCH BEFORE UPDATE ON ADM_APPROVAL_POLICY_STEP FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_APPROVAL_REQUEST_TOUCH BEFORE UPDATE ON ADM_APPROVAL_REQUEST FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_FILE_JOB_ROW_TOUCH BEFORE UPDATE ON ADM_FILE_JOB_ROW FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_BUTTON_TOUCH BEFORE UPDATE ON ADM_BUTTON FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_MFA_OTP_SECRET_TOUCH BEFORE UPDATE ON ADM_MFA_OTP_SECRET FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_ORGANIZATION_TOUCH BEFORE UPDATE ON ADM_ORGANIZATION FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_PASSWORD_HISTORY_TOUCH BEFORE UPDATE ON ADM_PASSWORD_HISTORY FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_OPERATOR_ROLE_TOUCH BEFORE UPDATE ON ADM_OPERATOR_ROLE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_ROLE_MENU_TOUCH BEFORE UPDATE ON ADM_ROLE_MENU FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_EXECUTION_LINK_TOUCH BEFORE UPDATE ON BAT_EXECUTION_LINK FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_JOB_TOUCH BEFORE UPDATE ON BAT_JOB FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CPF_NOTIFICATION_DELIVERY_LOG_TOUCH BEFORE UPDATE ON CPF_NOTIFICATION_DELIVERY_LOG FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_CPF_TRANSACTION_LOG_DETAIL_TOUCH BEFORE UPDATE ON CPF_TRANSACTION_LOG_DETAIL FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();
...
CREATE TRIGGER TRG_ADM_API_PERMISSION_TOUCH BEFORE UPDATE ON ADM_API_PERMISSION FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_ROLE_BUTTON_TOUCH BEFORE UPDATE ON ADM_ROLE_BUTTON FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_ADM_OPERATOR_PROFILE_TOUCH BEFORE UPDATE ON ADM_OPERATOR_PROFILE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_CENTER_CUT_JOB_TOUCH BEFORE UPDATE ON BAT_CENTER_CUT_JOB FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_EXECUTION_TOUCH BEFORE UPDATE ON BAT_EXECUTION FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_JOB_RELATION_TOUCH BEFORE UPDATE ON BAT_JOB_RELATION FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_SCHEDULE_TOUCH BEFORE UPDATE ON BAT_SCHEDULE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_OPS_LOG_POLICY_AUDIT_TOUCH BEFORE UPDATE ON OPS_LOG_POLICY_AUDIT FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();
...
CREATE TRIGGER TRG_BAT_CENTER_CUT_EXECUTION_TOUCH BEFORE UPDATE ON BAT_CENTER_CUT_EXECUTION FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_CENTER_CUT_PARAMETER_TOUCH BEFORE UPDATE ON BAT_CENTER_CUT_PARAMETER FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_EXECUTION_LEASE_TOUCH BEFORE UPDATE ON BAT_EXECUTION_LEASE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_EXECUTION_RESULT_DETAIL_TOUCH BEFORE UPDATE ON BAT_EXECUTION_RESULT_DETAIL FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_GHOST_EVENT_TOUCH BEFORE UPDATE ON BAT_GHOST_EVENT FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_STEP_EXECUTION_TOUCH BEFORE UPDATE ON BAT_STEP_EXECUTION FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_EXECUTION_TARGET_TOUCH BEFORE UPDATE ON BAT_EXECUTION_TARGET FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_OPS_RUNTIME_DELIVERY_TOUCH BEFORE UPDATE ON OPS_RUNTIME_DELIVERY FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_OPS_RUNTIME_GROUP_MEMBER_TOUCH BEFORE UPDATE ON OPS_RUNTIME_GROUP_MEMBER FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_OPS_RUNTIME_INSTANCE_FEATURE_STATE_TOUCH BEFORE UPDATE ON OPS_RUNTIME_INSTANCE_FEATURE_STATE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_OPS_RUNTIME_INSTANCE_STATE_TOUCH BEFORE UPDATE ON OPS_RUNTIME_INSTANCE_STATE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_OPS_SERVICE_CALL_HISTORY_TOUCH BEFORE UPDATE ON OPS_SERVICE_CALL_HISTORY FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_OPS_SERVICE_CIRCUIT_STATE_TOUCH BEFORE UPDATE ON OPS_SERVICE_CIRCUIT_STATE FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_OPS_SERVICE_HEALTH_STATUS_TOUCH BEFORE UPDATE ON OPS_SERVICE_HEALTH_STATUS FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_CENTER_CUT_ITEM_TOUCH BEFORE UPDATE ON BAT_CENTER_CUT_ITEM FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_CENTER_CUT_RATE_WINDOW_TOUCH BEFORE UPDATE ON BAT_CENTER_CUT_RATE_WINDOW FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();

CREATE TRIGGER TRG_BAT_CENTER_CUT_CLAIM_TOUCH BEFORE UPDATE ON BAT_CENTER_CUT_CLAIM FOR EACH ROW EXECUTE FUNCTION CPF_TOUCH_UPDATED_AT();
...
-- AUTO-GENERATED DERIVED COMPATIBILITY SOURCE
-- authority=cpf-tools/db/generated/current/postgresql/backoffice-schema.sql
