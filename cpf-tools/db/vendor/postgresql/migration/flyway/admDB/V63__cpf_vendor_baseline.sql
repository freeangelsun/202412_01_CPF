-- CPF postgresql initial baseline for admDB
...
CREATE OR REPLACE FUNCTION fn_adm_api_permission_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_api_permission_touch BEFORE UPDATE ON adm_api_permission
FOR EACH ROW EXECUTE FUNCTION fn_adm_api_permission_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_approval_execution_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_approval_execution_touch BEFORE UPDATE ON adm_approval_execution
FOR EACH ROW EXECUTE FUNCTION fn_adm_approval_execution_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_approval_participant_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_approval_participant_touch BEFORE UPDATE ON adm_approval_participant
FOR EACH ROW EXECUTE FUNCTION fn_adm_approval_participant_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_approval_policy_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_approval_policy_touch BEFORE UPDATE ON adm_approval_policy
FOR EACH ROW EXECUTE FUNCTION fn_adm_approval_policy_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_approval_policy_step_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_approval_policy_step_touch BEFORE UPDATE ON adm_approval_policy_step
FOR EACH ROW EXECUTE FUNCTION fn_adm_approval_policy_step_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_approval_request_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_approval_request_touch BEFORE UPDATE ON adm_approval_request
FOR EACH ROW EXECUTE FUNCTION fn_adm_approval_request_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_audit_log_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_audit_log_touch BEFORE UPDATE ON adm_audit_log
FOR EACH ROW EXECUTE FUNCTION fn_adm_audit_log_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_break_glass_session_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_break_glass_session_touch BEFORE UPDATE ON adm_break_glass_session
FOR EACH ROW EXECUTE FUNCTION fn_adm_break_glass_session_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_button_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_button_touch BEFORE UPDATE ON adm_button
FOR EACH ROW EXECUTE FUNCTION fn_adm_button_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_download_audit_log_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_download_audit_log_touch BEFORE UPDATE ON adm_download_audit_log
FOR EACH ROW EXECUTE FUNCTION fn_adm_download_audit_log_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_dynamic_log_level_rule_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_dynamic_log_level_rule_touch BEFORE UPDATE ON adm_dynamic_log_level_rule
FOR EACH ROW EXECUTE FUNCTION fn_adm_dynamic_log_level_rule_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_ip_allowlist_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_ip_allowlist_touch BEFORE UPDATE ON adm_ip_allowlist
FOR EACH ROW EXECUTE FUNCTION fn_adm_ip_allowlist_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_menu_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_menu_touch BEFORE UPDATE ON adm_menu
FOR EACH ROW EXECUTE FUNCTION fn_adm_menu_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_mfa_otp_secret_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_mfa_otp_secret_touch BEFORE UPDATE ON adm_mfa_otp_secret
FOR EACH ROW EXECUTE FUNCTION fn_adm_mfa_otp_secret_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_operator_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_operator_touch BEFORE UPDATE ON adm_operator
FOR EACH ROW EXECUTE FUNCTION fn_adm_operator_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_operator_profile_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_operator_profile_touch BEFORE UPDATE ON adm_operator_profile
FOR EACH ROW EXECUTE FUNCTION fn_adm_operator_profile_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_operator_role_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_operator_role_touch BEFORE UPDATE ON adm_operator_role
FOR EACH ROW EXECUTE FUNCTION fn_adm_operator_role_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_operator_session_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_operator_session_touch BEFORE UPDATE ON adm_operator_session
FOR EACH ROW EXECUTE FUNCTION fn_adm_operator_session_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_organization_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_organization_touch BEFORE UPDATE ON adm_organization
FOR EACH ROW EXECUTE FUNCTION fn_adm_organization_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_password_history_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_password_history_touch BEFORE UPDATE ON adm_password_history
FOR EACH ROW EXECUTE FUNCTION fn_adm_password_history_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_password_policy_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_password_policy_touch BEFORE UPDATE ON adm_password_policy
FOR EACH ROW EXECUTE FUNCTION fn_adm_password_policy_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_role_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_role_touch BEFORE UPDATE ON adm_role
FOR EACH ROW EXECUTE FUNCTION fn_adm_role_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_role_api_permission_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_role_api_permission_touch BEFORE UPDATE ON adm_role_api_permission
FOR EACH ROW EXECUTE FUNCTION fn_adm_role_api_permission_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_role_button_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_adm_role_button_touch BEFORE UPDATE ON adm_role_button
FOR EACH ROW EXECUTE FUNCTION fn_adm_role_button_touch();
...
CREATE OR REPLACE FUNCTION fn_adm_role_menu_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
