-- CPF postgresql initial baseline for batDB
...
CREATE OR REPLACE FUNCTION fn_bat_center_cut_claim_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_center_cut_claim_touch BEFORE UPDATE ON bat_center_cut_claim
FOR EACH ROW EXECUTE FUNCTION fn_bat_center_cut_claim_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_center_cut_execution_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_center_cut_execution_touch BEFORE UPDATE ON bat_center_cut_execution
FOR EACH ROW EXECUTE FUNCTION fn_bat_center_cut_execution_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_center_cut_item_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_center_cut_item_touch BEFORE UPDATE ON bat_center_cut_item
FOR EACH ROW EXECUTE FUNCTION fn_bat_center_cut_item_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_center_cut_job_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_center_cut_job_touch BEFORE UPDATE ON bat_center_cut_job
FOR EACH ROW EXECUTE FUNCTION fn_bat_center_cut_job_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_center_cut_parameter_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_center_cut_parameter_touch BEFORE UPDATE ON bat_center_cut_parameter
FOR EACH ROW EXECUTE FUNCTION fn_bat_center_cut_parameter_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_center_cut_rate_window_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_center_cut_rate_window_touch BEFORE UPDATE ON bat_center_cut_rate_window
FOR EACH ROW EXECUTE FUNCTION fn_bat_center_cut_rate_window_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_center_cut_result_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_center_cut_result_touch BEFORE UPDATE ON bat_center_cut_result
FOR EACH ROW EXECUTE FUNCTION fn_bat_center_cut_result_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_deployment_cell_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_deployment_cell_touch BEFORE UPDATE ON bat_deployment_cell
FOR EACH ROW EXECUTE FUNCTION fn_bat_deployment_cell_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_deployment_plan_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_deployment_plan_touch BEFORE UPDATE ON bat_deployment_plan
FOR EACH ROW EXECUTE FUNCTION fn_bat_deployment_plan_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_execution_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_execution_touch BEFORE UPDATE ON bat_execution
FOR EACH ROW EXECUTE FUNCTION fn_bat_execution_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_execution_lease_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_execution_lease_touch BEFORE UPDATE ON bat_execution_lease
FOR EACH ROW EXECUTE FUNCTION fn_bat_execution_lease_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_execution_target_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_execution_target_touch BEFORE UPDATE ON bat_execution_target
FOR EACH ROW EXECUTE FUNCTION fn_bat_execution_target_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_ghost_event_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_ghost_event_touch BEFORE UPDATE ON bat_ghost_event
FOR EACH ROW EXECUTE FUNCTION fn_bat_ghost_event_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_instance_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_instance_touch BEFORE UPDATE ON bat_instance
FOR EACH ROW EXECUTE FUNCTION fn_bat_instance_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_job_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_job_touch BEFORE UPDATE ON bat_job
FOR EACH ROW EXECUTE FUNCTION fn_bat_job_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_job_relation_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_job_relation_touch BEFORE UPDATE ON bat_job_relation
FOR EACH ROW EXECUTE FUNCTION fn_bat_job_relation_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_lock_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_lock_touch BEFORE UPDATE ON bat_lock
FOR EACH ROW EXECUTE FUNCTION fn_bat_lock_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_on_demand_request_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_on_demand_request_touch BEFORE UPDATE ON bat_on_demand_request
FOR EACH ROW EXECUTE FUNCTION fn_bat_on_demand_request_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_operation_log_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_operation_log_touch BEFORE UPDATE ON bat_operation_log
FOR EACH ROW EXECUTE FUNCTION fn_bat_operation_log_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_runtime_command_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_runtime_command_touch BEFORE UPDATE ON bat_runtime_command
FOR EACH ROW EXECUTE FUNCTION fn_bat_runtime_command_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_runtime_instance_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_runtime_instance_touch BEFORE UPDATE ON bat_runtime_instance
FOR EACH ROW EXECUTE FUNCTION fn_bat_runtime_instance_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_schedule_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_schedule_touch BEFORE UPDATE ON bat_schedule
FOR EACH ROW EXECUTE FUNCTION fn_bat_schedule_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_scheduler_lease_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_scheduler_lease_touch BEFORE UPDATE ON bat_scheduler_lease
FOR EACH ROW EXECUTE FUNCTION fn_bat_scheduler_lease_touch();
...
CREATE OR REPLACE FUNCTION fn_bat_step_execution_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_step_execution_touch BEFORE UPDATE ON bat_step_execution
FOR EACH ROW EXECUTE FUNCTION fn_bat_step_execution_touch();
...
CREATE TABLE bat_worker (
    worker_id VARCHAR(160) NOT NULL,
    server_instance_id VARCHAR(160) NOT NULL,
    host_name VARCHAR(150),
...
CREATE OR REPLACE FUNCTION fn_bat_worker_touch() RETURNS trigger AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER trg_bat_worker_touch BEFORE UPDATE ON bat_worker
FOR EACH ROW EXECUTE FUNCTION fn_bat_worker_touch();
