CREATE TABLE bat_job_definition_version (
  ...
  executor_reference VARCHAR(300) NOT NULL, definition_json TEXT NOT NULL, checksum VARCHAR(128), effective_from TIMESTAMP(3) NULL,
...
CREATE TABLE bat_job_parameter_definition (
  ...
  sensitive_yn CHAR(1) NOT NULL, default_value VARCHAR(1000), allowed_values TEXT, validation_pattern VARCHAR(1000),
...
CREATE TABLE bat_job_definition_audit (
  audit_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, job_id VARCHAR(80) NOT NULL, definition_version BIGINT NOT NULL,
