...
CREATE TABLE cpf_gateway_server_group (
    ...
    hash_key_source VARCHAR(200) DEFAULT '' NOT NULL,
    health_policy_id VARCHAR(100) DEFAULT '' NOT NULL,
    failover_group_id VARCHAR(100) DEFAULT '' NOT NULL,
...
CREATE TABLE cpf_gateway_server_group_member (
    ...
    priority_no INTEGER DEFAULT 0 NOT NULL,
...
CREATE TABLE cpf_gateway_binding (
    ...
    tls_policy_id VARCHAR(100) DEFAULT '' NOT NULL,
    authentication_policy_id VARCHAR(100) DEFAULT '' NOT NULL,
    authorization_policy_id VARCHAR(100) DEFAULT '' NOT NULL,
    header_policy_id VARCHAR(100) DEFAULT '' NOT NULL,
    rate_limit_policy_id VARCHAR(100) DEFAULT '' NOT NULL,
    health_policy_id VARCHAR(100) DEFAULT '' NOT NULL,
    ...
    approval_id VARCHAR(100) DEFAULT '' NOT NULL,
...
CREATE TABLE cpf_gateway_apply_status (
    ...
    applied_version VARCHAR(100) DEFAULT '' NOT NULL,
    apply_status VARCHAR(30) NOT NULL,
    error_code VARCHAR(100) DEFAULT '' NOT NULL,
    error_message VARCHAR(1000) DEFAULT '' NOT NULL,
...
CREATE TABLE cpf_gateway_connection_test (
    ...
    binding_id VARCHAR(100) NOT NULL,
    gateway_instance_id VARCHAR(100) DEFAULT '' NOT NULL,
    instance_id VARCHAR(100) DEFAULT '' NOT NULL,
    test_type VARCHAR(50) NOT NULL,
    test_status VARCHAR(30) NOT NULL,
    failure_stage VARCHAR(50) DEFAULT '' NOT NULL,
    duration_ms BIGINT DEFAULT 0 NOT NULL,
    trace_id VARCHAR(100) DEFAULT '' NOT NULL,
    operation_id VARCHAR(100) DEFAULT '' NOT NULL,
...
CREATE TABLE cpf_gateway_transaction (
    ...
    source_ip VARCHAR(100) DEFAULT '' NOT NULL,
    source_port INTEGER,
    gateway_instance_id VARCHAR(100) NOT NULL,
    binding_id VARCHAR(100) NOT NULL,
    route_id VARCHAR(100) NOT NULL,
    route_version VARCHAR(100) NOT NULL,
    server_group_id VARCHAR(100) NOT NULL,
    final_instance_id VARCHAR(100) DEFAULT '' NOT NULL,
    result_status VARCHAR(30) NOT NULL,
    protocol_status VARCHAR(30) DEFAULT '' NOT NULL,
    business_code VARCHAR(100) DEFAULT '' NOT NULL,
    failure_stage VARCHAR(50) DEFAULT '' NOT NULL,
...
CREATE TABLE cpf_gateway_attempt (
    ...
    instance_id VARCHAR(100) NOT NULL,
    target_host VARCHAR(300) DEFAULT '' NOT NULL,
    target_port INTEGER,
    target_protocol VARCHAR(30) NOT NULL,
    ...
    protocol_status VARCHAR(30) DEFAULT '' NOT NULL,
    failure_code VARCHAR(100) DEFAULT '' NOT NULL,
    failure_message VARCHAR(1000) DEFAULT '' NOT NULL,
