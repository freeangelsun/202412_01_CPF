...
ALTER TABLE MBW_LOGIN_HISTORY ALTER COLUMN system_code TYPE VARCHAR(20);
ALTER TABLE MBW_LOGIN_HISTORY RENAME COLUMN was_id TO application_name;
ALTER TABLE MBW_LOGIN_HISTORY ALTER COLUMN application_name TYPE VARCHAR(200);
ALTER TABLE MBW_LOGIN_HISTORY RENAME COLUMN server_instance_id TO instance_id;
ALTER TABLE MBW_LOGIN_HISTORY ALTER COLUMN login_domain SET DEFAULT 'MBW';
