...
ALTER TABLE MBW_LOGIN_HISTORY ALTER COLUMN login_domain SET DEFAULT 'BZA';
...
ALTER TABLE MBW_LOGIN_HISTORY ALTER COLUMN was_id TYPE VARCHAR(7);
ALTER TABLE MBW_LOGIN_HISTORY RENAME COLUMN system_code TO module_id;
ALTER TABLE MBW_LOGIN_HISTORY ALTER COLUMN module_id TYPE VARCHAR(3);
