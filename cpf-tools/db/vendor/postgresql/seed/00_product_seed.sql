...
INSERT INTO cpf_log_policy (policy_key, policy_name, target_type, target_id, log_level, db_log_enabled_yn, file_log_enabled_yn, request_body_log_yn, response_body_log_yn, error_stack_log_yn, retention_days, sampling_rate, priority, active_yn, description, created_by, updated_by) VALUES ('ONLINE_DEFAULT', '온라인 거래 기본 로그 정책', 'ONLINE_TRANSACTION', '*', 'INFO', 'Y', 'Y', 'N', 'N', 'Y', 90, 100.00, 100, 'Y', '온라인 Controller/API 기본 로그 정책', 'SYSTEM', 'SYSTEM'),
    ...
    ('ADM_OPERATION_DEFAULT', 'ADM 운영 기본 로그 정책', 'MODULE', 'ADM', 'INFO', 'Y', 'Y', 'N', 'N', 'Y', 365, 100.00, 50, 'Y', 'ADM 운영 API 기본 로그 정책', 'SYSTEM', 'SYSTEM') ON CONFLICT (policy_key) DO UPDATE SET policy_name = EXCLUDED.policy_name, target_type = EXCLUDED.target_type, target_id = EXCLUDED.target_id, log_level = EXCLUDED.log_level, db_log_enabled_yn = EXCLUDED.db_log_enabled_yn, file_log_enabled_yn = EXCLUDED.file_log_enabled_yn, request_body_log_yn = EXCLUDED.request_body_log_yn, response_body_log_yn = EXCLUDED.response_body_log_yn, error_stack_log_yn = EXCLUDED.error_stack_log_yn, retention_days = EXCLUDED.retention_days, sampling_rate = EXCLUDED.sampling_rate, priority = EXCLUDED.priority, active_yn = EXCLUDED.active_yn, description = EXCLUDED.description, updated_by = EXCLUDED.updated_by, updated_at = CURRENT_TIMESTAMP;
