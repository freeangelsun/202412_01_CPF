...
INSERT INTO REF_SAMPLE_ITEM (sample_item_id, sample_key, item_name, category_code, status_code, searchable_text, owner_reference, sort_order, version_no, deleted_yn, created_by, created_at, updated_by, updated_at) VALUES (90001, 'REF-MAPPER-90001', '단건 조회 샘플', 'SINGLE', 'ACTIVE', 'single', 'REF-90001', 90001, 0, 'N', 'MAPPER_TEST', '2026-06-01 09:00:00.000', 'MAPPER_TEST', '2026-06-01 09:00:00.000'),
    ...
    (90008, 'REF-MAPPER-90008', 'Keyset 조회 샘플', 'KEYSET', 'ACTIVE', 'keyset', 'REF-90008', 90008, 0, 'N', 'MAPPER_TEST', '2026-06-08 09:00:00.000', 'MAPPER_TEST', '2026-06-08 09:00:00.000') ON CONFLICT (sample_item_id) DO UPDATE SET sample_key = EXCLUDED.sample_key, item_name = EXCLUDED.item_name, category_code = EXCLUDED.category_code, status_code = EXCLUDED.status_code, searchable_text = EXCLUDED.searchable_text, owner_reference = EXCLUDED.owner_reference, sort_order = EXCLUDED.sort_order, updated_by = EXCLUDED.updated_by, updated_at = EXCLUDED.updated_at;
