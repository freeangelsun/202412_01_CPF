...
INSERT INTO cpf_code (parent_id, code_key, code_value, description, created_by, updated_by) VALUES ((SELECT code_id FROM (SELECT code_id FROM cpf_code WHERE code_key = 'CODE_GROUP' AND code_value = 'MODULE') p), 'MODULE', 'CPF', '프레임워크 공통 엔진', 'SYSTEM', 'SYSTEM'),
    ...
    ((SELECT code_id FROM (SELECT code_id FROM cpf_code WHERE code_key = 'CODE_GROUP' AND code_value = 'YN') p), 'YN', 'N', '아니오', 'SYSTEM', 'SYSTEM') ON CONFLICT (code_key, code_value) DO UPDATE SET parent_id = EXCLUDED.parent_id, description = EXCLUDED.description, updated_by = EXCLUDED.updated_by, updated_at = CURRENT_TIMESTAMP;
...
INSERT INTO cpf_response_code (response_code, message_code, result_type, module_id, response_group, sequence_no, http_status, description, created_by, updated_by) VALUES ('SCPF000000', 'MCPF000000', 'S', 'CPF', '00', '0000', 200, 'CPF 공통 성공', 'SYSTEM', 'SYSTEM'),
    ...
    ('EBZA010002', 'MBZA010002', 'E', 'BZA', '01', '0002', 403, 'BZA 권한 오류', 'SYSTEM', 'SYSTEM') ON CONFLICT (response_code) DO UPDATE SET message_code = EXCLUDED.message_code, result_type = EXCLUDED.result_type, module_id = EXCLUDED.module_id, response_group = EXCLUDED.response_group, sequence_no = EXCLUDED.sequence_no, http_status = EXCLUDED.http_status, description = EXCLUDED.description, use_yn = 'Y', updated_by = EXCLUDED.updated_by, updated_at = CURRENT_TIMESTAMP;
