...
def main() -> None:
    ...
    contract_path = root / "cpf-tools/generator/contracts/education-reference-fixture-contract.json"
    ...
    if contract.get("ownerModule") != "cpf-tools/db" or contract.get("logicalDatabase") != "referenceFixture":
        fail("Reference Fixture lifecycle ownership은 cpf-tools/db + referenceFixture여야 합니다.")
