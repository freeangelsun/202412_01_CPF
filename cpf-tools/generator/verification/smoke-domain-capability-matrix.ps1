...
$sandbox = Join-Path $Root 'cpf-docs/governance/development-harness/evidence/platform/current/generated/domain-generator/capability-matrix'
...
"@
        ...
        $transientRoots.Add((Join-Path $Root "cpf-docs/governance/development-harness/evidence/platform/current/generated/domain-generator/verification/cpf-$($case.domain)")) | Out-Null
