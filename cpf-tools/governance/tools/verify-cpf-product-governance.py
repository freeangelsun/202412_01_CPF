...
def verify(root: Path) -> dict:
    rel=Path('cpf-tools/governance/product-capability-policy.json')
    ...
    workflow=(root/'.github/workflows/cpf-final-source-gates.yml').read_text(encoding='utf-8-sig')
    require('verify-cpf-product-governance.py' in workflow,'final source gate workflow does not consume product governance gate')
