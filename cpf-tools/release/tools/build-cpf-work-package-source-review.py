...
MANUAL_GATE_MAPPING = {
    "P09-GATE": ["cpf-tools/verification/tools/verify-cpf-frontend-consumer-closure.py", "cpf-tools/verification/tools/verify-cpf-operator-trust-boundary.py"],
    "P10-GATE": ["cpf-tools/verification/tools/verify-cpf-execution-scope-exhaustive.py", "cpf-tools/governance/tools/verify-cpf-requirement-traceability.py"],
    "P11-GATE": ["cpf-tools/verification/tools/verify-cpf-operator-trust-boundary.py", "cpf-tools/verification/tools/verify-cpf-transaction-id-standard.py"],
    "P12-GATE": ["cpf-tools/verification/tools/verify-cpf-development-evidence-integrity.py", "cpf-tools/verification/tools/verify-cpf-starter-catalog-truth.py"],
    "P13-GATE": [
        "cpf-tools/verification/tools/verify-cpf-development-evidence-integrity.py",
        "cpf-tools/testing/tools/tests/test_verify_cpf_development_evidence_integrity.py",
        "cpf-tools/db/verification/verify-cpf-db-vendor-semantic-parity.py",
        "cpf-tools/testing/tools/tests/test_verify_cpf_db_vendor_semantic_parity.py",
        "cpf-tools/db/tools/run-db-vendor-lifecycle.ps1",
    ],
    "P14-GATE": [
        "cpf-tools/verification/tools/verify-cpf-execution-scope-exhaustive.py",
        "cpf-tools/testing/tools/tests/test_verify_cpf_execution_scope_exhaustive.py",
    ],
    "P15-GATE": [
        "cpf-tools/verification/tools/verify-cpf-development-evidence-integrity.py",
        "cpf-tools/testing/tools/tests/test_verify_cpf_development_evidence_integrity.py",
        "cpf-tools/governance/tools/verify-cpf-requirement-traceability.py",
        "cpf-tools/testing/tools/tests/test_verify_cpf_requirement_traceability.py",
        "cpf-tools/verification/tools/verify-cpf-development-traceability-closure.py",
        "cpf-tools/testing/tools/tests/test_verify_cpf_development_traceability_closure.py",
    ],
}
