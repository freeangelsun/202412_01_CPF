...
.EXAMPLE
pwsh -File .\cpf-tools\release\tools\promote-cpf-verified-local-artifacts.ps1 -StagingRepository .\build\cpf-artifact-staging\repository
#>
param(
...
$verify = Join-Path $Root 'cpf-tools/verification/tools/verify-local-artifact-propagation.ps1'
