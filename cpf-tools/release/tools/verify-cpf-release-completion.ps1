...
try{
    ...
    $exit=0
    try{
        & pwsh -NoProfile -File .\cpf-tools\verification\tools\verify-cpf-final-completion.ps1 `
    ...
    & pwsh -NoProfile -File .\cpf-tools\verification\tools\check-final-evidence-contract.ps1 -Root $RepoRoot -RequireAll
