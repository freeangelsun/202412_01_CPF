...
public CpfLocalBatchRuntimeStatusController(Environment e){this.e=e;}
 ...
 public Status status(){return new Status("CPF_LOCAL_BATCH",true,true,List.of(role("control-plane",true,8090),role("scheduler",true,8091),role("worker",true,8092),role("center-cut",false,8093),
         role("agent",false,8094)),Instant.now());}
