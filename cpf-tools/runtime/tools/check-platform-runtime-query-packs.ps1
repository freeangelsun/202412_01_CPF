...
$syncScript = Join-Path $Root "cpf-tools\runtime\tools\sync-platform-runtime-query-packs.ps1"
...
$managedRuntimeScripts = @(
    "cpf-tools/runtime/tools/sync-platform-runtime-query-packs.ps1",
    "cpf-tools/runtime/tools/check-platform-runtime-query-packs.ps1",
    "cpf-tools/runtime/tools/smoke-platform-runtime-query-packs-mariadb.ps1",
    "cpf-tools/runtime/tools/smoke-platform-runtime-query-packs-official-db.ps1",
    "cpf-tools/db/verification/check-query-contract-integrity.ps1"
)
foreach ($scriptRelativePath in $managedRuntimeScripts) {
    $scriptName = Split-Path -Leaf $scriptRelativePath
...
$integrityScript = Join-Path $Root "cpf-tools\db\verification\check-query-contract-integrity.ps1"
