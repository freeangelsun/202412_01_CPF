...
try {
    ...
    $result.checks += Test-RequiredText "cpf-tools/db/vendor/mariadb/source/10_cpf_schema.sql" "CREATE TABLE OPS_SERVICE_ENDPOINT" "SQL_CPF_SERVICE_ENDPOINT"
    $result.checks += Test-RequiredText "cpf-tools/db/vendor/mariadb/source/10_cpf_schema.sql" "CREATE TABLE OPS_SERVICE_INSTANCE" "SQL_CPF_SERVICE_INSTANCE"
