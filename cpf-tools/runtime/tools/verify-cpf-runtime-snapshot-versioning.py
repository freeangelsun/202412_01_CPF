...
def verify(root:Path)->dict:
    path=root.resolve()/'cpf-starters/integration/http/src/main/java/com/cpf/integration/http/internal/CpfServiceEndpointRegistry.java'
    ...
    requirements={
      ...
      'equal_payload_compared':bool(re.search(r'(?:immutable\.equals\(old\.endpoints\(\)\)|old\.endpoints\(\)\.equals\(immutable\))',body)),
