...
foreach ($marker in @("ValidateSet('minimal','standard','full','integration')",'local-batch-$Mode','healthUrls','Wait-CpfHealth','BatchControlPort','BatchWorkerPort','-Xms','-Xmx')) {
