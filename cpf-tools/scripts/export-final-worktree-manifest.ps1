...
$requestPath = Join-Path $Root "cpf-docs/work/current/CPF_CURRENT_WORK_REQUEST.md"
$requestSha256 = Get-Sha256 $requestPath
$requestGitBlob = (& git -C $Root hash-object -- "cpf-docs/work/current/CPF_CURRENT_WORK_REQUEST.md").Trim()
...
$lines.Add("COMMAND=powershell -NoProfile -ExecutionPolicy Bypass -File cpf-tools/scripts/export-final-worktree-manifest.ps1") | Out-Null
