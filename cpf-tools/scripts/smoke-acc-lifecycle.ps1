...
try {
    ...
    $legacyAttempt = Invoke-Script (Join-Path $sandboxRoot 'cpf-tools/scripts/remove-domain.ps1') @(
    ...
    [void](Invoke-Script (Join-Path $sandboxRoot 'cpf-tools/scripts/verify-domain.ps1') @(
