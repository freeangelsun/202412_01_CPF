...
try {
    ...
    Copy-Item -LiteralPath (Join-Path $Root 'cpf-tools/scripts/create-domain.ps1') -Destination (Join-Path $sandbox 'cpf-tools/scripts/create-domain.ps1')
    Copy-Item -LiteralPath (Join-Path $Root 'cpf-tools/scripts/remove-domain.ps1') -Destination (Join-Path $sandbox 'cpf-tools/scripts/remove-domain.ps1')
    ...
    [void] (Invoke-Tool -Script (Join-Path $sandbox 'cpf-tools/scripts/create-domain.ps1') -Arguments $createArgs)

    $cleanDir = Join-Path $sandbox 'build/remove-domain-clean'
    [void] (Invoke-Tool -Script (Join-Path $sandbox 'cpf-tools/scripts/remove-domain.ps1') -Arguments @(
    ...
    [void] (Invoke-Tool -Script (Join-Path $sandbox 'cpf-tools/scripts/create-domain.ps1') -Arguments @(
