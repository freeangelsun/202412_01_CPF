...
$services=@(
 @{Module='control-server';Artifact='cpf-batch-control-server';Role='CONTROL_SERVER';BasePort=8180;Count=$ControlCount},
 ...
 @{Module='center-cut-runner';Artifact='cpf-center-cut-runner';Role='CENTER_CUT_RUNNER';BasePort=8210;Count=$CenterCutCount},
 @{Module='host-agent';Artifact='cpf-batch-host-agent';Role='HOST_AGENT';BasePort=8220;Count=$HostAgentCount}
)
Push-Location $RepoRoot
try{
 Invoke-Gradle @(':cpf-batch:verifyStandaloneArtifacts','--no-daemon')
