...
public final class CpfCacheRuntimeHarness {
 public static void main(String[] a) throws Exception {
  ...
  CpfCacheMetricsSnapshot m=p.metrics(); req(m.hits()>=3&&m.misses()>=2&&m.puts()>=3&&m.evictions()>=2&&m.lockContentions()>=1,"metrics"); req(p.health().ready()&&!p.health().durableInvalidationReady(),"health"); System.out.println("CACHE_RUNTIME_PASS");
 }
