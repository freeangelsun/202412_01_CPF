...
SCRIPT = ROOT / "cpf-tools/scripts/verify-cpf-cmn-runtime-query-contract.py"
...
class CmnRuntimeQueryContractTest(unittest.TestCase):
    ...
    def copy_fixture(self) -> Path:
        ...
        for relative in [
            ...
            "cpf-common/src/main/java/com/cpf/common/sample/CmnSampleItemService.java",
            "cpf-common/src/main/java/com/cpf/common/sample/CmnSampleSqlDialect.java",
