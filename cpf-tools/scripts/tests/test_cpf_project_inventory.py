...
class ProjectInventoryTest(unittest.TestCase):
    ...
    def test_public_internal_import_rejected(self):
        t,r,o=self.make(); self.addCleanup(t.cleanup); p=r/'cpf-core/src/main/java/com/cpf/core/api/demo/DemoApi.java'; p.write_text('package com.cpf.core.api.demo; import com.cpf.core.internal.Secret; public interface DemoApi {}', encoding="utf-8")
