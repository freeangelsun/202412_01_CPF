...
GENERATOR_PATH = ROOT / "cpf-tools/scripts/generate-cpf-data-retention-sql.py"
...
class DataRetentionContractTest(unittest.TestCase):
    ...
    def test_wrapper_requires_plan_hash_archive_confirmation_and_unknown(self):
        text = (ROOT / "cpf-tools/scripts/invoke-cpf-data-retention.ps1").read_text(encoding="utf-8")
        for token in [
            "ExpectedPlanSha256",
