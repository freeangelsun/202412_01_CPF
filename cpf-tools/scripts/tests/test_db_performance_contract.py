...
MODULE_PATH = ROOT / "cpf-tools/scripts/verify-cpf-db-performance-evidence.py"
...
class DbPerformanceContractTest(unittest.TestCase):
    ...
    def test_powershell_consumer_requires_independent_approval_and_confirmations(self):
        text = (ROOT / "cpf-tools/scripts/invoke-cpf-db-performance-gate.ps1").read_text(encoding="utf-8")
