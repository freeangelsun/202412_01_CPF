...
SCRIPT = Path(__file__).parents[1] / "verify-cpf-batch-fail-closed.py"
...
class BatchFailClosedTest(unittest.TestCase):
    def fixture(self) -> Path:
        ...
        files = {
            ...
            "cpf-batch/control-server/src/main/java/com/cpf/batch/control/compat/BatInternalOperationsController.java": '''actorResolver.actor(request,textOrNull(payload,"requestUser"),"requestUser");''',
        }
