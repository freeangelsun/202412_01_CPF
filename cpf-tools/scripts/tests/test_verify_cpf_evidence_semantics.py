...
SCRIPT=Path(__file__).resolve().parents[1]/'verify-cpf-evidence-semantics.py';spec=importlib.util.spec_from_file_location('evidence',SCRIPT);module=importlib.util.module_from_spec(spec);assert spec and spec.loader;spec.loader.exec_module(module)
SHA='a'*40
