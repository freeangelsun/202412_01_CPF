...
def verify(root: Path) -> None:
    errors: list[str] = []
    service_rel = "cpf-batch/control-server/src/main/java/com/cpf/batch/control/compat/BatchOperationsCompatibilityService.java"
    ...
    if "RECONCILE" in api:
        errors.append(f"{api_rel}: unsupported RECONCILE action is exposed")
