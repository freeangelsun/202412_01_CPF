...
CONSUMER_PATHS = {
    ...
    "CmnSampleItemService": "cpf-common/src/main/java/com/cpf/common/sample/CmnSampleItemService.java",
    "CmnSampleSqlDialect": "cpf-common/src/main/java/com/cpf/common/sample/CmnSampleSqlDialect.java",
