...
CATEGORIES={
 'PUBLIC_CONTRACT':['cpf-core/src/main/java/**/api/**/*.java','cpf-core/src/main/java/**/spi/**/*.java','cpf-common/src/main/java/**/api/**/*.java','cpf-common/src/main/java/**/spi/**/*.java','cpf-batch/contract/src/main/java/**/*.java'],
...
DECL='cpf-docs/quality/CPF_20260801_01_EDU_IMPACT_DECLARATION.csv'
COVERAGE={'cpf-tools/governance/cpf-edu-executable-catalog.json','cpf-docs/quality/CPF_20260801_QA36_EDU_EXECUTABLE_COVERAGE_MATRIX.csv'}
TEST_MARKERS=('/src/test/','/scripts/tests/','.test.ts','.spec.ts','Test.java')
...
def validate(root:Path,changed:list[str],declaration:Path):
 ...
 if not changed&COVERAGE:errors.append('impactful product change requires EDU catalog or Canonical-162 coverage matrix change')
