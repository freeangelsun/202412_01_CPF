...
def main():
 ...
 wrappers=[
  root/'cpf-tools/scripts/verify-cpf-final-readonly.ps1',
  root/'cpf-tools/scripts/verify-cpf-fresh-clone-final.ps1',
  root/'cpf-tools/scripts/verify-cpf-approved-baseline-three-db.ps1',
  root/'cpf-tools/scripts/sync-cpf-runtime-openapi-generated-client.ps1',
 ]
