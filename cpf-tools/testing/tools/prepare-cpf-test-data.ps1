...
$rootPath=(Resolve-Path $Root).Path;. (Join-Path $rootPath 'cpf-tools/db/tools/database-profile-common.ps1');. (Join-Path $rootPath 'cpf-tools/db/tools/cpf-backup-lifecycle-common.ps1')
