...
SCRIPTS = ROOT / "cpf-tools" / "db" / "verification"
DB = ROOT / "cpf-tools" / "db"


def load_module(filename: str, module_name: str, base: Path = SCRIPTS):
...
DS = load_module("verify-cpf-datasource-runtime-evidence.py", "cpf_ds_runtime_evidence", ROOT / "cpf-tools/runtime/tools")
OBS = load_module("verify-cpf-data-observability-evidence.py", "cpf_data_observability_evidence", ROOT / "cpf-tools/verification/tools")
