...
NORMALIZER_PATH = ROOT / "cpf-tools/db/tools/normalize-cpf-db-operation-evidence.py"
GENERATOR_PATH = ROOT / "cpf-tools/contracts/openapi/generate-cpf-db-operations-openapi.py"
...
WRAPPER_PATH = ROOT / "cpf-tools/db/tools/invoke-cpf-db-operability-gate.ps1"
