...
SCRIPT = ROOT / 'cpf-tools/governance/tools/verify-cpf-product-governance.py'
...
def fixture(tmp_path: Path) -> Path:
    for rel in [
        'cpf-tools/governance/product-capability-policy.json',
        'cpf-tools/governance/tools/verify-cpf-product-governance.py',
...
def mutate(root: Path, mutation) -> None:
    path = root / 'cpf-tools/governance/product-capability-policy.json'
