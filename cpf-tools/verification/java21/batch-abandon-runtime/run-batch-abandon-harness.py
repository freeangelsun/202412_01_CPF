...
def main() -> int:
    ...
    product_sources = [
        root / 'cpf-batch/api/src/main/java/com/cpf/batch/api/BatchControlState.java',
        root / 'cpf-batch/runtime/src/main/java/com/cpf/batch/execution/CpfBatchExecutionException.java',
        root / 'cpf-batch/runtime/src/main/java/com/cpf/batch/execution/CpfBatchUnknownResultException.java',
        root / 'cpf-batch/runtime/src/main/java/com/cpf/batch/execution/CpfBatchAbandonCoordinator.java',
    ]
