...
def main()->int:
 ...
 sources=[
  root/'cpf-batch/control-server/src/main/java/com/cpf/batch/control/RuntimeCommandExecutionException.java',
  root/'cpf-batch/control-server/src/main/java/com/cpf/batch/control/RuntimeCommandExecutor.java',
