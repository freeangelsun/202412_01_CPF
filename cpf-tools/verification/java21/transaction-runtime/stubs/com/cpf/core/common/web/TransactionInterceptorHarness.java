...
import com.fasterxml.jackson.databind.ObjectMapper; import com.cpf.core.common.header.*; import jakarta.servlet.http.*; import org.springframework.beans.factory.ObjectProvider; import org.springframework.core.env.Environment; import org.springframework.web.method.HandlerMethod; import java.io.*; import java.lang.reflect.*; import java.util.*;
public final class TransactionInterceptorHarness {
 ...
 static class C {public void plain(){} @com.cpf.core.api.execution.CpfOnlineTransaction(id="O-12345678",name="online") public void online(){} @com.cpf.core.api.execution.CpfSharedApi(id="S-12345678",name="shared",allowedCallers={"PAY"}) public void shared(){}}
