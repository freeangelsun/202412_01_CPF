...
'com/cpf/web/api/CpfController.java':'''package com.cpf.web.api; import java.lang.annotation.*; @Target(ElementType.TYPE) @Retention(RetentionPolicy.RUNTIME) public @interface CpfController { String value() default ""; }''',
...
'com/cpf/data/persistence/api/annotation/CpfTransactional.java':'''package com.cpf.data.persistence.api.annotation; import java.lang.annotation.*; @Target({ElementType.METHOD,ElementType.TYPE}) @Retention(RetentionPolicy.RUNTIME) public @interface CpfTransactional { boolean readOnly() default false; String transactionManager() default ""; }''',
...
'org/mybatis/spring/annotation/MapperScan.java':'''package org.mybatis.spring.annotation; import java.lang.annotation.*; @Target(ElementType.TYPE) @Retention(RetentionPolicy.RUNTIME) public @interface MapperScan { String[] value() default {}; String[] basePackages() default {}; String sqlSessionFactoryRef() default ""; }''',
'org/springframework/beans/factory/annotation/Qualifier.java':'''package org.springframework.beans.factory.annotation; import java.lang.annotation.*; @Target({ElementType.FIELD,ElementType.PARAMETER,ElementType.METHOD,ElementType.TYPE}) @Retention(RetentionPolicy.RUNTIME) public @interface Qualifier { String value() default ""; }''',
...
'org/assertj/core/api/Assertions.java':'''package org.assertj.core.api; public final class Assertions { public interface ThrowingCallable { void call() throws Throwable; } public static <T> GenericAssert<T> assertThat(T v){return new GenericAssert<>();} public static GenericAssert<Throwable> assertThatThrownBy(ThrowingCallable c){try{c.call();}catch(Throwable t){} return new GenericAssert<>();} public static final class GenericAssert<T>{ public GenericAssert<T> as(String d,Object... a){return this;} public GenericAssert<T> isEqualTo(Object o){return this;} public GenericAssert<T> isNotNull(){return this;} public GenericAssert<T> isNotBlank(){return this;} public GenericAssert<T> isTrue(){return this;} public GenericAssert<T> isInstanceOf(Class<?> c){return this;} public GenericAssert<T> containsExactlyInAnyOrder(Object... values){return this;} } }''',
}
