...
STUBS={
'com/cpf/core/api/context/CpfContexts.java':'''package com.cpf.core.api.context; public final class CpfContexts { public static CpfContext requireCurrent(){return new CpfContext();} public static long transactionSequence(){return 1L;} public static String operatorId(){return "OPERATOR";} public static final class CpfContext { public String transactionId(){return "TX";} } }''',
...
'com/cpf/web/api/CpfController.java':'''package com.cpf.web.api; import java.lang.annotation.*; @Target(ElementType.TYPE) @Retention(RetentionPolicy.RUNTIME) public @interface CpfController {}''',
...
'com/cpf/data/persistence/api/annotation/CpfTx.java':'''package com.cpf.data.persistence.api.annotation; import java.lang.annotation.*; @Target({ElementType.METHOD,ElementType.TYPE}) @Retention(RetentionPolicy.RUNTIME) public @interface CpfTx { String id(); String name(); String ownerDomain(); boolean readOnly() default false; }''',
