...
def main() -> int:
    ...
    port=read(root/REQ['shared']/'SpringDataRedisCpfCachePort.java')
    coord=read(root/REQ['shared']/'CpfCacheInvalidationCoordinator.java')
    operation_test=read(root/'cpf-starters/data/cache/spring-data-redis/src/test/java/com/cpf/data/cache/rediscommon/SpringDataRedisCpfCachePortOperationTest.java')
