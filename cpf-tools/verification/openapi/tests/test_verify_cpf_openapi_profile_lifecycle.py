...
def profile():
    return {
        ...
        "generator_capabilities": [{
            ...
            "evidence_paths": ["cpf-tools/generator/tools/generator.py"]
        }],
...
def setup_repo(tmp_path: Path, doc=None, prof=None):
    ...
    (repo / "cpf-tools/generator/tools").mkdir(parents=True)
    ...
    (repo / "cpf-tools/generator/tools/generator.py").write_text("print('ok')\n", encoding="utf-8")
