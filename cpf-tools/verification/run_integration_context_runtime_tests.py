...
def main():
 ...
 try:
  ...
  '''),encoding='utf-8')
  src=fs('cpf-core/src/main/java/com/cpf/core/api/context/CpfContext.java','cpf-core/src/main/java/com/cpf/core/api/context/CpfContextSnapshot.java','cpf-core/src/main/java/com/cpf/core/api/context/CpfContexts.java','cpf-core/src/main/java/com/cpf/core/spi/context/CpfContextRuntimeProvider.java','cpf-starters/base/runtime/src/main/java/com/cpf/starter/internal/context/CpfStarterContextRuntime.java','cpf-starters/base/runtime/src/main/java/com/cpf/foundation/context/CpfContextProjection.java','cpf-starters/base/runtime/src/main/java/com/cpf/foundation/context/CpfContextProjectionRegistry.java','cpf-starters/base/runtime/src/main/java/com/cpf/foundation/id/spi/CpfExecutionIdGenerator.java','cpf-starters/integration/src/main/java/com/cpf/integration/context','cpf-starters/integration/src/main/java/com/cpf/integration/internal/context/CpfIntegrationContextRuntime.java','cpf-starters/integration/http/src/main/java/com/cpf/integration/http/CpfHttpClientProperties.java','cpf-starters/integration/http/src/main/java/com/cpf/integration/http/CpfTypedHttpClient.java')+[str(ann),str(h)]
