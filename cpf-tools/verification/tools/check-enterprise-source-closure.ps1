...
'cpf-backoffice-web/frontend/src/shared/components/StructuredDataView.vue','cpf-backoffice/online/src/main/java/com/cpf/backoffice/online/auth/permission/BzaPermissionManifest.java',
