...
AddCheck 'BATCH_CANONICAL' @('cpf-batch/api/build.gradle','cpf-batch/runtime-support/build.gradle','cpf-batch/runtime/build.gradle','cpf-batch/remote-kafka/build.gradle','cpf-batch/control-plane/build.gradle','cpf-batch/center-cut/build.gradle','cpf-batch/agent/build.gradle') 'Batch canonical module 실물을 검증합니다.'
AddCheck 'GENERATOR_CANONICAL' @('cpf-tools/generator/contracts/cpf-starter-catalog.json','cpf-tools/generator/engine/cpf_domain_generator.py','cpf-tools/generator/tools/create-domain.ps1','cpf-tools/generator/verification/smoke-generated-domain-lifecycle.ps1') 'Generator catalog/engine/lifecycle 검증기를 확인합니다.'
