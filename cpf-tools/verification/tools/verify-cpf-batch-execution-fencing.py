...
CHECKS = {
    ...
    "cpf-batch/center-cut/src/main/java/com/cpf/batch/centercut/runner/CenterCutTargetGenerator.java": (
    ...
    for rel, tokens in CHECKS.items():
        ...
        if rel.endswith("CpfBatchKafkaInboundBridge.java"):
            try:
                ...
                compact_accept = "".join(accept.split())
                for token in (
                        "String attemptOwnerId=attemptOwnerId();",
                    ...
                    if "".join(token.split()) not in compact_accept:
