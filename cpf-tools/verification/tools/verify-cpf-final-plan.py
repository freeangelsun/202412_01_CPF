...
REQUIRED_FLAGS={
  "cpf-tools/verification/openapi/verify-cpf-openapi-controller-coverage.py": {"--root","--module","--openapi"},
  "cpf-tools/governance/tools/verify-cpf-requirement-traceability.py": {"--root","--expected-sha"},
...
def main()->int:
    ...
    parser.add_argument("--plan",default="cpf-tools/verification/contracts/cpf-final-verification-plan.json")
