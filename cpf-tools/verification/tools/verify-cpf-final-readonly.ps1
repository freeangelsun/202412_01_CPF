...
function Assert-GateInventory {
    $required = @(
        ...
        'cpf-tools/verification/tools/verify-cpf-adm-capability-registry.py',
        'cpf-tools/verification/tools/verify-cpf-adm-commercial-page-contract.py',
        'cpf-tools/security/tools/verify-cpf-controller-permission-contract.py',
        'cpf-tools/verification/tools/check-repository-hygiene.ps1',
        'cpf-tools/db/verification/check-db-vendor-pack-parity.ps1',
        'cpf-tools/db/verification/check-migration-checksums.ps1',
        'cpf-tools/verification/tools/check-enterprise-source-closure.ps1',
        'cpf-tools/verification/tools/check-direct-client-boundary.ps1',
        'cpf-tools/verification/tools/check-semantic-consumer-graph.ps1',
        'cpf-tools/verification/tools/check-evidence-contract.ps1'
    )
...
try {
    ...
    Invoke-Required 'Requirement traceability' 'cpf-tools/governance/tools/verify-cpf-requirement-traceability.py' $traceArgs
    Invoke-Required 'ADM capability registry' 'cpf-tools/verification/tools/verify-cpf-adm-capability-registry.py' @('--root',$root)
    Invoke-Required 'ADM commercial page contract' 'cpf-tools/verification/tools/verify-cpf-adm-commercial-page-contract.py' @('--root',$root)
    Invoke-Required 'Controller permission contract' 'cpf-tools/security/tools/verify-cpf-controller-permission-contract.py' @('--root',$root,'--strict')
    Invoke-Required 'Repository hygiene' 'cpf-tools/verification/tools/check-repository-hygiene.ps1' @('-Root',$root)
    Invoke-Required 'DB vendor parity' 'cpf-tools/db/verification/check-db-vendor-pack-parity.ps1' @('-Root',$root)
    Invoke-Required 'Migration checksums' 'cpf-tools/db/verification/check-migration-checksums.ps1' @('-Root',$root)
    Invoke-Required 'Ownership boundary' 'cpf-tools/verification/tools/check-enterprise-source-closure.ps1' @('-Root',$root)
    Invoke-Required 'Direct client boundary' 'cpf-tools/verification/tools/check-direct-client-boundary.ps1' @('-Root',$root)
    Invoke-Required 'Semantic consumer graph' 'cpf-tools/verification/tools/check-semantic-consumer-graph.ps1' @('-Root',$root)
    Invoke-Required 'Evidence contract' 'cpf-tools/verification/tools/check-evidence-contract.ps1' @('-Root',$root)
