...
POLICY="cpf-starters/security/src/main/java/com/cpf/security/api/network/CpfNetworkEndpointPolicy.java"
POLICY_TEST="cpf-starters/security/src/test/java/com/cpf/security/api/network/CpfNetworkEndpointPolicyTest.java"
REQUIRED={
 "cpf-starters/integration/http/src/main/java/com/cpf/integration/http/internal/CpfServiceEndpointRegistry.java":(
  "validateEndpoint","validateResolvedAddresses","ResolvedEndpoint","pinnedAddress","rejectMixedAddressClasses","pinnedAddresses"),
 "cpf-starters/integration/http/src/main/java/com/cpf/integration/http/internal/CpfPinnedHttpConnectorFactory.java":(
  "remoteAddress","endpoint.pinnedAddress()","InetSocketAddress"),
 "cpf-starters/integration/http/src/main/java/com/cpf/integration/http/internal/CpfWebClient.java":(
 ...
 "cpf-batch/agent/src/main/java/com/cpf/batch/agent/internal/PinnedArtifactHttpTransport.java":(
  "CpfNetworkEndpointPolicy","validateEndpoint","validateResolvedAddresses","openSocket","InetSocketAddress(target.address()"),
}
TESTS={
 "cpf-starters/integration/http/src/test/java/com/cpf/integration/http/internal/CpfServiceEndpointRegistryTest.java":(
 ...
 "cpf-starters/integration/http/src/test/java/com/cpf/integration/http/internal/CpfPinnedHttpConnectorFactoryContractTest.java":(
