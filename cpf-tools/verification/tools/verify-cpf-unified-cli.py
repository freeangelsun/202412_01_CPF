...
def main()->int:
    ...
    src=root/'cpf-tools/runtime/cli/java/CpfCli.java'; catalog=root/'cpf-tools/runtime/cli/contracts/cpf-command-catalog.json'; inv=root/'cpf-tools/runtime/cli/contracts/cpf-tooling-entrypoint-inventory.json'
