...
def main():
 ...
 for rel in ['cpf-admin/frontend/package.json','cpf-admin/frontend/package-lock.json','cpf-biz-admin/frontend/package.json','cpf-biz-admin/frontend/package-lock.json']:
