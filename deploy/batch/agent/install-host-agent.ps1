...
$services=@('cpf-batch-control-server','cpf-batch-scheduler','cpf-batch-worker','cpf-center-cut-runner','cpf-batch-host-agent')
...
Write-Host 'BAT managed-service Windows layout installed. Configure startup policy for Host Agent using the approved enterprise service wrapper/task policy.'
