...
public class ExsOperationController {
    ...
    @Operation(operationId = "exsOperationFindTokens", summary = "대외 token 상태 조회", description = "원문 token 없이 hash preview, 마스킹 token, 만료 시각을 조회합니다.")
    ...
    @Operation(operationId = "exsOperationRefreshToken", summary = "대외 token 갱신", description = "외부기관 인증 프로파일 기준으로 token을 갱신하고 원문 대신 hash와 마스킹 값을 DB에 남깁니다.")
    ...
    @Operation(operationId = "exsOperationFindTokenEvents", summary = "대외 token 이벤트 조회", description = "token 갱신/폐기 같은 운영 이벤트를 조회합니다.")
    ...
    @Operation(operationId = "exsOperationRequestRetry", summary = "대외 재처리 요청", description = "transactionGlobalId 기준 재처리 요청을 등록하고 운영 사유를 남깁니다.")
    ...
    @Operation(operationId = "exsOperationFindRetryRequests", summary = "대외 재처리 요청 조회", description = "대외 재처리 요청 상태와 사유를 조회합니다.")
    ...
    @Operation(operationId = "exsOperationSaveControlPolicy", summary = "대외 통제 정책 저장", description = "외부기관/통제유형별 허용 여부와 운영 사유를 저장합니다.")
    ...
    @Operation(operationId = "exsOperationFindControlPolicies", summary = "대외 통제 정책 조회", description = "외부기관/통제유형별 허용 여부를 조회합니다.")
