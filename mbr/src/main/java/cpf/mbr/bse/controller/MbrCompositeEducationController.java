...
public class MbrCompositeEducationController {
    ...
    @Operation(operationId = "mbrCompositeEducationMemberProfile", summary = "MBR 회원 조회 구간", description = "ACC에서 전달된 transactionGlobalId와 parentSegmentId를 이어받아 MBR 구간을 기록합니다.")
    ...
    @Operation(operationId = "mbrCompositeEducationMemberCallsExternal", summary = "MBR 중첩 외부연계 구간", description = "MBR이 EXS를 호출하는 중첩 복합 거래 구간을 기록합니다.")
