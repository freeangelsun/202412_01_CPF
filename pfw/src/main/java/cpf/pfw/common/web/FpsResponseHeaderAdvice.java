...
/**
 * Adds FPS standard response metadata headers when a response body exposes them.
 *
 ...
 */
@ControllerAdvice
public class FpsResponseHeaderAdvice implements ResponseBodyAdvice<Object> {
    public static final String RESPONSE_CODE_HEADER = "X-Fps-Response-Code";
    public static final String RESPONSE_MESSAGE_CODE_HEADER = "X-Fps-Response-Message-Code";
    public static final String MESSAGE_CODE_HEADER = "X-Fps-Message-Code";
    public static final String MESSAGE_CONTENT_HEADER = "X-Fps-Message-Content";
    public static final String MESSAGE_ID_HEADER = "X-Fps-Message-Id";
    public static final String TRANSACTION_ID_HEADER = "X-Fps-Transaction-Id";
    public static final String TRACE_ID_HEADER = "X-Fps-Trace-Id";
