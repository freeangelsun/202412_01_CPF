...
public final class TransactionContext {
    ...
    /**
     * 컨트롤러 업무 거래ID와 거래명을 MDC에 저장합니다.
     *
     * <p>필터 단계에서는 어떤 컨트롤러가 실행될지 알 수 없으므로,
     * {@code LoggingAspect}가 {@code @FpsTransaction}을 해석한 뒤 호출합니다.</p>
     *
    ...
    /**
     * 현재 거래에 적용된 동적 로그레벨을 MDC에 저장합니다.
     *
     * @param logLevel 동적 로그레벨
     */
