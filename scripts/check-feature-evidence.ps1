...
Test-RequiredFile "specs/evidence/20260703_05/file-log-standard-result.sanitized.json" "SANITIZED_05_FILE_LOG_STANDARD"
Test-RequiredFile "specs/evidence/20260703_05/file-log-grep-summary.sanitized.log" "SANITIZED_05_FILE_LOG_GREP"
Test-RequiredFile "specs/evidence/20260703_05/trace-boost-runtime-result.sanitized.json" "SANITIZED_05_TRACE_BOOST"
Test-RequiredFile "specs/evidence/20260703_05/bat-trace-boost-runtime-result.sanitized.json" "SANITIZED_05_BAT_TRACE_BOOST"
Test-RequiredFile "specs/evidence/20260703_05/create-domain-result.sanitized.json" "SANITIZED_05_CREATE_DOMAIN"
Test-RequiredFile "specs/evidence/20260703_05/runtime-smoke-summary.sanitized.json" "SANITIZED_05_RUNTIME_SUMMARY"
