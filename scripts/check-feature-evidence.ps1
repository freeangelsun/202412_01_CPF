...
Test-RequiredFile "scripts/deploy/deploy-module.ps1" "DEPLOY_MODULE_PS1"
Test-RequiredFile "scripts/deploy/deploy-module.sh" "DEPLOY_MODULE_SH"
Test-RequiredFile "scripts/deploy/check-packaged-dependencies.ps1" "CHECK_PACKAGED_DEPENDENCIES"
Test-RequiredFile "scripts/deploy/deploy-acc.ps1" "DEPLOY_ACC_WRAPPER"
Test-RequiredFile "scripts/deploy/deploy-mbr.ps1" "DEPLOY_MBR_WRAPPER"
Test-RequiredFile "scripts/deploy/deploy-exs.ps1" "DEPLOY_EXS_WRAPPER"
Test-RequiredFile "scripts/deploy/deploy-adm.ps1" "DEPLOY_ADM_WRAPPER"
Test-RequiredFile "scripts/deploy/deploy-bat.ps1" "DEPLOY_BAT_WRAPPER"
Test-RequiredFile "scripts/deploy/deploy-bizadm.ps1" "DEPLOY_BIZADM_WRAPPER"
Test-RequiredFile "scripts/deploy/deploy-edu.ps1" "DEPLOY_EDU_WRAPPER"
Test-RequiredFile "scripts/deploy/deploy-xyz.ps1" "DEPLOY_XYZ_WRAPPER"
...
Test-RequiredText "scripts/deploy/deploy-module.ps1" "DryRun" "DEPLOY_MODULE_DRY_RUN"
Test-RequiredText "scripts/deploy/deploy-module.ps1" "SkipArtifactRequired" "DEPLOY_MODULE_SKIP_ARTIFACT"
Test-RequiredText "scripts/deploy/deploy-module.ps1" "rollbackEnabled" "DEPLOY_MODULE_ROLLBACK_FIELD"
Test-RequiredText "scripts/deploy/check-packaged-dependencies.ps1" "BOOT-INF/lib/pfw" "PACKAGED_DEPENDENCY_PFW_JAR_SCAN"
...
Test-RequiredText "README.md" "scripts/deploy/deploy-module.ps1" "README_DEPLOY_MODULE_CHECK"
