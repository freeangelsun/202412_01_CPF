...
Test-RequiredFile "scripts/check-architecture-ownership.ps1" "CHECK_ARCHITECTURE_OWNERSHIP"
Test-RequiredFile "scripts/check-spring-event-usage.ps1" "CHECK_SPRING_EVENT_USAGE"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerPublisher.java" "PFW_BROKER_PUBLISHER"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerConsumer.java" "PFW_BROKER_CONSUMER"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerMessage.java" "PFW_BROKER_MESSAGE"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerEnvelope.java" "PFW_BROKER_ENVELOPE"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerDlqPort.java" "PFW_BROKER_DLQ_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerReplayPort.java" "PFW_BROKER_REPLAY_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerHealthPort.java" "PFW_BROKER_HEALTH_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerHistoryPort.java" "PFW_BROKER_HISTORY_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerOutboxPort.java" "PFW_BROKER_OUTBOX_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerInboxPort.java" "PFW_BROKER_INBOX_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerIdempotencyPort.java" "PFW_BROKER_IDEMPOTENCY_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerDlqReplayRequest.java" "PFW_BROKER_DLQ_REPLAY_REQUEST"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerDlqReplayResult.java" "PFW_BROKER_DLQ_REPLAY_RESULT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/JdbcCpfBrokerReliabilityRepository.java" "PFW_BROKER_JDBC_RELIABILITY_REPOSITORY"
Test-RequiredFile "pfw/src/test/java/cpf/pfw/common/broker/JdbcCpfBrokerReliabilityRepositoryTest.java" "PFW_BROKER_JDBC_RELIABILITY_REPOSITORY_TEST"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/filetransfer/CpfFileTransferClient.java" "PFW_FILE_TRANSFER_CLIENT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/filetransfer/CpfFileTransferPort.java" "PFW_FILE_TRANSFER_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/filetransfer/CpfFileTransferEndpoint.java" "PFW_FILE_TRANSFER_ENDPOINT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/filetransfer/CpfFileTransferHistoryPort.java" "PFW_FILE_TRANSFER_HISTORY_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/filetransfer/CpfFileTransferHealthPort.java" "PFW_FILE_TRANSFER_HEALTH_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/filetransfer/CpfFileTransferProtocol.java" "PFW_FILE_TRANSFER_PROTOCOL"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/filetransfer/CpfFileTransferPolicy.java" "PFW_FILE_TRANSFER_POLICY"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/filetransfer/CpfFileChecksumPolicy.java" "PFW_FILE_CHECKSUM_POLICY"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/filetransfer/CpfDuplicatePreventionPort.java" "PFW_FILE_DUPLICATE_PREVENTION_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/filetransfer/CpfFileTransferHistoryQuery.java" "PFW_FILE_TRANSFER_HISTORY_QUERY"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/filetransfer/JdbcCpfFileTransferRepository.java" "PFW_FILE_TRANSFER_JDBC_REPOSITORY"
Test-RequiredFile "pfw/src/test/java/cpf/pfw/common/filetransfer/JdbcCpfFileTransferRepositoryTest.java" "PFW_FILE_TRANSFER_JDBC_REPOSITORY_TEST"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/idempotency/CpfIdempotencyRecord.java" "PFW_IDEMPOTENCY_RECORD"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/idempotency/CpfIdempotencyPort.java" "PFW_IDEMPOTENCY_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/idempotency/JdbcCpfIdempotencyRepository.java" "PFW_IDEMPOTENCY_JDBC_REPOSITORY"
Test-RequiredFile "pfw/src/test/java/cpf/pfw/common/idempotency/JdbcCpfIdempotencyRepositoryTest.java" "PFW_IDEMPOTENCY_JDBC_REPOSITORY_TEST"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/reconciliation/CpfUnknownResultRecord.java" "PFW_UNKNOWN_RESULT_RECORD"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/reconciliation/CpfReconciliationPort.java" "PFW_RECONCILIATION_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/reconciliation/JdbcCpfReconciliationRepository.java" "PFW_RECONCILIATION_JDBC_REPOSITORY"
Test-RequiredFile "pfw/src/test/java/cpf/pfw/common/reconciliation/JdbcCpfReconciliationRepositoryTest.java" "PFW_RECONCILIATION_JDBC_REPOSITORY_TEST"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/security/CpfCredentialRef.java" "PFW_CREDENTIAL_REF"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/security/CpfCredentialProviderPort.java" "PFW_CREDENTIAL_PROVIDER_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/security/CpfCredentialValidationResult.java" "PFW_CREDENTIAL_VALIDATION_RESULT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/security/CpfTokenProviderPort.java" "PFW_TOKEN_PROVIDER_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/security/CpfTokenRequest.java" "PFW_TOKEN_REQUEST"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/security/CpfTokenResult.java" "PFW_TOKEN_RESULT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/security/CpfSecretProviderPort.java" "PFW_SECRET_PROVIDER_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/security/CpfKeyProviderPort.java" "PFW_KEY_PROVIDER_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/security/CpfCertificateProviderPort.java" "PFW_CERTIFICATE_PROVIDER_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/security/CpfSignaturePort.java" "PFW_SIGNATURE_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/security/CpfEncryptionPort.java" "PFW_ENCRYPTION_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/runtime/CpfDistributedLockPort.java" "PFW_DISTRIBUTED_LOCK_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/runtime/CpfHeartbeatPort.java" "PFW_HEARTBEAT_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/runtime/CpfHealthCheckPort.java" "PFW_HEALTH_CHECK_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/runtime/CpfGhostDetectorPort.java" "PFW_GHOST_DETECTOR_PORT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/runtime/CpfLockAcquireRequest.java" "PFW_LOCK_ACQUIRE_REQUEST"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/runtime/CpfLockAcquireResult.java" "PFW_LOCK_ACQUIRE_RESULT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/runtime/CpfHeartbeatRequest.java" "PFW_HEARTBEAT_REQUEST"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/runtime/CpfHeartbeatResult.java" "PFW_HEARTBEAT_RESULT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/runtime/CpfGhostDetectionResult.java" "PFW_GHOST_DETECTION_RESULT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/runtime/CpfWorkerControlRequest.java" "PFW_WORKER_CONTROL_REQUEST"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/runtime/CpfWorkerControlResult.java" "PFW_WORKER_CONTROL_RESULT"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/runtime/CpfRuntimeHealthQuery.java" "PFW_RUNTIME_HEALTH_QUERY"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/admin/CpfBrokerStatusQuery.java" "PFW_ADMIN_BROKER_STATUS_QUERY"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/admin/CpfFileTransferStatusQuery.java" "PFW_ADMIN_FILE_TRANSFER_STATUS_QUERY"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/admin/CpfCredentialStatusQuery.java" "PFW_ADMIN_CREDENTIAL_STATUS_QUERY"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/admin/CpfRuntimeHealthStatusQuery.java" "PFW_ADMIN_RUNTIME_HEALTH_STATUS_QUERY"
Test-RequiredFile "pfw/src/test/java/cpf/pfw/common/capability/CpfCapabilityContractTest.java" "PFW_CAPABILITY_CONTRACT_TEST"
Test-RequiredFile "specs/sql/migration/flyway/V22__pfw_reliability_persistence.sql" "FLYWAY_PFW_RELIABILITY_PERSISTENCE"
Test-RequiredText "specs/sql/10_pfw_schema.sql" "pfw_idempotency_record" "SQL_PFW_IDEMPOTENCY_RECORD"
Test-RequiredText "specs/sql/10_pfw_schema.sql" "pfw_broker_outbox" "SQL_PFW_BROKER_OUTBOX"
Test-RequiredText "specs/sql/10_pfw_schema.sql" "pfw_file_transfer_history" "SQL_PFW_FILE_TRANSFER_HISTORY"
Test-RequiredText "specs/sql/10_pfw_schema.sql" "pfw_unknown_result" "SQL_PFW_UNKNOWN_RESULT"
Test-RequiredText "specs/sql/00_all_install.sql" "pfw_broker_dlq" "ALL_INSTALL_PFW_BROKER_DLQ"
Test-RequiredText "specs/sql/00_all_install_and_smoke.sql" "pfw_unknown_result" "ALL_INSTALL_SMOKE_PFW_UNKNOWN_RESULT"
Test-RequiredFile "scripts/check-cpf-request-protection.ps1" "CHECK_CPF_REQUEST_PROTECTION"
Test-RequiredText "build.gradle" "checkCpfRequestProtection" "GRADLE_CHECK_CPF_REQUEST_PROTECTION"
Test-RequiredText "build.gradle" "initializeCpfRequestProtection" "GRADLE_INITIALIZE_CPF_REQUEST_PROTECTION"
Test-RequiredText "scripts/check-cpf-request-protection.ps1" "InitializeBaseline" "CHECK_CPF_REQUEST_PROTECTION_EXPLICIT_BASELINE"
Test-RequiredText "scripts/check-cpf-request-protection.ps1" "Baseline is missing" "CHECK_CPF_REQUEST_PROTECTION_MISSING_BASELINE_FAILS"
Test-RequiredText "README.md" "scripts/smoke-service-registry-runtime.ps1" "README_SERVICE_REGISTRY_SMOKE"
Test-RequiredText "README.md" "scripts/check-architecture-ownership.ps1" "README_ARCHITECTURE_OWNERSHIP_SCAN"
Test-RequiredText "README.md" "scripts/check-spring-event-usage.ps1" "README_SPRING_EVENT_SCAN"
...
Test-RequiredText "pfw/src/main/resources/application-pfw.yml" "cpf-{moduleCode}-{logType}-{instanceId}.{date}.log" "PFW_FILE_LOG_PATTERN"
...
Test-RequiredFile "scripts/check-profile-loading.ps1" "CHECK_PROFILE_LOADING"
Test-RequiredFile "scripts/check-runtime-config-standard.ps1" "CHECK_RUNTIME_CONFIG_STANDARD"
Test-ForbiddenFile "scripts/deploy/deploy-module.ps1" "DEPLOY_MODULE_PS1_RETIRED"
Test-ForbiddenFile "scripts/deploy/deploy-module.sh" "DEPLOY_MODULE_SH_RETIRED"
Test-ForbiddenFile "scripts/deploy/check-packaged-dependencies.ps1" "CHECK_PACKAGED_DEPENDENCIES_SCRIPT_RETIRED"
Test-RequiredText "build.gradle" "tasks.register('checkDeployEnv')" "GRADLE_CHECK_DEPLOY_ENV_TASK"
Test-RequiredText "build.gradle" "tasks.register('checkDeployInventory')" "GRADLE_CHECK_DEPLOY_INVENTORY_TASK"
Test-RequiredText "build.gradle" "tasks.register('checkPackagedDependencies')" "GRADLE_CHECK_PACKAGED_DEPENDENCIES_TASK"
Test-RequiredText "build.gradle" "tasks.register('remoteDeployDryRun')" "GRADLE_REMOTE_DEPLOY_DRY_RUN_TASK"
Test-RequiredText "build.gradle" "tasks.register('rollbackDeploy')" "GRADLE_ROLLBACK_DEPLOY_TASK"
Test-RequiredFile "deploy/inventory/dev-services.json" "DEPLOY_DEV_INVENTORY"
Test-RequiredFile "deploy/inventory/stg-services.json" "DEPLOY_STG_INVENTORY"
Test-RequiredFile "deploy/inventory/prod-services.template.json" "DEPLOY_PROD_INVENTORY_TEMPLATE"
Test-RequiredFile "deploy/env/dev-acc.env" "DEPLOY_ENV_DEV_ACC"
Test-RequiredFile "deploy/env/stg-adm.env" "DEPLOY_ENV_STG_ADM"
Test-RequiredFile "deploy/env/prod-bat.env" "DEPLOY_ENV_PROD_BAT"
...
Test-RequiredText "scripts/check-runtime-config-standard.ps1" "deleted-files.sanitized.json" "RUNTIME_CONFIG_DELETED_FILES_EVIDENCE"
Test-RequiredText "scripts/check-runtime-config-standard.ps1" "retained-review-required-files.sanitized.json" "RUNTIME_CONFIG_RETAINED_FILES_EVIDENCE"
Test-RequiredText "scripts/check-runtime-config-standard.ps1" "DATASOURCE_MODE" "RUNTIME_CONFIG_DATASOURCE_MODE_SCAN"
Test-RequiredText "scripts/check-runtime-config-standard.ps1" "runtimeMode" "RUNTIME_CONFIG_INVENTORY_RUNTIME_MODE"
Test-RequiredText "build.gradle" "BOOT-INF\/lib\/pfw" "PACKAGED_DEPENDENCY_PFW_JAR_SCAN"
...
Test-RequiredText "scripts/create-domain.ps1" "cpf-{moduleCode}-{logType}-{instanceId}.{date}.log" "CREATE_DOMAIN_FILE_LOG_GUIDE"
...
Test-RequiredText "README.md" "scripts/check-profile-loading.ps1" "README_PROFILE_LOADING_CHECK"
Test-RequiredText "README.md" "remoteDeployDryRun" "README_GRADLE_DEPLOY_DRY_RUN_CHECK"
Test-ForbiddenText "README.md" "scripts/deploy/deploy-module.ps1" "README_RETIRED_DEPLOY_SCRIPT"
...
Test-RequiredTextInSpecs "profile-loading-standard" "DOC_PROFILE_LOADING_MATRIX"
Test-RequiredTextInSpecs "deploy-dry-run-standard" "DOC_DEPLOY_DRY_RUN_MATRIX"
Test-RequiredTextInSpecs "packaged-dependencies-check" "DOC_PACKAGED_DEPENDENCIES_MATRIX"
Test-RequiredTextInSpecs "garbage-file-cleanup" "DOC_GARBAGE_FILE_CLEANUP_MATRIX"
Test-RequiredTextInSpecs "deploy-env-standard" "DOC_DEPLOY_ENV_STANDARD_MATRIX"
Test-RequiredTextInSpecs "bat-job-log-policy" "DOC_BAT_JOB_LOG_POLICY_MATRIX"
...
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/idempotency/CpfIdempotencyEngine.java" "PFW_IDEMPOTENCY_ENGINE"
Test-RequiredFile "pfw/src/test/java/cpf/pfw/common/idempotency/CpfIdempotencyEngineTest.java" "PFW_IDEMPOTENCY_ENGINE_TEST"
Test-RequiredText "xyz/src/main/java/cpf/xyz/edu/idempotency/XyzIdempotencyEducationSample.java" "CpfIdempotencyEngine" "XYZ_IDEMPOTENCY_PFW_ENGINE"
Test-RequiredText "bat/src/main/java/cpf/bat/edu/idempotency/BatIdempotencyEducationSample.java" "CpfIdempotencyEngine" "BAT_IDEMPOTENCY_PFW_ENGINE"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerPublisherWorker.java" "PFW_BROKER_PUBLISHER_WORKER"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/broker/CpfBrokerConsumerWorker.java" "PFW_BROKER_CONSUMER_WORKER"
Test-RequiredFile "pfw/src/test/java/cpf/pfw/common/broker/CpfBrokerWorkerTest.java" "PFW_BROKER_WORKER_TEST"
Test-RequiredText "xyz/src/main/java/cpf/xyz/edu/messaging/XyzOutboxInboxEducationSample.java" "CpfBrokerPublisherWorker" "XYZ_BROKER_PFW_WORKER"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/filetransfer/LocalCpfFileTransferAdapter.java" "PFW_LOCAL_FILE_TRANSFER_ADAPTER"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/filetransfer/CpfFileTransferEngine.java" "PFW_FILE_TRANSFER_ENGINE"
Test-RequiredFile "pfw/src/test/java/cpf/pfw/common/filetransfer/LocalCpfFileTransferAdapterTest.java" "PFW_LOCAL_FILE_TRANSFER_TEST"
Test-RequiredText "xyz/src/main/java/cpf/xyz/edu/filetransfer/XyzFileChecksumEducationSample.java" "CpfFileTransferEngine" "XYZ_FILE_TRANSFER_PFW_ENGINE"
Test-RequiredFile "adm/src/main/java/cpf/adm/opr/controller/AdmReliabilityController.java" "ADM_RELIABILITY_CONTROLLER"
Test-RequiredText "adm/src/main/java/cpf/adm/opr/controller/AdmReliabilityController.java" 'operationId = "requestAdmBrokerDlqReplay"' "ADM_RELIABILITY_REPLAY_OPENAPI"
Test-RequiredText "adm/src/main/java/cpf/adm/opr/filter/AdmApiAuthFilter.java" "RELIABILITY_REPLAY" "ADM_RELIABILITY_SERVER_PERMISSION"
Test-RequiredFile "adm/src/test/java/cpf/adm/opr/service/AdmReliabilityServiceTest.java" "ADM_RELIABILITY_SERVICE_TEST"
Test-RequiredFile "specs/sql/migration/flyway/V23__adm_reliability_operations.sql" "ADM_RELIABILITY_FLYWAY"
Test-RequiredText "specs/sql/60_adm_seed_data.sql" "RELIABILITY_RESOLVE" "ADM_RELIABILITY_SEED"
Test-RequiredText "scripts/create-domain.ps1" "Application.java" "CREATE_DOMAIN_APPLICATION_TEMPLATE"
Test-RequiredText "scripts/create-domain.ps1" 'operationId = "search' "CREATE_DOMAIN_OPENAPI_OPERATION_ID"
Test-RequiredText "scripts/smoke-create-domain.ps1" "bootJarTask" "CREATE_DOMAIN_BOOTJAR_SMOKE"
Test-RequiredText "scripts/smoke-create-domain.ps1" "mojibake marker" "CREATE_DOMAIN_MOJIBAKE_SMOKE"
Test-RequiredText ".gitignore" "!specs/evidence/**/*.sanitized.log" "SANITIZED_LOG_TRACKING_POLICY"
Test-RequiredFile "pfw/src/main/resources/log/cpf-logback-spring.xml" "SHARED_LOGBACK_STANDARD"
Test-RequiredText "pfw/src/main/resources/application-pfw.yml" "CPF_LOG_ROOT" "CPF_LOG_ROOT_STANDARD"
Test-RequiredFile "pfw/src/main/java/cpf/pfw/common/batch/CpfBatchJobLogPath.java" "BAT_JOB_INSTANCE_LOG_PATH"
Test-RequiredText "pfw/src/main/java/cpf/pfw/common/batch/CpfBatchFileLogWriter.java" "CONTEXT_BUSINESS_DATE" "BAT_BUSINESS_DATE_CONTEXT"
Test-RequiredText "pfw/src/main/java/cpf/pfw/common/batch/CpfBatchFileLogWriter.java" "transactionGlobalId" "BAT_TRANSACTION_GLOBAL_ID_LOG"
Test-RequiredFile "pfw/src/test/java/cpf/pfw/common/batch/CpfBatchFileLogWriterTest.java" "BAT_JOB_INSTANCE_LOG_TEST"
Test-RequiredFile "adm/src/main/java/cpf/adm/opr/service/AdmBatchJobLogService.java" "ADM_BATCH_JOB_LOG_SERVICE"
Test-RequiredText "adm/src/main/java/cpf/adm/opr/controller/AdmReliabilityController.java" 'operationId = "findAdmBatchJobInstanceLogs"' "ADM_BATCH_LOG_OPENAPI"
Test-RequiredFile "specs/sql/migration/flyway/V24__batch_job_instance_log_linkage.sql" "BAT_JOB_INSTANCE_LOG_FLYWAY"
Test-RequiredFile "scripts/check-log-management-standard.ps1" "LOG_MANAGEMENT_GATE"
Test-RequiredFile "scripts/write-sanitized-evidence.ps1" "SANITIZED_EVIDENCE_WRITER"
Test-RequiredText "pfw/src/main/java/cpf/pfw/config/PfwOpenApiAutoConfiguration.java" "cpfOperationIdCustomizer" "OPENAPI_OPERATION_ID_CUSTOMIZER"
Test-RequiredFile "scripts/check-openapi-source-coverage.ps1" "OPENAPI_SOURCE_COVERAGE_GATE"
Test-RequiredText "scripts/create-domain.ps1" "rootProject.ext.cpfJavaVersion" "CREATE_DOMAIN_JAVA_TARGET"
