...
$repositoryText = [System.IO.File]::ReadAllText((Join-Path $Root "pfw/src/main/java/cpf/pfw/common/servicecall/CpfServiceRegistryRepository.java"), [System.Text.Encoding]::UTF8)
