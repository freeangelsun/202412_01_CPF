...
| `flyway/V2__add_transaction_header_columns.sql` | 거래 헤더 컬럼 보강 |
| `flyway/V3__adm_cmn_batch_security_operations.sql` | 기존 DB 업그레이드 전환용 placeholder |
| `flyway/V4__batch_schedule_repository_notification.sql` | Spring Batch 표준 저장소, 배치 스케줄/관계/대상, 운영 알림 보강 |
