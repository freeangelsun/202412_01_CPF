package cpf.xyz.ai.controller;

import cpf.pfw.common.ai.CpfAiProviderPort;
import cpf.pfw.common.execution.CpfOnlineTransaction;
import cpf.xyz.ai.XyzAiEducationSample;
...
@RestController
@RequestMapping({"/api/xyz/reference/ai", "/xyz/edu/ai"})
@Tag(name = "XYZ Reference 16. AI", description = "LLM port, 구조화 출력, streaming, tool calling, RAG, 사람 승인 교육 샘플")
public class XyzAiEducationController extends cpf.xyz.common.base.XyzBaseController {
