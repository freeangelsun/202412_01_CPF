package cpf.xyz.batch.controller;
 ...
 */
@RestController
@RequestMapping({"/api/xyz/reference/batch", "/xyz/edu/batch"})
@Tag(name = "XYZ Reference 13. Batch", description = "PFW 공통 배치 API 기반 Spring Batch 유형별 개발 샘플")
public class XyzBatchEducationController extends cpf.xyz.common.base.XyzBaseController {
