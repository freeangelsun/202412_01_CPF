...
@Tag(name = "XYZ Reference 02. CMN Cache", description = "Common code, message, response code, and config cache samples")
public class XyzCmnEducationController extends cpf.xyz.common.base.XyzBaseController {
