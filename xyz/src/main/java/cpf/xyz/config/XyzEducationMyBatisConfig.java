...
/**
 * XYZ 기준 업무 조회 샘플에서 사용하는 MyBatis 설정입니다.
 *
 ...
 */
@Configuration
@MapperScan(basePackages = "cpf.xyz.query.adapter", sqlSessionFactoryRef = "xyzEduSqlSessionFactory")
    ...
    public SqlSessionFactory xyzEduSqlSessionFactory() throws Exception {
        ...
        factoryBean.setMapperLocations(
                new PathMatchingResourcePatternResolver()
                        .getResources("classpath:mybatis/mapper/xyz/**/*.xml")
        );
