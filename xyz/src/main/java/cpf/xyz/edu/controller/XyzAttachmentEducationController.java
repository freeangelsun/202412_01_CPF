...
import cpf.xyz.edu.attachment.XyzAttachmentEducationSample;
...
@RestController
@RequestMapping("/xyz/edu/attachments")
@Tag(name = "XYZ-EDU 17. 첨부파일", description = "안전한 첨부 저장, checksum, 저장 adapter 교체 교육 샘플")
public class XyzAttachmentEducationController {
