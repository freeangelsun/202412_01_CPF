 ...
 */
@RestController
@RequestMapping("/xyz/edu/center-cut")
@Tag(name = "XYZ-EDU 14. Center-Cut", description = "업무 DB 기반 center-cut target/provider/handler/result adapter 샘플")
public class XyzCenterCutEducationController {
    ...
    @PostMapping("/run")
    @CpfOnlineTransaction(id = "OXYZ-EDU-14-0001", name = "XYZCenterCut업무DBAdapter실행")
