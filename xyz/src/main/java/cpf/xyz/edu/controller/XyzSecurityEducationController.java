...
public class XyzSecurityEducationController {
    ...
    @FpsTransaction(id = "XYZ09EDU0030", name = "XYZBasicCrypto")
    ...
    @FpsTransaction(id = "XYZ09EDU0031", name = "XYZAesGcm")
    ...
    @FpsTransaction(id = "XYZ09EDU0032", name = "XYZPasswordHash")
    ...
    @FpsTransaction(id = "XYZ09EDU0033", name = "XYZJwtCreate")
    ...
    @FpsTransaction(id = "XYZ09EDU0034", name = "XYZJwtValidate")
    ...
    @FpsTransaction(id = "XYZ09EDU0035", name = "XYZJwtClaims")
    ...
    @FpsTransaction(id = "XYZ09EDU0036", name = "XYZOAuthBearerIntrospect")
