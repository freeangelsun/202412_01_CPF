package cpf.xyz.filetransfer.controller;
...
@Tag(name = "XYZ Reference 08. 파일 연계", description = "로컬 파일, 원격 파일 전송, SSH 명령 계획 샘플")
public class XyzFileExchangeEducationController extends cpf.xyz.common.base.XyzBaseController {
