package cpf.xyz.utility.controller;
...
@Tag(name = "XYZ Reference 04. Utility", description = "Common utilities and transaction header samples")
public class XyzUtilityEducationController extends cpf.xyz.common.base.XyzBaseController {
