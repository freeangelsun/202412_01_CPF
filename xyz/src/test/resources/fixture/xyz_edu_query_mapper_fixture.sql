CREATE TABLE IF NOT EXISTS cmn_edu_query_item (
    ...
    category_code VARCHAR(30) NOT NULL COMMENT '조회 패턴 분류 코드',
    status_code VARCHAR(30) NOT NULL COMMENT '상태 코드',
    owner_member_no VARCHAR(50) NULL COMMENT '샘플 담당 회원 번호',
...
INSERT INTO cmn_edu_query_item (
    ...
    (90005, '페이징 조회 샘플', 'PAGE', 'ACTIVE', 'MBR-90005', 'Y', 'MAPPER_TEST', '2026-06-05 09:00:00.000000', 'MAPPER_TEST', '2026-06-05 09:00:00.000000'),
